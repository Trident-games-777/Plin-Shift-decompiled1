...
public abstract class MapLikeSerializer<Key, Value, Collection, Builder extends Map<Key, Value>> extends AbstractCollectionSerializer<Map.Entry<? extends Key, ? extends Value>, Collection, Builder> {
    ...
    public final void readElement(CompositeDecoder compositeDecoder, int i, Builder builder, boolean z) {
        ...
        int i3 = i;
        Object decodeSerializableElement$default = CompositeDecoder.DefaultImpls.decodeSerializableElement$default(compositeDecoder2, getDescriptor(), i3, this.keySerializer, (Object) null, 8, (Object) null);
        CompositeDecoder compositeDecoder3 = compositeDecoder2;
        if (z) {
            i2 = compositeDecoder3.decodeElementIndex(getDescriptor());
            if (i2 != i3 + 1) {
                throw new IllegalArgumentException(("Value must follow key in a map, index for key: " + i3 + ", returned index for value: " + i2).toString());
            }
        } else {
            i2 = i3 + 1;
        }
        ...
        if (!builder.containsKey(decodeSerializableElement$default) || (this.valueSerializer.getDescriptor().getKind() instanceof PrimitiveKind)) {
            obj = CompositeDecoder.DefaultImpls.decodeSerializableElement$default(compositeDecoder3, getDescriptor(), i4, this.valueSerializer, (Object) null, 8, (Object) null);
        } else {
            obj = compositeDecoder3.decodeSerializableElement(getDescriptor(), i4, this.valueSerializer, MapsKt.getValue(builder, decodeSerializableElement$default));
        }
