...
final class ClassValueParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object m9427getgIAlus(KClass<Object> kClass, List<? extends KType> list) {
        Object obj;
        ...
        if (obj3 == null) {
            try {
                ...
                obj = Result.m7823constructorimpl(this.compute.invoke(kClass, list));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.Companion;
                obj = Result.m7823constructorimpl(ResultKt.createFailure(th));
            }
            Result r6 = Result.m7822boximpl(obj);
        ...
        return ((Result) obj3).m7832unboximpl();
    }
}
