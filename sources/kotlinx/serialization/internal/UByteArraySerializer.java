...
public final class UByteArraySerializer extends PrimitiveArraySerializer<UByte, UByteArray, UByteArrayBuilder> implements KSerializer<UByteArray> {
    ...
    public /* bridge */ /* synthetic */ int collectionSize(Object obj) {
        return m9436collectionSizeGBYM_sE(((UByteArray) obj).m7908unboximpl());
    }

    public /* bridge */ /* synthetic */ Object empty() {
        return UByteArray.m7892boximpl(m9437emptyTcUX1vc());
    }

    public /* bridge */ /* synthetic */ Object toBuilder(Object obj) {
        return m9438toBuilderGBYM_sE(((UByteArray) obj).m7908unboximpl());
    }

    public /* bridge */ /* synthetic */ void writeContent(CompositeEncoder compositeEncoder, Object obj, int i) {
        m9439writeContentCoi6ktg(compositeEncoder, ((UByteArray) obj).m7908unboximpl(), i);
    }
    ...
    public int m9436collectionSizeGBYM_sE(byte[] bArr) {
        Intrinsics.checkNotNullParameter(bArr, "$this$collectionSize");
        return UByteArray.m7900getSizeimpl(bArr);
    }

    /* access modifiers changed from: protected */
    /* renamed from: toBuilder-GBYM_sE  reason: not valid java name */
    public UByteArrayBuilder m9438toBuilderGBYM_sE(byte[] bArr) {
    ...
    public byte[] m9437emptyTcUX1vc() {
        return UByteArray.m7893constructorimpl(0);
    }
    ...
    public void readElement(CompositeDecoder compositeDecoder, int i, UByteArrayBuilder uByteArrayBuilder, boolean z) {
        ...
        uByteArrayBuilder.m9434append7apg3OU$kotlinx_serialization_core(UByte.m7841constructorimpl(compositeDecoder.decodeInlineElement(getDescriptor(), i).decodeByte()));
    }

    /* access modifiers changed from: protected */
    /* renamed from: writeContent-Coi6ktg  reason: not valid java name */
    public void m9439writeContentCoi6ktg(CompositeEncoder compositeEncoder, byte[] bArr, int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            compositeEncoder.encodeInlineElement(getDescriptor(), i2).encodeByte(UByteArray.m7899getw2LRezQ(bArr, i2));
        }
    }
}
