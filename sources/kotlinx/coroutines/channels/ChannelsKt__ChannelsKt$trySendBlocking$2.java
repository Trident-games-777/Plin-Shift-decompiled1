    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ...
            try {
                ...
                obj2 = Result.m7823constructorimpl(ResultKt.createFailure(th));
            }
        } else {
            throw new IllegalStateException("call to 'resume' before 'invoke' with coroutine");
        }
        obj2 = Result.m7823constructorimpl(Unit.INSTANCE);
        if (Result.m7830isSuccessimpl(obj2)) {
            obj3 = ChannelResult.Companion.m9372successJP2dKIU(Unit.INSTANCE);
        } else {
            obj3 = ChannelResult.Companion.m9370closedJP2dKIU(Result.m7826exceptionOrNullimpl(obj2));
        }
