...
public final class DelayKt {
    ...
    public static final Object m9331delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object delay = delay(m9332toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m9332toDelayMillisLRDsOJo(long j) {
        boolean r0 = Duration.m9189isPositiveimpl(j);
        if (r0) {
            Duration.Companion companion = Duration.Companion;
            return Duration.m9173getInWholeMillisecondsimpl(Duration.m9191plusLRDsOJo(j, DurationKt.toDuration(999999, DurationUnit.NANOSECONDS)));
        } else if (!r0) {
            return 0;
        } else {
