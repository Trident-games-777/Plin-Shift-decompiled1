        ...
        if (!DebugKt.getASSERTIONS_ENABLED() || this.resumeMode != -1) {
            try {
                ...
                if (job != null && !job.isActive()) {
                    ...
                    continuation.resumeWith(Result.m7823constructorimpl(ResultKt.createFailure(exceptionalResult$kotlinx_coroutines_core)));
                } else {
                    Result.Companion companion3 = Result.Companion;
                    continuation.resumeWith(Result.m7823constructorimpl(getSuccessfulResult$kotlinx_coroutines_core(takeState$kotlinx_coroutines_core)));
                }
