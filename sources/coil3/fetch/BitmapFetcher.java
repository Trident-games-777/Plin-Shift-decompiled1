...
public final class BitmapFetcher implements Fetcher {
    ...
    public Object fetch(Continuation<? super FetchResult> continuation) {
        return new ImageFetchResult(Image_androidKt.asImage((Drawable) new BitmapDrawable(this.options.getContext().getResources(), this.data)), false, DataSource.MEMORY);
    }
