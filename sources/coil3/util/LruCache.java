...
public class LruCache<K, V> {
    private final Map<K, V> map = Collections_jvmCommonKt.LruMutableMap$default(0, 0.0f, 3, (Object) null);
    ...
    public final void trimToSize(long j) {
        while (getSize() > j) {
            if (!this.map.isEmpty()) {
                ...
                entryRemoved(key, value, (Object) null);
            } else if (getSize() != 0) {
