...
public final class ServiceLoaderComponentRegistry {
    ...
    private static final Lazy decoders$delegate = LazyKt.lazy(new ServiceLoaderComponentRegistry$$ExternalSyntheticLambda1());
    private static final Lazy fetchers$delegate = LazyKt.lazy(new ServiceLoaderComponentRegistry$$ExternalSyntheticLambda0());
