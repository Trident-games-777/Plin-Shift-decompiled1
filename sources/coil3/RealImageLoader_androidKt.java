...
public final class RealImageLoader_androidKt {
    public static final boolean needsExecuteOnMainDispatcher(ImageRequest imageRequest) {
        return (imageRequest.getTarget() instanceof ViewTarget) || ImageRequests_androidKt.getLifecycle(imageRequest) != null;
    }
    ...
    public static final ComponentRegistry.Builder addAndroidComponents(ComponentRegistry.Builder builder, RealImageLoader.Options options) {
        builder.add(new AndroidUriMapper(), Reflection.getOrCreateKotlinClass(Uri.class));
        ...
        if (enableStaticImageDecoder(options)) {
            builder.add((Decoder.Factory) new StaticImageDecoder.Factory(Semaphore$default));
        }
        builder.add((Decoder.Factory) new BitmapFactoryDecoder.Factory(Semaphore$default, ImageLoaders_androidKt.getBitmapFactoryExifOrientationStrategy(options)));
        return builder;
    }
    ...
    private static final boolean enableStaticImageDecoder(RealImageLoader.Options options) {
        ...
        return Intrinsics.areEqual((Object) bitmapFactoryExifOrientationStrategy, (Object) ExifOrientationStrategy.RESPECT_PERFORMANCE) || Intrinsics.areEqual((Object) bitmapFactoryExifOrientationStrategy, (Object) ExifOrientationStrategy.RESPECT_ALL);
    }
}
