...
final class AsyncImagePainter$onRemembered$1$1 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    AsyncImagePainter$onRemembered$1$1(AsyncImagePainter asyncImagePainter, AsyncImagePreviewHandler asyncImagePreviewHandler, Continuation<? super AsyncImagePainter$onRemembered$1$1> continuation) {
    ...
    public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
        return new AsyncImagePainter$onRemembered$1$1(this.this$0, this.$previewHandler, continuation);
    }
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<AsyncImagePainter.Input, Continuation<? super AsyncImagePainter.State>, Object> {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            AnonymousClass2 r0 = new AnonymousClass2(asyncImagePainter, asyncImagePreviewHandler, continuation);
            r0.L$0 = obj;
            return r0;
        }
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            if (i == 0) {
                ...
                ImageRequest access$updateRequest = asyncImagePainter.updateRequest(input.getRequest(), true);
                this.label = 1;
                Object handle = asyncImagePreviewHandler.handle(input.getImageLoader(), access$updateRequest, this);
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (i == 0) {
            ResultKt.throwOnFailure(obj);
            Flow transformLatest = FlowKt.transformLatest(this.this$0.restartSignal, new AsyncImagePainter$onRemembered$1$1$invokeSuspend$$inlined$flatMapLatest$1((Continuation) null, this.this$0));
            final AsyncImagePainter asyncImagePainter = this.this$0;
            final AsyncImagePreviewHandler asyncImagePreviewHandler = this.$previewHandler;
