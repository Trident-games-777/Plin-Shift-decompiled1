...
public final class ImagePainter_androidKt {
    ...
    public static final Painter m7471asPainter55t9rM(Image image, Context context, int i) {
        if (image instanceof BitmapImage) {
            return BitmapPainterKt.m5038BitmapPainterQZhYCtY$default(AndroidImageBitmap_androidKt.asImageBitmap(((BitmapImage) image).getBitmap()), 0, 0, i, 6, (Object) null);
        }
    ...
    public static /* synthetic */ Painter m7472asPainter55t9rM$default(Image image, Context context, int i, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = DrawScope.Companion.m4868getDefaultFilterQualityfv9h1I();
        }
        return m7471asPainter55t9rM(image, context, i);
    }
}
