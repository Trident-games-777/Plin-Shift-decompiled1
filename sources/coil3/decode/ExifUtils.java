...
public final class ExifUtils {
    ...
    public final Bitmap reverseTransformations(Bitmap bitmap, ExifData exifData) {
        ...
        if (ExifUtilsKt.isRotated(exifData)) {
            matrix.postRotate((float) exifData.getRotationDegrees(), width, height);
        }
        ...
        if (ExifUtilsKt.isSwapped(exifData)) {
            bitmap2 = Bitmap.createBitmap(bitmap.getHeight(), bitmap.getWidth(), BitmapsKt.getSafeConfig(bitmap));
        } else {
            bitmap2 = Bitmap.createBitmap(bitmap.getWidth(), bitmap.getHeight(), BitmapsKt.getSafeConfig(bitmap));
        }
