...
public abstract class AbstractDoubleTimeSource implements TimeSource.WithComparableMarks {
    ...
    private static final class DoubleTimeMark implements ComparableTimeMark {
        ...
        public ComparableTimeMark m9133minusLRDsOJo(long j) {
            return ComparableTimeMark.DefaultImpls.m9150minusLRDsOJo(this, j);
        }

        /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
        public long m9131elapsedNowUwyO8pc() {
            return Duration.m9190minusLRDsOJo(DurationKt.toDuration(this.timeSource.read() - this.startedAt, this.timeSource.getUnit()), this.offset);
        }

        /* renamed from: plus-LRDsOJo  reason: not valid java name */
        public ComparableTimeMark m9136plusLRDsOJo(long j) {
            return new DoubleTimeMark(this.startedAt, this.timeSource, Duration.m9191plusLRDsOJo(this.offset, j), (DefaultConstructorMarker) null);
        }

        /* renamed from: minus-UwyO8pc  reason: not valid java name */
        public long m9134minusUwyO8pc(ComparableTimeMark comparableTimeMark) {
            ...
            if (comparableTimeMark instanceof DoubleTimeMark) {
                ...
                if (Intrinsics.areEqual((Object) this.timeSource, (Object) doubleTimeMark.timeSource)) {
                    if (Duration.m9160equalsimpl0(this.offset, doubleTimeMark.offset) && Duration.m9187isInfiniteimpl(this.offset)) {
                        return Duration.Companion.m9258getZEROUwyO8pc();
                    }
                    long r2 = Duration.m9190minusLRDsOJo(this.offset, doubleTimeMark.offset);
                    long duration = DurationKt.toDuration(this.startedAt - doubleTimeMark.startedAt, this.timeSource.getUnit());
                    return Duration.m9160equalsimpl0(duration, Duration.m9208unaryMinusUwyO8pc(r2)) ? Duration.Companion.m9258getZEROUwyO8pc() : Duration.m9191plusLRDsOJo(duration, r2);
                }
            }
        ...
        public boolean equals(Object obj) {
            return (obj instanceof DoubleTimeMark) && Intrinsics.areEqual((Object) this.timeSource, (Object) ((DoubleTimeMark) obj).timeSource) && Duration.m9160equalsimpl0(m9134minusUwyO8pc((ComparableTimeMark) obj), Duration.Companion.m9258getZEROUwyO8pc());
        }

        public int hashCode() {
            return Duration.m9183hashCodeimpl(Duration.m9191plusLRDsOJo(DurationKt.toDuration(this.startedAt, this.timeSource.getUnit()), this.offset));
        }

        public String toString() {
            return "DoubleTimeMark(" + this.startedAt + DurationUnitKt.shortName(this.timeSource.getUnit()) + " + " + Duration.m9204toStringimpl(this.offset) + ", " + this.timeSource + ')';
        }
    }

    public ComparableTimeMark markNow() {
        return new DoubleTimeMark(read(), this, Duration.Companion.m9258getZEROUwyO8pc(), (DefaultConstructorMarker) null);
    }
}
