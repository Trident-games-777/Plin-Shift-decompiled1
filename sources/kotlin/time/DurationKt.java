...
public final class DurationKt {
    ...
    private static final long m9282timesmvk6XK0(int i, long j) {
        return Duration.m9193timesUwyO8pc(j, i);
    }

    /* renamed from: times-kIfJnKk  reason: not valid java name */
    private static final long m9281timeskIfJnKk(double d, long j) {
        return Duration.m9192timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        if (length != 0) {
            long r72 = Duration.Companion.m9258getZEROUwyO8pc();
            ...
            if (length > i3) {
                ...
                if (str2.charAt(i3) == 'P') {
                                ...
                                if (charSequence.length() != 0) {
                                    ...
                                    if (durationUnit2 == null || durationUnit2.compareTo(durationUnitByIsoChar) > 0) {
                                        ...
                                        if (durationUnitByIsoChar != DurationUnit.SECONDS || indexOf$default <= 0) {
                                            r72 = Duration.m9191plusLRDsOJo(r72, toDuration(parseOverLongIsoComponent(substring), durationUnitByIsoChar));
                                        } else {
                                            Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                                            String substring2 = substring.substring(0, indexOf$default);
                                            Intrinsics.checkNotNullExpressionValue(substring2, "substring(...)");
                                            long r73 = Duration.m9191plusLRDsOJo(r72, toDuration(parseOverLongIsoComponent(substring2), durationUnitByIsoChar));
                                            Intrinsics.checkNotNull(substring, "null cannot be cast to non-null type java.lang.String");
                                            String substring3 = substring.substring(indexOf$default);
                                            Intrinsics.checkNotNullExpressionValue(substring3, "substring(...)");
                                            r72 = Duration.m9191plusLRDsOJo(r73, toDuration(Double.parseDouble(substring3), durationUnitByIsoChar));
                                        }
                    ...
                    if (!z) {
                        ...
                        if (StringsKt.regionMatches(str2, i3, "Infinity", 0, Math.max(i6 - i3, "Infinity".length()), true)) {
                            r72 = Duration.Companion.m9256getINFINITEUwyO8pc();
                        } else {
                            boolean z5 = !z2;
                                ...
                                if (charSequence3.length() != 0) {
                                    ...
                                    if (durationUnit == null || durationUnit.compareTo(durationUnitByShortName) > 0) {
                                        ...
                                        if (indexOf$default2 > 0) {
                                            ...
                                            long r74 = Duration.m9191plusLRDsOJo(r72, toDuration(Long.parseLong(substring6), durationUnitByShortName));
                                            Intrinsics.checkNotNull(substring4, "null cannot be cast to non-null type java.lang.String");
                                            String substring7 = substring4.substring(indexOf$default2);
                                            Intrinsics.checkNotNullExpressionValue(substring7, str3);
                                            r7 = Duration.m9191plusLRDsOJo(r74, toDuration(Double.parseDouble(substring7), durationUnitByShortName));
                                            if (i3 < i) {
                                                throw new IllegalArgumentException("Fractional component must be last");
                                            }
                                        } else {
                                            r7 = Duration.m9191plusLRDsOJo(r72, toDuration(Long.parseLong(substring4), durationUnitByShortName));
                                        }
                ...
                if (z3) {
                    return Duration.m9208unaryMinusUwyO8pc(r72);
                }
                return r72;
            }
            throw new IllegalArgumentException("No components");
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m9155constructorimpl(j << 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m9155constructorimpl((j << 1) + 1);
    }

    /* access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m9155constructorimpl((j << 1) + ((long) i));
    }
