...
final class AdjustedTimeMark implements TimeMark {
    ...
    public final long m9144getAdjustmentUwyO8pc() {
    ...
    public TimeMark m9145minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m9295minusLRDsOJo(this, j);
    }

    /* renamed from: elapsedNow-UwyO8pc  reason: not valid java name */
    public long m9143elapsedNowUwyO8pc() {
        return Duration.m9190minusLRDsOJo(this.mark.m9292elapsedNowUwyO8pc(), this.adjustment);
    }

    /* renamed from: plus-LRDsOJo  reason: not valid java name */
    public TimeMark m9146plusLRDsOJo(long j) {
        return new AdjustedTimeMark(this.mark, Duration.m9191plusLRDsOJo(this.adjustment, j), (DefaultConstructorMarker) null);
    }
}
