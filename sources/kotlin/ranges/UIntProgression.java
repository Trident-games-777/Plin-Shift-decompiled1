...
public class UIntProgression implements Iterable<UInt>, KMappedMarker {
    ...
    private UIntProgression(int i, int i2, int i3) {
        if (i3 == 0) {
            ...
            this.first = i;
            this.last = UProgressionUtilKt.m9028getProgressionLastElementNkh28Cs(i, i2, i3);
            this.step = i3;
        } else {
    ...
    public final int m9042getFirstpVg5ArA() {
        return this.first;
    }

    /* renamed from: getLast-pVg5ArA  reason: not valid java name */
    public final int m9043getLastpVg5ArA() {
        return this.last;
    }
    ...
    public String toString() {
        ...
        int i;
        if (this.step > 0) {
            append = new StringBuilder().append(UInt.m7964toStringimpl(this.first)).append("..").append(UInt.m7964toStringimpl(this.last)).append(" step ");
            i = this.step;
        } else {
            append = new StringBuilder().append(UInt.m7964toStringimpl(this.first)).append(" downTo ").append(UInt.m7964toStringimpl(this.last)).append(" step ");
            i = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final UIntProgression m9044fromClosedRangeNkh28Cs(int i, int i2, int i3) {
