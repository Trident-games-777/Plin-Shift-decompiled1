...
class UCollectionsKt___UCollectionsKt {
    public static final byte[] toUByteArray(Collection<UByte> collection) {
        ...
        byte[] r0 = UByteArray.m7893constructorimpl(collection.size());
        int i = 0;
        for (UByte r2 : collection) {
            UByteArray.m7904setVurrAj0(r0, i, r2.m7891unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int[] toUIntArray(Collection<UInt> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        int[] r0 = UIntArray.m7972constructorimpl(collection.size());
        int i = 0;
        for (UInt r2 : collection) {
            UIntArray.m7983setVXSXFK8(r0, i, r2.m7970unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final long[] toULongArray(Collection<ULong> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        long[] r0 = ULongArray.m8051constructorimpl(collection.size());
        int i = 0;
        for (ULong r2 : collection) {
            ULongArray.m8062setk8EXiF4(r0, i, r2.m8049unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final short[] toUShortArray(Collection<UShort> collection) {
        Intrinsics.checkNotNullParameter(collection, "<this>");
        short[] r0 = UShortArray.m8156constructorimpl(collection.size());
        int i = 0;
        for (UShort r2 : collection) {
            UShortArray.m8167set01HTLdE(r0, i, r2.m8154unboximpl());
            i++;
        }
        return r0;
    }
    ...
    public static final int sumOfUInt(Iterable<UInt> iterable) {
        ...
        for (UInt r1 : iterable) {
            i = UInt.m7918constructorimpl(i + r1.m7970unboximpl());
        }
        return i;
    }
    ...
    public static final long sumOfULong(Iterable<ULong> iterable) {
        ...
        for (ULong r2 : iterable) {
            j = ULong.m7997constructorimpl(j + r2.m8049unboximpl());
        }
        return j;
    }
    ...
    public static final int sumOfUByte(Iterable<UByte> iterable) {
        ...
        for (UByte r1 : iterable) {
            i = UInt.m7918constructorimpl(i + UInt.m7918constructorimpl(r1.m7891unboximpl() & 255));
        }
        return i;
    }
    ...
    public static final int sumOfUShort(Iterable<UShort> iterable) {
        ...
        for (UShort r1 : iterable) {
            i = UInt.m7918constructorimpl(i + UInt.m7918constructorimpl(r1.m8154unboximpl() & UShort.MAX_VALUE));
        }
        return i;
    }
}
