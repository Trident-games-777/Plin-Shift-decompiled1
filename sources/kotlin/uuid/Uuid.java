...
public final class Uuid implements Serializable {
    ...
    private final <T> T toULongs(Function2<? super ULong, ? super ULong, ? extends T> function2) {
        Intrinsics.checkNotNullParameter(function2, "action");
        return function2.invoke(ULong.m7991boximpl(ULong.m7997constructorimpl(getMostSignificantBits())), ULong.m7991boximpl(ULong.m7997constructorimpl(getLeastSignificantBits())));
    }
    ...
    public static final class Companion {
        ...
        public final Uuid m9327fromULongseb3DHEI(long j, long j2) {
    ...
    public static final int LEXICAL_ORDER$lambda$2(Uuid uuid, Uuid uuid2) {
        ...
        if (j != uuid2.mostSignificantBits) {
            return Long.compareUnsigned(ULong.m7997constructorimpl(j), ULong.m7997constructorimpl(uuid2.mostSignificantBits));
        }
        return Long.compareUnsigned(ULong.m7997constructorimpl(uuid.leastSignificantBits), ULong.m7997constructorimpl(uuid2.leastSignificantBits));
    }
}
