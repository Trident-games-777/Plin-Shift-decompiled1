...
public final class ULongArrayKt {
    ...
    private static final long[] m8068ulongArrayOfQwZRm1k(long... jArr) {
    ...
    private static final long[] ULongArray(int i, Function1<? super Integer, ULong> function1) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            jArr[i2] = function1.invoke(Integer.valueOf(i2)).m8049unboximpl();
        }
        return ULongArray.m8052constructorimpl(jArr);
    }
}
