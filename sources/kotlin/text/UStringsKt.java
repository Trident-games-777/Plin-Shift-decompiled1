...
public final class UStringsKt {
    ...
    public static final String m9128toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m9130toStringolVBNx4(short s, int i) {
    ...
    public static final String m9129toStringV7xB4Y4(int i, int i2) {
        return UnsignedKt.ulongToString(((long) i) & 4294967295L, CharsKt.checkRadix(i2));
    }

    /* renamed from: toString-JSWoG40  reason: not valid java name */
    public static final String m9127toStringJSWoG40(long j, int i) {
    ...
    public static final byte toUByte(String str) {
        ...
        if (uByteOrNull != null) {
            return uByteOrNull.m7891unboximpl();
        }
    ...
    public static final short toUShort(String str) {
        ...
        if (uShortOrNull != null) {
            return uShortOrNull.m8154unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final int toUInt(String str) {
        ...
        if (uIntOrNull != null) {
            return uIntOrNull.m7970unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final long toULong(String str) {
        ...
        if (uLongOrNull != null) {
            return uLongOrNull.m8049unboximpl();
        }
        StringsKt.numberFormatError(str);
        throw new KotlinNothingValueException();
    }
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m7970unboximpl();
        if (Integer.compareUnsigned(r1, UInt.m7918constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m7835boximpl(UByte.m7841constructorimpl((byte) r1));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int r1 = uIntOrNull.m7970unboximpl();
        if (Integer.compareUnsigned(r1, UInt.m7918constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m8098boximpl(UShort.m8104constructorimpl((short) r1));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int r3 = UInt.m7918constructorimpl(i);
        int i4 = 119304647;
        while (i2 < length) {
            ...
            int r2 = UInt.m7918constructorimpl(i3 * r3);
            int r7 = UInt.m7918constructorimpl(UInt.m7918constructorimpl(digitOf) + r2);
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long r5 = ULong.m7997constructorimpl((long) i2);
        long j = 0;
        ...
        while (i3 < length) {
            ...
            long r9 = ULong.m7997constructorimpl(j * r5);
            long r13 = ULong.m7997constructorimpl(ULong.m7997constructorimpl(((long) UInt.m7918constructorimpl(digitOf)) & 4294967295L) + r9);
