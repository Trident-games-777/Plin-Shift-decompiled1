...
public final class FileSystem {
    ...
    /* JADX WARNING: Removed duplicated region for block: B:20:0x0047 A[Catch:{ all -> 0x0038, all -> 0x003f, all -> 0x005f }] */
    ...
    public static final void commonCopy(okio.FileSystem r4, okio.Path r5, okio.Path r6) throws java.io.IOException {
        /*
            ...
            r0 = 0
            r1 = r5
            okio.Source r1 = (okio.Source) r1     // Catch:{ all -> 0x005f }
            okio.Sink r4 = r4.sink(r6)     // Catch:{ all -> 0x005f }
            okio.BufferedSink r4 = okio.Okio.buffer((okio.Sink) r4)     // Catch:{ all -> 0x005f }
        ...
        L_0x003f:
            r4 = move-exception
            kotlin.ExceptionsKt.addSuppressed(r6, r4)     // Catch:{ all -> 0x005f }
        L_0x0043:
            r4 = r6
            r6 = r0
        L_0x0045:
            if (r4 != 0) goto L_0x005e
            java.lang.Object r6 = (java.lang.Object) r6     // Catch:{ all -> 0x005f }
            java.lang.Number r6 = (java.lang.Number) r6     // Catch:{ all -> 0x005f }
            long r1 = r6.longValue()     // Catch:{ all -> 0x005f }
            java.lang.Long r4 = java.lang.Long.valueOf(r1)     // Catch:{ all -> 0x005f }
