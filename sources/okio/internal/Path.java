...
public final class Path {
    ...
    /* access modifiers changed from: private */
    public static final ByteString SLASH = ByteString.Companion.encodeUtf8(RemoteSettings.FORWARD_SLASH_STRING);
    ...
    public static final okio.Path commonRelativeTo(okio.Path path, okio.Path path2) {
        ...
        if (Intrinsics.areEqual((Object) path.getRoot(), (Object) path2.getRoot())) {
            ...
            } else if (Intrinsics.areEqual((Object) path2.getBytes$okio(), (Object) DOT)) {
                return path;
            } else {
                Buffer buffer = new Buffer();
