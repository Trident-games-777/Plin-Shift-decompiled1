...
public final class SegmentedByteString {
    ...
    public static final int segment(C0013SegmentedByteString segmentedByteString, int i) {
    ...
    public static final void forEachSegment(C0013SegmentedByteString segmentedByteString, Function3<? super byte[], ? super Integer, ? super Integer, Unit> function3) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    private static final void forEachSegment(C0013SegmentedByteString segmentedByteString, int i, int i2, Function3<? super byte[], ? super Integer, ? super Integer, Unit> function3) {
        int i3;
    ...
    public static final ByteString commonSubstring(C0013SegmentedByteString segmentedByteString, int i, int i2) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    public static final byte commonInternalGet(C0013SegmentedByteString segmentedByteString, int i) {
        int i2;
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    public static final int commonGetSize(C0013SegmentedByteString segmentedByteString) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
        return segmentedByteString.getDirectory$okio()[((Object[]) segmentedByteString.getSegments$okio()).length - 1];
    }

    public static final byte[] commonToByteArray(C0013SegmentedByteString segmentedByteString) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    public static final boolean commonRangeEquals(C0013SegmentedByteString segmentedByteString, int i, ByteString byteString, int i2, int i3) {
        int i4;
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    public static final boolean commonRangeEquals(C0013SegmentedByteString segmentedByteString, int i, byte[] bArr, int i2, int i3) {
        int i4;
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    public static final void commonCopyInto(C0013SegmentedByteString segmentedByteString, int i, byte[] bArr, int i2, int i3) {
        int i4;
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    public static final boolean commonEquals(C0013SegmentedByteString segmentedByteString, Object obj) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    public static final int commonHashCode(C0013SegmentedByteString segmentedByteString) {
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
    ...
    public static final void commonWrite(C0013SegmentedByteString segmentedByteString, Buffer buffer, int i, int i2) {
        int i3;
        Intrinsics.checkNotNullParameter(segmentedByteString, "<this>");
