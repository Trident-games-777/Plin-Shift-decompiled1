...
public final class TypedOptions<T> extends AbstractList<T> implements RandomAccess {
    ...
    public TypedOptions(List<? extends T> list2, Options options2) {
        Intrinsics.checkNotNullParameter(list2, "list");
        Intrinsics.checkNotNullParameter(options2, "options");
        this.options = options2;
        List<T> list3 = CollectionsKt.toList(list2);
        this.list = list3;
        if (list3.size() != options2.size()) {
    ...
    public static final class Companion {
        ...
        public final <T> okio.TypedOptions<T> of(java.lang.Iterable<? extends T> r6, kotlin.jvm.functions.Function1<? super T, ? extends okio.ByteString> r7) {
            /*
                r5 = this;
