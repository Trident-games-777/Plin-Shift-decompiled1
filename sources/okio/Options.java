...
public final class Options extends AbstractList<ByteString> implements RandomAccess {
    ...
    public static final class Companion {
        ...
        public final Options of(ByteString... byteStringArr) {
            ...
            int i3 = 0;
            while (i2 < length) {
                list.set(CollectionsKt.binarySearch$default(mutableList, (Comparable) byteStringArr2[i2], 0, 0, 6, (Object) null), Integer.valueOf(i3));
                i2++;
                i3++;
            }
            if (((ByteString) mutableList.get(0)).size() > 0) {
                ...
                while (i4 < mutableList.size()) {
                    ...
                    while (i6 < mutableList.size()) {
                        ...
                        } else if (((Number) list.get(i6)).intValue() > ((Number) list.get(i4)).intValue()) {
                ...
                buildTrieRecursive$default(this, 0, buffer, 0, list2, 0, 0, list, 53, (Object) null);
