...
public final class SeqViewModel$doOnFinish$lambda$5$$inlined$sortByDescending$1<T> implements Comparator {
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues(Integer.valueOf(((LeaderModel) t2).getScore()), Integer.valueOf(((LeaderModel) t).getScore()));
    }
}
