...
public class FirebaseMessaging {
    ...
    static Provider<TransportFactory> transportFactory = new FirebaseMessaging$$ExternalSyntheticLambda8();
    ...
    FirebaseMessaging(FirebaseApp firebaseApp2, FirebaseInstanceIdInternal firebaseInstanceIdInternal, Provider<TransportFactory> provider, Subscriber subscriber, Metadata metadata2, GmsRpc gmsRpc2, Executor executor, Executor executor2, Executor executor3) {
        ...
        if (firebaseInstanceIdInternal != null) {
            firebaseInstanceIdInternal.addNewTokenListener(new FirebaseMessaging$$ExternalSyntheticLambda3(this));
        }
        executor2.execute(new FirebaseMessaging$$ExternalSyntheticLambda4(this));
        ...
        createInstance.addOnSuccessListener(executor2, (OnSuccessListener<? super TopicsSubscriber>) new FirebaseMessaging$$ExternalSyntheticLambda5(this));
    ...
    public /* synthetic */ void m7752lambda$new$2$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    public /* synthetic */ void m7753lambda$new$3$comgooglefirebasemessagingFirebaseMessaging(TopicsSubscriber topicsSubscriber) {
        if (isAutoInitEnabled()) {
    ...
    public void m7754lambda$new$4$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    private void handleProxiedNotificationData() {
        this.gmsRpc.getProxyNotificationData().addOnSuccessListener(this.initExecutor, new FirebaseMessaging$$ExternalSyntheticLambda12(this));
    }
    ...
    public /* synthetic */ void m7750lambda$handleProxiedNotificationData$5$comgooglefirebasemessagingFirebaseMessaging(CloudMessage cloudMessage) {
    ...
    public Task<Void> setNotificationDelegationEnabled(boolean z) {
        return ProxyNotificationInitializer.setEnableProxyNotification(this.initExecutor, this.context, z).addOnSuccessListener((Executor) new AdIdManager$Api33Ext4Impl$$ExternalSyntheticLambda0(), new FirebaseMessaging$$ExternalSyntheticLambda10(this));
    }
    ...
    public /* synthetic */ void m7755lambda$setNotificationDelegationEnabled$6$comgooglefirebasemessagingFirebaseMessaging(Void voidR) {
        ProxyNotificationPreferences.setProxyRetention(this.context, this.gmsRpc, shouldRetainProxyNotifications());
    }
    ...
    public Task<String> getToken() {
        ...
        this.initExecutor.execute(new FirebaseMessaging$$ExternalSyntheticLambda11(this, taskCompletionSource));
        return taskCompletionSource.getTask();
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$getToken$7$com-google-firebase-messaging-FirebaseMessaging  reason: not valid java name */
    public /* synthetic */ void m7749lambda$getToken$7$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public Task<Void> deleteToken() {
        if (this.iid != null) {
            ...
            FcmExecutors.newNetworkIOExecutor().execute(new FirebaseMessaging$$ExternalSyntheticLambda2(this, taskCompletionSource2));
    ...
    public /* synthetic */ void m7747lambda$deleteToken$8$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public /* synthetic */ void m7748lambda$deleteToken$9$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public Task<Void> unsubscribeFromTopic(String str) {
        return this.topicsSubscriberTask.onSuccessTask(new FirebaseMessaging$$ExternalSyntheticLambda13(str));
    }
    ...
    static void clearTransportFactoryForTest() {
        transportFactory = new FirebaseMessaging$$ExternalSyntheticLambda7();
    }
    ...
    public String blockingGetToken() throws IOException {
        ...
        if (firebaseInstanceIdInternal != null) {
            ...
            try {
                return (String) Tasks.await(this.requestDeduplicator.getOrStartGetTokenRequest(defaultSenderId, new FirebaseMessaging$$ExternalSyntheticLambda14(this, defaultSenderId, tokenWithoutTriggeringSync)));
    ...
    public /* synthetic */ Task m7746lambda$blockingGetToken$14$comgooglefirebasemessagingFirebaseMessaging(String str, Store.Token token) {
        return this.gmsRpc.getToken().onSuccessTask(this.fileExecutor, new FirebaseMessaging$$ExternalSyntheticLambda9(this, str, token));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$blockingGetToken$13$com-google-firebase-messaging-FirebaseMessaging  reason: not valid java name */
    public /* synthetic */ Task m7745lambda$blockingGetToken$13$comgooglefirebasemessagingFirebaseMessaging(String str, Store.Token token, String str2) throws Exception {
        getStore(this.context).saveToken(getSubtype(), str, str2, this.metadata.getAppVersionCode());
        if (token == null || !str2.equals(token.token)) {
            m7751lambda$new$1$comgooglefirebasemessagingFirebaseMessaging(str2);
        }
    ...
    public void m7751lambda$new$1$comgooglefirebasemessagingFirebaseMessaging(String str) {
        if (FirebaseApp.DEFAULT_APP_NAME.equals(this.firebaseApp.getName())) {
    ...
    private class AutoInit {
        ...
        public /* synthetic */ void m7756lambda$initialize$0$comgooglefirebasemessagingFirebaseMessaging$AutoInit(Event event) {
            if (isEnabled()) {
