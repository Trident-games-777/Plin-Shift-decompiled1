...
public final class MessagingClientEvent {
    ...
    public static final class Builder {
        ...
        public MessagingClientEvent build() {
            ...
            String str = this.message_id_;
            String str2 = this.instance_id_;
            MessageType messageType = this.message_type_;
            SDKPlatform sDKPlatform = this.sdk_platform_;
            String str3 = this.package_name_;
            String str4 = this.collapse_key_;
            int i = this.priority_;
            int i2 = this.ttl_;
            String str5 = this.topic_;
            long j2 = this.bulk_id_;
            Event event = this.event_;
            String str6 = this.analytics_label_;
            return new MessagingClientEvent(j, str, str2, messageType, sDKPlatform, str3, str4, i, i2, str5, j2, event, str6, this.campaign_id_, this.composer_label_);
        }
