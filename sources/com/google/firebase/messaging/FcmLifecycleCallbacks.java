...
class FcmLifecycleCallbacks implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityCreated(Activity activity, Bundle bundle) {
        ...
        if (intent != null) {
            m7744lambda$onActivityCreated$0$comgooglefirebasemessagingFcmLifecycleCallbacks(intent);
        }
    }

    /* access modifiers changed from: private */
    /* renamed from: logNotificationOpen */
    public void m7744lambda$onActivityCreated$0$comgooglefirebasemessagingFcmLifecycleCallbacks(Intent intent) {
        Bundle bundle = null;
        try {
