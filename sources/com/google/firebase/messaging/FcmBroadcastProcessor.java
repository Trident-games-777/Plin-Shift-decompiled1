...
public class FcmBroadcastProcessor {
    ...
    static /* synthetic */ Task lambda$startMessagingService$2(Context context2, Intent intent, boolean z, Task task) throws Exception {
        return (!PlatformVersion.isAtLeastO() || ((Integer) task.getResult()).intValue() != 402) ? task : bindToMessagingService(context2, intent, z).continueWith(new AdIdManager$Api33Ext4Impl$$ExternalSyntheticLambda0(), new FcmBroadcastProcessor$$ExternalSyntheticLambda0());
    }
