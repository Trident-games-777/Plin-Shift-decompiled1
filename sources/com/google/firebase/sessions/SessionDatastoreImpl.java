...
public final class SessionDatastoreImpl implements SessionDatastore {
    ...
    public SessionDatastoreImpl(Context context2, CoroutineContext coroutineContext) {
        ...
        this.firebaseSessionDataFlow = new SessionDatastoreImpl$special$$inlined$map$1(FlowKt.m9384catch(Companion.getDataStore(context2).getData(), new SessionDatastoreImpl$firebaseSessionDataFlow$1((Continuation<? super SessionDatastoreImpl$firebaseSessionDataFlow$1>) null)), this);
