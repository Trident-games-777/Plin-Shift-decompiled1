...
public final class SessionsSettings {
    ...
    private SessionsSettings(android.content.Context r9, kotlin.coroutines.CoroutineContext r10, kotlin.coroutines.CoroutineContext r11, com.google.firebase.installations.FirebaseInstallationsApi r12, com.google.firebase.sessions.ApplicationInfo r13) {
        /*
            r8 = this;
            ...
            com.google.firebase.sessions.settings.RemoteSettings r1 = new com.google.firebase.sessions.settings.RemoteSettings
            com.google.firebase.sessions.settings.RemoteSettingsFetcher r2 = new com.google.firebase.sessions.settings.RemoteSettingsFetcher
            r6 = 4
            r7 = 0
            r5 = 0
            r4 = r10
            ...
            r5 = r2
            com.google.firebase.sessions.settings.CrashlyticsSettingsFetcher r5 = (com.google.firebase.sessions.settings.CrashlyticsSettingsFetcher) r5
            com.google.firebase.sessions.settings.SessionsSettings$Companion r10 = Companion
            androidx.datastore.core.DataStore r6 = r10.getDataStore(r9)
            r2 = r11
            r4 = r3
            r3 = r12
    ...
    public final long m7769getSessionRestartTimeoutUwyO8pc() {
        Duration r0 = this.localOverrideSettings.m7770getSessionRestartTimeoutFghU774();
        if (r0 != null) {
            long r02 = r0.m9210unboximpl();
            if (m7768isValidSessionRestartTimeoutLRDsOJo(r02)) {
                return r02;
            }
        }
        Duration r03 = this.remoteSettings.m7770getSessionRestartTimeoutFghU774();
        if (r03 != null) {
            long r04 = r03.m9210unboximpl();
            if (m7768isValidSessionRestartTimeoutLRDsOJo(r04)) {
                return r04;
            }
        }
    ...
    private final boolean m7768isValidSessionRestartTimeoutLRDsOJo(long j) {
        return Duration.m9189isPositiveimpl(j) && Duration.m9184isFiniteimpl(j);
    }

    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0059, code lost:
        if (r6.updateSettings(r0) != r1) goto L_0x005c;
     */
