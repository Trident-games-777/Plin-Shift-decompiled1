...
final class RemoteSettings$updateSettings$2$1 extends SuspendLambda implements Function2<JSONObject, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:42:0x0119, code lost:
        if (r2.getSettingsCache().updateSessionRestartTimeout((java.lang.Integer) r8.element, r12) != r4) goto L_0x011d;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:46:0x013f, code lost:
        if (r2.getSettingsCache().updateSamplingRate((java.lang.Double) r1.element, r12) != r4) goto L_0x0142;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:50:0x0164, code lost:
        if (r1.getSettingsCache().updateSessionCacheDuration((java.lang.Integer) r0.element, r12) != r4) goto L_0x0167;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:55:0x0187, code lost:
        if (r13.updateSessionCacheDuration(r0, r12) != r4) goto L_0x018a;
     */
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:57:0x01a8, code lost:
        if (r12.this$0.getSettingsCache().updateSessionCacheUpdatedTime(kotlin.coroutines.jvm.internal.Boxing.boxLong(java.lang.System.currentTimeMillis()), r12) != r4) goto L_0x01ab;
     */
