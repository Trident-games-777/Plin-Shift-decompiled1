...
public class CrashlyticsReportDataCapture {
    ...
    public CrashlyticsReport.Session.Event captureEventData(Throwable th, Thread thread, String str, long j, int i, int i2, boolean z) {
        ...
        int i4 = i3;
        return CrashlyticsReport.Session.Event.builder().setType(str).setTimestamp(j).setApp(populateEventApplicationData(i4, makeTrimmedThrowableData, thread, i, i2, z)).setDevice(populateEventDeviceData(i4)).build();
    }
