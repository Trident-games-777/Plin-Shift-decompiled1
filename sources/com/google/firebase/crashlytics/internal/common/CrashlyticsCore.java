...
public class CrashlyticsCore {
    ...
    public boolean onPreExecute(AppData appData, SettingsProvider settingsProvider) {
        ...
        if (isBuildIdValid(appData2.buildId, CommonUtils.getBooleanResourceValue(this.context, CRASHLYTICS_REQUIRE_BUILD_ID, true))) {
            ...
            try {
                ...
                SessionReportingCoordinator create = SessionReportingCoordinator.create(this.context, this.idManager, this.fileStore, appData2, logFileManager, userMetadata, middleOutFallbackStrategy, settingsProvider2, this.onDemandCounter, this.sessionsSubscriber, this.crashlyticsWorkers);
                ...
                this.controller = new CrashlyticsController(context2, idManager3, dataCollectionArbiter3, fileStore3, crashlyticsFileMarker2, appData, userMetadata, logFileManager, create, this.nativeComponent, this.analyticsEventLogger, this.sessionsSubscriber, this.crashlyticsWorkers);
    ...
    public void m7716lambda$finishInitSynchronously$9$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(SettingsProvider settingsProvider) {
        CrashlyticsWorkers.checkBackgroundThread();
        markInitializationStarted();
        try {
            this.breadcrumbSource.registerBreadcrumbHandler(new CrashlyticsCore$$ExternalSyntheticLambda4(this));
    ...
    public void logException(Throwable th) {
        this.crashlyticsWorkers.common.submit((Runnable) new CrashlyticsCore$$ExternalSyntheticLambda3(this, th));
    }
    ...
    public /* synthetic */ void m7719lambda$logException$1$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(Throwable th) {
        this.controller.writeNonFatalException(Thread.currentThread(), th);
    }

    public void log(String str) {
        this.crashlyticsWorkers.common.submit((Runnable) new CrashlyticsCore$$ExternalSyntheticLambda11(this, System.currentTimeMillis() - this.startTime, str));
    }

    /* access modifiers changed from: package-private */
    /* renamed from: lambda$log$2$com-google-firebase-crashlytics-internal-common-CrashlyticsCore  reason: not valid java name */
    public /* synthetic */ void m7717lambda$log$2$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(long j, String str) {
    ...
    public /* synthetic */ void m7718lambda$log$3$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(long j, String str) {
        this.crashlyticsWorkers.diskWrite.submit((Runnable) new CrashlyticsCore$$ExternalSyntheticLambda9(this, j, str));
    }
    ...
    public /* synthetic */ void m7724lambda$setUserId$4$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(String str) {
        this.controller.setUserId(str);
    }

    public void setUserId(String str) {
        this.crashlyticsWorkers.common.submit((Runnable) new CrashlyticsCore$$ExternalSyntheticLambda6(this, str));
    }
    ...
    public /* synthetic */ void m7721lambda$setCustomKey$5$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(String str, String str2) {
        this.controller.setCustomKey(str, str2);
    }

    public void setCustomKey(String str, String str2) {
        this.crashlyticsWorkers.common.submit((Runnable) new CrashlyticsCore$$ExternalSyntheticLambda7(this, str, str2));
    }
    ...
    public /* synthetic */ void m7722lambda$setCustomKeys$6$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(Map map) {
        this.controller.setCustomKeys(map);
    }

    public void setCustomKeys(Map<String, String> map) {
        this.crashlyticsWorkers.common.submit((Runnable) new CrashlyticsCore$$ExternalSyntheticLambda1(this, map));
    }
    ...
    public /* synthetic */ void m7723lambda$setInternalKey$7$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(String str, String str2) {
    ...
    public void logFatalException(Throwable th) {
        ...
        this.crashlyticsWorkers.common.submit((Runnable) new CrashlyticsCore$$ExternalSyntheticLambda5(this, th));
    }
    ...
    public /* synthetic */ void m7720lambda$logFatalException$8$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(Throwable th) {
    ...
    private void finishInitSynchronously(SettingsProvider settingsProvider) {
        Future<?> submit = this.crashlyticsWorkers.common.getExecutor().submit(new CrashlyticsCore$$ExternalSyntheticLambda2(this, settingsProvider));
    ...
    private void checkForPreviousCrash() {
        try {
            this.didCrashOnPreviousExecution = Boolean.TRUE.equals((Boolean) this.crashlyticsWorkers.common.getExecutor().submit(new CrashlyticsCore$$ExternalSyntheticLambda10(this)).get(3, TimeUnit.SECONDS));
    ...
    public /* synthetic */ Boolean m7714lambda$checkForPreviousCrash$10$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore() throws Exception {
