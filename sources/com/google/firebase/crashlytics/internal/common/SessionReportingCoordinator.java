...
public class SessionReportingCoordinator {
    ...
    public static SessionReportingCoordinator create(Context context, IdManager idManager2, FileStore fileStore, AppData appData, LogFileManager logFileManager2, UserMetadata userMetadata, StackTraceTrimmingStrategy stackTraceTrimmingStrategy, SettingsProvider settingsProvider, OnDemandCounter onDemandCounter, CrashlyticsAppQualitySessionsSubscriber crashlyticsAppQualitySessionsSubscriber, CrashlyticsWorkers crashlyticsWorkers2) {
        return new SessionReportingCoordinator(new CrashlyticsReportDataCapture(context, idManager2, appData, stackTraceTrimmingStrategy, settingsProvider), new CrashlyticsReportPersistence(fileStore, settingsProvider, crashlyticsAppQualitySessionsSubscriber), DataTransportCrashlyticsReportSender.create(context, settingsProvider, onDemandCounter), logFileManager2, userMetadata, idManager2, crashlyticsWorkers2);
    }
    ...
    private void persistEvent(Throwable th, Thread thread, String str, String str2, long j, boolean z) {
        ...
        CrashlyticsReport.Session.Event addMetaDataToEvent = addMetaDataToEvent(this.dataCapture.captureEventData(th, thread, str2, j, 4, 8, z));
        if (!z) {
            this.crashlyticsWorkers.diskWrite.submit((Runnable) new SessionReportingCoordinator$$ExternalSyntheticLambda2(this, addMetaDataToEvent, str, equals));
        } else {
    ...
    public /* synthetic */ void m7725lambda$persistEvent$0$comgooglefirebasecrashlyticsinternalcommonSessionReportingCoordinator(CrashlyticsReport.Session.Event event, String str, boolean z) {
