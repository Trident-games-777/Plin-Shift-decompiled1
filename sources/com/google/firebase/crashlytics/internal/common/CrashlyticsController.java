...
class CrashlyticsController {
    ...
    public /* synthetic */ void m7713lambda$openSession$1$comgooglefirebasecrashlyticsinternalcommonCrashlyticsController(String str) {
    ...
    public void doOpenSession(String str, Boolean bool) {
        ...
        StaticSessionData.AppData appData2 = createAppData;
        CrashlyticsNativeComponent crashlyticsNativeComponent = this.nativeComponent;
        StaticSessionData create = StaticSessionData.create(appData2, createOsData, createDeviceData);
        String str2 = str;
        crashlyticsNativeComponent.prepareNativeSession(str2, format, currentTimestampSeconds, create);
        if (bool.booleanValue() && str2 != null) {
            this.userMetadata.setNewSession(str2);
        }
        this.logFileManager.setCurrentSession(str2);
        this.sessionsSubscriber.setSessionId(str2);
        this.reportingCoordinator.onBeginSession(str2, currentTimestampSeconds);
    }
