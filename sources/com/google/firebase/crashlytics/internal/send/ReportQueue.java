...
final class ReportQueue {
    ...
    public /* synthetic */ void m7734lambda$flushScheduledReportsIfAble$0$comgooglefirebasecrashlyticsinternalsendReportQueue(CountDownLatch countDownLatch) {
        try {
    ...
    public /* synthetic */ void m7735lambda$sendReport$1$comgooglefirebasecrashlyticsinternalsendReportQueue(TaskCompletionSource taskCompletionSource, boolean z, CrashlyticsReportWithSessionId crashlyticsReportWithSessionId, Exception exc) {
        if (exc != null) {
