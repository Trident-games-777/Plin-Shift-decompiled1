        ...
        synchronized (FirebaseAnalytics.class) {
            try {
                if (this.zzc == null) {
                    ...
                    firebaseAnalytics.zzc = new zza(firebaseAnalytics, 0, 1, 30, TimeUnit.SECONDS, new ArrayBlockingQueue(100));
                } else {
                    firebaseAnalytics = this;
                }
                ExecutorService executorService = firebaseAnalytics.zzc;
