    ...
    private void drawArc(Canvas canvas, Paint paint, float f, float f2, int i, int i2, int i3) {
        ...
        if (this.totalTrackLengthFraction < 1.0f) {
            ...
            if (f5 > 1.0f) {
                ...
                Paint paint2 = paint;
                int i4 = i;
                drawArc(canvas2, paint2, f4, 1.0f, i4, i2, 0);
                drawArc(canvas2, paint2, 1.0f, f5, i4, 0, i3);
                return;
            }
        }
        ...
        if (degrees3 > 0.0f) {
            ...
            canvas.drawArc(rectF, f11, degrees3 - f9, false, paint);
            float f12 = f11;
            if (!this.useStrokeCap && this.displayedCornerRadius > 0.0f) {
                paint.setStyle(Paint.Style.FILL);
                Paint paint3 = paint;
                drawRoundedBlock(canvas, paint3, f12, this.displayedCornerRadius * 2.0f, this.displayedTrackThickness);
                drawRoundedBlock(canvas, paint3, (f6 + degrees3) - degrees, this.displayedCornerRadius * 2.0f, this.displayedTrackThickness);
            }
        }
    }
