...
public final class zzag extends zzja {
    ...
    public final int zza(String str) {
        return zza(str, zzbh.zzaj, ServiceStarter.ERROR_UNKNOWN, 2000);
    }

    /* access modifiers changed from: package-private */
    public final int zza(String str, boolean z) {
        return z ? zza(str, zzbh.zzat, 100, ServiceStarter.ERROR_UNKNOWN) : ServiceStarter.ERROR_UNKNOWN;
    }
    ...
    public final boolean zzf(String str, zzfz<Boolean> zzfz) {
        ...
        return zzfz.zza(Boolean.valueOf(DiskLruCache.VERSION.equals(zza2))).booleanValue();
    }
