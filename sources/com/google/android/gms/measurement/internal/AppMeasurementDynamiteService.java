...
public class AppMeasurementDynamiteService extends zzdm {
        ...
        public final void interceptEvent(String str, String str2, Bundle bundle, long j) {
            try {
                ...
                if (AppMeasurementDynamiteService.this.zza != null) {
                    AppMeasurementDynamiteService.this.zza.zzj().zzu().zza("Event interceptor threw exception", remoteException);
                }
            }
        }
    }
    ...
    class zzb implements zzjl {
        ...
        public final void onEvent(String str, String str2, Bundle bundle, long j) {
            try {
                ...
                RemoteException remoteException = e;
                if (AppMeasurementDynamiteService.this.zza != null) {
                    AppMeasurementDynamiteService.this.zza.zzj().zzu().zza("Event listener threw exception", remoteException);
                }
            }
        }
    }
    ...
    public void logEventAndBundle(String str, String str2, Bundle bundle, zzdo zzdo, long j) throws RemoteException {
        ...
        this.zza.zzl().zzb((Runnable) new zzk(this, zzdo, new zzbf(str2, new zzbe(bundle), "app", j), str));
    }
