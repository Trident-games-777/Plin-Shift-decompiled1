...
public final class zzic extends zzge {
    ...
    public final zzaj zza(zzo zzo) {
        ...
        try {
            return (zzaj) this.zza.zzl().zzb(new zziv(this, zzo)).get(WorkRequest.MIN_BACKOFF_MILLIS, TimeUnit.MILLISECONDS);
    ...
    public final zzbf zzb(zzbf zzbf, zzo zzo) {
        if (!Constants.ScionAnalytics.EVENT_FIREBASE_CAMPAIGN.equals(zzbf.zza) || zzbf.zzb == null || zzbf.zzb.zza() == 0) {
            return zzbf;
        }
    ...
    public final void zza(long j, String str, String str2, String str3) {
        String str4 = str2;
        String str5 = str3;
        zzb((Runnable) new zzik(this, str4, str5, str, j));
    }
    ...
    public final byte[] zza(zzbf zzbf, String str) {
        ...
        try {
            ...
            this.zza.zzj().zzc().zza("Log and bundle processed. event, size, time_ms", this.zza.zzg().zza(zzbf.zza), Integer.valueOf(bArr.length), Long.valueOf((this.zza.zzb().nanoTime() / AnimationKt.MillisToNanos) - nanoTime));
            return bArr;
        } catch (InterruptedException | ExecutionException e) {
