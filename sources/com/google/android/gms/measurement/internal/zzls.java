                ...
                if (abstractSafeParcelable3 instanceof zzbf) {
                    if (zza3) {
                        try {
                            ...
                            try {
                                j = this.zzu.zzb().elapsedRealtime();
                                ...
                                zzgm.zza(this.zzu).zza(36301, 13, j2, this.zzu.zzb().currentTimeMillis(), (int) (this.zzu.zzb().elapsedRealtime() - j));
                                i5 = i6;
                            }
                    ...
                    try {
                        ...
                        if (zza3) {
                            ...
                            zzgm.zza(this.zzu).zza(36301, 0, j2, this.zzu.zzb().currentTimeMillis(), (int) (this.zzu.zzb().elapsedRealtime() - j));
                        }
