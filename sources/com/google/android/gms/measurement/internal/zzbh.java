...
public final class zzbh {
    ...
    public static final zzfz<Long> zzab = zzb("measurement.upload.initial_upload_delay_time", 15000L, new zzdh());
    public static final zzfz<Long> zzac = zzb("measurement.upload.retry_time", 1800000L, new zzdk());
    ...
    public static final zzfz<Long> zzaf = zzb("measurement.upload.google_signal_max_queue_time", Long.valueOf(PeriodicWorkRequest.MIN_PERIODIC_FLEX_MILLIS), new zzdn());
    ...
    public static final zzfz<Long> zzal = zzb("measurement.service_client.idle_disconnect_millis", Long.valueOf(CoroutineLiveDataKt.DEFAULT_TIMEOUT), new zzds());
    ...
    public static final zzfz<Integer> zzat = zza("measurement.upload.max_event_parameter_value_length", Integer.valueOf(ServiceStarter.ERROR_UNKNOWN), new zzeb());
    ...
    public static final zzfz<String> zzaz = zzb("measurement.rb.attribution.uri_scheme", ProxyConfig.MATCH_HTTPS, new zzek());
    ...
    public static final zzfz<String> zze = zzb("measurement.config.url_scheme", ProxyConfig.MATCH_HTTPS, new zzej());
    ...
    private static <V> zzfz<V> zza(String str, V v, V v2, zzfx<V> zzfx, boolean z) {
        zzfz<V> zzfz = new zzfz<>(str, v, v2, zzfx);
        if (z) {
            zzdm.add(zzfz);
        }
        return zzfz;
    ...
    static {
        ...
        zza = zzb("measurement.ad_id_cache_time", valueOf, new zzbj());
        Long valueOf2 = Long.valueOf(CalendarModelKt.MillisecondsIn24Hours);
        zzc = zzb("measurement.monitoring.sample_period_millis", valueOf2, new zzdl());
        zzd = zza("measurement.config.cache_time", valueOf2, 3600000L, new zzdx(), false);
        Integer valueOf3 = Integer.valueOf(AndroidComposeViewAccessibilityDelegateCompat.ParcelSafeTextLength);
        zzk = zzb("measurement.upload.max_events_per_day", valueOf3, new zzcf());
        zzp = zzb("measurement.store.max_stored_events_per_app", valueOf3, new zzct());
        zzv = zzb("measurement.upload.realtime_upload_interval", valueOf, new zzdb());
        zzz = zzb("measurement.upload.stale_data_deletion_interval", valueOf2, new zzdf());
