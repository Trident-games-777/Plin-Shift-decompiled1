...
public class zzhy implements zzjc {
    ...
    public final boolean zzah() {
        ...
        if (((Boolean) zza2.second).booleanValue() || TextUtils.isEmpty((CharSequence) zza2.first)) {
            ...
            zzh();
            String str = zzad2;
            URL zza4 = zzt2.zza(106000, str, (String) zza2.first, zzn().zzp.zza() - 1, sb2.toString());
            if (zza4 != null) {
                zzle zzai2 = zzai();
                ...
                zzai2.zzl().zza((Runnable) new zzlg(zzai2, str, zza4, (byte[]) null, (Map<String, String>) null, zzia));
            }
            return false;
        }
    }
