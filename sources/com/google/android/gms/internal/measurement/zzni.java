...
public final class zzni implements zznj {
    ...
    static {
        ...
        zze = zza2.zza("measurement.config.cache_time", (long) CalendarModelKt.MillisecondsIn24Hours);
        ...
        zzi = zza2.zza("measurement.session.engagement_interval", 3600000);
        ...
        zzo = zza2.zza("measurement.upload.max_event_parameter_value_length", 500);
        ...
        zzt = zza2.zza("measurement.rb.max_trigger_registrations_per_day", 0);
        zzu = zza2.zza("measurement.rb.attribution.max_trigger_uris_queried_at_once", 0);
        zzv = zza2.zza("measurement.rb.attribution.client.min_ad_services_version", 7);
        zzw = zza2.zza("measurement.alarm_manager.minimum_interval", 60000);
        zzx = zza2.zza("measurement.upload.minimum_delay", 500);
        zzy = zza2.zza("measurement.monitoring.sample_period_millis", (long) CalendarModelKt.MillisecondsIn24Hours);
        ...
        zzab = zza2.zza("measurement.upload.realtime_upload_interval", (long) WorkRequest.MIN_BACKOFF_MILLIS);
        zzac = zza2.zza("measurement.upload.refresh_blacklisted_config_interval", 604800000);
        zza2.zza("measurement.config.cache_time.service", 3600000);
        zzad = zza2.zza("measurement.service_client.idle_disconnect_millis", (long) CoroutineLiveDataKt.DEFAULT_TIMEOUT);
        ...
        zzaf = zza2.zza("measurement.upload.stale_data_deletion_interval", (long) CalendarModelKt.MillisecondsIn24Hours);
        zzag = zza2.zza("measurement.rb.attribution.uri_authority", "google-analytics.com");
        zzah = zza2.zza("measurement.rb.attribution.max_queue_time", 1209600000);
        ...
        zzak = zza2.zza("measurement.rb.attribution.uri_scheme", ProxyConfig.MATCH_HTTPS);
        zzal = zza2.zza("measurement.sdk.attribution.cache.ttl", 604800000);
        zzam = zza2.zza("measurement.redaction.app_instance_id.ttl", 7200000);
        zzan = zza2.zza("measurement.upload.backoff_period", 43200000);
        zzao = zza2.zza("measurement.upload.initial_upload_delay_time", 15000);
        zzap = zza2.zza("measurement.upload.interval", 3600000);
        zzaq = zza2.zza("measurement.upload.max_bundle_size", 65536);
        zzar = zza2.zza("measurement.upload.max_bundles", 100);
        zzas = zza2.zza("measurement.upload.max_conversions_per_day", 500);
        zzat = zza2.zza("measurement.upload.max_error_events_per_day", 1000);
        zzau = zza2.zza("measurement.upload.max_events_per_bundle", 1000);
        zzav = zza2.zza("measurement.upload.max_events_per_day", 100000);
        zzaw = zza2.zza("measurement.upload.max_public_events_per_day", 50000);
        zzax = zza2.zza("measurement.upload.max_queue_time", 518400000);
        zzay = zza2.zza("measurement.upload.max_realtime_events_per_day", 10);
        zzaz = zza2.zza("measurement.upload.max_batch_size", 65536);
        zzba = zza2.zza("measurement.upload.retry_count", 6);
        zzbb = zza2.zza("measurement.upload.retry_time", 1800000);
        zzbc = zza2.zza("measurement.upload.url", "https://app-measurement.com/a");
        zzbd = zza2.zza("measurement.upload.window_interval", 3600000);
