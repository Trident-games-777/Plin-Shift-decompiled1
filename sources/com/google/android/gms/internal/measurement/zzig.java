...
final class zzig {
    ...
    private static int zza(zzlu zzlu, byte[] bArr, int i, int i2, int i3, zzij zzij) throws IOException {
        ...
        zzlu zzlu2 = zzlu;
        zzij zzij2 = zzij;
        int zza3 = zza(zza2, zzlu2, bArr, i, i2, i3, zzij2);
        zzlu2.zzd(zza2);
        zzij2.zzc = zza2;
        return zza3;
    }
    ...
    static int zza(zzlu zzlu, int i, byte[] bArr, int i2, int i3, zzkc<?> zzkc, zzij zzij) throws IOException {
        ...
        int i5 = i3;
        zzij zzij2 = zzij;
        int zza2 = zza(zzlu2, bArr2, i2, i5, i4, zzij2);
        zzkc.add(zzij2.zzc);
        while (zza2 < i5) {
            int zzc = zzc(bArr2, zza2, zzij2);
            if (i != zzij2.zza) {
                break;
            }
            zza2 = zza(zzlu2, bArr2, zzc, i5, i4, zzij2);
            zzkc.add(zzij2.zzc);
        }
        return zza2;
    }
    ...
    static int zza(zzlu zzlu, byte[] bArr, int i, int i2, zzij zzij) throws IOException {
        ...
        zzlu zzlu2 = zzlu;
        zzij zzij2 = zzij;
        int zza3 = zza(zza2, zzlu2, bArr, i, i2, zzij2);
        zzlu2.zzd(zza2);
        zzij2.zzc = zza2;
        return zza3;
    }
    ...
    static int zza(int i, byte[] bArr, int i2, int i3, zzmj zzmj, zzij zzij) throws zzkb {
        if ((i >>> 3) != 0) {
            ...
            if (i4 == 0) {
                zzij zzij2 = zzij;
                int zzd = zzd(bArr, i2, zzij2);
                zzmj.zza(i, (Object) Long.valueOf(zzij2.zzb));
                return zzd;
            } else if (i4 == 1) {
                ...
                if (i5 < 0) {
                    ...
                    if (i5 == 0) {
                        ...
                        zzmj.zza(i, (Object) zzik.zza(bArr2, zzc, i5));
                    }
                    return zzc + i5;
                } else {
                    throw zzkb.zzi();
                ...
                while (true) {
                    ...
                    i2 = zza(i7, bArr, zzc2, i3, zzd2, zzij);
                }
                int i8 = i3;
                zzij.zze--;
                if (i2 > i8 || i7 != i6) {
    ...
    static int zza(Object obj, zzlu zzlu, byte[] bArr, int i, int i2, int i3, zzij zzij) throws IOException {
        ...
        zzlg zzlg = (zzlg) zzlu;
        Object obj2 = obj;
        int zza2 = zzlg.zza(obj2, bArr, i, i2, i3, zzij);
        zzij.zze--;
        zzij.zzc = obj2;
        return zza2;
    }
