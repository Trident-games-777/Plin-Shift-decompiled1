...
final class zzlw {
    ...
    static int zzb(List<Integer> list) {
        ...
        int i3 = 0;
        while (i < size) {
            i3 += zzjc.zzd(list.get(i).intValue());
            i++;
        }
        return i3;
    }
    ...
    static int zze(List<Integer> list) {
        ...
        int i3 = 0;
        while (i < size) {
            i3 += zzjc.zzf(list.get(i).intValue());
            i++;
        }
        return i3;
    }
    ...
    static int zzf(List<Long> list) {
        ...
        int i3 = 0;
        while (i < size) {
            i3 += zzjc.zzd(list.get(i).longValue());
            i++;
        }
        return i3;
    }
    ...
    static int zzg(List<Integer> list) {
        ...
        int i3 = 0;
        while (i < size) {
            i3 += zzjc.zzh(list.get(i).intValue());
            i++;
        }
        return i3;
    }
    ...
    static int zzh(List<Long> list) {
        ...
        int i3 = 0;
        while (i < size) {
            i3 += zzjc.zzf(list.get(i).longValue());
            i++;
        }
        return i3;
    }
    ...
    static int zzi(List<Integer> list) {
        ...
        int i3 = 0;
        while (i < size) {
            i3 += zzjc.zzj(list.get(i).intValue());
            i++;
        }
        return i3;
    }
    ...
    static int zzj(List<Long> list) {
        ...
        int i3 = 0;
        while (i < size) {
            i3 += zzjc.zzg(list.get(i).longValue());
            i++;
        }
        return i3;
    }
