    ...
    static /* bridge */ /* synthetic */ zzci zza(zzn zzn) {
        ...
        if (displayCutout == null) {
            ...
            for (Rect next : displayCutout.getBoundingRects()) {
                if (next != null) {
                    zzcf zzcf = new zzcf();
                    zzcf.zzb = Integer.valueOf(next.left);
                    zzcf.zzc = Integer.valueOf(next.right);
                    zzcf.zza = Integer.valueOf(next.top);
                    zzcf.zzd = Integer.valueOf(next.bottom);
                    arrayList.add(zzcf);
                }
            }
            list2 = arrayList;
        ...
        zzcc.zzb = str;
        if (packageInfo != null) {
            zzcc.zzc = Long.toString(packageInfo.getLongVersionCode());
        }
        zzci.zzg = zzcc;
        zzch zzch = new zzch();
        zzch.zza = "3.0.0";
