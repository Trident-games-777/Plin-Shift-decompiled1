...
final class zzhbu {
    ...
    static {
        /*
            ...
            zzc = r0
            int r1 = com.google.android.gms.internal.ads.zzgxc.zza
        ...
        L_0x0026:
            ...
            com.google.android.gms.internal.ads.zzhbr r3 = new com.google.android.gms.internal.ads.zzhbr
            r3.<init>(r0)
        L_0x002d:
            zzf = r3
        ...
        L_0x005f:
            r3 = move-exception
            java.util.logging.Logger.getLogger(com.google.android.gms.internal.ads.zzhbu.class.getName()).logp(java.util.logging.Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(r3.toString()))
            goto L_0x0038
        L_0x0064:
            zzg = r3
            com.google.android.gms.internal.ads.zzhbt r3 = zzf
        ...
        L_0x00f9:
            r0 = move-exception
            java.util.logging.Logger.getLogger(com.google.android.gms.internal.ads.zzhbu.class.getName()).logp(java.util.logging.Level.WARNING, "com.google.protobuf.UnsafeUtil", "logMissingMethod", "platform method missing - proto runtime falling back to safer methods: ".concat(r0.toString()))
            goto L_0x006a
        L_0x00ff:
            zzh = r0
    ...
    public static void zzG(Object obj, long j, byte b) {
        zzhbt zzhbt = zzf;
        long j2 = -4 & j;
        int i = zzhbt.zza.getInt(obj, j2);
        int i2 = ((~((int) j)) & 3) << 3;
        zzhbt.zza.putInt(obj, j2, ((255 & b) << i2) | (i & (~(255 << i2))));
    }
    ...
    public static void zzH(Object obj, long j, byte b) {
        ...
        long j2 = -4 & j;
        int i = (((int) j) & 3) << 3;
        zzhbt.zza.putInt(obj, j2, ((255 & b) << i) | (zzhbt.zza.getInt(obj, j2) & (~(255 << i))));
    }
    ...
    static long zze(ByteBuffer byteBuffer) {
        zzhbt zzhbt = zzf;
        return zzhbt.zza.getLong(byteBuffer, zzi);
    }
