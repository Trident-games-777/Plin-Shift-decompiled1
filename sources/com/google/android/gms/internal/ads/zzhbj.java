...
class zzhbj extends AbstractMap {
    ...
    private final int zzl(Comparable comparable) {
        ...
        int i3 = 0;
        if (i2 >= 0) {
            int compareTo = comparable.compareTo(((zzhbf) this.zza[i2]).zza());
            if (compareTo > 0) {
                return -(i + 1);
            }
            if (compareTo == 0) {
        ...
        while (i3 <= i2) {
            int i4 = (i3 + i2) / 2;
            int compareTo2 = comparable.compareTo(((zzhbf) this.zza[i4]).zza());
            if (compareTo2 < 0) {
                i2 = i4 - 1;
    ...
    public final Object zzm(int i) {
        zzo();
        Object value = ((zzhbf) this.zza[i]).getValue();
        ...
        if (!this.zzc.isEmpty()) {
            ...
            objArr2[i2] = new zzhbf(this, (Comparable) entry.getKey(), entry.getValue());
            this.zzb++;
            it.remove();
        }
        return value;
    ...
    public final Set entrySet() {
        if (this.zze == null) {
            this.zze = new zzhbh(this, (zzhbi) null);
        }
        return this.zze;
    }
    ...
    public final boolean equals(Object obj) {
        ...
        int i = this.zzb;
        if (i != zzhbj.zzb) {
            return entrySet().equals(zzhbj.entrySet());
        }
        for (int i2 = 0; i2 < i; i2++) {
            if (!zzg(i2).equals(zzhbj.zzg(i2))) {
                return false;
            }
        }
        if (i != size) {
            return this.zzc.equals(zzhbj.zzc);
        }
        return true;
    }
    ...
    public final Object put(Comparable comparable, Object obj) {
        ...
        if (this.zzb == 16) {
            zzhbf zzhbf = (zzhbf) this.zza[15];
            this.zzb = 15;
            zzn().put(zzhbf.zza(), zzhbf.getValue());
        }
        Object[] objArr = this.zza;
        int length = objArr.length;
        System.arraycopy(objArr, i, objArr, i + 1, 15 - i);
        this.zza[i] = new zzhbf(this, comparable, obj);
        this.zzb++;
        return null;
    }
