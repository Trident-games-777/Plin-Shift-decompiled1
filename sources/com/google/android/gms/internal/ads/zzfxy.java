...
final class zzfxy extends zzfyb implements NavigableMap {
    ...
    zzfxy(zzfyh zzfyh, NavigableMap navigableMap) {
    ...
    public final NavigableMap descendingMap() {
        return new zzfxy(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).descendingMap());
    }
    ...
    public final NavigableSet zzg() {
        return new zzfxz(this.zzc, (NavigableMap) ((SortedMap) this.zza));
    }
    ...
    public final NavigableMap headMap(Object obj, boolean z) {
        return new zzfxy(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).headMap(obj, z));
    }

    public final NavigableMap subMap(Object obj, boolean z, Object obj2, boolean z2) {
        return new zzfxy(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).subMap(obj, z, obj2, z2));
    }

    public final NavigableMap tailMap(Object obj, boolean z) {
        return new zzfxy(this.zzc, ((NavigableMap) ((SortedMap) this.zza)).tailMap(obj, z));
    }
}
