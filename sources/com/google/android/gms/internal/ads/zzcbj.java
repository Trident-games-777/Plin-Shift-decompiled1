...
public final class zzcbj extends zzcbl implements TextureView.SurfaceTextureListener, MediaPlayer.OnBufferingUpdateListener, MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnInfoListener, MediaPlayer.OnPreparedListener, MediaPlayer.OnVideoSizeChangedListener {
    ...
    public zzcbj(Context context, zzccf zzccf, boolean z, boolean z2, zzcce zzcce, zzccg zzccg) {
        super(context);
        ...
        if (this.zzj != null && surfaceTexture != null) {
            ...
            try {
                ...
                if (this.zzo) {
                    ...
                    this.zzn = zzccd;
                    zzccd.zzd(surfaceTexture, getWidth(), getHeight());
                    this.zzn.start();
    ...
    private final boolean zzH() {
        ...
        L_0x000f:
            ...
            return r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzcbj.zzH():boolean");
    }

    static /* bridge */ /* synthetic */ void zzl(zzcbj zzcbj, MediaPlayer mediaPlayer) {
        MediaFormat format;
        if (((Boolean) zzbe.zzc().zza(zzbcn.zzbW)).booleanValue() && zzcbj.zzd != null && mediaPlayer != null) {
            try {
                ...
                if (trackInfo != null) {
                    ...
                    if (!hashMap.isEmpty()) {
                        zzcbj.zzd.zzd("onMetadataEvent", hashMap);
                    }
                }
    ...
    public final boolean onError(MediaPlayer mediaPlayer, int i, int i2) {
        ...
        zzF(-1);
        this.zzh = -1;
        zzs.zza.post(new zzcbd(this, str, str2));
        return true;
    }
    ...
    public final void onPrepared(android.media.MediaPlayer r8) {
        /*
            ...
            r0 = 2
            r7.zzF(r0)
            com.google.android.gms.internal.ads.zzccg r0 = r7.zze
            r0.zzb()
            com.google.android.gms.internal.ads.zzftd r0 = com.google.android.gms.ads.internal.util.zzs.zza
            com.google.android.gms.internal.ads.zzcbb r1 = new com.google.android.gms.internal.ads.zzcbb
            r1.<init>(r7, r8)
            r0.post(r1)
        ...
        L_0x00a8:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzcbj.onPrepared(android.media.MediaPlayer):void");
    }
    ...
    public final void onSurfaceTextureSizeChanged(SurfaceTexture surfaceTexture, int i, int i2) {
        ...
        zzs.zza.post(new zzcbf(this, i, i2));
    }
