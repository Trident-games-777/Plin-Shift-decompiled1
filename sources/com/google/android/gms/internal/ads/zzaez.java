...
final class zzaez extends zzafb {
    ...
    private static Double zzg(zzed zzed) {
        return Double.valueOf(Double.longBitsToDouble(zzed.zzt()));
    }

    private static String zzi(zzed zzed) {
        int zzq = zzed.zzq();
        int zzd2 = zzed.zzd();
        zzed.zzM(zzq);
        return new String(zzed.zzN(), zzd2, zzq);
    }

    private static HashMap zzj(zzed zzed) {
        int zzp = zzed.zzp();
        HashMap hashMap = new HashMap(zzp);
        for (int i = 0; i < zzp; i++) {
            String zzi = zzi(zzed);
            Object zzh = zzh(zzed, zzed.zzm());
            if (zzh != null) {
                hashMap.put(zzi, zzh);
            }
        }
    ...
    /* access modifiers changed from: protected */
    public final boolean zzb(zzed zzed, long j) {
        if (zzed.zzm() == 2 && "onMetaData".equals(zzi(zzed)) && zzed.zzb() != 0 && zzed.zzm() == 8) {
            HashMap zzj = zzj(zzed);
    ...
    private static java.lang.Object zzh(com.google.android.gms.internal.ads.zzed r4, int r5) {
        /*
        ...
        L_0x007a:
            ...
            return r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzaez.zzh(com.google.android.gms.internal.ads.zzed, int):java.lang.Object");
    }
}
