...
public final class zzazg {
    ...
    public final Activity zza() {
        synchronized (this.zza) {
            zzaze zzaze = this.zzb;
            if (zzaze == null) {
                return null;
            }
            Activity zza2 = zzaze.zza();
            return zza2;
        }
    }
    ...
    public final Context zzb() {
        synchronized (this.zza) {
            ...
            Context zzb2 = zzaze.zzb();
            return zzb2;
        }
    }

    public final void zzc(zzazf zzazf) {
        synchronized (this.zza) {
            if (this.zzb == null) {
                this.zzb = new zzaze();
            }
    ...
    public final void zzd(android.content.Context r4) {
        ...
        L_0x0016:
            ...
            return
        L_0x001f:
            com.google.android.gms.internal.ads.zzaze r2 = r3.zzb     // Catch:{ all -> 0x0034 }
            if (r2 != 0) goto L_0x002a
            com.google.android.gms.internal.ads.zzaze r2 = new com.google.android.gms.internal.ads.zzaze     // Catch:{ all -> 0x0034 }
        ...
        L_0x0034:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzazg.zzd(android.content.Context):void");
    }

    public final void zze(zzazf zzazf) {
        synchronized (this.zza) {
            zzaze zzaze = this.zzb;
            if (zzaze != null) {
                zzaze.zzh(zzazf);
