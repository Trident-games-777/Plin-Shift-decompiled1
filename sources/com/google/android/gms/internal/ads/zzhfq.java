...
public final class zzhfq {
    ...
    public zzhfq(double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
        this.zze = d5;
        this.zzf = d6;
        this.zzg = d7;
        this.zzh = d;
    ...
    public final boolean equals(Object obj) {
        ...
        zzhfq zzhfq = (zzhfq) obj;
        return Double.compare(zzhfq.zzh, this.zzh) == 0 && Double.compare(zzhfq.zzi, this.zzi) == 0 && Double.compare(zzhfq.zzj, this.zzj) == 0 && Double.compare(zzhfq.zzk, this.zzk) == 0 && Double.compare(zzhfq.zzl, this.zzl) == 0 && Double.compare(zzhfq.zzm, this.zzm) == 0 && Double.compare(zzhfq.zze, this.zze) == 0 && Double.compare(zzhfq.zzf, this.zzf) == 0 && Double.compare(zzhfq.zzg, this.zzg) == 0;
    }
