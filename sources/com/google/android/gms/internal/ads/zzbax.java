...
public final class zzbax extends AbstractSafeParcelable {
    ...
    zzbax(String str, long j, String str2, String str3, String str4, Bundle bundle, boolean z, long j2, String str5, int i) {
        this.zza = str;
        this.zzb = j;
    ...
    public static zzbax zza(Uri uri) {
        ...
        Uri uri2 = uri;
        try {
            if (!"gcache".equals(uri2.getScheme())) {
                return null;
            }
            ...
            boolean equals = DiskLruCache.VERSION.equals(uri2.getQueryParameter("read_only"));
            ...
            return new zzbax(queryParameter, j, host, str, str2, bundle, equals, 0, "", 0);
