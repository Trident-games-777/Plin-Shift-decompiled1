                ...
                try {
                    ...
                    if (signatureArr == null || (r0 = signatureArr.length) == 0) {
                        ...
                        for (Signature byteArray : signatureArr) {
                            String zza2 = zzfvw.zza(byteArray.toByteArray());
                            arrayList.add(zza2);
                        ...
                        zzfvv.zzd(String.format("Play Store package certs are not valid. Found these sha256 certs: [%s].", new Object[]{sb.toString()}), new Object[0]);
                    }
