...
interface zzhav {
    ...
    @Deprecated
    void zzC(List list, zzhbb zzhbb, zzgyh zzgyh) throws IOException;

    void zzD(List list) throws IOException;

    void zzE(List list) throws IOException;

    void zzF(List list, zzhbb zzhbb, zzgyh zzgyh) throws IOException;
    ...
    void zzt(Object obj, zzhbb zzhbb, zzgyh zzgyh) throws IOException;

    void zzu(Object obj, zzhbb zzhbb, zzgyh zzgyh) throws IOException;
