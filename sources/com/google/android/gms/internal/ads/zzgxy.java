...
final class zzgxy extends zzgyc {
    ...
    public final void zzi(int i) throws IOException {
        try {
            ...
            throw new zzgxz(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzc), Integer.valueOf(this.zzb), 1}), e);
        }
    }
    ...
    public final void zzr(String str) throws IOException {
        ...
        try {
            ...
            if (zzD2 == zzD) {
                int i2 = i + zzD2;
                this.zzc = i2;
                int zzd = zzhbz.zzd(str, this.zza, i2, this.zzb - i2);
                this.zzc = i;
                zzu((zzd - i) - zzD2);
                this.zzc = zzd;
                return;
            ...
            byte[] bArr = this.zza;
            int i3 = this.zzc;
            this.zzc = zzhbz.zzd(str, bArr, i3, this.zzb - i3);
        } catch (zzhby e) {
            this.zzc = i;
            zzG(str, e);
    ...
    public final void zze(byte[] bArr, int i, int i2) throws IOException {
        try {
            ...
            throw new zzgxz(String.format("Pos: %d, limit: %d, len: %d", new Object[]{Integer.valueOf(this.zzc), Integer.valueOf(this.zzb), Integer.valueOf(i2)}), e);
        }
    }
        ...
        if (!zzgyc.zzb || this.zzb - this.zzc < 10) {
            ...
            while (true) {
                ...
                if ((j & -128) == 0) {
                    ...
                    int i4 = this.zzc;
                    this.zzc = i4 + 1;
                    zzhbu.zzq(bArr3, (long) i4, (byte) i3);
                    return;
                }
                byte[] bArr4 = this.zza;
                int i5 = this.zzc;
                this.zzc = i5 + 1;
                zzhbu.zzq(bArr4, (long) i5, (byte) ((i3 | 128) & 255));
                j >>>= 7;
            }
        }
    }
