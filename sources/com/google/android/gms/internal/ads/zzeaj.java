...
public final class zzeaj extends zzeap {
    ...
    zzeaj(Context context, ScheduledExecutorService scheduledExecutorService) {
        this.zze = context;
    ...
    public final synchronized void onConnected(android.os.Bundle r4) {
        /*
            ...
            com.google.android.gms.internal.ads.zzbvb r1 = r3.zzh     // Catch:{ RemoteException -> 0x002b, all -> 0x001a }
        ...
        L_0x0039:
            ...
            throw r4
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzeaj.onConnected(android.os.Bundle):void");
    }

    public final synchronized ListenableFuture zza(zzbvb zzbvb, long j) {
        if (this.zzb) {
        ...
        zzo.addListener(new zzeai(this), zzcaj.zzf);
        return zzo;
    }
}
