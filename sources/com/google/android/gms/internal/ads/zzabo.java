...
public final class zzabo {
    ...
    private static int zzc(zzec zzec) {
        int zzd = zzec.zzd(5);
        return zzd == 31 ? zzec.zzd(6) + 32 : zzd;
    }

    private static int zzd(zzec zzec) throws zzbh {
        int zzd = zzec.zzd(4);
        if (zzd == 15) {
            if (zzec.zza() >= 24) {
                return zzec.zzd(24);
            }
            throw zzbh.zza("AAC header insufficient data", (Throwable) null);
        } else if (zzd < 13) {
            return zzb[zzd];
        } else {
            throw zzbh.zza("AAC header wrong Sampling Frequency Index", (Throwable) null);
        }
    }
}
