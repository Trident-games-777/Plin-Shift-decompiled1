...
public final class zzfcn implements zzhfx {
    ...
    public zzfcn(zzhgp zzhgp, zzhgp zzhgp2, zzhgp zzhgp3) {
        this.zza = zzhgp;
        this.zzb = zzhgp2;
        this.zzc = zzhgp3;
    }
    ...
    public final zzfck zzb() {
        ...
        if (((Integer) zzbe.zzc().zza(zzbcn.zzgj)).intValue() > 0) {
            if (!((Boolean) zzbe.zzc().zza(zzbcn.zzgg)).booleanValue() || z) {
                zzfhp zza2 = zzfhq.zza(zzfhg.Rewarded, context, zzfgy, new zzfbo(new zzfbl()));
