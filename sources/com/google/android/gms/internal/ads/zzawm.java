...
public final class zzawm implements View.OnAttachStateChangeListener, ViewTreeObserver.OnGlobalLayoutListener, ViewTreeObserver.OnScrollChangedListener, Application.ActivityLifecycleCallbacks {
    ...
    public zzawm(Context context, zzavy zzavy) {
    ...
    private final void zzh(View view) {
        ...
        if (this.zzf == null) {
            ...
            zzawl zzawl = new zzawl(this);
            this.zzf = zzawl;
            this.zzb.registerReceiver(zzawl, intentFilter);
        }
    ...
    private final void zzi(android.view.View r4) {
        ...
        L_0x0036:
            ...
            com.google.android.gms.internal.ads.zzavu r0 = r3.zzj     // Catch:{ Exception -> 0x003f }
            r4.unregisterActivityLifecycleCallbacks(r0)     // Catch:{ Exception -> 0x003f }
        L_0x003f:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.google.android.gms.internal.ads.zzawm.zzi(android.view.View):void");
    }
