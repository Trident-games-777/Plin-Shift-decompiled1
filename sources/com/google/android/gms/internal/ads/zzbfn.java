...
public final class zzbfn extends AbstractSafeParcelable {
    ...
    public zzbfn(int i, boolean z, int i2, boolean z2, int i3, zzga zzga, boolean z3, int i4, int i5, boolean z4, int i6) {
        this.zza = i;
        this.zzb = z;
        this.zzc = i2;
        this.zzd = z2;
    ...
    public static com.google.android.gms.ads.nativead.NativeAdOptions zza(com.google.android.gms.internal.ads.zzbfn r5) {
        /*
