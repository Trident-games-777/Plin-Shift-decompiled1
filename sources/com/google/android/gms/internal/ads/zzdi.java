...
public final class zzdi implements SurfaceTexture.OnFrameAvailableListener, Runnable {
    ...
    public zzdi(Handler handler, zzdh zzdh) {
        this.zzb = handler;
    }
    ...
    public final void zzb(int i) throws zzdj {
        EGLSurface eGLSurface;
        EGLDisplay eglGetDisplay = EGL14.eglGetDisplay(0);
        zzdk.zza(eglGetDisplay != null, "eglGetDisplay failed");
        int[] iArr = new int[2];
        zzdk.zza(EGL14.eglInitialize(eglGetDisplay, iArr, 0, iArr, 1), "eglInitialize failed");
        this.zzd = eglGetDisplay;
        EGLConfig[] eGLConfigArr = new EGLConfig[1];
        int[] iArr2 = new int[1];
        boolean eglChooseConfig = EGL14.eglChooseConfig(eglGetDisplay, zza, 0, eGLConfigArr, 0, 1, iArr2, 0);
        zzdk.zza(eglChooseConfig && iArr2[0] > 0 && eGLConfigArr[0] != null, String.format(Locale.US, "eglChooseConfig failed: success=%b, numConfigs[0]=%d, configs[0]=%s", new Object[]{Boolean.valueOf(eglChooseConfig), Integer.valueOf(iArr2[0]), eGLConfigArr[0]}));
        ...
        zzdk.zza(eglCreateContext != null, "eglCreateContext failed");
        ...
        if (i == 1) {
            ...
            zzdk.zza(eGLSurface != null, "eglCreatePbufferSurface failed");
        }
        zzdk.zza(EGL14.eglMakeCurrent(eGLDisplay, eGLSurface, eGLSurface, eglCreateContext), "eglMakeCurrent failed");
        this.zzf = eGLSurface;
