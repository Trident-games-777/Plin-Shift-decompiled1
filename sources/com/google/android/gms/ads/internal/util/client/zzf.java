...
public final class zzf {
    ...
    private static final void zzE(ViewGroup viewGroup, zzs zzs, String str, int i, int i2) {
        if (viewGroup.getChildCount() == 0) {
            ...
            frameLayout.addView(textView, new FrameLayout.LayoutParams(zzs.zzf - zzy, zzs.zzc - zzy, 17));
    ...
    public final void zzm(ViewGroup viewGroup, zzs zzs, String str, String str2) {
        if (str2 != null) {
            zzm.zzj(str2);
        }
        zzE(viewGroup, zzs, str, SupportMenu.CATEGORY_MASK, ViewCompat.MEASURED_STATE_MASK);
    }

    public final void zzn(ViewGroup viewGroup, zzs zzs, String str) {
        zzE(viewGroup, zzs, "Ads by Google", ViewCompat.MEASURED_STATE_MASK, -1);
    }
