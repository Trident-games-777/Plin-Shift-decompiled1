...
final class FarmHashFingerprint64 extends AbstractNonStreamingHashFunction {
    ...
    private static long hashLength33To64(byte[] bArr, int i, int i2) {
        ...
        return hashLength16(Long.rotateRight(load645 + load646, 43) + Long.rotateRight(load647, 30) + ((hashLength16 + LittleEndianByteArray.load64(bArr2, i3 - 24)) * j), load645 + Long.rotateRight(load646 + load64, 18) + load647, j);
    }
