...
final class OnBackInstance {
    ...
    public OnBackInstance(CoroutineScope coroutineScope, boolean z, Function2<? super Flow<BackEventCompat>, ? super Continuation<? super Unit>, ? extends Object> function2, OnBackPressedCallback onBackPressedCallback) {
        ...
        this.job = BuildersKt__Builders_commonKt.launch$default(coroutineScope, (CoroutineContext) null, (CoroutineStart) null, new OnBackInstance$job$1(onBackPressedCallback, function2, this, (Continuation<? super OnBackInstance$job$1>) null), 3, (Object) null);
    }
    ...
    public final Object m7sendJP2dKIU(BackEventCompat backEventCompat) {
        return this.channel.m9382trySendJP2dKIU(backEventCompat);
    }
