...
public final class InternalNavType$DoubleArrayType$1 extends CollectionNavType<double[]> {
    ...
    public double[] parseValue(java.lang.String r2, double[] r3) {
        /*
            ...
            double[] r3 = kotlin.collections.ArraysKt.plus((double[]) r3, (double[]) r0)
            if (r3 != 0) goto L_0x0012
            goto L_0x0013
        L_0x0012:
            return r3
        L_0x0013:
            double[] r2 = r1.parseValue((java.lang.String) r2)
            return r2
        */
    ...
    public boolean valueEquals(double[] dArr, double[] dArr2) {
        Double[] dArr3 = null;
        Double[] typedArray = dArr != null ? ArraysKt.toTypedArray(dArr) : null;
        if (dArr2 != null) {
            dArr3 = ArraysKt.toTypedArray(dArr2);
        }
        return ArraysKt.contentDeepEquals(typedArray, dArr3);
    }
