...
public final class NavDeepLinkBuilder {
    ...
    public NavDeepLinkBuilder(Context context2) {
        ...
        Activity activity2 = (Activity) SequencesKt.firstOrNull(SequencesKt.mapNotNull(SequencesKt.generateSequence(context2, NavDeepLinkBuilder$activity$1.INSTANCE), NavDeepLinkBuilder$activity$2.INSTANCE));
