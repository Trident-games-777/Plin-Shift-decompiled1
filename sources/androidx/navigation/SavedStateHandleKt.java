...
public final class SavedStateHandleKt {
    public static /* synthetic */ Object toRoute$default(SavedStateHandle savedStateHandle, Map map, int i, Object obj) {
        ...
        return internalToRoute(savedStateHandle, Reflection.getOrCreateKotlinClass(Object.class), map);
    }
    ...
    public static final <T> T internalToRoute(SavedStateHandle savedStateHandle, KClass<T> kClass, Map<KType, ? extends NavType<?>> map) {
        Intrinsics.checkNotNullParameter(savedStateHandle, "<this>");
        Intrinsics.checkNotNullParameter(kClass, "route");
        Intrinsics.checkNotNullParameter(map, "typeMap");
        Map linkedHashMap = new LinkedHashMap();
        KSerializer<T> serializer = SerializersKt.serializer(kClass);
        ...
        return RouteDeserializerKt.decodeArguments(serializer, savedStateHandle, (Map<String, ? extends NavType<?>>) linkedHashMap);
    }
}
