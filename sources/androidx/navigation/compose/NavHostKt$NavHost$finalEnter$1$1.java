...
final class NavHostKt$NavHost$finalEnter$1$1 extends Lambda implements Function1<AnimatedContentTransitionScope<NavBackStackEntry>, EnterTransition> {
    ...
    NavHostKt$NavHost$finalEnter$1$1(ComposeNavigator composeNavigator, Function1<AnimatedContentTransitionScope<NavBackStackEntry>, EnterTransition> function1, Function1<AnimatedContentTransitionScope<NavBackStackEntry>, EnterTransition> function12, MutableState<Boolean> mutableState) {
        super(1);
    ...
    public final EnterTransition invoke(AnimatedContentTransitionScope<NavBackStackEntry> animatedContentTransitionScope) {
        ...
        if (this.$composeNavigator.isPop$navigation_compose_release().getValue().booleanValue() || NavHostKt.NavHost$lambda$11(this.$inPredictiveBack$delegate)) {
            ...
            while (true) {
                if (it.hasNext()) {
                    EnterTransition access$createPopEnterTransition = NavHostKt.createPopEnterTransition(it.next(), animatedContentTransitionScope);
        ...
        while (true) {
            if (it2.hasNext()) {
                EnterTransition access$createEnterTransition = NavHostKt.createEnterTransition(it2.next(), animatedContentTransitionScope);
