...
public final class ComposeNavigatorDestinationBuilder extends NavDestinationBuilder<ComposeNavigator.Destination> {
    ...
    public ComposeNavigatorDestinationBuilder(ComposeNavigator composeNavigator2, String str, Function4<? super AnimatedContentScope, ? super NavBackStackEntry, ? super Composer, ? super Integer, Unit> function4) {
        super(composeNavigator2, str);
        this.composeNavigator = composeNavigator2;
        this.content = function4;
    }

    public ComposeNavigatorDestinationBuilder(ComposeNavigator composeNavigator2, KClass<?> kClass, Map<KType, NavType<?>> map, Function4<? super AnimatedContentScope, ? super NavBackStackEntry, ? super Composer, ? super Integer, Unit> function4) {
        super(composeNavigator2, kClass, map);
        this.composeNavigator = composeNavigator2;
        this.content = function4;
    }
    ...
    public ComposeNavigator.Destination instantiateDestination() {
        return new ComposeNavigator.Destination(this.composeNavigator, (Function4<? super AnimatedContentScope, NavBackStackEntry, ? super Composer, ? super Integer, Unit>) this.content);
    }
