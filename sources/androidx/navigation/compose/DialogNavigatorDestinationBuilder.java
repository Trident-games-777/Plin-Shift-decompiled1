...
public final class DialogNavigatorDestinationBuilder extends NavDestinationBuilder<DialogNavigator.Destination> {
    ...
    public DialogNavigatorDestinationBuilder(DialogNavigator dialogNavigator2, String str, DialogProperties dialogProperties2, Function3<? super NavBackStackEntry, ? super Composer, ? super Integer, Unit> function3) {
        super(dialogNavigator2, str);
        this.dialogNavigator = dialogNavigator2;
        this.dialogProperties = dialogProperties2;
        this.content = function3;
    }

    public DialogNavigatorDestinationBuilder(DialogNavigator dialogNavigator2, KClass<?> kClass, Map<KType, NavType<?>> map, DialogProperties dialogProperties2, Function3<? super NavBackStackEntry, ? super Composer, ? super Integer, Unit> function3) {
        super(dialogNavigator2, kClass, map);
        this.dialogNavigator = dialogNavigator2;
        this.dialogProperties = dialogProperties2;
        this.content = function3;
    }
