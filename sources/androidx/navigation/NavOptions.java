...
public final class NavOptions {
    ...
    public NavOptions(boolean z, boolean z2, Object obj, boolean z3, boolean z4, int i, int i2, int i3, int i4) {
        this(z, z2, RouteSerializerKt.generateHashCode(SerializersKt.serializer(Reflection.getOrCreateKotlinClass(obj.getClass()))), z3, z4, i, i2, i3, i4);
    ...
    public int hashCode() {
        ...
        return ((((((((((((hashCode2 + i2) * 31) + (isPopUpToInclusive() ? 1 : 0)) * 31) + (shouldPopUpToSaveState() ? 1 : 0)) * 31) + this.enterAnim) * 31) + this.exitAnim) * 31) + this.popEnterAnim) * 31) + this.popExitAnim;
    }
    ...
    public static final class Builder {
        ...
        public static /* synthetic */ Builder setPopUpTo$default(Builder builder, boolean z, boolean z2, int i, Object obj) {
            ...
            builder.setPopUpTo((KClass<?>) Reflection.getOrCreateKotlinClass(Object.class), z, z2);
            return builder;
        }
        ...
        public final Builder setPopUpTo(KClass<?> kClass, boolean z, boolean z2) {
        ...
        public final <T> Builder setPopUpTo(T t, boolean z, boolean z2) {
            Intrinsics.checkNotNullParameter(t, "route");
