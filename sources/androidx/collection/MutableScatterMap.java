...
public final class MutableScatterMap<K, V> extends ScatterMap<K, V> {
                ...
                if (j == 254) {
                    ...
                    if (((findFirstAvailableSlot - i10) & i2) / 8 == ((i3 - i10) & i2) / 8) {
                        ...
                        if (((j2 >> i12) & 255) == 128) {
                            ...
                            objArr[i3] = null;
                            objArr2[findFirstAvailableSlot] = objArr2[i3];
                            objArr2[i3] = null;
                            i4 = i3;
                        } else {
                            ...
                            objArr[findFirstAvailableSlot] = objArr[i3];
                            objArr[i3] = objArr[i4];
                            objArr2[i4] = objArr2[findFirstAvailableSlot];
                            objArr2[findFirstAvailableSlot] = objArr2[i3];
    ...
    public final void minusAssign(ObjectList<K> objectList) {
        Intrinsics.checkNotNullParameter(objectList, UserMetadata.KEYDATA_FILENAME);
