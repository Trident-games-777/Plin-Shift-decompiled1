...
public class ChangeBounds extends Transition {
    ...
    public Animator createAnimator(ViewGroup viewGroup, TransitionValues transitionValues, TransitionValues transitionValues2) {
        ...
        if (!this.mResizeClip) {
            ...
            if (i17 == 2) {
                if (i13 == i15 && i14 == i16) {
                    animator = ObjectAnimatorUtils.ofPointF(view, POSITION_PROPERTY, getPathMotion().getPath((float) i5, (float) i7, (float) i6, (float) i8));
                } else {
            ...
            int i18 = i16;
            Rect rect7 = rect5;
            ViewUtils.setLeftTopRightBottom(view, i5, i7, Math.max(i13, i15) + i5, i7 + Math.max(i14, i18));
            if (i5 == i6 && i7 == i8) {
                objectAnimator = null;
                i3 = i12;
                i2 = i6;
            ...
            boolean z3 = rect7 == null ? true : z;
            Rect rect8 = z3 ? new Rect(z ? 1 : 0, z, i15, i18) : rect7;
            if (!rect.equals(rect8)) {
                view.setClipBounds(rect);
                objectAnimator2 = ObjectAnimator.ofObject(view, "clipBounds", sRectEvaluator, new Object[]{rect, rect8});
                ClipListener clipListener = new ClipListener(view, rect, z2, rect8, z3, i5, i7, i9, i11, i2, i8, i4, i3);
