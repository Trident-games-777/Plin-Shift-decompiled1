...
final class UnprojectedRipple extends RippleDrawable {
    ...
    public final void m1702setColorDxMtmZc(long j, float f) {
        long r3 = m1701calculateRippleColor5vOe2sY(j, f);
        Color color = this.rippleColor;
        if (!(color == null ? false : Color.m4240equalsimpl0(color.m4249unboximpl(), r3))) {
            this.rippleColor = Color.m4229boximpl(r3);
            setColor(ColorStateList.valueOf(ColorKt.m4293toArgb8_81llA(r3)));
        }
    }
    ...
    private final long m1701calculateRippleColor5vOe2sY(long j, float f) {
        return Color.m4238copywmQWz5c$default(j, RangesKt.coerceAtMost(f, 1.0f), 0.0f, 0.0f, 0.0f, 14, (Object) null);
    }
