...
public final class CommonRippleNode extends RippleNode {
    ...
    private CommonRippleNode(InteractionSource interactionSource, boolean z, float f, ColorProducer colorProducer, Function0<RippleAlpha> function0) {
        ...
        this.ripples = new MutableScatterMap<>(0, 1, (DefaultConstructorMarker) null);
    }

    /* renamed from: addRipple-12SF9DM  reason: not valid java name */
    public void m1679addRipple12SF9DM(PressInteraction.Press press, long j, float f) {
        PressInteraction.Press press2 = press;
        ScatterMap scatterMap = this.ripples;
            ...
            while (true) {
                ...
                if ((((~j2) << 7) & j2 & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    for (int i3 = 0; i3 < i2; i3++) {
                        if ((255 & j2) < 128) {
                            int i4 = (i << 3) + i3;
                            PressInteraction.Press press3 = (PressInteraction.Press) objArr[i4];
        ...
        RippleAnimation rippleAnimation = new RippleAnimation(getBounded() ? Offset.m3976boximpl(press2.m588getPressPositionF1C5BW0()) : null, f, getBounded(), (DefaultConstructorMarker) null);
        this.ripples.set(press2, rippleAnimation);
        Job unused = BuildersKt__Builders_commonKt.launch$default(getCoroutineScope(), (CoroutineContext) null, (CoroutineStart) null, new CommonRippleNode$addRipple$2(rippleAnimation, this, press2, (Continuation<? super CommonRippleNode$addRipple$2>) null), 3, (Object) null);
                    ...
                    if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                        ...
                        while (i7 < i6) {
                            if ((j2 & 255) < 128) {
                                ...
                                i2 = i5;
                                f2 = pressedAlpha;
                                ((RippleAnimation) objArr2[i8]).m1683draw4WTKRHQ(drawScope, Color.m4238copywmQWz5c$default(m1693getRippleColor0d7_KjU(), pressedAlpha, 0.0f, 0.0f, 0.0f, 14, (Object) null));
                            } else {
                                i = i7;
                                i3 = i6;
                                i2 = i5;
