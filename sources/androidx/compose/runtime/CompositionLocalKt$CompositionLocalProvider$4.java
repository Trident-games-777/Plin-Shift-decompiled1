...
final class CompositionLocalKt$CompositionLocalProvider$4 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    CompositionLocalKt$CompositionLocalProvider$4(CompositionLocalContext compositionLocalContext, Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
