...
final class SnapshotStateKt__SnapshotFlowKt$snapshotFlow$1$unregisterApplyObserver$1 extends Lambda implements Function2<Set<? extends Object>, Snapshot, Unit> {
    ...
    public final void invoke(Set<? extends Object> set, Snapshot snapshot) {
                    ...
                    if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                        ...
                        for (int i3 = 0; i3 < i2; i3++) {
                            if ((255 & j) < 128) {
                                ...
                                if (((StateObjectImpl) obj).m3817isReadInh_f27i8$runtime_release(ReaderKind.m3804constructorimpl(4))) {
                                    break loop0;
                                }
                            }
                            j >>= 8;
            ...
            if (!(iterable instanceof Collection) || !((Collection) iterable).isEmpty()) {
                for (Object next : iterable) {
                    if (next instanceof StateObjectImpl) {
                        ...
                        if (((StateObjectImpl) next).m3817isReadInh_f27i8$runtime_release(ReaderKind.m3804constructorimpl(4))) {
                        }
                    }
                }
                return;
        ...
        this.$appliedChanges.m9382trySendJP2dKIU(set2);
    }
}
