...
final class MovableContentKt$movableContentOf$5 extends Lambda implements Function6<P1, P2, P3, P4, Composer, Integer, Unit> {
    ...
    public final void invoke(P1 p1, P2 p2, P3 p3, P4 p4, Composer composer, int i) {
        ...
        if ((i & 6) == 0) {
            i2 = ((i & 8) == 0 ? composer.changed((Object) p1) : composer.changedInstance(p1) ? 4 : 2) | i;
        } else {
            i2 = i;
        }
        if ((i & 48) == 0) {
            i2 |= (i & 64) == 0 ? composer.changed((Object) p2) : composer.changedInstance(p2) ? 32 : 16;
        }
        if ((i & 384) == 0) {
            i2 |= (i & 512) == 0 ? composer.changed((Object) p3) : composer.changedInstance(p3) ? 256 : 128;
        }
        if ((i & 3072) == 0) {
            i2 |= (i & 4096) == 0 ? composer.changed((Object) p4) : composer.changedInstance(p4) ? 2048 : 1024;
        }
