...
final class Recomposer$runRecomposeConcurrentlyAndApplyChanges$2$2$2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super Unit>, Object> {
    ...
    public final Object invokeSuspend(Object obj) {
        ...
        if (this.label == 0) {
            ...
            ControlledComposition access$performRecompose = this.this$0.performRecompose(this.$composition, (MutableScatterSet<Object>) null);
            ...
            if (access$deriveStateLocked != null) {
                ...
                access$deriveStateLocked.resumeWith(Result.m7823constructorimpl(Unit.INSTANCE));
            }
