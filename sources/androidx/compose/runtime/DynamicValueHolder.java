...
public final class DynamicValueHolder<T> implements ValueHolder<T> {
    ...
    public static /* synthetic */ DynamicValueHolder copy$default(DynamicValueHolder dynamicValueHolder, MutableState<T> mutableState, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof DynamicValueHolder) && Intrinsics.areEqual((Object) this.state, (Object) ((DynamicValueHolder) obj).state);
    }
    ...
    public ProvidedValue<T> toProvided(CompositionLocal<T> compositionLocal) {
        return new ProvidedValue<>(compositionLocal, null, false, (SnapshotMutationPolicy) null, this.state, (Function1) null, true);
    }
}
