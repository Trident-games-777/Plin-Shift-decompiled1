...
final class SaveableStateHolderImpl implements SaveableStateHolder {
    ...
    public void SaveableStateProvider(Object obj, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        ...
        if ((i2 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>) SaveableStateRegistryKt.getLocalSaveableStateRegistry().provides(registryHolder.getRegistry()), function2, startRestartGroup, (i2 & 112) | ProvidedValue.$stable);
            ...
            if (changedInstance || rememberedValue2 == Composer.Companion.getEmpty()) {
                rememberedValue2 = new SaveableStateHolderImpl$SaveableStateProvider$1$1$1(this, obj, registryHolder);
                startRestartGroup.updateRememberedValue(rememberedValue2);
            }
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
            EffectsKt.DisposableEffect((Object) unit, (Function1<? super DisposableEffectScope, ? extends DisposableEffectResult>) (Function1) rememberedValue2, startRestartGroup, 6);
            ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
