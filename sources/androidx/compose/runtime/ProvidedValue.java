...
public final class ProvidedValue<T> {
    ...
    public ProvidedValue(CompositionLocal<T> compositionLocal2, T t, boolean z, SnapshotMutationPolicy<T> snapshotMutationPolicy, MutableState<T> mutableState, Function1<? super CompositionLocalAccessorScope, ? extends T> function1, boolean z2) {
    ...
    public final ProvidedValue<T> ifNotAlreadyProvided$runtime_release() {
        ProvidedValue providedValue2 = this;
