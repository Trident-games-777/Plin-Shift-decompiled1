...
public final class ComputedValueHolder<T> implements ValueHolder<T> {
    ...
    public static /* synthetic */ ComputedValueHolder copy$default(ComputedValueHolder computedValueHolder, Function1<CompositionLocalAccessorScope, T> function1, int i, Object obj) {
        if ((i & 1) != 0) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ComputedValueHolder) && Intrinsics.areEqual((Object) this.compute, (Object) ((ComputedValueHolder) obj).compute);
    }
    ...
    public ProvidedValue<T> toProvided(CompositionLocal<T> compositionLocal) {
        return new ProvidedValue<>(compositionLocal, null, false, (SnapshotMutationPolicy) null, (MutableState) null, this.compute, false);
    }
}
