...
public final class ReaderKind {
    ...
    public static final /* synthetic */ ReaderKind m3803boximpl(int i) {
    ...
    public static boolean m3806equalsimpl(int i, Object obj) {
        return (obj instanceof ReaderKind) && i == ((ReaderKind) obj).m3812unboximpl();
    }
    ...
    public static final boolean m3809isReadInh_f27i8(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public boolean equals(Object obj) {
        return m3806equalsimpl(this.mask, obj);
    }

    public int hashCode() {
        return m3808hashCodeimpl(this.mask);
    }

    public String toString() {
        return m3810toStringimpl(this.mask);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m3812unboximpl() {
        return this.mask;
    }
    ...
    public static /* synthetic */ int m3805constructorimpl$default(int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        if ((i2 & 1) != 0) {
            i = 0;
        }
        return m3804constructorimpl(i);
    }
    ...
    public static final int m3811withReadIn3QSx2Dw(int i, int i2) {
        return m3804constructorimpl(i | i2);
    }
    ...
    public static final class Companion {
        ...
        public final int m3813getComposition6f8NoZ8() {
            return ReaderKind.m3804constructorimpl(1);
        }

        /* renamed from: getSnapshotStateObserver-6f8NoZ8  reason: not valid java name */
        public final int m3815getSnapshotStateObserver6f8NoZ8() {
            return ReaderKind.m3804constructorimpl(2);
        }

        /* renamed from: getSnapshotFlow-6f8NoZ8  reason: not valid java name */
        public final int m3814getSnapshotFlow6f8NoZ8() {
            return ReaderKind.m3804constructorimpl(4);
        }
    }
}
