    ...
    public static final class Companion {
        ...
        public final <T> T observe(Function1<Object, Unit> function1, Function1<Object, Unit> function12, Function0<? extends T> function0) {
            ...
            if (snapshot2 instanceof TransparentObserverMutableSnapshot) {
                ...
                if (transparentObserverMutableSnapshot.getThreadId$runtime_release() == ActualJvm_jvmKt.currentThreadId()) {
                    Function1<Object, Unit> readObserver$runtime_release = transparentObserverMutableSnapshot.getReadObserver();
                    Function1<Object, Unit> writeObserver$runtime_release = transparentObserverMutableSnapshot.getWriteObserver$runtime_release();
                    try {
                        ((TransparentObserverMutableSnapshot) snapshot2).setReadObserver(SnapshotKt.mergedReadObserver$default(function1, readObserver$runtime_release, false, 4, (Object) null));
                        ((TransparentObserverMutableSnapshot) snapshot2).setWriteObserver(SnapshotKt.mergedWriteObserver(function12, writeObserver$runtime_release));
                        T invoke = function0.invoke();
                        transparentObserverMutableSnapshot.setReadObserver(readObserver$runtime_release);
                        transparentObserverMutableSnapshot.setWriteObserver(writeObserver$runtime_release);
                        return invoke;
                    } catch (Throwable th) {
                        Throwable th2 = th;
                        transparentObserverMutableSnapshot.setReadObserver(readObserver$runtime_release);
            ...
            if (snapshot2 == null || (snapshot2 instanceof MutableSnapshot)) {
                ...
                if (snapshot3 instanceof MutableSnapshot) {
                    mutableSnapshot = (MutableSnapshot) snapshot3;
                }
        ...
        public final Snapshot makeCurrentNonObservable(Snapshot snapshot) {
            if (snapshot instanceof TransparentObserverMutableSnapshot) {
                ...
                if (transparentObserverMutableSnapshot.getThreadId$runtime_release() == ActualJvm_jvmKt.currentThreadId()) {
                    transparentObserverMutableSnapshot.setReadObserver((Function1<Object, Unit>) null);
                    return snapshot;
                }
            }
            if (snapshot instanceof TransparentObserverSnapshot) {
                ...
                if (transparentObserverSnapshot.getThreadId$runtime_release() == ActualJvm_jvmKt.currentThreadId()) {
                    transparentObserverSnapshot.setReadObserver((Function1<Object, Unit>) null);
                    return snapshot;
                }
            }
            Snapshot createTransparentSnapshotWithNoParentReadObserver$default = SnapshotKt.createTransparentSnapshotWithNoParentReadObserver$default(snapshot, (Function1) null, false, 6, (Object) null);
