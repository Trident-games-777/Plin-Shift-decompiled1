...
public final class SnapshotWeakSet<T> {
    ...
    public final boolean add(T t) {
        ...
        if (i2 == length) {
            ...
            ArraysKt.copyInto$default((Object[]) this.values, (Object[]) weakReferenceArr2, 0, 0, i3, 6, (Object) null);
            WeakReference<T>[] weakReferenceArr3 = weakReferenceArr2;
            ArraysKt.copyInto(this.hashes, iArr, i5, i3, i2);
            int[] iArr2 = iArr;
            ArraysKt.copyInto$default(this.hashes, iArr2, 0, 0, i3, 6, (Object) null);
            this.values = weakReferenceArr3;
            this.hashes = iArr2;
        } else {
            int i6 = i3 + 1;
            ArraysKt.copyInto((T[]) weakReferenceArr, (T[]) weakReferenceArr, i6, i3, i2);
            int[] iArr3 = this.hashes;
            ArraysKt.copyInto(iArr3, iArr3, i6, i3, i2);
        }
