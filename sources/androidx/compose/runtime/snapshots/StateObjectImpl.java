...
public abstract class StateObjectImpl implements StateObject {
    ...
    public final void m3818recordReadInh_f27i8$runtime_release(int i) {
        int r0;
        do {
            r0 = ReaderKind.m3804constructorimpl(this.readerKind.get());
            if ((r0 & i) == 0) {
            } else {
                return;
            }
        } while (!this.readerKind.compareAndSet(r0, ReaderKind.m3804constructorimpl(r0 | i)));
    }

    /* renamed from: isReadIn-h_f27i8$runtime_release  reason: not valid java name */
    public final boolean m3817isReadInh_f27i8$runtime_release(int i) {
        return (i & ReaderKind.m3804constructorimpl(this.readerKind.get())) != 0;
    }
}
