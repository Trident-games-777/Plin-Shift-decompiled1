...
public final class ComposerKt {
    ...
    public static final void removeCurrentGroup(SlotWriter slotWriter, RememberManager rememberManager) {
        int i;
        int access$dataIndex = slotWriter.dataIndex(slotWriter.groups, slotWriter.groupIndexToAddress(slotWriter.getCurrentGroup() + slotWriter.groupSize(slotWriter.getCurrentGroup())));
        for (int access$dataIndex2 = slotWriter.dataIndex(slotWriter.groups, slotWriter.groupIndexToAddress(slotWriter.getCurrentGroup())); access$dataIndex2 < access$dataIndex; access$dataIndex2++) {
            Object obj = slotWriter.slots[slotWriter.dataIndexToDataAddress(access$dataIndex2)];
            int i2 = -1;
            if (obj instanceof ComposeNodeLifecycleCallback) {
                rememberManager.releasing((ComposeNodeLifecycleCallback) obj, slotWriter.getSlotsSize() - access$dataIndex2, -1, -1);
            }
    ...
    public static final void deactivateCurrentGroup(SlotWriter slotWriter, RememberManager rememberManager) {
        ...
        while (currentGroup < currentGroupEnd) {
            ...
            int access$dataIndex = slotWriter.dataIndex(slotWriter.groups, slotWriter.groupIndexToAddress(i3));
            for (int i4 = access$slotIndex; i4 < access$dataIndex; i4++) {
                int i5 = i4 - access$slotIndex;
                ...
                if (obj instanceof RememberObserverHolder) {
                    ...
                    if (!(wrapped instanceof ReusableRememberObserver)) {
                        ...
                        rememberManager.forgetting(wrapped, slotsSize, i2, i);
                    }
    ...
    public static final <K, V> MutableScatterMap<K, Object> multiMap(int i) {
        return MutableScatterMultiMap.m3656constructorimpl(new MutableScatterMap(i));
    }
    ...
    public static final void insertIfMissing(List<Invalidation> list, int i, RecomposeScopeImpl recomposeScopeImpl, Object obj) {
        ...
        if (obj instanceof DerivedState) {
            ...
            invalidation.setInstances((Object) null);
        }
    }
