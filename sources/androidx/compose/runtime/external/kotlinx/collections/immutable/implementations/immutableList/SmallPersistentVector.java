...
public final class SmallPersistentVector<E> extends AbstractPersistentList<E> implements ImmutableList<E> {
    ...
    public SmallPersistentVector(Object[] objArr) {
        this.buffer = objArr;
        CommonFunctionsKt.m3801assert(objArr.length <= 32);
    }
    ...
    public PersistentList<E> addAll(int i, Collection<? extends E> collection) {
        ...
        if (size() + collection.size() <= 32) {
            ...
            ArraysKt.copyInto((T[]) this.buffer, (T[]) bufferOfSize, collection.size() + i2, i2, size());
            for (Object obj : collection) {
                bufferOfSize[i2] = obj;
                i2++;
            }
    ...
    public PersistentList<E> add(int i, E e) {
        ...
        if (size() < 32) {
            ...
            int i2 = i;
            ArraysKt.copyInto$default(this.buffer, bufferOfSize, 0, 0, i2, 6, (Object) null);
            ArraysKt.copyInto((T[]) this.buffer, (T[]) bufferOfSize, i2 + 1, i2, size());
            bufferOfSize[i2] = e;
            return new SmallPersistentVector<>(bufferOfSize);
        }
        int i3 = i;
        ...
        ArraysKt.copyInto((T[]) this.buffer, (T[]) copyOf, i3 + 1, i3, size() - 1);
        copyOf[i3] = e;
