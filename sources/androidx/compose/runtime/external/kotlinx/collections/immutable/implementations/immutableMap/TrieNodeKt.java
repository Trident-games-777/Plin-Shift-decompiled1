...
public final class TrieNodeKt {
    ...
    public static final <K, V> Object[] insertEntryAtIndex(Object[] objArr, int i, K k, V v) {
        ...
        int i2 = i;
        ArraysKt.copyInto$default(objArr3, objArr2, 0, 0, i2, 6, (Object) null);
        ArraysKt.copyInto((T[]) objArr3, (T[]) objArr2, i2 + 2, i2, objArr3.length);
        objArr2[i2] = k;
        objArr2[i2 + 1] = v;
        return objArr2;
    }
    ...
    public static final Object[] replaceEntryWithNode(Object[] objArr, int i, int i2, TrieNode<?, ?> trieNode) {
        ...
        Object[] objArr3 = objArr;
        int i3 = i;
        ArraysKt.copyInto$default(objArr3, objArr2, 0, 0, i3, 6, (Object) null);
        ArraysKt.copyInto((T[]) objArr3, (T[]) objArr2, i3, i3 + 2, i2);
        objArr2[i2 - 2] = trieNode;
        ArraysKt.copyInto((T[]) objArr3, (T[]) objArr2, i2 - 1, i2, objArr3.length);
        return objArr2;
    }
    ...
    public static final Object[] removeEntryAtIndex(Object[] objArr, int i) {
        ...
        int i2 = i;
        ArraysKt.copyInto$default(objArr3, objArr2, 0, 0, i2, 6, (Object) null);
        ArraysKt.copyInto((T[]) objArr3, (T[]) objArr2, i2, i2 + 2, objArr3.length);
        return objArr2;
    }
    ...
    public static final Object[] removeNodeAtIndex(Object[] objArr, int i) {
        ...
        int i2 = i;
        ArraysKt.copyInto$default(objArr3, objArr2, 0, 0, i2, 6, (Object) null);
        ArraysKt.copyInto((T[]) objArr3, (T[]) objArr2, i2, i2 + 1, objArr3.length);
        return objArr2;
    }
}
