...
public final class TrieNode<K, V> {
    ...
    private final TrieNode<K, V> moveEntryToNode(int i, int i2, int i3, K k, V v, int i4) {
        int i5 = i2;
        return new TrieNode<>(this.dataMap ^ i5, this.nodeMap | i5, bufferMoveEntryToNode(i, i5, i3, k, v, i4, (MutabilityOwnership) null));
    }
    ...
    private final TrieNode<K, V> mutableMoveEntryToNode(int i, int i2, int i3, K k, V v, int i4, MutabilityOwnership mutabilityOwnership) {
        if (this.ownedBy == mutabilityOwnership) {
            Object[] bufferMoveEntryToNode = bufferMoveEntryToNode(i, i2, i3, k, v, i4, mutabilityOwnership);
            int i5 = i2;
        ...
        Object[] bufferMoveEntryToNode2 = bufferMoveEntryToNode(i, i2, i3, k, v, i4, mutabilityOwnership);
        int i6 = i2;
        return new TrieNode<>(this.dataMap ^ i6, i6 | this.nodeMap, bufferMoveEntryToNode2, mutabilityOwnership);
    }
    ...
    private final TrieNode<K, V> makeNode(int i, K k, V v, int i2, K k2, V v2, int i3, MutabilityOwnership mutabilityOwnership) {
        ...
        if (i4 > 30) {
            return new TrieNode<>(0, 0, new Object[]{k, v, k3, v3}, mutabilityOwnership2);
        }
        int indexSegment = TrieNodeKt.indexSegment(i, i4);
        int i5 = i2;
        int indexSegment2 = TrieNodeKt.indexSegment(i5, i4);
        if (indexSegment != indexSegment2) {
            return new TrieNode<>((1 << indexSegment) | (1 << indexSegment2), 0, indexSegment < indexSegment2 ? new Object[]{k, v, k3, v3} : new Object[]{k3, v3, k, v}, mutabilityOwnership2);
        }
        return new TrieNode<>(0, 1 << indexSegment, new Object[]{makeNode(i, k, v, i5, k3, v3, i4 + 5, mutabilityOwnership2)}, mutabilityOwnership2);
    }
    ...
    private final TrieNode<K, V> mutableCollisionPutAll(TrieNode<K, V> trieNode, DeltaCounter deltaCounter, MutabilityOwnership mutabilityOwnership) {
        CommonFunctionsKt.m3801assert(this.nodeMap == 0);
        CommonFunctionsKt.m3801assert(this.dataMap == 0);
        CommonFunctionsKt.m3801assert(trieNode.nodeMap == 0);
        CommonFunctionsKt.m3801assert(trieNode.dataMap == 0);
        Object[] objArr = this.buffer;
    ...
    private final TrieNode<K, V> mutablePutAllFromOtherNodeCell(TrieNode<K, V> trieNode, int i, int i2, DeltaCounter deltaCounter, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        if (hasNodeAt(i)) {
            ...
            if (trieNode.hasNodeAt(i)) {
                return nodeAtIndex$runtime_release.mutablePutAll(trieNode.nodeAtIndex$runtime_release(trieNode.nodeIndex$runtime_release(i)), i2 + 5, deltaCounter2, persistentHashMapBuilder);
            }
            ...
            if (keyAtIndex != null) {
                i3 = keyAtIndex.hashCode();
            }
            TrieNode<K, V> mutablePut = nodeAtIndex$runtime_release.mutablePut(i3, keyAtIndex, valueAtKeyIndex, i2 + 5, persistentHashMapBuilder2);
            ...
            return nodeAtIndex$runtime_release2.mutablePut(i3, keyAtIndex2, valueAtKeyIndex2, i4, persistentHashMapBuilder);
        } else {
            ...
            return makeNode(hashCode, keyAtIndex3, valueAtKeyIndex3, i3, keyAtIndex4, valueAtKeyIndex4, i2 + 5, persistentHashMapBuilder.getOwnership());
        }
    }
    ...
    public final TrieNode<K, V> mutablePutAll(TrieNode<K, V> trieNode, int i, DeltaCounter deltaCounter, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        int i3 = this.nodeMap | trieNode3.nodeMap;
        int i4 = this.dataMap;
        int i5 = trieNode3.dataMap;
        int i6 = (i4 ^ i5) & (~i3);
        int i7 = i4 & i5;
        while (i7 != 0) {
        ...
        if (Intrinsics.areEqual((Object) this.ownedBy, (Object) persistentHashMapBuilder.getOwnership()) && this.dataMap == i6 && this.nodeMap == i3) {
            trieNode2 = this;
        } else {
            trieNode2 = new TrieNode(i6, i3, new Object[((Integer.bitCount(i6) * 2) + Integer.bitCount(i3))]);
        }
        int i9 = i3;
        int i10 = 0;
        while (i9 != 0) {
            ...
            objArr[(objArr.length - 1) - i10] = mutablePutAllFromOtherNodeCell(trieNode3, lowestOneBit2, i2, deltaCounter2, persistentHashMapBuilder);
            i10++;
            i9 ^= lowestOneBit2;
            i2 = i;
        }
        while (i6 != 0) {
            ...
            if (!trieNode3.hasEntryAt$runtime_release(lowestOneBit3)) {
                ...
                trieNode2.buffer[i11] = trieNode3.keyAtIndex(entryKeyIndex$runtime_release2);
                trieNode2.buffer[i11 + 1] = trieNode3.valueAtKeyIndex(entryKeyIndex$runtime_release2);
    ...
    public final ModificationResult<K, V> put(int i, K k, V v, int i2) {
        ...
        if (i4 == 30) {
            modificationResult = nodeAtIndex$runtime_release.collisionPut(k2, v2);
            if (modificationResult == null) {
                return null;
            }
        } else {
            modificationResult = nodeAtIndex$runtime_release.put(i3, k2, v2, i4 + 5);
            if (modificationResult == null) {
                return null;
            }
        }
    ...
    public final TrieNode<K, V> mutablePut(int i, K k, V v, int i2, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        int i6 = i2;
        if (hasNodeAt(i5)) {
            int nodeIndex$runtime_release = nodeIndex$runtime_release(i5);
            TrieNode<K, V> nodeAtIndex$runtime_release = nodeAtIndex$runtime_release(nodeIndex$runtime_release);
            if (i6 == 30) {
                trieNode = nodeAtIndex$runtime_release.mutableCollisionPut(k2, v2, persistentHashMapBuilder);
                persistentHashMapBuilder2 = persistentHashMapBuilder;
            } else {
                int i7 = i6 + 5;
                persistentHashMapBuilder2 = persistentHashMapBuilder;
                trieNode = nodeAtIndex$runtime_release.mutablePut(i4, k2, v2, i7, persistentHashMapBuilder2);
            }
            if (nodeAtIndex$runtime_release == trieNode) {
                return this;
            }
            return mutableUpdateNodeAtIndex(nodeIndex$runtime_release, trieNode, persistentHashMapBuilder2.getOwnership());
        }
        PersistentHashMapBuilder<K, V> persistentHashMapBuilder3 = persistentHashMapBuilder;
        persistentHashMapBuilder3.setSize(persistentHashMapBuilder3.size() + 1);
        return mutableInsertEntryAt(i5, k2, v2, persistentHashMapBuilder3.getOwnership());
    }
    ...
    public final TrieNode<K, V> remove(int i, K k, V v, int i2) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            int entryKeyIndex$runtime_release = entryKeyIndex$runtime_release(indexSegment);
            if (Intrinsics.areEqual((Object) k, keyAtIndex(entryKeyIndex$runtime_release)) && Intrinsics.areEqual((Object) v, valueAtKeyIndex(entryKeyIndex$runtime_release))) {
                return removeEntryAtIndex(entryKeyIndex$runtime_release, indexSegment);
            }
        } else if (hasNodeAt(indexSegment)) {
            int nodeIndex$runtime_release = nodeIndex$runtime_release(indexSegment);
    ...
    public final TrieNode<K, V> mutableRemove(int i, K k, V v, int i2, PersistentHashMapBuilder<K, V> persistentHashMapBuilder) {
        ...
        if (hasEntryAt$runtime_release(indexSegment)) {
            ...
            TrieNode nodeAtIndex$runtime_release = nodeAtIndex$runtime_release(nodeIndex$runtime_release);
            if (i2 == 30) {
                trieNode = nodeAtIndex$runtime_release.mutableCollisionRemove(k, v, persistentHashMapBuilder);
            } else {
                trieNode = nodeAtIndex$runtime_release.mutableRemove(i, k, v, i2 + 5, persistentHashMapBuilder);
            }
            return mutableReplaceNode(nodeAtIndex$runtime_release, trieNode, nodeIndex$runtime_release, indexSegment, persistentHashMapBuilder.getOwnership());
        }
        return this;
    ...
    private final void accept(Function5<? super TrieNode<K, V>, ? super Integer, ? super Integer, ? super Integer, ? super Integer, Unit> function5, int i, int i2) {
        Function5<? super TrieNode<K, V>, ? super Integer, ? super Integer, ? super Integer, ? super Integer, Unit> function52 = function5;
        function52.invoke(this, Integer.valueOf(i2), Integer.valueOf(i), Integer.valueOf(this.dataMap), Integer.valueOf(this.nodeMap));
        int i3 = this.nodeMap;
        while (i3 != 0) {
            int lowestOneBit = Integer.lowestOneBit(i3);
            nodeAtIndex$runtime_release(nodeIndex$runtime_release(lowestOneBit)).accept(function52, (Integer.numberOfTrailingZeros(lowestOneBit) << i2) + i, i2 + 5);
            i3 -= lowestOneBit;
        }
    }
