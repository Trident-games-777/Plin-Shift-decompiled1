...
final class ComposableLambdaImpl$invoke$18 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        composableLambdaImpl2.invoke(this.$p1, this.$p2, this.$p3, this.$p4, this.$p5, this.$p6, this.$p7, this.$p8, this.$p9, this.$p10, this.$p11, this.$p12, this.$p13, this.$p14, this.$p15, this.$p16, this.$p17, this.$p18, composer, RecomposeScopeImplKt.updateChangedFlags(this.$changed) | 1, RecomposeScopeImplKt.updateChangedFlags(this.$changed1));
    }
}
