...
public final class SkippableUpdater<T> {
    ...
    public static final /* synthetic */ SkippableUpdater m3666boximpl(Composer composer2) {
        return new SkippableUpdater(composer2);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static <T> Composer m3667constructorimpl(Composer composer2) {
        return composer2;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m3668equalsimpl(Composer composer2, Object obj) {
        return (obj instanceof SkippableUpdater) && Intrinsics.areEqual((Object) composer2, (Object) ((SkippableUpdater) obj).m3673unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m3669equalsimpl0(Composer composer2, Composer composer3) {
    ...
    public static int m3670hashCodeimpl(Composer composer2) {
        return composer2.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m3671toStringimpl(Composer composer2) {
        return "SkippableUpdater(composer=" + composer2 + ')';
    }

    public boolean equals(Object obj) {
        return m3668equalsimpl(this.composer, obj);
    }

    public int hashCode() {
        return m3670hashCodeimpl(this.composer);
    }

    public String toString() {
        return m3671toStringimpl(this.composer);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ Composer m3673unboximpl() {
    ...
    public static final void m3672updateimpl(Composer composer2, Function1<? super Updater<T>, Unit> function1) {
        composer2.startReplaceableGroup(509942095);
        function1.invoke(Updater.m3674boximpl(Updater.m3675constructorimpl(composer2)));
