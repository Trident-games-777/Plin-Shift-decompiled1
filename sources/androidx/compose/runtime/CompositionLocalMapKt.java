...
public final class CompositionLocalMapKt {
    ...
    /* JADX WARNING: type inference failed for: r3v0, types: [androidx.compose.runtime.CompositionLocal<T>, java.lang.Object, androidx.compose.runtime.CompositionLocal] */
    /* JADX WARNING: Unknown variable types count: 1 */
    /* Code decompiled incorrectly, please refer to instructions dump. */
    public static final <T> T read(androidx.compose.runtime.PersistentCompositionLocalMap r2, androidx.compose.runtime.CompositionLocal<T> r3) {
        /*
            r0 = r2
            ...
            androidx.compose.runtime.ValueHolder r0 = r3.getDefaultValueHolder$runtime_release()
        L_0x0012:
            androidx.compose.runtime.ValueHolder r0 = (androidx.compose.runtime.ValueHolder) r0
            java.lang.Object r2 = r0.readValue(r2)
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.runtime.CompositionLocalMapKt.read(androidx.compose.runtime.PersistentCompositionLocalMap, androidx.compose.runtime.CompositionLocal):java.lang.Object");
    }
    ...
    public static final PersistentCompositionLocalMap updateCompositionMap(ProvidedValue<?>[] providedValueArr, PersistentCompositionLocalMap persistentCompositionLocalMap, PersistentCompositionLocalMap persistentCompositionLocalMap2) {
        ...
        for (ProvidedValue<?> providedValue : providedValueArr) {
            ...
            if (providedValue.getCanOverride() || !contains(persistentCompositionLocalMap, providableCompositionLocal)) {
                ...
                builder.put(providableCompositionLocal, providableCompositionLocal.updatedStateOf$runtime_release(providedValue, (ValueHolder) persistentMap.get(providableCompositionLocal)));
            }
        }
        return builder.build();
    }
