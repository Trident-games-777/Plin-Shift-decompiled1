...
final class DpCornerSize implements CornerSize, InspectableValue {
    ...
    private final float m1141component1D9Ej5fM() {
        return this.size;
    }

    /* renamed from: copy-0680j_4$default  reason: not valid java name */
    public static /* synthetic */ DpCornerSize m1142copy0680j_4$default(DpCornerSize dpCornerSize, float f, int i, Object obj) {
        if ((i & 1) != 0) {
            f = dpCornerSize.size;
        }
        return dpCornerSize.m1143copy0680j_4(f);
    }

    /* renamed from: copy-0680j_4  reason: not valid java name */
    public final DpCornerSize m1143copy0680j_4(float f) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof DpCornerSize) && Dp.m7116equalsimpl0(this.size, ((DpCornerSize) obj).size);
    }
    ...
    public /* bridge */ /* synthetic */ Object getValueOverride() {
        return Dp.m7109boximpl(m1144getValueOverrideD9Ej5fM());
    }

    /* renamed from: toPx-TmRCtEA  reason: not valid java name */
    public float m1145toPxTmRCtEA(long j, Density density) {
        return density.m7091toPx0680j_4(this.size);
    }
    ...
    public float m1144getValueOverrideD9Ej5fM() {
        return this.size;
    }
}
