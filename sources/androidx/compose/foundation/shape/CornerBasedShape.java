...
public abstract class CornerBasedShape implements Shape {
    ...
    public abstract Outline m1132createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection);
    ...
    public final Outline m1133createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        float r4 = this.topStart.m1134toPxTmRCtEA(j, density);
        float r5 = this.topEnd.m1134toPxTmRCtEA(j, density);
        float r6 = this.bottomEnd.m1134toPxTmRCtEA(j, density);
        float r3 = this.bottomStart.m1134toPxTmRCtEA(j, density);
        float r7 = Size.m4055getMinDimensionimpl(j);
        float f = r4 + r3;
        if (f > r7) {
            float f2 = r7 / f;
            r4 *= f2;
        ...
        if (r4 < 0.0f || r5 < 0.0f || r6 < 0.0f || r3 < 0.0f) {
            float f5 = r6;
            float f6 = r3;
            float f7 = r4;
            throw new IllegalArgumentException(("Corner size in Px can't be negative(topStart = " + f7 + ", topEnd = " + r5 + ", bottomEnd = " + f5 + ", bottomStart = " + f6 + ")!").toString());
        }
        float f8 = r6;
        float f9 = r3;
        return m1132createOutlineLjSzlW0(j, r4, r5, f8, f9, layoutDirection);
    }
