...
public final class AbsoluteCutCornerShape extends CornerBasedShape {
    ...
    public Outline m1123createOutlineLjSzlW0(long j, float f, float f2, float f3, float f4, LayoutDirection layoutDirection) {
        if (f + f2 + f4 + f3 == 0.0f) {
        ...
        Path.moveTo(0.0f, f);
        Path.lineTo(f, 0.0f);
        Path.lineTo(Size.m4056getWidthimpl(j) - f2, 0.0f);
        Path.lineTo(Size.m4056getWidthimpl(j), f2);
        Path.lineTo(Size.m4056getWidthimpl(j), Size.m4053getHeightimpl(j) - f3);
        Path.lineTo(Size.m4056getWidthimpl(j) - f3, Size.m4053getHeightimpl(j));
        Path.lineTo(f4, Size.m4053getHeightimpl(j));
        Path.lineTo(0.0f, Size.m4053getHeightimpl(j) - f4);
        Path.close();
