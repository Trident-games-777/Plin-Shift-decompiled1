...
public final class GenericShape implements Shape {
    ...
    public Outline m1146createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        Path Path = AndroidPath_androidKt.Path();
        this.builder.invoke(Path, Size.m4044boximpl(j), layoutDirection);
        Path.close();
