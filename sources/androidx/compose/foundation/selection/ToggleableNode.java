...
final class ToggleableNode extends ClickableNode {
    ...
    public Function1<? super Boolean, Unit> onValueChange;
    /* access modifiers changed from: private */
    ...
    private ToggleableNode(final boolean z, MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory, boolean z2, Role role, final Function1<? super Boolean, Unit> function1) {
        super(mutableInteractionSource, indicationNodeFactory, z2, (String) null, role, new Function0<Unit>() {
    ...
    public final void m1121updateQzZPfjk(boolean z, MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory, boolean z2, Role role, Function1<? super Boolean, Unit> function1) {
        if (this.value != z) {
            this.value = z;
            SemanticsModifierNodeKt.invalidateSemantics(this);
        }
        this.onValueChange = function1;
        super.m289updateQzZPfjk(mutableInteractionSource, indicationNodeFactory, z2, (String) null, role, this._onClick);
    }
