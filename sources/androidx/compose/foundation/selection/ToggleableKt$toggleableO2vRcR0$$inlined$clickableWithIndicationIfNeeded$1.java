...
public final class ToggleableKt$toggleableO2vRcR0$$inlined$clickableWithIndicationIfNeeded$1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public ToggleableKt$toggleableO2vRcR0$$inlined$clickableWithIndicationIfNeeded$1(Indication indication, boolean z, boolean z2, Role role, Function1 function1) {
        super(3);
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        Modifier then = IndicationKt.indication(Modifier.Companion, mutableInteractionSource, this.$indication).then(new ToggleableElement(this.$value$inlined, mutableInteractionSource, (IndicationNodeFactory) null, this.$enabled$inlined, this.$role$inlined, this.$onValueChange$inlined, (DefaultConstructorMarker) null));
        if (ComposerKt.isTraceInProgress()) {
