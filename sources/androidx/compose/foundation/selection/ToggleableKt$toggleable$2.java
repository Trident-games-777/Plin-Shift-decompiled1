...
final class ToggleableKt$toggleable$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        Modifier modifier2 = ToggleableKt.m1113toggleableO2vRcR0(Modifier.Companion, this.$value, mutableInteractionSource, indication, this.$enabled, this.$role, this.$onValueChange);
        if (ComposerKt.isTraceInProgress()) {
