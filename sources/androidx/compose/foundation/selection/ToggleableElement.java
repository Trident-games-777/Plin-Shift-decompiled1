...
final class ToggleableElement extends ModifierNodeElement<ToggleableNode> {
    ...
    public /* synthetic */ ToggleableElement(boolean z, MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory2, boolean z2, Role role2, Function1 function1, DefaultConstructorMarker defaultConstructorMarker) {
        this(z, mutableInteractionSource, indicationNodeFactory2, z2, role2, function1);
    }

    private ToggleableElement(boolean z, MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory2, boolean z2, Role role2, Function1<? super Boolean, Unit> function1) {
        this.value = z;
    ...
    public ToggleableNode create() {
        return new ToggleableNode(this.value, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onValueChange, (DefaultConstructorMarker) null);
    }

    public void update(ToggleableNode toggleableNode) {
        toggleableNode.m1121updateQzZPfjk(this.value, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onValueChange);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.value == toggleableElement.value && Intrinsics.areEqual((Object) this.interactionSource, (Object) toggleableElement.interactionSource) && Intrinsics.areEqual((Object) this.indicationNodeFactory, (Object) toggleableElement.indicationNodeFactory) && this.enabled == toggleableElement.enabled && Intrinsics.areEqual((Object) this.role, (Object) toggleableElement.role) && this.onValueChange == toggleableElement.onValueChange;
    }
    ...
    public int hashCode() {
        ...
        return ((hashCode3 + i) * 31) + this.onValueChange.hashCode();
    }
}
