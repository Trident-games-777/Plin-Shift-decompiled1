...
final class SelectableElement extends ModifierNodeElement<SelectableNode> {
    ...
    public /* synthetic */ SelectableElement(boolean z, MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory2, boolean z2, Role role2, Function0 function0, DefaultConstructorMarker defaultConstructorMarker) {
        this(z, mutableInteractionSource, indicationNodeFactory2, z2, role2, function0);
    }

    private SelectableElement(boolean z, MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory2, boolean z2, Role role2, Function0<Unit> function0) {
        this.selected = z;
    ...
    public SelectableNode create() {
        return new SelectableNode(this.selected, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onClick, (DefaultConstructorMarker) null);
    }

    public void update(SelectableNode selectableNode) {
        selectableNode.m1112updateQzZPfjk(this.selected, this.interactionSource, this.indicationNodeFactory, this.enabled, this.role, this.onClick);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.selected == selectableElement.selected && Intrinsics.areEqual((Object) this.interactionSource, (Object) selectableElement.interactionSource) && Intrinsics.areEqual((Object) this.indicationNodeFactory, (Object) selectableElement.indicationNodeFactory) && this.enabled == selectableElement.enabled && Intrinsics.areEqual((Object) this.role, (Object) selectableElement.role) && this.onClick == selectableElement.onClick;
    }
