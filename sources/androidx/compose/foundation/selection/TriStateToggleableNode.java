...
final class TriStateToggleableNode extends ClickableNode {
    ...
    private TriStateToggleableNode(ToggleableState toggleableState, MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory, boolean z, Role role, Function0<Unit> function0) {
        super(mutableInteractionSource, indicationNodeFactory, z, (String) null, role, function0, (DefaultConstructorMarker) null);
        this.state = toggleableState;
    }

    /* renamed from: update-QzZPfjk  reason: not valid java name */
    public final void m1122updateQzZPfjk(ToggleableState toggleableState, MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory, boolean z, Role role, Function0<Unit> function0) {
        if (this.state != toggleableState) {
            this.state = toggleableState;
            SemanticsModifierNodeKt.invalidateSemantics(this);
        }
        super.m289updateQzZPfjk(mutableInteractionSource, indicationNodeFactory, z, (String) null, role, function0);
    }
