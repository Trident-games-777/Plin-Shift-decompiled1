...
final class ClickableElement extends ModifierNodeElement<ClickableNode> {
    ...
    public /* synthetic */ ClickableElement(MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory2, boolean z, String str, Role role2, Function0 function0, DefaultConstructorMarker defaultConstructorMarker) {
        this(mutableInteractionSource, indicationNodeFactory2, z, str, role2, function0);
    }

    private ClickableElement(MutableInteractionSource mutableInteractionSource, IndicationNodeFactory indicationNodeFactory2, boolean z, String str, Role role2, Function0<Unit> function0) {
    ...
    public ClickableNode create() {
        return new ClickableNode(this.interactionSource, this.indicationNodeFactory, this.enabled, this.onClickLabel, this.role, this.onClick, (DefaultConstructorMarker) null);
    }

    public void update(ClickableNode clickableNode) {
        clickableNode.m289updateQzZPfjk(this.interactionSource, this.indicationNodeFactory, this.enabled, this.onClickLabel, this.role, this.onClick);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.interactionSource, (Object) clickableElement.interactionSource) && Intrinsics.areEqual((Object) this.indicationNodeFactory, (Object) clickableElement.indicationNodeFactory) && this.enabled == clickableElement.enabled && Intrinsics.areEqual((Object) this.onClickLabel, (Object) clickableElement.onClickLabel) && Intrinsics.areEqual((Object) this.role, (Object) clickableElement.role) && this.onClick == clickableElement.onClick;
    }
