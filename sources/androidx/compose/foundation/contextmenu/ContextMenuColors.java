...
public final class ContextMenuColors {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m4240equalsimpl0(this.backgroundColor, contextMenuColors.backgroundColor) && Color.m4240equalsimpl0(this.textColor, contextMenuColors.textColor) && Color.m4240equalsimpl0(this.iconColor, contextMenuColors.iconColor) && Color.m4240equalsimpl0(this.disabledTextColor, contextMenuColors.disabledTextColor) && Color.m4240equalsimpl0(this.disabledIconColor, contextMenuColors.disabledIconColor);
    }

    public int hashCode() {
        return (((((((Color.m4246hashCodeimpl(this.backgroundColor) * 31) + Color.m4246hashCodeimpl(this.textColor)) * 31) + Color.m4246hashCodeimpl(this.iconColor)) * 31) + Color.m4246hashCodeimpl(this.disabledTextColor)) * 31) + Color.m4246hashCodeimpl(this.disabledIconColor);
    }

    public String toString() {
        return "ContextMenuColors(backgroundColor=" + Color.m4247toStringimpl(this.backgroundColor) + ", textColor=" + Color.m4247toStringimpl(this.textColor) + ", iconColor=" + Color.m4247toStringimpl(this.iconColor) + ", disabledTextColor=" + Color.m4247toStringimpl(this.disabledTextColor) + ", disabledIconColor=" + Color.m4247toStringimpl(this.disabledIconColor) + ')';
    }
}
