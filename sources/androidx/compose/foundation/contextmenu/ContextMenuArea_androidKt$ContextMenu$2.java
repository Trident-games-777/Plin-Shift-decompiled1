...
final class ContextMenuArea_androidKt$ContextMenu$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    ContextMenuArea_androidKt$ContextMenu$2(ContextMenuState contextMenuState, Function0<Unit> function0, Modifier modifier, Function1<? super ContextMenuScope, Unit> function1, int i, int i2) {
        super(2);
