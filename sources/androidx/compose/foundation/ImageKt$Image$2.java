...
final class ImageKt$Image$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    ImageKt$Image$2(Painter painter, String str, Modifier modifier, Alignment alignment, ContentScale contentScale, float f, ColorFilter colorFilter, int i, int i2) {
        super(2);
