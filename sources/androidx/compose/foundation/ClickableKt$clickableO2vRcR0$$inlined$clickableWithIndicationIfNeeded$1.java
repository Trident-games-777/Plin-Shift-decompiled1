...
public final class ClickableKt$clickableO2vRcR0$$inlined$clickableWithIndicationIfNeeded$1 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public ClickableKt$clickableO2vRcR0$$inlined$clickableWithIndicationIfNeeded$1(Indication indication, boolean z, String str, Role role, Function0 function0) {
        super(3);
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        Modifier then = IndicationKt.indication(Modifier.Companion, mutableInteractionSource, this.$indication).then(new ClickableElement(mutableInteractionSource, (IndicationNodeFactory) null, this.$enabled$inlined, this.$onClickLabel$inlined, this.$role$inlined, this.$onClick$inlined, (DefaultConstructorMarker) null));
        if (ComposerKt.isTraceInProgress()) {
