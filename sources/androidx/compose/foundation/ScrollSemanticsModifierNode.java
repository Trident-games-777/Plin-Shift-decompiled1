...
final class ScrollSemanticsModifierNode extends Modifier.Node implements SemanticsModifierNode {
    ...
    public final void setFlingBehavior(FlingBehavior flingBehavior2) {
    ...
    public ScrollSemanticsModifierNode(ScrollState scrollState, boolean z, FlingBehavior flingBehavior2, boolean z2, boolean z3) {
        this.state = scrollState;
        this.reverseScrolling = z;
        this.flingBehavior = flingBehavior2;
    ...
    public void applySemantics(SemanticsPropertyReceiver semanticsPropertyReceiver) {
        ...
        ScrollAxisRange scrollAxisRange = new ScrollAxisRange(new ScrollSemanticsModifierNode$applySemantics$accessibilityScrollState$1(this), new ScrollSemanticsModifierNode$applySemantics$accessibilityScrollState$2(this), this.reverseScrolling);
        if (this.isVertical) {
