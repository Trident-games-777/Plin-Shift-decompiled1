...
public final class PlatformMagnifierFactoryApi28Impl implements PlatformMagnifierFactory {
    ...
    public PlatformMagnifierImpl m350createnHHXs2Y(View view, boolean z, long j, float f, float f2, boolean z2, Density density, float f3) {
    ...
    public static class PlatformMagnifierImpl implements PlatformMagnifier {
        ...
        public long m351getSizeYbymL2g() {
        ...
        public void m352updateWko1d7g(long j, long j2, float f) {
            this.magnifier.show(Offset.m3987getXimpl(j), Offset.m3988getYimpl(j));
        }
