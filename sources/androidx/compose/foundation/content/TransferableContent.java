...
public final class TransferableContent {
    ...
    public /* synthetic */ TransferableContent(ClipEntry clipEntry2, ClipMetadata clipMetadata2, int i, PlatformTransferableContent platformTransferableContent2, DefaultConstructorMarker defaultConstructorMarker) {
        this(clipEntry2, clipMetadata2, i, platformTransferableContent2);
    }

    private TransferableContent(ClipEntry clipEntry2, ClipMetadata clipMetadata2, int i, PlatformTransferableContent platformTransferableContent2) {
        this.clipEntry = clipEntry2;
        this.clipMetadata = clipMetadata2;
        this.source = i;
        this.platformTransferableContent = platformTransferableContent2;
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ TransferableContent(ClipEntry clipEntry2, ClipMetadata clipMetadata2, int i, PlatformTransferableContent platformTransferableContent2, int i2, DefaultConstructorMarker defaultConstructorMarker) {
        this(clipEntry2, clipMetadata2, i, (i2 & 8) != 0 ? null : platformTransferableContent2, (DefaultConstructorMarker) null);
    }
    ...
    public final int m357getSourcekB6V9T0() {
        return this.source;
    }
    ...
    public static final class Source {
        ...
        public static final int Clipboard = m359constructorimpl(2);
        public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
        /* access modifiers changed from: private */
        public static final int DragAndDrop = m359constructorimpl(1);
        /* access modifiers changed from: private */
        public static final int Keyboard = m359constructorimpl(0);
        ...
        public static boolean m360equalsimpl(int i, Object obj) {
            return (obj instanceof Source) && i == ((Source) obj).m364unboximpl();
        }
        ...
        public static String m363toStringimpl(int i) {
            if (m361equalsimpl0(i, Keyboard)) {
                return "Source.Keyboard";
            }
            if (m361equalsimpl0(i, DragAndDrop)) {
                return "Source.DragAndDrop";
            }
            if (m361equalsimpl0(i, Clipboard)) {
                return "Source.Clipboard";
            }
            return "Invalid (" + i + ')';
        }
