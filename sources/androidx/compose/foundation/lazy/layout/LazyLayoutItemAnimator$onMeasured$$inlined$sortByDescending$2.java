...
public final class LazyLayoutItemAnimator$onMeasured$$inlined$sortByDescending$2<T> implements Comparator {
    ...
    public final int compare(T t, T t2) {
        return ComparisonsKt.compareValues(Integer.valueOf(this.$keyIndexMap$inlined.getIndex(((LazyLayoutMeasuredItem) t2).getKey())), Integer.valueOf(this.$keyIndexMap$inlined.getIndex(((LazyLayoutMeasuredItem) t).getKey())));
    }
}
