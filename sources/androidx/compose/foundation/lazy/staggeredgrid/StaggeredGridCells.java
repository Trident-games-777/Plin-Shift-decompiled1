...
public interface StaggeredGridCells {
    ...
    public static final class Adaptive implements StaggeredGridCells {
        ...
        public int[] calculateCrossAxisCellSizes(Density density, int i, int i2) {
            return LazyStaggeredGridCellsKt.calculateCellsCrossAxisSizeImpl(i, Math.max((i + i2) / (density.m7086roundToPx0680j_4(this.minSize) + i2), 1), i2);
        }
    ...
    public static final class FixedSize implements StaggeredGridCells {
        ...
        public int[] calculateCrossAxisCellSizes(Density density, int i, int i2) {
            int r2 = density.m7086roundToPx0680j_4(this.size);
            int i3 = r2 + i2;
            int i4 = i2 + i;
            if (i3 >= i4) {
                return new int[]{i};
