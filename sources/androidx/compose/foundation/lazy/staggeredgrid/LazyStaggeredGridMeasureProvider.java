...
public abstract class LazyStaggeredGridMeasureProvider implements LazyLayoutMeasuredItemProvider<LazyStaggeredGridMeasuredItem> {
    ...
    public abstract LazyStaggeredGridMeasuredItem m1059createItempitSLOA(int i, int i2, int i3, Object obj, Object obj2, List<? extends Placeable> list, long j);
    ...
    private final long m1058childConstraintsJhjzzOo(int i, int i2) {
        int i3;
        if (i2 == 1) {
        ...
        if (this.isVertical) {
            return Constraints.Companion.m7064fixedWidthOenEA2s(i3);
        }
        return Constraints.Companion.m7063fixedHeightOenEA2s(i3);
    }

    /* renamed from: getAndMeasure-jy6DScQ  reason: not valid java name */
    public final LazyStaggeredGridMeasuredItem m1062getAndMeasurejy6DScQ(int i, long j) {
        ...
        long r8 = m1058childConstraintsJhjzzOo(coerceAtMost, coerceAtMost2);
        return m1059createItempitSLOA(i, coerceAtMost, coerceAtMost2, key, contentType, this.measureScope.m990measure0kLqBqw(i, r8), r8);
    }

    /* renamed from: getAndMeasure--hBUhpc  reason: not valid java name */
    public LazyStaggeredGridMeasuredItem m1061getAndMeasurehBUhpc(int i, int i2, int i3, long j) {
        return m1059createItempitSLOA(i, i2, i3, this.itemProvider.getKey(i), this.itemProvider.getContentType(i), this.measureScope.m990measure0kLqBqw(i, j), j);
    }
