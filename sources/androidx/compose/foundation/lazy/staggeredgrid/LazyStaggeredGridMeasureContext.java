...
public final class LazyStaggeredGridMeasureContext {
    ...
    public final boolean m1051isFullSpanSZVOQXA(long j) {
    ...
    public final long m1047getConstraintsmsEJaDk() {
    ...
    public final long m1048getContentOffsetnOccac() {
    ...
    public final long m1050getSpanRangelOCCd4c(LazyStaggeredGridItemProvider lazyStaggeredGridItemProvider, int i, int i2) {
        boolean isFullSpan = lazyStaggeredGridItemProvider.getSpanProvider().isFullSpan(i);
        int i3 = isFullSpan ? this.laneCount : 1;
        if (isFullSpan) {
            i2 = 0;
        }
        return SpanRange.m1074constructorimpl(i2, i3);
    }
}
