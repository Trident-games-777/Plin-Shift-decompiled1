...
final class LazyStaggeredGridItemProviderImpl implements LazyStaggeredGridItemProvider {
    ...
    public void Item(int i, Object obj, Composer composer, int i2) {
        ...
        if ((i3 & 147) != 146 || !startRestartGroup.getSkipping()) {
            ...
            i4 = i;
            obj2 = obj;
            LazyLayoutPinnableItemKt.LazyLayoutPinnableItem(obj2, i4, this.state.getPinnedItems$foundation_release(), ComposableLambdaKt.rememberComposableLambda(608834466, true, new LazyStaggeredGridItemProviderImpl$Item$1(this, i), startRestartGroup, 54), startRestartGroup, ((i3 >> 3) & 14) | 3072 | ((i3 << 3) & 112));
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new LazyStaggeredGridItemProviderImpl$Item$2(this, i4, obj2, i2));
        }
    }
