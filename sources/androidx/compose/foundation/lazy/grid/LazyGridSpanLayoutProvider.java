...
public final class LazyGridSpanLayoutProvider {
    ...
    private final List<GridItemSpan> getDefaultSpans(int i) {
        ...
        for (int i2 = 0; i2 < i; i2++) {
            arrayList.add(GridItemSpan.m929boximpl(LazyGridSpanKt.GridItemSpan(1)));
        }
    ...
    public final androidx.compose.foundation.lazy.grid.LazyGridSpanLayoutProvider.LineConfiguration getLineConfiguration(int r11) {
        ...
        L_0x012e:
            ...
            androidx.compose.foundation.lazy.grid.GridItemSpan r5 = androidx.compose.foundation.lazy.grid.GridItemSpan.m929boximpl(r5)
            r11.add(r5)
            r5 = r3
            goto L_0x0116
        L_0x0142:
            ...
            if (firstItemIndex <= i) {
                ...
                while (true) {
                    ...
                    if (bucketSize % getBucketSize() == 0 && bucketSize / getBucketSize() >= this.buckets.size()) {
                        ...
                        arrayList.add(new Bucket(i4 - i3, 0, 2, (DefaultConstructorMarker) null));
                    }
                    firstItemIndex = i4;
                }
    ...
    public final int spanOf(int i, int i2) {
        ...
        return GridItemSpan.m933getCurrentLineSpanimpl(((LazyGridInterval) interval.getValue()).getSpan().invoke(lazyGridItemSpanScopeImpl, Integer.valueOf(i - interval.getStartIndex())).m936unboximpl());
    }
