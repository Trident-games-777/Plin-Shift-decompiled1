...
final class LazyGridState$prefetchState$1 extends Lambda implements Function1<NestedPrefetchScope, Unit> {
    final /* synthetic */ int $firstVisibleItemIndex;
    final /* synthetic */ LazyGridState this$0;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    LazyGridState$prefetchState$1(LazyGridState lazyGridState, int i) {
        super(1);
    ...
    public final void invoke(NestedPrefetchScope nestedPrefetchScope) {
        LazyGridPrefetchStrategy access$getPrefetchStrategy$p = this.this$0.prefetchStrategy;
