...
public abstract class LazyGridMeasuredLineProvider {
    ...
    public final long m963childConstraintsJhjzzOo$foundation_release(int i, int i2) {
        int i3;
        if (i2 == 1) {
        ...
        if (this.isVertical) {
            return Constraints.Companion.m7064fixedWidthOenEA2s(coerceAtLeast);
        }
        return Constraints.Companion.m7063fixedHeightOenEA2s(coerceAtLeast);
    }
    ...
    public final LazyGridMeasuredLine getAndMeasure(int i) {
        ...
        for (int i4 = 0; i4 < size; i4++) {
            int r9 = GridItemSpan.m933getCurrentLineSpanimpl(lineConfiguration.getSpans().get(i4).m936unboximpl());
            LazyGridMeasuredItem r4 = this.measuredItemProvider.m962getAndMeasurem8Kt_7k(lineConfiguration.getFirstItemIndex() + i4, m963childConstraintsJhjzzOo$foundation_release(i3, r9), i3, r9, i2);
            i3 += r9;
            Unit unit = Unit.INSTANCE;
            lazyGridMeasuredItemArr[i4] = r4;
        }
