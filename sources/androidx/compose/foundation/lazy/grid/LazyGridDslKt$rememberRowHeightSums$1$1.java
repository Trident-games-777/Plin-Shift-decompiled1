...
final class LazyGridDslKt$rememberRowHeightSums$1$1 extends Lambda implements Function2<Density, Constraints, LazyGridSlots> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m943invoke0kLqBqw((Density) obj, ((Constraints) obj2).m7058unboximpl());
    }

    /* renamed from: invoke-0kLqBqw  reason: not valid java name */
    public final LazyGridSlots m943invoke0kLqBqw(Density density, long j) {
        if (Constraints.m7051getMaxHeightimpl(j) != Integer.MAX_VALUE) {
            ...
            int[] intArray = CollectionsKt.toIntArray(gridCells.calculateCrossAxisCellSizes(density, r4, density.m7086roundToPx0680j_4(vertical.m645getSpacingD9Ej5fM())));
