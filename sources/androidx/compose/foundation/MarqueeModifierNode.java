...
final class MarqueeModifierNode extends Modifier.Node implements LayoutModifierNode, DrawModifierNode, FocusEventModifierNode {
    ...
    private MarqueeModifierNode(int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f) {
        ...
        this.animationMode$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(MarqueeAnimationMode.m323boximpl(i2), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public final int m337getAnimationModeZbEOnfQ() {
        return ((MarqueeAnimationMode) this.animationMode$delegate.getValue()).m329unboximpl();
    }

    /* renamed from: setAnimationMode-97h66l8  reason: not valid java name */
    public final void m339setAnimationMode97h66l8(int i) {
        this.animationMode$delegate.setValue(MarqueeAnimationMode.m323boximpl(i));
    }
    ...
    public final void m340updatelWfNwf4(int i, int i2, int i3, int i4, MarqueeSpacing marqueeSpacing, float f) {
        setSpacing(marqueeSpacing);
        m339setAnimationMode97h66l8(i2);
        if (this.iterations != i || this.delayMillis != i3 || this.initialDelayMillis != i4 || !Dp.m7116equalsimpl0(this.velocity, f)) {
            this.iterations = i;
            this.delayMillis = i3;
            this.initialDelayMillis = i4;
            this.velocity = f;
    ...
    public MeasureResult m338measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        long j2 = j;
        ...
        setContainerWidth(ConstraintsKt.m7069constrainWidthK40F9xA(j2, r10.getWidth()));
        setContentWidth(r10.getWidth());
        return MeasureScope.layout$default(measureScope, getContainerWidth(), r10.getHeight(), (Map) null, new MarqueeModifierNode$measure$1(r10, this), 4, (Object) null);
    }
    ...
    public void draw(ContentDrawScope contentDrawScope) {
        ...
        float r6 = Size.m4053getHeightimpl(drawScope.m4865getSizeNHjbRc());
        int r7 = ClipOp.Companion.m4228getIntersectrtfAjoo();
        DrawContext drawContext = drawScope.getDrawContext();
        long r11 = drawContext.m4806getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().m4926clipRectN_I0leg(floatValue, 0.0f, containerWidth, r6, r7);
            if (z) {
