...
final class AndroidEmbeddedExternalSurfaceState extends BaseAndroidExternalSurfaceState implements TextureView.SurfaceTextureListener {
    ...
    private long surfaceSize = IntSize.Companion.m7288getZeroYbymL2g();
    ...
    public final long m233getSurfaceSizeYbymL2g() {
        return this.surfaceSize;
    }

    /* renamed from: setSurfaceSize-ozmzZPI  reason: not valid java name */
    public final void m234setSurfaceSizeozmzZPI(long j) {
        this.surfaceSize = j;
    }
    ...
    public void onSurfaceTextureAvailable(SurfaceTexture surfaceTexture, int i, int i2) {
        if (!IntSize.m7281equalsimpl0(this.surfaceSize, IntSize.Companion.m7288getZeroYbymL2g())) {
            i = IntSize.m7283getWidthimpl(this.surfaceSize);
            i2 = IntSize.m7282getHeightimpl(this.surfaceSize);
