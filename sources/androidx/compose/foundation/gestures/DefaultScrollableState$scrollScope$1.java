...
public final class DefaultScrollableState$scrollScope$1 implements ScrollScope {
    ...
    public float scrollBy(float f) {
        ...
        float floatValue = this.this$0.getOnDelta().invoke(Float.valueOf(f)).floatValue();
        boolean z = true;
        this.this$0.isLastScrollForwardState.setValue(Boolean.valueOf(floatValue > 0.0f));
        MutableState access$isLastScrollBackwardState$p = this.this$0.isLastScrollBackwardState;
        if (floatValue >= 0.0f) {
            z = false;
        }
        access$isLastScrollBackwardState$p.setValue(Boolean.valueOf(z));
        return floatValue;
    }
}
