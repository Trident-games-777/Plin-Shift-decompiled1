...
final class TargetApproachAnimation implements ApproachAnimation<Float, AnimationVector1D> {
    ...
    public TargetApproachAnimation(AnimationSpec<Float> animationSpec2) {
    ...
    public Object approachAnimation(ScrollScope scrollScope, float f, float f2, Function1<? super Float, Unit> function1, Continuation<? super AnimationResult<Float, AnimationVector1D>> continuation) {
        Object access$animateWithTarget = SnapFlingBehaviorKt.animateWithTarget(scrollScope, Math.abs(f) * Math.signum(f2), f, AnimationStateKt.AnimationState$default(0.0f, f2, 0, 0, false, 28, (Object) null), this.animationSpec, function1, continuation);
