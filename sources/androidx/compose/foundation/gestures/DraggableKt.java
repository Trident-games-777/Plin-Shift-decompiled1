...
public final class DraggableKt {
    ...
    public static final Function3<CoroutineScope, Offset, Continuation<? super Unit>, Object> NoOpOnDragStarted = new DraggableKt$NoOpOnDragStarted$1((Continuation<? super DraggableKt$NoOpOnDragStarted$1>) null);
    /* access modifiers changed from: private */
    public static final Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> NoOpOnDragStopped = new DraggableKt$NoOpOnDragStopped$1((Continuation<? super DraggableKt$NoOpOnDragStopped$1>) null);
    ...
    public static /* synthetic */ Modifier draggable$default(Modifier modifier, DraggableState draggableState, Orientation orientation, boolean z, MutableInteractionSource mutableInteractionSource, boolean z2, Function3 function3, Function3 function32, boolean z3, int i, Object obj) {
        Function3<CoroutineScope, Float, Continuation<? super Unit>, Object> function33;
        int i2 = i;
        if ((i2 & 4) != 0) {
            z = true;
        }
        ...
        Function3<CoroutineScope, Offset, Continuation<? super Unit>, Object> function34 = (i2 & 32) != 0 ? NoOpOnDragStarted : function3;
        if ((i2 & 64) != 0) {
            function33 = NoOpOnDragStopped;
        } else {
            function33 = function32;
        }
        return draggable(modifier, draggableState, orientation, z4, mutableInteractionSource2, z5, function34, function33, (i2 & 128) != 0 ? false : z3);
    }
    ...
    public static final float m483toFloat3MmeM6k(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Offset.m3988getYimpl(j) : Offset.m3987getXimpl(j);
    }

    /* access modifiers changed from: private */
    /* renamed from: toFloat-sF-c-tU  reason: not valid java name */
    public static final float m484toFloatsFctU(long j, Orientation orientation) {
        return orientation == Orientation.Vertical ? Velocity.m7351getYimpl(j) : Velocity.m7350getXimpl(j);
    }

    /* access modifiers changed from: private */
    /* renamed from: toValidVelocity-TH1AsA0  reason: not valid java name */
    public static final long m485toValidVelocityTH1AsA0(long j) {
        float f = 0.0f;
        float r0 = Float.isNaN(Velocity.m7350getXimpl(j)) ? 0.0f : Velocity.m7350getXimpl(j);
        if (!Float.isNaN(Velocity.m7351getYimpl(j))) {
            f = Velocity.m7351getYimpl(j);
        }
        return VelocityKt.Velocity(r0, f);
    }
}
