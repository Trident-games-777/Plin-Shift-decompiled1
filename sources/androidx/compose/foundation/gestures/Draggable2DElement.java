...
public final class Draggable2DElement extends ModifierNodeElement<Draggable2DNode> {
    ...
    public static final Function1<PointerInputChange, Boolean> CanDrag = Draggable2DElement$Companion$CanDrag$1.INSTANCE;
    ...
    public Draggable2DNode create() {
        return new Draggable2DNode(this.state, CanDrag, this.enabled, this.interactionSource, this.startDragImmediately, this.reverseDirection, (Function3) null, this.onDragStarted, (Function3) null, this.onDragStopped, 320, (DefaultConstructorMarker) null);
    }

    public void update(Draggable2DNode draggable2DNode) {
        Draggable2DNode.update$default(draggable2DNode, this.state, CanDrag, this.enabled, this.interactionSource, this.startDragImmediately, this.reverseDirection, (Function3) null, (Function3) null, this.onDragStarted, this.onDragStopped, 192, (Object) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.state, (Object) draggable2DElement.state) && this.enabled == draggable2DElement.enabled && Intrinsics.areEqual((Object) this.interactionSource, (Object) draggable2DElement.interactionSource) && this.startDragImmediately == draggable2DElement.startDragImmediately && this.onDragStarted == draggable2DElement.onDragStarted && this.onDragStopped == draggable2DElement.onDragStopped && this.reverseDirection == draggable2DElement.reverseDirection;
    }
