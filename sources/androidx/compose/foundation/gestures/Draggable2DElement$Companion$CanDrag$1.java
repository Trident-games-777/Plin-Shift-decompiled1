...
final class Draggable2DElement$Companion$CanDrag$1 extends Lambda implements Function1<PointerInputChange, Boolean> {
    public static final Draggable2DElement$Companion$CanDrag$1 INSTANCE = new Draggable2DElement$Companion$CanDrag$1();

    Draggable2DElement$Companion$CanDrag$1() {
        super(1);
    }
