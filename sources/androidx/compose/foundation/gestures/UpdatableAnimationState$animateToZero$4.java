...
final class UpdatableAnimationState$animateToZero$4 extends Lambda implements Function1<Long, Unit> {
    ...
    public final void invoke(long j) {
        ...
        float value = ((AnimationVector1D) this.this$0.vectorizedSpec.getValueFromNanos(j3, animationVector, UpdatableAnimationState.Companion.getZeroVector(), this.this$0.lastVelocity)).getValue();
        UpdatableAnimationState updatableAnimationState = this.this$0;
        updatableAnimationState.lastVelocity = (AnimationVector1D) updatableAnimationState.vectorizedSpec.getVelocityFromNanos(j3, animationVector, UpdatableAnimationState.Companion.getZeroVector(), this.this$0.lastVelocity);
        this.this$0.lastFrameTime = j;
