...
public final class Draggable2DCompatElement extends ModifierNodeElement<Draggable2DNode> {
    ...
    public static final Function1<PointerInputChange, Boolean> CanDrag = Draggable2DCompatElement$Companion$CanDrag$1.INSTANCE;
    ...
    public Draggable2DNode create() {
        return new Draggable2DNode(this.state, CanDrag, this.enabled, this.interactionSource, this.startDragImmediately, this.reverseDirection, this.onDragStarted, (Function1) null, this.onDragStopped, (Function1) null, 640, (DefaultConstructorMarker) null);
    }

    public void update(Draggable2DNode draggable2DNode) {
        Draggable2DNode.update$default(draggable2DNode, this.state, CanDrag, this.enabled, this.interactionSource, this.startDragImmediately, this.reverseDirection, this.onDragStarted, this.onDragStopped, (Function1) null, (Function1) null, ViewUtils.EDGE_TO_EDGE_FLAGS, (Object) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.state, (Object) draggable2DCompatElement.state) && this.enabled == draggable2DCompatElement.enabled && Intrinsics.areEqual((Object) this.interactionSource, (Object) draggable2DCompatElement.interactionSource) && this.startDragImmediately == draggable2DCompatElement.startDragImmediately && this.onDragStarted == draggable2DCompatElement.onDragStarted && this.onDragStopped == draggable2DCompatElement.onDragStopped && this.reverseDirection == draggable2DCompatElement.reverseDirection;
    }
