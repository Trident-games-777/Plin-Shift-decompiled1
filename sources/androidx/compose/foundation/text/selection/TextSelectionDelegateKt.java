...
public final class TextSelectionDelegateKt {
    public static final long getSelectionHandleCoordinates(TextLayoutResult textLayoutResult, int i, boolean z, boolean z2) {
        ...
        return OffsetKt.Offset(RangesKt.coerceIn(getHorizontalPosition(textLayoutResult, i, z, z2), 0.0f, (float) IntSize.m7283getWidthimpl(textLayoutResult.m6537getSizeYbymL2g())), RangesKt.coerceIn(textLayoutResult.getLineBottom(lineForOffset), 0.0f, (float) IntSize.m7282getHeightimpl(textLayoutResult.m6537getSizeYbymL2g())));
    }
