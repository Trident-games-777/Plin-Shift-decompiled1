...
public abstract class BaseTextPreparedSelection<T extends BaseTextPreparedSelection<T>> {
    ...
    public final long m1554getOriginalSelectiond9O1mEE() {
    ...
    public final long m1555getSelectiond9O1mEE() {
        return this.selection;
    }

    /* renamed from: setSelection-5zc-tL8  reason: not valid java name */
    public final void m1556setSelection5zctL8(long j) {
        this.selection = j;
    }
    ...
    public final int getPrecedingCharacterIndex() {
        return StringHelpers_androidKt.findPrecedingBreak(this.annotatedString.getText(), TextRange.m6559getEndimpl(this.selection));
    }

    public final int getNextCharacterIndex() {
        return StringHelpers_androidKt.findFollowingBreak(this.annotatedString.getText(), TextRange.m6559getEndimpl(this.selection));
    }
    ...
    private final int getNextWordOffsetForLayout(TextLayoutResult textLayoutResult, int i) {
        while (i < this.originalText.length()) {
            long r0 = textLayoutResult.m6538getWordBoundaryjx7JFs(charOffset(i));
            if (TextRange.m6559getEndimpl(r0) > i) {
                return this.offsetMapping.transformedToOriginal(TextRange.m6559getEndimpl(r0));
            }
            i++;
        }
    ...
    private final int getPrevWordOffset(TextLayoutResult textLayoutResult, int i) {
        while (i > 0) {
            ...
            if (TextRange.m6564getStartimpl(r0) < i) {
                return this.offsetMapping.transformedToOriginal(TextRange.m6564getStartimpl(r0));
            }
            i--;
        }
        return 0;
    ...
    private final int jumpByLinesOffset(TextLayoutResult textLayoutResult, int i) {
        ...
        return this.offsetMapping.transformedToOriginal(textLayoutResult.m6536getOffsetForPositionk4lQ0M(OffsetKt.Offset(number.floatValue(), lineBottom)));
    }

    private final int transformedEndOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m6559getEndimpl(this.selection));
    }

    private final int transformedMinOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m6562getMinimpl(this.selection));
    }

    private final int transformedMaxOffset() {
        return this.offsetMapping.originalToTransformed(TextRange.m6561getMaximpl(this.selection));
    }
    ...
    public final T moveCursorPrevByParagraph() {
        ...
        if (getText$foundation_release().length() > 0) {
            BaseTextPreparedSelection baseTextPreparedSelection = this;
            int findParagraphStart = StringHelpersKt.findParagraphStart(getText$foundation_release(), TextRange.m6562getMinimpl(this.selection));
    ...
    public final T moveCursorNextByParagraph() {
        ...
        if (getText$foundation_release().length() > 0) {
            BaseTextPreparedSelection baseTextPreparedSelection = this;
            int findParagraphEnd = StringHelpersKt.findParagraphEnd(getText$foundation_release(), TextRange.m6561getMaximpl(this.selection));
            if (findParagraphEnd == TextRange.m6561getMaximpl(this.selection) && findParagraphEnd != getText$foundation_release().length()) {
    ...
    public final T selectMovement() {
        if (getText$foundation_release().length() > 0) {
            BaseTextPreparedSelection baseTextPreparedSelection = this;
            this.selection = TextRangeKt.TextRange(TextRange.m6564getStartimpl(this.originalSelection), TextRange.m6559getEndimpl(this.selection));
        }
        Intrinsics.checkNotNull(this, "null cannot be cast to non-null type T of androidx.compose.foundation.text.selection.BaseTextPreparedSelection");
        BaseTextPreparedSelection baseTextPreparedSelection2 = this;
        return this;
