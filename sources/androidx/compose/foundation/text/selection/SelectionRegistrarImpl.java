...
public final class SelectionRegistrarImpl implements SelectionRegistrar {
    ...
    private SelectionRegistrarImpl(long j) {
        ...
        this.subselections$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(LongObjectMapKt.emptyLongObjectMap(), (SnapshotMutationPolicy) null, 2, (Object) null);
    }
    ...
    public Selectable subscribe(Selectable selectable) {
        ...
        } else if (!this._selectableMap.containsKey(selectable.getSelectableId())) {
    ...
    public void m1638notifySelectionUpdateStartubNVwUQ(LayoutCoordinates layoutCoordinates, long j, SelectionAdjustment selectionAdjustment, boolean z) {
        ...
        if (function4 != null) {
            function4.invoke(Boolean.valueOf(z), layoutCoordinates, Offset.m3976boximpl(j), selectionAdjustment);
        }
    }
    ...
    public boolean m1637notifySelectionUpdatenjBpvok(LayoutCoordinates layoutCoordinates, long j, long j2, boolean z, SelectionAdjustment selectionAdjustment, boolean z2) {
        long j3 = j;
        ...
        return function6.invoke(Boolean.valueOf(z2), layoutCoordinates2, Offset.m3976boximpl(j3), Offset.m3976boximpl(j2), Boolean.valueOf(z), selectionAdjustment).booleanValue();
    }
