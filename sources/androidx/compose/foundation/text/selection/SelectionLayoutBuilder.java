...
public final class SelectionLayoutBuilder {
    ...
    public final long m1585getCurrentPositionF1C5BW0() {
        return this.currentPosition;
    }

    /* renamed from: getPreviousHandlePosition-F1C5BW0  reason: not valid java name */
    public final long m1586getPreviousHandlePositionF1C5BW0() {
    ...
    public final SelectionLayout build() {
        ...
        if (size == 0) {
            ...
            LongIntMap longIntMap = this.selectableIdToInfoListIndex;
            List<SelectableInfo> list = this.infoList;
            int i2 = this.startSlot;
            int i3 = i2 == -1 ? i : i2;
            int i4 = this.endSlot;
            return new MultiSelectionLayout(longIntMap, list, i3, i4 == -1 ? i : i4, this.isStartHandle, this.previousSelection);
        } else {
