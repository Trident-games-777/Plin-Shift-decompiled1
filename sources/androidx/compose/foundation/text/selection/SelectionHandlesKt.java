...
public final class SelectionHandlesKt {
    ...
    public static final long m1584getAdjustedCoordinatesk4lQ0M(long j) {
        return OffsetKt.Offset(Offset.m3987getXimpl(j), Offset.m3988getYimpl(j) - 1.0f);
    }
    ...
    static {
        float f = (float) 25;
        HandleWidth = Dp.m7111constructorimpl(f);
