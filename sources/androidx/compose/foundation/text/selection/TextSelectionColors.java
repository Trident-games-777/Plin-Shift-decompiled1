...
public final class TextSelectionColors {
    ...
    public final long m1673getHandleColor0d7_KjU() {
        return this.handleColor;
    }

    /* renamed from: getBackgroundColor-0d7_KjU  reason: not valid java name */
    public final long m1672getBackgroundColor0d7_KjU() {
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m4240equalsimpl0(this.handleColor, textSelectionColors.handleColor) && Color.m4240equalsimpl0(this.backgroundColor, textSelectionColors.backgroundColor);
    }

    public int hashCode() {
        return (Color.m4246hashCodeimpl(this.handleColor) * 31) + Color.m4246hashCodeimpl(this.backgroundColor);
    }

    public String toString() {
        return "SelectionColors(selectionHandleColor=" + Color.m4247toStringimpl(this.handleColor) + ", selectionBackgroundColor=" + Color.m4247toStringimpl(this.backgroundColor) + ')';
    }
}
