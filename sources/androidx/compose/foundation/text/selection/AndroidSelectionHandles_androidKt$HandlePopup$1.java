...
final class AndroidSelectionHandles_androidKt$HandlePopup$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    AndroidSelectionHandles_androidKt$HandlePopup$1(OffsetProvider offsetProvider, Alignment alignment, Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
