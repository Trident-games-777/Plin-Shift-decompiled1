...
public final class TextFieldPreparedSelection extends BaseTextPreparedSelection<TextFieldPreparedSelection> {
    ...
    public TextFieldPreparedSelection(androidx.compose.ui.text.input.TextFieldValue r9, androidx.compose.ui.text.input.OffsetMapping r10, androidx.compose.foundation.text.TextLayoutResultProxy r11, androidx.compose.foundation.text.selection.TextPreparedSelectionState r12) {
        /*
            ...
            long r2 = r9.m6823getSelectiond9O1mEE()
    ...
    public final TextFieldValue getValue() {
        return TextFieldValue.m6818copy3r_uNRQ$default(this.currentValue, getAnnotatedString(), m1555getSelectiond9O1mEE(), (TextRange) null, 4, (Object) null);
    }
    ...
    public final List<EditCommand> deleteIfSelectedOr(Function1<? super TextFieldPreparedSelection, ? extends EditCommand> function1) {
        if (TextRange.m6558getCollapsedimpl(m1555getSelectiond9O1mEE())) {
        ...
        return CollectionsKt.listOf(new CommitTextCommand("", 0), new SetSelectionCommand(TextRange.m6562getMinimpl(m1555getSelectiond9O1mEE()), TextRange.m6562getMinimpl(m1555getSelectiond9O1mEE())));
    }
    ...
    private final int jumpByPagesOffset(androidx.compose.foundation.text.TextLayoutResultProxy r6, int r7) {
        ...
        L_0x001b:
            ...
            long r3 = r1.m6823getSelectiond9O1mEE()
            int r1 = androidx.compose.ui.text.TextRange.m6559getEndimpl(r3)
            ...
            float r1 = r0.getLeft()
            float r0 = r0.getTop()
            long r2 = r2.m4020getSizeNHjbRc()
            float r2 = androidx.compose.ui.geometry.Size.m4053getHeightimpl(r2)
            float r7 = (float) r7
            float r2 = r2 * r7
            float r0 = r0 + r2
            ...
            int r6 = r6.m6536getOffsetForPositionk4lQ0M(r0)
