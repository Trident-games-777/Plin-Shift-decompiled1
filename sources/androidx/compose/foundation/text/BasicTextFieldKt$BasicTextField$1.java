...
final class BasicTextFieldKt$BasicTextField$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        BasicTextFieldKt.BasicTextField(textFieldState2, this.$modifier, this.$enabled, this.$readOnly, this.$inputTransformation, this.$textStyle, this.$keyboardOptions, this.$onKeyboardAction, this.$lineLimits, (Function2<? super Density, ? super Function0<TextLayoutResult>, Unit>) this.$onTextLayout, this.$interactionSource, this.$cursorBrush, this.$outputTransformation, this.$decorator, this.$scrollState, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), RecomposeScopeImplKt.updateChangedFlags(this.$$changed1), this.$$default);
    }
}
