...
final class HorizontalScrollLayoutModifier$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope placementScope) {
        ...
        Placeable.PlacementScope.placeRelative$default(placementScope, this.$placeable, Math.round(-this.this$0.getScrollerPosition().getOffset()), 0, 0.0f, 4, (Object) null);
    }
}
