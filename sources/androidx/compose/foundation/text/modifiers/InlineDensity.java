...
public final class InlineDensity {
    ...
    public static final long Unspecified = m1508constructorimpl(Float.NaN, Float.NaN);
    private final long packedValue;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ InlineDensity m1507boximpl(long j) {
        return new InlineDensity(j);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static long m1509constructorimpl(long j) {
        return j;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1511equalsimpl(long j, Object obj) {
        return (obj instanceof InlineDensity) && j == ((InlineDensity) obj).m1517unboximpl();
    }
    ...
    public int hashCode() {
        return m1515hashCodeimpl(this.packedValue);
    }
    ...
    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1510constructorimpl(Density density) {
        return m1508constructorimpl(density.getDensity(), density.getFontScale());
    }

    public String toString() {
        return m1516toStringimpl(this.packedValue);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m1516toStringimpl(long j) {
        return "InlineDensity(density=" + m1513getDensityimpl(j) + ", fontScale=" + m1514getFontScaleimpl(j) + ')';
    }
    ...
    public static final class Companion {
        ...
        public final long m1518getUnspecifiedL26CHvs() {
            return InlineDensity.Unspecified;
        }
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static long m1508constructorimpl(float f, float f2) {
        long floatToRawIntBits = (long) Float.floatToRawIntBits(f);
        return m1509constructorimpl((((long) Float.floatToRawIntBits(f2)) & 4294967295L) | (floatToRawIntBits << 32));
    }

    /* renamed from: getDensity-impl  reason: not valid java name */
    public static final float m1513getDensityimpl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getFontScale-impl  reason: not valid java name */
    public static final float m1514getFontScaleimpl(long j) {
