...
public final class MinLinesConstrainer {
    ...
    public final long m1522coerceMinLinesOh53vG4$foundation_release(long j, int i) {
        int i2;
        int i3 = i;
        float f = this.oneLineHeightCache;
        float f2 = this.lineHeightCache;
        if (Float.isNaN(f) || Float.isNaN(f2)) {
            f = ParagraphKt.m6447ParagraphUdtVg6A$default(MinLinesConstrainerKt.EmptyTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, (Object) null), this.density, this.fontFamilyResolver, (List) null, (List) null, 1, false, 96, (Object) null).getHeight();
            f2 = ParagraphKt.m6447ParagraphUdtVg6A$default(MinLinesConstrainerKt.TwoLineTextReplacement, this.resolvedStyle, ConstraintsKt.Constraints$default(0, 0, 0, 0, 15, (Object) null), this.density, this.fontFamilyResolver, (List) null, (List) null, 2, false, 96, (Object) null).getHeight() - f;
            this.oneLineHeightCache = f;
            this.lineHeightCache = f2;
        }
        if (i3 != 1) {
            i2 = RangesKt.coerceAtMost(RangesKt.coerceAtLeast(Math.round(f + (f2 * ((float) (i3 - 1)))), 0), Constraints.m7051getMaxHeightimpl(j));
        } else {
            i2 = Constraints.m7053getMinHeightimpl(j);
        }
        return ConstraintsKt.Constraints(Constraints.m7054getMinWidthimpl(j), Constraints.m7052getMaxWidthimpl(j), i2, Constraints.m7051getMaxHeightimpl(j));
    }
}
