...
public final class KeyEventHelpers_androidKt {
    ...
    public static final boolean m1189cancelsTextSelectionZmokQxo(KeyEvent keyEvent) {
        return keyEvent.getKeyCode() == 4 && KeyEventType.m5423equalsimpl0(KeyEvent_androidKt.m5431getTypeZmokQxo(keyEvent), KeyEventType.Companion.m5428getKeyUpCS__XNY());
    }
}
