...
public final class StylusHandwritingKt {
    private static final float HandwritingBoundsHorizontalOffset = Dp.m7111constructorimpl((float) 10);
    private static final float HandwritingBoundsVerticalOffset = Dp.m7111constructorimpl((float) 40);

    public static final Modifier stylusHandwriting(Modifier modifier, boolean z, Function0<Boolean> function0) {
        return (!z || !StylusHandwriting_androidKt.isStylusHandwritingSupported()) ? modifier : PaddingKt.m776paddingVpY3zN4(modifier.then(new StylusHandwritingElementWithNegativePadding(function0)), HandwritingBoundsHorizontalOffset, HandwritingBoundsVerticalOffset);
    }
