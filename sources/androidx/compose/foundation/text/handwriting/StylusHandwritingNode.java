...
public class StylusHandwritingNode extends DelegatingNode implements PointerInputModifierNode, FocusEventModifierNode {
    ...
    private final SuspendingPointerInputModifierNode suspendingPointerInputModifierNode = ((SuspendingPointerInputModifierNode) delegate(SuspendingPointerInputFilterKt.SuspendingPointerInputModifierNode(new StylusHandwritingNode$suspendingPointerInputModifierNode$1(this, (Continuation<? super StylusHandwritingNode$suspendingPointerInputModifierNode$1>) null))));
    ...
    public void m1301onPointerEventH0pRuoY(PointerEvent pointerEvent, PointerEventPass pointerEventPass, long j) {
        this.suspendingPointerInputModifierNode.m6200onPointerEventH0pRuoY(pointerEvent, pointerEventPass, j);
    }
