...
public final class TextDelegateKt {
    ...
    public static /* synthetic */ TextDelegate m1255updateTextDelegaterm0N8CA$default(TextDelegate textDelegate, AnnotatedString annotatedString, TextStyle textStyle, Density density, FontFamily.Resolver resolver, boolean z, int i, int i2, int i3, List list, int i4, Object obj) {
        if ((i4 & 32) != 0) {
            z = true;
        }
        if ((i4 & 64) != 0) {
        ...
        return m1254updateTextDelegaterm0N8CA(textDelegate, annotatedString, textStyle, density, resolver, z, i, i2, i3, list);
    }

    /* renamed from: updateTextDelegate-rm0N8CA  reason: not valid java name */
    public static final TextDelegate m1254updateTextDelegaterm0N8CA(TextDelegate textDelegate, AnnotatedString annotatedString, TextStyle textStyle, Density density, FontFamily.Resolver resolver, boolean z, int i, int i2, int i3, List<AnnotatedString.Range<Placeholder>> list) {
        ...
        if (!Intrinsics.areEqual((Object) textDelegate.getText(), (Object) annotatedString) || !Intrinsics.areEqual((Object) textDelegate.getStyle(), (Object) textStyle)) {
            ...
            if (textDelegate.getSoftWrap() == z2) {
                i4 = i;
                if (TextOverflow.m7030equalsimpl0(textDelegate.m1252getOverflowgIe3tQ8(), i4)) {
                    i6 = i2;
                    if (textDelegate.getMaxLines() == i6) {
                        i5 = i3;
                        if (textDelegate.getMinLines() != i5 || !Intrinsics.areEqual((Object) textDelegate.getDensity(), (Object) density)) {
                            resolver2 = resolver;
                            list2 = list;
                            return new TextDelegate(annotatedString, textStyle, i6, i5, z2, i4, density, resolver2, list2, (DefaultConstructorMarker) null);
                        }
                        list2 = list;
                        if (Intrinsics.areEqual((Object) textDelegate.getPlaceholders(), (Object) list2)) {
                            resolver2 = resolver;
