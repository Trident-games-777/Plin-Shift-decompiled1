...
public final class TextFieldKeyInput {
    ...
    public /* synthetic */ TextFieldKeyInput(LegacyTextFieldState legacyTextFieldState, TextFieldSelectionManager textFieldSelectionManager, TextFieldValue textFieldValue, boolean z, boolean z2, TextPreparedSelectionState textPreparedSelectionState, OffsetMapping offsetMapping2, UndoManager undoManager2, DeadKeyCombiner deadKeyCombiner, KeyMapping keyMapping2, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(legacyTextFieldState, textFieldSelectionManager, textFieldValue, z, z2, textPreparedSelectionState, offsetMapping2, undoManager2, deadKeyCombiner, keyMapping2, function1, i);
    }
    ...
    private final CommitTextCommand m1272typedCommandZmokQxo(KeyEvent keyEvent) {
        Integer r3;
        if (!TextFieldKeyInput_androidKt.m1277isTypedEventZmokQxo(keyEvent) || (r3 = this.keyCombiner.m1186consumeZmokQxo(keyEvent)) == null) {
            return null;
        }
    ...
    public final boolean m1273processZmokQxo(KeyEvent keyEvent) {
        KeyCommand r5;
        CommitTextCommand r0 = m1272typedCommandZmokQxo(keyEvent);
        if (r0 != null) {
            if (!this.editable) {
                return false;
            }
            ...
            return true;
        } else if (!KeyEventType.m5423equalsimpl0(KeyEvent_androidKt.m5431getTypeZmokQxo(keyEvent), KeyEventType.Companion.m5427getKeyDownCS__XNY()) || (r5 = this.keyMapping.m1190mapZmokQxo(keyEvent)) == null || (r5.getEditsText() && !this.editable)) {
            return false;
        } else {
    ...
    private final void commandExecutionContext(Function1<? super TextFieldPreparedSelection, Unit> function1) {
        ...
        if (!TextRange.m6557equalsimpl0(textFieldPreparedSelection.m1555getSelectiond9O1mEE(), this.value.m6823getSelectiond9O1mEE()) || !Intrinsics.areEqual((Object) textFieldPreparedSelection.getAnnotatedString(), (Object) this.value.getAnnotatedString())) {
