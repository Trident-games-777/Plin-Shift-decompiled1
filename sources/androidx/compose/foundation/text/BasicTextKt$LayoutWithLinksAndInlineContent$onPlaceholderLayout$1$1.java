...
final class BasicTextKt$LayoutWithLinksAndInlineContent$onPlaceholderLayout$1$1 extends Lambda implements Function1<List<? extends Rect>, Unit> {
    final /* synthetic */ MutableState<List<Rect>> $measuredPlaceholderPositions;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BasicTextKt$LayoutWithLinksAndInlineContent$onPlaceholderLayout$1$1(MutableState<List<Rect>> mutableState) {
        super(1);
