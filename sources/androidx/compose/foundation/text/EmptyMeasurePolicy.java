...
final class EmptyMeasurePolicy implements MeasurePolicy {
    ...
    public MeasureResult m1187measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        return MeasureScope.layout$default(measureScope, Constraints.m7052getMaxWidthimpl(j), Constraints.m7051getMaxHeightimpl(j), (Map) null, placementBlock, 4, (Object) null);
    }
}
