...
public final class TextHighlightType {
    ...
    public static final int HandwritingDeletePreview = m1318constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int HandwritingSelectPreview = m1318constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TextHighlightType m1317boximpl(int i) {
        return new TextHighlightType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m1318constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m1319equalsimpl(int i, Object obj) {
        return (obj instanceof TextHighlightType) && i == ((TextHighlightType) obj).m1323unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m1325getHandwritingSelectPreviewsxJuwY() {
        ...
        public final int m1324getHandwritingDeletePreviewsxJuwY() {
