...
final class InputTransformationByValue implements InputTransformation {
    ...
    public void transformInput(TextFieldBuffer textFieldBuffer) {
        ...
        TextFieldCharSequence r7 = TextFieldBuffer.m1304toTextFieldCharSequenceudt6zUU$foundation_release$default(textFieldBuffer2, 0, (TextRange) null, 3, (Object) null);
        CharSequence invoke = this.transformation.invoke(textFieldBuffer2.getOriginalValue$foundation_release(), r7);
        if (invoke != r7) {
            if (invoke == textFieldBuffer2.getOriginalValue$foundation_release()) {
                textFieldBuffer2.revertAllChanges();
            } else {
                textFieldBuffer2.setTextIfChanged$foundation_release(invoke);
            }
        }
    }
