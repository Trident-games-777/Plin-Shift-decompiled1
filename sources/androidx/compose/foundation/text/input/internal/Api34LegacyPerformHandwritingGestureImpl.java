...
final class Api34LegacyPerformHandwritingGestureImpl {
    ...
    public final void performHandwritingGesture(LegacyTextFieldState legacyTextFieldState, TextFieldSelectionManager textFieldSelectionManager, HandwritingGesture handwritingGesture, ViewConfiguration viewConfiguration, Executor executor, IntConsumer intConsumer, Function1<? super EditCommand, Unit> function1) {
        int i;
        if (legacyTextFieldState != null) {
            i = HandwritingGestureApi34.INSTANCE.performHandwritingGesture$foundation_release(legacyTextFieldState, handwritingGesture, textFieldSelectionManager, viewConfiguration, function1);
        } else {
            i = 3;
        }
        if (intConsumer != null) {
            if (executor != null) {
                executor.execute(new Api34LegacyPerformHandwritingGestureImpl$$ExternalSyntheticLambda0(intConsumer, i));
            } else {
    ...
    public static final void performHandwritingGesture$lambda$0(IntConsumer intConsumer, int i) {
        intConsumer.accept(i);
    }
