...
final class TextFieldScrollKt$textFieldScrollable$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        boolean changed2 = composer.changed((Object) rememberScrollableState) | composer.changed((Object) this.$scrollerPosition);
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        Modifier scrollable$default = ScrollableKt.scrollable$default(Modifier.Companion, textFieldScrollKt$textFieldScrollable$2$wrappedScrollableState$1$1, this.$scrollerPosition.getOrientation(), this.$enabled && this.$scrollerPosition.getMaximum() != 0.0f, z, (FlingBehavior) null, this.$interactionSource, 16, (Object) null);
        if (ComposerKt.isTraceInProgress()) {
