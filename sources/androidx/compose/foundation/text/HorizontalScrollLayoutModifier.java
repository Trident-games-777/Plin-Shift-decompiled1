...
final class HorizontalScrollLayoutModifier implements LayoutModifier {
    ...
    public MeasureResult m1188measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        long j2;
        if (measurable.maxIntrinsicWidth(Constraints.m7051getMaxHeightimpl(j)) < Constraints.m7052getMaxWidthimpl(j)) {
            j2 = j;
        } else {
            j2 = j;
            j = Constraints.m7043copyZbe2FdA$default(j2, 0, Integer.MAX_VALUE, 0, 0, 13, (Object) null);
        }
        Placeable r12 = measurable.m5848measureBRTryo0(j);
        int min = Math.min(r12.getWidth(), Constraints.m7052getMaxWidthimpl(j2));
