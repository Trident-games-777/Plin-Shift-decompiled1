...
public final class TextDelegate {
    ...
    public final int m1252getOverflowgIe3tQ8() {
    ...
    private final MultiParagraph m1251layoutTextK40F9xA(long j, LayoutDirection layoutDirection) {
        int i;
        int i2;
        layoutIntrinsics(layoutDirection);
        int r12 = Constraints.m7054getMinWidthimpl(j);
        if ((this.softWrap || TextOverflow.m7030equalsimpl0(this.overflow, TextOverflow.Companion.m7038getEllipsisgIe3tQ8())) && Constraints.m7048getHasBoundedWidthimpl(j)) {
            i = Constraints.m7052getMaxWidthimpl(j);
        } else {
            i = Integer.MAX_VALUE;
        }
        if (this.softWrap || !TextOverflow.m7030equalsimpl0(this.overflow, TextOverflow.Companion.m7038getEllipsisgIe3tQ8())) {
            i2 = this.maxLines;
        } else {
            i2 = 1;
        }
        int i3 = i2;
        if (r12 != i) {
            i = RangesKt.coerceIn(getMaxIntrinsicWidth(), r12, i);
        }
        return new MultiParagraph(getNonNullIntrinsics(), Constraints.Companion.m7061fitPrioritizingWidthZbe2FdA(0, i, 0, Constraints.m7051getMaxHeightimpl(j)), i3, TextOverflow.m7030equalsimpl0(this.overflow, TextOverflow.Companion.m7038getEllipsisgIe3tQ8()), (DefaultConstructorMarker) null);
    }

    /* renamed from: layout-NN6Ew-U$default  reason: not valid java name */
    public static /* synthetic */ TextLayoutResult m1250layoutNN6EwU$default(TextDelegate textDelegate, long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult, int i, Object obj) {
        if ((i & 4) != 0) {
            textLayoutResult = null;
        }
        return textDelegate.m1253layoutNN6EwU(j, layoutDirection, textLayoutResult);
    }

    /* renamed from: layout-NN6Ew-U  reason: not valid java name */
    public final TextLayoutResult m1253layoutNN6EwU(long j, LayoutDirection layoutDirection, TextLayoutResult textLayoutResult) {
        if (textLayoutResult != null) {
            TextLayoutResult textLayoutResult2 = textLayoutResult;
            TextLayoutResult textLayoutResult3 = textLayoutResult2;
            if (TextLayoutHelperKt.m1286canReuse7_7YC6M(textLayoutResult2, this.text, this.style, this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, j)) {
                long j2 = j;
                return textLayoutResult3.m6535copyO0kMr_c(new TextLayoutInput(textLayoutResult3.getLayoutInput().getText(), this.style, (List) textLayoutResult3.getLayoutInput().getPlaceholders(), textLayoutResult3.getLayoutInput().getMaxLines(), textLayoutResult3.getLayoutInput().getSoftWrap(), textLayoutResult3.getLayoutInput().m6533getOverflowgIe3tQ8(), textLayoutResult3.getLayoutInput().getDensity(), textLayoutResult3.getLayoutInput().getLayoutDirection(), textLayoutResult3.getLayoutInput().getFontFamilyResolver(), j2, (DefaultConstructorMarker) null), ConstraintsKt.m7066constrain4WqzIAM(j2, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(textLayoutResult3.getMultiParagraph().getWidth()), TextDelegateKt.ceilToIntPx(textLayoutResult3.getMultiParagraph().getHeight()))));
            }
        }
        long j3 = j;
        MultiParagraph r14 = m1251layoutTextK40F9xA(j, layoutDirection);
        return new TextLayoutResult(new TextLayoutInput(this.text, this.style, (List) this.placeholders, this.maxLines, this.softWrap, this.overflow, this.density, layoutDirection, this.fontFamilyResolver, j3, (DefaultConstructorMarker) null), r14, ConstraintsKt.m7066constrain4WqzIAM(j3, IntSizeKt.IntSize(TextDelegateKt.ceilToIntPx(r14.getWidth()), TextDelegateKt.ceilToIntPx(r14.getHeight()))), (DefaultConstructorMarker) null);
    }
