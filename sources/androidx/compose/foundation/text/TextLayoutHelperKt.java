...
public final class TextLayoutHelperKt {
    ...
    public static final boolean m1286canReuse7_7YC6M(TextLayoutResult textLayoutResult, AnnotatedString annotatedString, TextStyle textStyle, List<AnnotatedString.Range<Placeholder>> list, int i, boolean z, int i2, Density density, LayoutDirection layoutDirection, FontFamily.Resolver resolver, long j) {
        TextLayoutInput layoutInput = textLayoutResult.getLayoutInput();
        if (textLayoutResult.getMultiParagraph().getIntrinsics().getHasStaleResolvedFonts() || !Intrinsics.areEqual((Object) layoutInput.getText(), (Object) annotatedString) || !layoutInput.getStyle().hasSameLayoutAffectingAttributes(textStyle) || !Intrinsics.areEqual((Object) layoutInput.getPlaceholders(), (Object) list) || layoutInput.getMaxLines() != i || layoutInput.getSoftWrap() != z || !TextOverflow.m7030equalsimpl0(layoutInput.m6533getOverflowgIe3tQ8(), i2) || !Intrinsics.areEqual((Object) layoutInput.getDensity(), (Object) density) || layoutInput.getLayoutDirection() != layoutDirection || !Intrinsics.areEqual((Object) layoutInput.getFontFamilyResolver(), (Object) resolver) || Constraints.m7054getMinWidthimpl(j) != Constraints.m7054getMinWidthimpl(layoutInput.m6532getConstraintsmsEJaDk())) {
            return false;
        }
        if (!z && !TextOverflow.m7030equalsimpl0(i2, TextOverflow.Companion.m7038getEllipsisgIe3tQ8())) {
            return true;
        }
        if (Constraints.m7052getMaxWidthimpl(j) == Constraints.m7052getMaxWidthimpl(layoutInput.m6532getConstraintsmsEJaDk()) && Constraints.m7051getMaxHeightimpl(j) == Constraints.m7051getMaxHeightimpl(layoutInput.m6532getConstraintsmsEJaDk())) {
            return true;
        }
        return false;
    }
