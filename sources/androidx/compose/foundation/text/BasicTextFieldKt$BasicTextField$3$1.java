...
final class BasicTextFieldKt$BasicTextField$3$1 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
    ...
    BasicTextFieldKt$BasicTextField$3$1(TextFieldSelectionState textFieldSelectionState) {
        super(1);
        this.$textFieldSelectionState = textFieldSelectionState;
    }

    public final DisposableEffectResult invoke(DisposableEffectScope disposableEffectScope) {
        return new BasicTextFieldKt$BasicTextField$3$1$invoke$$inlined$onDispose$1(this.$textFieldSelectionState);
    }
}
