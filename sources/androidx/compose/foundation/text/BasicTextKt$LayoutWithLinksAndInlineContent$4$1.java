...
final class BasicTextKt$LayoutWithLinksAndInlineContent$4$1 extends Lambda implements Function0<Boolean> {
    final /* synthetic */ TextLinkScope $textScope;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    BasicTextKt$LayoutWithLinksAndInlineContent$4$1(TextLinkScope textLinkScope) {
        super(0);
