...
final class ClickableKt$clickable$2 extends Lambda implements Function3<Modifier, Composer, Integer, Modifier> {
    ...
    public final Modifier invoke(Modifier modifier, Composer composer, int i) {
        ...
        Modifier r8 = ClickableKt.m278clickableO2vRcR0(Modifier.Companion, mutableInteractionSource, indication, this.$enabled, this.$onClickLabel, this.$role, this.$onClick);
        if (ComposerKt.isTraceInProgress()) {
