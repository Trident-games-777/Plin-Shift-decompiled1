...
final class PaddingValuesInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        return density.m7086roundToPx0680j_4(this.paddingValues.m790calculateLeftPaddingu2uoSUM(layoutDirection));
    }

    public int getTop(Density density) {
        return density.m7086roundToPx0680j_4(this.paddingValues.m792calculateTopPaddingD9Ej5fM());
    }

    public int getRight(Density density, LayoutDirection layoutDirection) {
        return density.m7086roundToPx0680j_4(this.paddingValues.m791calculateRightPaddingu2uoSUM(layoutDirection));
    }

    public int getBottom(Density density) {
        return density.m7086roundToPx0680j_4(this.paddingValues.m789calculateBottomPaddingD9Ej5fM());
    }

    public String toString() {
        LayoutDirection layoutDirection = LayoutDirection.Ltr;
        return "PaddingValues(" + Dp.m7122toStringimpl(this.paddingValues.m790calculateLeftPaddingu2uoSUM(layoutDirection)) + ", " + Dp.m7122toStringimpl(this.paddingValues.m792calculateTopPaddingD9Ej5fM()) + ", " + Dp.m7122toStringimpl(this.paddingValues.m791calculateRightPaddingu2uoSUM(layoutDirection)) + ", " + Dp.m7122toStringimpl(this.paddingValues.m789calculateBottomPaddingD9Ej5fM()) + ')';
    }
