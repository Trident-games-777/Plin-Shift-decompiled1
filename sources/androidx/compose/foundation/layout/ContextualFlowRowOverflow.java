...
public final class ContextualFlowRowOverflow extends FlowLayoutOverflow {
    ...
    public static final ContextualFlowRowOverflow Clip = new ContextualFlowRowOverflow(FlowLayoutOverflow.OverflowType.Clip, 0, 0, (Function1) null, (Function1) null, 30, (DefaultConstructorMarker) null);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final ContextualFlowRowOverflow Visible = new ContextualFlowRowOverflow(FlowLayoutOverflow.OverflowType.Visible, 0, 0, (Function1) null, (Function1) null, 30, (DefaultConstructorMarker) null);
    ...
    /* synthetic */ ContextualFlowRowOverflow(androidx.compose.foundation.layout.FlowLayoutOverflow.OverflowType r2, int r3, int r4, kotlin.jvm.functions.Function1 r5, kotlin.jvm.functions.Function1 r6, int r7, kotlin.jvm.internal.DefaultConstructorMarker r8) {
        /*
            r1 = this;
            r8 = r7 & 2
            r0 = 0
        ...
        L_0x0018:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: androidx.compose.foundation.layout.ContextualFlowRowOverflow.<init>(androidx.compose.foundation.layout.FlowLayoutOverflow$OverflowType, int, int, kotlin.jvm.functions.Function1, kotlin.jvm.functions.Function1, int, kotlin.jvm.internal.DefaultConstructorMarker):void");
    }
    ...
    public static final class Companion {
        ...
        public final ContextualFlowRowOverflow expandIndicator(Function3<? super ContextualFlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function3) {
            return new ContextualFlowRowOverflow(FlowLayoutOverflow.OverflowType.ExpandIndicator, 0, 0, new ContextualFlowRowOverflow$Companion$expandIndicator$seeMoreGetter$1(function3), (Function1) null, 22, (DefaultConstructorMarker) null);
        }

        /* renamed from: expandOrCollapseIndicator--jt2gSs  reason: not valid java name */
        public final ContextualFlowRowOverflow m680expandOrCollapseIndicatorjt2gSs(Function3<? super ContextualFlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function3, Function3<? super ContextualFlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function32, int i, float f, Composer composer, int i2, int i3) {
            float f2;
            Composer composer2 = composer;
            int i4 = i2;
            ComposerKt.sourceInformationMarkerStart(composer2, 1435293820, "C(expandOrCollapseIndicator)P(1!1,3,2:c#ui.unit.Dp)*458@20145L7,461@20241L1109:FlowLayoutOverflow.kt#2w3rfo");
            boolean z = true;
            int i5 = (i3 & 4) != 0 ? 1 : i;
            if ((i3 & 8) != 0) {
            ...
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1435293820, i4, -1, "androidx.compose.foundation.layout.ContextualFlowRowOverflow.Companion.expandOrCollapseIndicator (FlowLayoutOverflow.kt:457)");
            }
            ComposerKt.sourceInformationMarkerStart(composer2, 2023513938, "CC:CompositionLocal.kt#9igjgp");
            Object consume = composer2.consume(CompositionLocalsKt.getLocalDensity());
            ComposerKt.sourceInformationMarkerEnd(composer2);
            int r8 = ((Density) consume).m7086roundToPx0680j_4(f2);
            ComposerKt.sourceInformationMarkerStart(composer2, 172958269, "CC(remember):FlowLayoutOverflow.kt#9igjgp");
            ...
            if (z2 || rememberedValue == Composer.Companion.getEmpty()) {
                ContextualFlowRowOverflow contextualFlowRowOverflow = new ContextualFlowRowOverflow(FlowLayoutOverflow.OverflowType.ExpandOrCollapseIndicator, i5, r8, new ContextualFlowRowOverflow$Companion$expandOrCollapseIndicator$1$seeMoreGetter$1(function3), new ContextualFlowRowOverflow$Companion$expandOrCollapseIndicator$1$collapseGetter$1(function32), (DefaultConstructorMarker) null);
