...
public final class Arrangement {
    ...
    public interface Horizontal {
        ...
        public static final class DefaultImpls {
            ...
            public static float m632getSpacingD9Ej5fM(Horizontal horizontal) {
                return Horizontal.super.m631getSpacingD9Ej5fM();
            }
        }

        /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
        float m631getSpacingD9Ej5fM() {
            return Dp.m7111constructorimpl((float) 0);
        }
    }
    ...
    public interface Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m646getSpacingD9Ej5fM(Vertical vertical) {
                return Vertical.super.m645getSpacingD9Ej5fM();
            }
        }

        /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
        float m645getSpacingD9Ej5fM() {
            return Dp.m7111constructorimpl((float) 0);
        }
    }
    ...
    public interface HorizontalOrVertical extends Horizontal, Vertical {
        ...
        public static final class DefaultImpls {
            @Deprecated
            /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
            public static float m635getSpacingD9Ej5fM(HorizontalOrVertical horizontalOrVertical) {
                return HorizontalOrVertical.super.m634getSpacingD9Ej5fM();
            }
        }

        /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
        float m634getSpacingD9Ej5fM() {
            return Dp.m7111constructorimpl((float) 0);
        }
    }
    ...
    public final HorizontalOrVertical m623spacedBy0680j_4(float f) {
    ...
    public final Horizontal m624spacedByD5KLDUw(float f, Alignment.Horizontal horizontal) {
        return new SpacedAligned(f, true, new Arrangement$spacedBy$2(horizontal), (DefaultConstructorMarker) null);
    }

    /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
    public final Vertical m625spacedByD5KLDUw(float f, Alignment.Vertical vertical) {
    ...
    public final Horizontal aligned(Alignment.Horizontal horizontal) {
        return new SpacedAligned(Dp.m7111constructorimpl((float) 0), true, new Arrangement$aligned$1(horizontal), (DefaultConstructorMarker) null);
    }

    public final Vertical aligned(Alignment.Vertical vertical) {
        return new SpacedAligned(Dp.m7111constructorimpl((float) 0), false, new Arrangement$aligned$2(vertical), (DefaultConstructorMarker) null);
    }
    ...
    public static final class Absolute {
        ...
        /* renamed from: spacedBy-0680j_4  reason: not valid java name */
        public final HorizontalOrVertical m626spacedBy0680j_4(float f) {
            return new SpacedAligned(f, false, (Function2) null, (DefaultConstructorMarker) null);
        }

        /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
        public final Horizontal m627spacedByD5KLDUw(float f, Alignment.Horizontal horizontal) {
            return new SpacedAligned(f, false, new Arrangement$Absolute$spacedBy$1(horizontal), (DefaultConstructorMarker) null);
        }

        /* renamed from: spacedBy-D5KLDUw  reason: not valid java name */
        public final Vertical m628spacedByD5KLDUw(float f, Alignment.Vertical vertical) {
            return new SpacedAligned(f, false, new Arrangement$Absolute$spacedBy$2(vertical), (DefaultConstructorMarker) null);
        }

        public final Horizontal aligned(Alignment.Horizontal horizontal) {
            return new SpacedAligned(Dp.m7111constructorimpl((float) 0), false, new Arrangement$Absolute$aligned$1(horizontal), (DefaultConstructorMarker) null);
        }
    }
    ...
    public static final class SpacedAligned implements HorizontalOrVertical {
        ...
        public static /* synthetic */ SpacedAligned m639copy8Feqmps$default(SpacedAligned spacedAligned, float f, boolean z, Function2<Integer, LayoutDirection, Integer> function2, int i, Object obj) {
            if ((i & 1) != 0) {
            ...
            return spacedAligned.m641copy8Feqmps(f, z, function2);
        }

        /* renamed from: component1-D9Ej5fM  reason: not valid java name */
        public final float m640component1D9Ej5fM() {
            return this.space;
        }
        ...
        public final SpacedAligned m641copy8Feqmps(float f, boolean z, Function2<? super Integer, ? super LayoutDirection, Integer> function2) {
        ...
        public boolean equals(Object obj) {
            ...
            return Dp.m7116equalsimpl0(this.space, spacedAligned.space) && this.rtlMirror == spacedAligned.rtlMirror && Intrinsics.areEqual((Object) this.alignment, (Object) spacedAligned.alignment);
        }

        public int hashCode() {
            int r0 = ((Dp.m7117hashCodeimpl(this.space) * 31) + Boolean.hashCode(this.rtlMirror)) * 31;
        ...
        public final float m642getSpaceD9Ej5fM() {
            return this.space;
        }
        ...
        /* renamed from: getSpacing-D9Ej5fM  reason: not valid java name */
        public float m643getSpacingD9Ej5fM() {
            return this.spacing;
        }
        ...
        public void arrange(Density density, int i, int[] iArr, LayoutDirection layoutDirection, int[] iArr2) {
            ...
            int i3;
            if (iArr.length != 0) {
                int r9 = density.m7086roundToPx0680j_4(this.space);
                ...
                if (!z) {
                    ...
                    while (i4 < length) {
                        ...
                        iArr2[i5] = min;
                        int min2 = Math.min(r9, (i - min) - i6);
                        i4++;
                        int i8 = iArr2[i5] + i6 + min2;
                        i2 = min2;
                        i3 = i8;
                        i5 = i7;
                    }
        ...
        public String toString() {
            return (this.rtlMirror ? "" : "Absolute") + "Arrangement#spacedAligned(" + Dp.m7122toStringimpl(this.space) + ", " + this.alignment + ')';
        }
    }
    ...
    public final void placeSpaceAround$foundation_layout_release(int i, int[] iArr, int[] iArr2, boolean z) {
        ...
        float length = !(iArr.length == 0) ? ((float) (i - i3)) / ((float) iArr.length) : 0.0f;
