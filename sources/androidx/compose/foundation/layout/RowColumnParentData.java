...
public final class RowColumnParentData {
    ...
    public RowColumnParentData() {
        this(0.0f, false, (CrossAxisAlignment) null, (FlowLayoutData) null, 15, (DefaultConstructorMarker) null);
    }

    public static /* synthetic */ RowColumnParentData copy$default(RowColumnParentData rowColumnParentData, float f, boolean z, CrossAxisAlignment crossAxisAlignment2, FlowLayoutData flowLayoutData2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        if ((i & 8) != 0) {
            flowLayoutData2 = rowColumnParentData.flowLayoutData;
        }
        return rowColumnParentData.copy(f, z, crossAxisAlignment2, flowLayoutData2);
    }
    ...
    public final RowColumnParentData copy(float f, boolean z, CrossAxisAlignment crossAxisAlignment2, FlowLayoutData flowLayoutData2) {
        return new RowColumnParentData(f, z, crossAxisAlignment2, flowLayoutData2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Float.compare(this.weight, rowColumnParentData.weight) == 0 && this.fill == rowColumnParentData.fill && Intrinsics.areEqual((Object) this.crossAxisAlignment, (Object) rowColumnParentData.crossAxisAlignment) && Intrinsics.areEqual((Object) this.flowLayoutData, (Object) rowColumnParentData.flowLayoutData);
    }
    ...
    public int hashCode() {
        ...
        int i = 0;
        int hashCode2 = (hashCode + (crossAxisAlignment2 == null ? 0 : crossAxisAlignment2.hashCode())) * 31;
        FlowLayoutData flowLayoutData2 = this.flowLayoutData;
        if (flowLayoutData2 != null) {
            i = flowLayoutData2.hashCode();
        }
        return hashCode2 + i;
    }
    ...
    public RowColumnParentData(float f, boolean z, CrossAxisAlignment crossAxisAlignment2, FlowLayoutData flowLayoutData2) {
        this.weight = f;
        this.fill = z;
        this.crossAxisAlignment = crossAxisAlignment2;
        this.flowLayoutData = flowLayoutData2;
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    public /* synthetic */ RowColumnParentData(float f, boolean z, CrossAxisAlignment crossAxisAlignment2, FlowLayoutData flowLayoutData2, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? 0.0f : f, (i & 2) != 0 ? true : z, (i & 4) != 0 ? null : crossAxisAlignment2, (i & 8) != 0 ? null : flowLayoutData2);
    }
    ...
    public final void setFlowLayoutData(FlowLayoutData flowLayoutData2) {
        this.flowLayoutData = flowLayoutData2;
    }
}
