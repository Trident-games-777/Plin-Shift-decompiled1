...
final class PaddingElement extends ModifierNodeElement<PaddingNode> {
    ...
    public final float m762getStartD9Ej5fM() {
        return this.start;
    }

    /* renamed from: setStart-0680j_4  reason: not valid java name */
    public final void m766setStart0680j_4(float f) {
        this.start = f;
    }

    /* renamed from: getTop-D9Ej5fM  reason: not valid java name */
    public final float m763getTopD9Ej5fM() {
        return this.top;
    }

    /* renamed from: setTop-0680j_4  reason: not valid java name */
    public final void m767setTop0680j_4(float f) {
        this.top = f;
    }

    /* renamed from: getEnd-D9Ej5fM  reason: not valid java name */
    public final float m761getEndD9Ej5fM() {
        return this.end;
    }

    /* renamed from: setEnd-0680j_4  reason: not valid java name */
    public final void m765setEnd0680j_4(float f) {
        this.end = f;
    }

    /* renamed from: getBottom-D9Ej5fM  reason: not valid java name */
    public final float m760getBottomD9Ej5fM() {
        return this.bottom;
    }

    /* renamed from: setBottom-0680j_4  reason: not valid java name */
    public final void m764setBottom0680j_4(float f) {
        this.bottom = f;
    }
    ...
    private PaddingElement(float f, float f2, float f3, float f4, boolean z, Function1<? super InspectorInfo, Unit> function1) {
        ...
        if (f >= 0.0f || Dp.m7116equalsimpl0(f, Dp.Companion.m7131getUnspecifiedD9Ej5fM())) {
            float f5 = this.top;
            if (f5 >= 0.0f || Dp.m7116equalsimpl0(f5, Dp.Companion.m7131getUnspecifiedD9Ej5fM())) {
                float f6 = this.end;
                if (f6 >= 0.0f || Dp.m7116equalsimpl0(f6, Dp.Companion.m7131getUnspecifiedD9Ej5fM())) {
                    float f7 = this.bottom;
                    if (f7 >= 0.0f || Dp.m7116equalsimpl0(f7, Dp.Companion.m7131getUnspecifiedD9Ej5fM())) {
                        return;
                    }
                }
            }
    ...
    public void update(PaddingNode paddingNode) {
        paddingNode.m787setStart0680j_4(this.start);
        paddingNode.m788setTop0680j_4(this.top);
        paddingNode.m786setEnd0680j_4(this.end);
        paddingNode.m785setBottom0680j_4(this.bottom);
        paddingNode.setRtlAware(this.rtlAware);
    }

    public int hashCode() {
        return (((((((Dp.m7117hashCodeimpl(this.start) * 31) + Dp.m7117hashCodeimpl(this.top)) * 31) + Dp.m7117hashCodeimpl(this.end)) * 31) + Dp.m7117hashCodeimpl(this.bottom)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public boolean equals(Object obj) {
        PaddingElement paddingElement = obj instanceof PaddingElement ? (PaddingElement) obj : null;
        if (paddingElement != null && Dp.m7116equalsimpl0(this.start, paddingElement.start) && Dp.m7116equalsimpl0(this.top, paddingElement.top) && Dp.m7116equalsimpl0(this.end, paddingElement.end) && Dp.m7116equalsimpl0(this.bottom, paddingElement.bottom) && this.rtlAware == paddingElement.rtlAware) {
            return true;
        }
        return false;
    }
    ...
    public /* synthetic */ PaddingElement(float f, float f2, float f3, float f4, boolean z, Function1 function1, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? Dp.m7111constructorimpl((float) 0) : f, (i & 2) != 0 ? Dp.m7111constructorimpl((float) 0) : f2, (i & 4) != 0 ? Dp.m7111constructorimpl((float) 0) : f3, (i & 8) != 0 ? Dp.m7111constructorimpl((float) 0) : f4, z, function1, (DefaultConstructorMarker) null);
    }
}
