...
public final class SizeKt$requiredSizeInqDBjuR0$$inlined$debugInspectorInfo$1 extends Lambda implements Function1<InspectorInfo, Unit> {
    ...
    public final void invoke(InspectorInfo inspectorInfo) {
        ...
        inspectorInfo.getProperties().set("minWidth", Dp.m7109boximpl(this.$minWidth$inlined));
        inspectorInfo.getProperties().set("minHeight", Dp.m7109boximpl(this.$minHeight$inlined));
        inspectorInfo.getProperties().set("maxWidth", Dp.m7109boximpl(this.$maxWidth$inlined));
        inspectorInfo.getProperties().set("maxHeight", Dp.m7109boximpl(this.$maxHeight$inlined));
    }
}
