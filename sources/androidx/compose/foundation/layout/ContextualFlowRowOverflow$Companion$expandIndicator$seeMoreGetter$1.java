...
final class ContextualFlowRowOverflow$Companion$expandIndicator$seeMoreGetter$1 extends Lambda implements Function1<FlowLayoutOverflowState, Function2<? super Composer, ? super Integer, ? extends Unit>> {
    final /* synthetic */ Function3<ContextualFlowRowOverflowScope, Composer, Integer, Unit> $content;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ContextualFlowRowOverflow$Companion$expandIndicator$seeMoreGetter$1(Function3<? super ContextualFlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function3) {
        super(1);
        this.$content = function3;
    }

    public final Function2<Composer, Integer, Unit> invoke(final FlowLayoutOverflowState flowLayoutOverflowState) {
        final Function3<ContextualFlowRowOverflowScope, Composer, Integer, Unit> function3 = this.$content;
        return ComposableLambdaKt.composableLambdaInstance(1850548683, true, new Function2<Composer, Integer, Unit>() {
