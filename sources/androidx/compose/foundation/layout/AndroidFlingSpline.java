...
final class AndroidFlingSpline {
        ...
        while (true) {
            ...
            if (i < 100) {
                ...
                while (true) {
                    ...
                    if (((double) Math.abs(f18 - f6)) < 1.0E-5d) {
                        break;
                    } else if (f18 > f6) {
                        f17 = f7;
                    } else {
    ...
    public final long m613flingPositionLfoxSSI(float f) {
        float f2;
        float f3;
        float f4 = (float) 100;
        int i = (int) (f4 * f);
        ...
        return FlingResult.m615constructorimpl((((long) Float.floatToRawIntBits(f3)) & 4294967295L) | (floatToRawIntBits << 32));
    }
    ...
    public static final class FlingResult {
        ...
        public static final /* synthetic */ FlingResult m614boximpl(long j) {
        ...
        public static boolean m616equalsimpl(long j, Object obj) {
            return (obj instanceof FlingResult) && j == ((FlingResult) obj).m622unboximpl();
        }

        /* renamed from: equals-impl0  reason: not valid java name */
        public static final boolean m617equalsimpl0(long j, long j2) {
            return j == j2;
        }
        ...
        public boolean equals(Object obj) {
            return m616equalsimpl(this.packedValue, obj);
        }

        public int hashCode() {
            return m620hashCodeimpl(this.packedValue);
        }
        ...
        public static final float m618getDistanceCoefficientimpl(long j) {
            return Float.intBitsToFloat((int) (j >> 32));
        }

        /* renamed from: getVelocityCoefficient-impl  reason: not valid java name */
        public static final float m619getVelocityCoefficientimpl(long j) {
