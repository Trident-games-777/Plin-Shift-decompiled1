...
final class WrapContentNode$measure$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    public final void invoke(Placeable.PlacementScope placementScope) {
        ...
        Placeable.PlacementScope.m5890place70tqf50$default(placementScope2, this.$placeable, this.this$0.getAlignmentCallback().invoke(IntSize.m7275boximpl(IntSizeKt.IntSize(this.$wrapperWidth - this.$placeable.getWidth(), this.$wrapperHeight - this.$placeable.getHeight())), this.$this_measure.getLayoutDirection()).m7250unboximpl(), 0.0f, 2, (Object) null);
    }
}
