    ...
    public static final class Companion {
        ...
        public final WindowInsetsHolder current(Composer composer, int i) {
            ...
            if (changedInstance || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = new WindowInsetsHolder$Companion$current$1$1(orCreateFor, view);
                composer.updateRememberedValue(rememberedValue);
            }
            ComposerKt.sourceInformationMarkerEnd(composer);
            EffectsKt.DisposableEffect((Object) orCreateFor, (Function1<? super DisposableEffectScope, ? extends DisposableEffectResult>) (Function1) rememberedValue, composer, 0);
            if (ComposerKt.isTraceInProgress()) {
