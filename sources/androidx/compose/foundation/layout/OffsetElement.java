...
final class OffsetElement extends ModifierNodeElement<OffsetNode> {
    ...
    public final float m729getXD9Ej5fM() {
        return this.x;
    }

    /* renamed from: getY-D9Ej5fM  reason: not valid java name */
    public final float m730getYD9Ej5fM() {
        return this.y;
    }
    ...
    public void update(OffsetNode offsetNode) {
        offsetNode.m738setX0680j_4(this.x);
        offsetNode.m739setY0680j_4(this.y);
    ...
    public boolean equals(Object obj) {
        ...
        return offsetElement != null && Dp.m7116equalsimpl0(this.x, offsetElement.x) && Dp.m7116equalsimpl0(this.y, offsetElement.y) && this.rtlAware == offsetElement.rtlAware;
    }

    public int hashCode() {
        return (((Dp.m7117hashCodeimpl(this.x) * 31) + Dp.m7117hashCodeimpl(this.y)) * 31) + Boolean.hashCode(this.rtlAware);
    }

    public String toString() {
        return "OffsetModifierElement(x=" + Dp.m7122toStringimpl(this.x) + ", y=" + Dp.m7122toStringimpl(this.y) + ", rtlAware=" + this.rtlAware + ')';
    }
