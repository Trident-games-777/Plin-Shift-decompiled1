...
interface SideCalculator {
    ...
    long m818consumedOffsetsMKHz9U(long j);

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    long m819consumedVelocityQWom1Mo(long j, float f);
    ...
    public static final class Companion {
        ...
        public final SideCalculator m820chooseCalculatorni1skBw(int i, LayoutDirection layoutDirection) {
            if (WindowInsetsSides.m885equalsimpl0(i, WindowInsetsSides.Companion.m899getLeftJoeWqyM())) {
                return LeftSideCalculator;
            }
            if (WindowInsetsSides.m885equalsimpl0(i, WindowInsetsSides.Companion.m902getTopJoeWqyM())) {
                return TopSideCalculator;
            }
            if (WindowInsetsSides.m885equalsimpl0(i, WindowInsetsSides.Companion.m900getRightJoeWqyM())) {
                return RightSideCalculator;
            }
            if (WindowInsetsSides.m885equalsimpl0(i, WindowInsetsSides.Companion.m896getBottomJoeWqyM())) {
                return BottomSideCalculator;
            }
            if (WindowInsetsSides.m885equalsimpl0(i, WindowInsetsSides.Companion.m901getStartJoeWqyM())) {
                if (layoutDirection == LayoutDirection.Ltr) {
                    return LeftSideCalculator;
                }
                return RightSideCalculator;
            } else if (!WindowInsetsSides.m885equalsimpl0(i, WindowInsetsSides.Companion.m897getEndJoeWqyM())) {
