...
public final class OffsetKt {
    ...
    public static final Modifier m733offsetVpY3zN4(Modifier modifier, float f, float f2) {
        return modifier.then(new OffsetElement(f, f2, true, new OffsetKt$offset$1(f, f2), (DefaultConstructorMarker) null));
    }

    /* renamed from: absoluteOffset-VpY3zN4  reason: not valid java name */
    public static final Modifier m731absoluteOffsetVpY3zN4(Modifier modifier, float f, float f2) {
    ...
    public static /* synthetic */ Modifier m734offsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return m733offsetVpY3zN4(modifier, f, f2);
    }

    /* renamed from: absoluteOffset-VpY3zN4$default  reason: not valid java name */
    public static /* synthetic */ Modifier m732absoluteOffsetVpY3zN4$default(Modifier modifier, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = Dp.m7111constructorimpl((float) 0);
        }
        if ((i & 2) != 0) {
        ...
        return m731absoluteOffsetVpY3zN4(modifier, f, f2);
    }
}
