...
public final class SideCalculator$Companion$LeftSideCalculator$1 implements SideCalculator {
    ...
    public long m823consumedOffsetsMKHz9U(long j) {
        return OffsetKt.Offset(Offset.m3987getXimpl(j), 0.0f);
    }

    /* renamed from: consumedVelocity-QWom1Mo  reason: not valid java name */
    public long m824consumedVelocityQWom1Mo(long j, float f) {
        return VelocityKt.Velocity(Velocity.m7350getXimpl(j) - f, 0.0f);
    }
}
