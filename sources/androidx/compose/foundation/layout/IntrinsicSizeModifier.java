...
abstract class IntrinsicSizeModifier extends Modifier.Node implements LayoutModifierNode {
    ...
    public abstract long m725calculateContentConstraintsl58MMJ0(MeasureScope measureScope, Measurable measurable, long j);

    public abstract boolean getEnforceIncoming();

    /* renamed from: measure-3p2s80s  reason: not valid java name */
    public final MeasureResult m726measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        long r0 = m725calculateContentConstraintsl58MMJ0(measureScope, measurable, j);
        if (getEnforceIncoming()) {
            r0 = ConstraintsKt.m7067constrainN9IONVI(j, r0);
        }
        Placeable r9 = measurable.m5848measureBRTryo0(r0);
