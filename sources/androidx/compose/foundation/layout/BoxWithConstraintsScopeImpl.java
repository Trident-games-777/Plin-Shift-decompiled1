...
final class BoxWithConstraintsScopeImpl implements BoxWithConstraintsScope, BoxScope {
    ...
    public static /* synthetic */ BoxWithConstraintsScopeImpl m665copy0kLqBqw$default(BoxWithConstraintsScopeImpl boxWithConstraintsScopeImpl, Density density2, long j, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return boxWithConstraintsScopeImpl.m667copy0kLqBqw(density2, j);
    }
    ...
    public final long m666component2msEJaDk() {
        return this.constraints;
    }

    /* renamed from: copy-0kLqBqw  reason: not valid java name */
    public final BoxWithConstraintsScopeImpl m667copy0kLqBqw(Density density2, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.density, (Object) boxWithConstraintsScopeImpl.density) && Constraints.m7045equalsimpl0(this.constraints, boxWithConstraintsScopeImpl.constraints);
    }

    public int hashCode() {
        return (this.density.hashCode() * 31) + Constraints.m7055hashCodeimpl(this.constraints);
    }
    ...
    public String toString() {
        return "BoxWithConstraintsScopeImpl(density=" + this.density + ", constraints=" + Constraints.m7057toStringimpl(this.constraints) + ')';
    }
    ...
    public long m668getConstraintsmsEJaDk() {
        return this.constraints;
    }

    /* renamed from: getMinWidth-D9Ej5fM  reason: not valid java name */
    public float m672getMinWidthD9Ej5fM() {
        return this.density.m7088toDpu2uoSUM(Constraints.m7054getMinWidthimpl(m668getConstraintsmsEJaDk()));
    }

    /* renamed from: getMaxWidth-D9Ej5fM  reason: not valid java name */
    public float m670getMaxWidthD9Ej5fM() {
        return Constraints.m7048getHasBoundedWidthimpl(m668getConstraintsmsEJaDk()) ? this.density.m7088toDpu2uoSUM(Constraints.m7052getMaxWidthimpl(m668getConstraintsmsEJaDk())) : Dp.Companion.m7130getInfinityD9Ej5fM();
    }

    /* renamed from: getMinHeight-D9Ej5fM  reason: not valid java name */
    public float m671getMinHeightD9Ej5fM() {
        return this.density.m7088toDpu2uoSUM(Constraints.m7053getMinHeightimpl(m668getConstraintsmsEJaDk()));
    }

    /* renamed from: getMaxHeight-D9Ej5fM  reason: not valid java name */
    public float m669getMaxHeightD9Ej5fM() {
        return Constraints.m7047getHasBoundedHeightimpl(m668getConstraintsmsEJaDk()) ? this.density.m7088toDpu2uoSUM(Constraints.m7051getMaxHeightimpl(m668getConstraintsmsEJaDk())) : Dp.Companion.m7130getInfinityD9Ej5fM();
    }
}
