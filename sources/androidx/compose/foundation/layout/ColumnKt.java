...
public final class ColumnKt {
    ...
    public static final MeasurePolicy columnMeasurePolicy(Arrangement.Vertical vertical, Alignment.Horizontal horizontal, Composer composer, int i) {
        ...
        if (!Intrinsics.areEqual((Object) vertical, (Object) Arrangement.INSTANCE.getTop()) || !Intrinsics.areEqual((Object) horizontal, (Object) Alignment.Companion.getStart())) {
            ...
            boolean z = false;
            boolean z2 = (((i & 14) ^ 6) > 4 && composer.changed((Object) vertical)) || (i & 6) == 4;
            if ((((i & 112) ^ 48) > 32 && composer.changed((Object) horizontal)) || (i & 48) == 32) {
                z = true;
            }
            boolean z3 = z2 | z;
    ...
    public static final long createColumnConstraints(boolean z, int i, int i2, int i3, int i4) {
        ...
        return Constraints.Companion.m7060fitPrioritizingHeightZbe2FdA(i2, i4, i, i3);
    }
}
