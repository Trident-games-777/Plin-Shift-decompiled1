...
final class ContextualFlowLayoutKt$ContextualFlowColumn$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    ContextualFlowLayoutKt$ContextualFlowColumn$1(int i, Modifier modifier, Arrangement.Vertical vertical, Arrangement.Horizontal horizontal, int i2, int i3, ContextualFlowColumnOverflow contextualFlowColumnOverflow, Function4<? super ContextualFlowColumnScope, ? super Integer, ? super Composer, ? super Integer, Unit> function4, int i4, int i5) {
        super(2);
        this.$itemCount = i;
