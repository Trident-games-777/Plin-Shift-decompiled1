...
public final class ContextualFlowItemIterator implements Iterator<Measurable>, KMappedMarker {
    ...
    public Measurable next() {
        return getNext$foundation_layout_release$default(this, (FlowLineInfo) null, 1, (Object) null);
    }
    ...
    public final Measurable getNext$foundation_layout_release(FlowLineInfo flowLineInfo) {
        ...
        if (i < this.itemCount) {
            List invoke = this.getMeasurables.invoke(Integer.valueOf(i), flowLineInfo);
            this.itemIndex++;
            if (invoke.isEmpty()) {
                return next();
            }
            Measurable measurable2 = (Measurable) CollectionsKt.first(invoke);
