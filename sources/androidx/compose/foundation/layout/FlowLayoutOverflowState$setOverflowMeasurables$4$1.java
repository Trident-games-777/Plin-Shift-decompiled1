...
final class FlowLayoutOverflowState$setOverflowMeasurables$4$1 extends Lambda implements Function1<Placeable, Unit> {
    ...
    FlowLayoutOverflowState$setOverflowMeasurables$4$1(FlowLayoutOverflowState flowLayoutOverflowState, FlowLineMeasurePolicy flowLineMeasurePolicy) {
        super(1);
    ...
    public final void invoke(Placeable placeable) {
        ...
        this.this$0.collapseSize = IntIntPair.m26boximpl(IntIntPair.m29constructorimpl(i, i2));
