...
public final class ColumnMeasurePolicy implements MeasurePolicy, RowColumnMeasurePolicy {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.verticalArrangement, (Object) columnMeasurePolicy.verticalArrangement) && Intrinsics.areEqual((Object) this.horizontalAlignment, (Object) columnMeasurePolicy.horizontalAlignment);
    }
    ...
    public MeasureResult placeHelper(Placeable[] placeableArr, MeasureScope measureScope, int i, int[] iArr, int i2, int i3, int[] iArr2, int i4, int i5, int i6) {
        return MeasureScope.layout$default(measureScope, i3, i2, (Map) null, new ColumnMeasurePolicy$placeHelper$1$1(placeableArr, this, i3, i, measureScope, iArr), 4, (Object) null);
    }
    ...
    public long m673createConstraintsxF2OJ5Q(int i, int i2, int i3, int i4, boolean z) {
        return ColumnKt.createColumnConstraints(z, i, i2, i3, i4);
    }

    /* renamed from: measure-3p2s80s  reason: not valid java name */
    public MeasureResult m674measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        MeasureScope measureScope2 = measureScope;
        return RowColumnMeasurePolicyKt.measure$default(this, Constraints.m7053getMinHeightimpl(j), Constraints.m7054getMinWidthimpl(j), Constraints.m7051getMaxHeightimpl(j), Constraints.m7052getMaxWidthimpl(j), measureScope2.m7086roundToPx0680j_4(this.verticalArrangement.m645getSpacingD9Ej5fM()), measureScope2, list, new Placeable[list.size()], 0, list.size(), (int[]) null, 0, 3072, (Object) null);
    }

    public int minIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        return IntrinsicMeasureBlocks.INSTANCE.VerticalMinWidth(list, i, intrinsicMeasureScope.m7086roundToPx0680j_4(this.verticalArrangement.m645getSpacingD9Ej5fM()));
    }

    public int minIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        return IntrinsicMeasureBlocks.INSTANCE.VerticalMinHeight(list, i, intrinsicMeasureScope.m7086roundToPx0680j_4(this.verticalArrangement.m645getSpacingD9Ej5fM()));
    }

    public int maxIntrinsicWidth(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        return IntrinsicMeasureBlocks.INSTANCE.VerticalMaxWidth(list, i, intrinsicMeasureScope.m7086roundToPx0680j_4(this.verticalArrangement.m645getSpacingD9Ej5fM()));
    }

    public int maxIntrinsicHeight(IntrinsicMeasureScope intrinsicMeasureScope, List<? extends IntrinsicMeasurable> list, int i) {
        return IntrinsicMeasureBlocks.INSTANCE.VerticalMaxHeight(list, i, intrinsicMeasureScope.m7086roundToPx0680j_4(this.verticalArrangement.m645getSpacingD9Ej5fM()));
    }
}
