...
final class FlowRowOverflow$Companion$expandIndicator$seeMoreGetter$1 extends Lambda implements Function1<FlowLayoutOverflowState, Function2<? super Composer, ? super Integer, ? extends Unit>> {
    final /* synthetic */ Function3<FlowRowOverflowScope, Composer, Integer, Unit> $content;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FlowRowOverflow$Companion$expandIndicator$seeMoreGetter$1(Function3<? super FlowRowOverflowScope, ? super Composer, ? super Integer, Unit> function3) {
        super(1);
        this.$content = function3;
    }

    public final Function2<Composer, Integer, Unit> invoke(final FlowLayoutOverflowState flowLayoutOverflowState) {
        final Function3<FlowRowOverflowScope, Composer, Integer, Unit> function3 = this.$content;
        return ComposableLambdaKt.composableLambdaInstance(263270381, true, new Function2<Composer, Integer, Unit>() {
