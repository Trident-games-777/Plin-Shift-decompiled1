...
public final class WindowInsetsSides {
    ...
    public static final /* synthetic */ WindowInsetsSides m882boximpl(int i) {
        return new WindowInsetsSides(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m883constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m884equalsimpl(int i, Object obj) {
        return (obj instanceof WindowInsetsSides) && i == ((WindowInsetsSides) obj).m891unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m885equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hasAny-bkgdKaI$foundation_layout_release  reason: not valid java name */
    public static final boolean m886hasAnybkgdKaI$foundation_layout_release(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public boolean equals(Object obj) {
        return m884equalsimpl(this.value, obj);
    }
    ...
    public static final int m888plusgK_yJZ4(int i, int i2) {
        return m883constructorimpl(i | i2);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m889toStringimpl(int i) {
        return "WindowInsetsSides(" + m890valueToStringimpl(i) + ')';
    }
    ...
    private static final String m890valueToStringimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m892getAllowLeftInLtrJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowLeftInLtr;
        }

        /* renamed from: getAllowRightInLtr-JoeWqyM$foundation_layout_release  reason: not valid java name */
        public final int m894getAllowRightInLtrJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowRightInLtr;
        }

        /* renamed from: getAllowLeftInRtl-JoeWqyM$foundation_layout_release  reason: not valid java name */
        public final int m893getAllowLeftInRtlJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowLeftInRtl;
        }

        /* renamed from: getAllowRightInRtl-JoeWqyM$foundation_layout_release  reason: not valid java name */
        public final int m895getAllowRightInRtlJoeWqyM$foundation_layout_release() {
            return WindowInsetsSides.AllowRightInRtl;
        }

        /* renamed from: getStart-JoeWqyM  reason: not valid java name */
        public final int m901getStartJoeWqyM() {
            return WindowInsetsSides.Start;
        }

        /* renamed from: getEnd-JoeWqyM  reason: not valid java name */
        public final int m897getEndJoeWqyM() {
            return WindowInsetsSides.End;
        }

        /* renamed from: getTop-JoeWqyM  reason: not valid java name */
        public final int m902getTopJoeWqyM() {
            return WindowInsetsSides.Top;
        }

        /* renamed from: getBottom-JoeWqyM  reason: not valid java name */
        public final int m896getBottomJoeWqyM() {
            return WindowInsetsSides.Bottom;
        }

        /* renamed from: getLeft-JoeWqyM  reason: not valid java name */
        public final int m899getLeftJoeWqyM() {
            return WindowInsetsSides.Left;
        }

        /* renamed from: getRight-JoeWqyM  reason: not valid java name */
        public final int m900getRightJoeWqyM() {
            return WindowInsetsSides.Right;
        }

        /* renamed from: getHorizontal-JoeWqyM  reason: not valid java name */
        public final int m898getHorizontalJoeWqyM() {
            return WindowInsetsSides.Horizontal;
        }

        /* renamed from: getVertical-JoeWqyM  reason: not valid java name */
        public final int m903getVerticalJoeWqyM() {
            return WindowInsetsSides.Vertical;
        }
    }

    static {
        int r0 = m883constructorimpl(8);
        AllowLeftInLtr = r0;
        int r1 = m883constructorimpl(4);
        AllowRightInLtr = r1;
        int r2 = m883constructorimpl(2);
        AllowLeftInRtl = r2;
        int r3 = m883constructorimpl(1);
        AllowRightInRtl = r3;
        Start = m888plusgK_yJZ4(r0, r3);
        End = m888plusgK_yJZ4(r1, r2);
        int r4 = m883constructorimpl(16);
        Top = r4;
        int r5 = m883constructorimpl(32);
        Bottom = r5;
        int r02 = m888plusgK_yJZ4(r0, r2);
        Left = r02;
        int r12 = m888plusgK_yJZ4(r1, r3);
        Right = r12;
        Horizontal = m888plusgK_yJZ4(r02, r12);
        Vertical = m888plusgK_yJZ4(r4, r5);
    }
}
