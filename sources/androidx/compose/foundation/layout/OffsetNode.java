...
final class OffsetNode extends Modifier.Node implements LayoutModifierNode {
    ...
    public final float m735getXD9Ej5fM() {
        return this.x;
    }

    /* renamed from: setX-0680j_4  reason: not valid java name */
    public final void m738setX0680j_4(float f) {
        this.x = f;
    }

    /* renamed from: getY-D9Ej5fM  reason: not valid java name */
    public final float m736getYD9Ej5fM() {
        return this.y;
    }

    /* renamed from: setY-0680j_4  reason: not valid java name */
    public final void m739setY0680j_4(float f) {
        this.y = f;
    }
    ...
    public MeasureResult m737measure3p2s80s(MeasureScope measureScope, Measurable measurable, long j) {
        Placeable r9 = measurable.m5848measureBRTryo0(j);
        return MeasureScope.layout$default(measureScope, r9.getWidth(), r9.getHeight(), (Map) null, new OffsetNode$measure$1(this, r9, measureScope), 4, (Object) null);
    }
}
