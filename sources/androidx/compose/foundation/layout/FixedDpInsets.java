...
final class FixedDpInsets implements WindowInsets {
    ...
    public int getLeft(Density density, LayoutDirection layoutDirection) {
        return density.m7086roundToPx0680j_4(this.leftDp);
    }

    public int getTop(Density density) {
        return density.m7086roundToPx0680j_4(this.topDp);
    }

    public int getRight(Density density, LayoutDirection layoutDirection) {
        return density.m7086roundToPx0680j_4(this.rightDp);
    }

    public int getBottom(Density density) {
        return density.m7086roundToPx0680j_4(this.bottomDp);
    }

    public String toString() {
        return "Insets(left=" + Dp.m7122toStringimpl(this.leftDp) + ", top=" + Dp.m7122toStringimpl(this.topDp) + ", right=" + Dp.m7122toStringimpl(this.rightDp) + ", bottom=" + Dp.m7122toStringimpl(this.bottomDp) + ')';
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Dp.m7116equalsimpl0(this.leftDp, fixedDpInsets.leftDp) && Dp.m7116equalsimpl0(this.topDp, fixedDpInsets.topDp) && Dp.m7116equalsimpl0(this.rightDp, fixedDpInsets.rightDp) && Dp.m7116equalsimpl0(this.bottomDp, fixedDpInsets.bottomDp);
    }

    public int hashCode() {
        return (((((Dp.m7117hashCodeimpl(this.leftDp) * 31) + Dp.m7117hashCodeimpl(this.topDp)) * 31) + Dp.m7117hashCodeimpl(this.rightDp)) * 31) + Dp.m7117hashCodeimpl(this.bottomDp);
    }
}
