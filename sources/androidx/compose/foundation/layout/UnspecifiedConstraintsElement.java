...
final class UnspecifiedConstraintsElement extends ModifierNodeElement<UnspecifiedConstraintsNode> {
    ...
    public final float m865getMinWidthD9Ej5fM() {
        return this.minWidth;
    }

    /* renamed from: getMinHeight-D9Ej5fM  reason: not valid java name */
    public final float m864getMinHeightD9Ej5fM() {
    ...
    public void update(UnspecifiedConstraintsNode unspecifiedConstraintsNode) {
        unspecifiedConstraintsNode.m870setMinWidth0680j_4(this.minWidth);
        unspecifiedConstraintsNode.m869setMinHeight0680j_4(this.minHeight);
    }

    public void inspectableProperties(InspectorInfo inspectorInfo) {
        inspectorInfo.setName("defaultMinSize");
        inspectorInfo.getProperties().set("minWidth", Dp.m7109boximpl(this.minWidth));
        inspectorInfo.getProperties().set("minHeight", Dp.m7109boximpl(this.minHeight));
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Dp.m7116equalsimpl0(this.minWidth, unspecifiedConstraintsElement.minWidth) || !Dp.m7116equalsimpl0(this.minHeight, unspecifiedConstraintsElement.minHeight)) {
            return false;
        }
        return true;
    }
    ...
    public int hashCode() {
        return (Dp.m7117hashCodeimpl(this.minWidth) * 31) + Dp.m7117hashCodeimpl(this.minHeight);
    }
}
