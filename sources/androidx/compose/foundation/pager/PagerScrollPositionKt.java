...
public final class PagerScrollPositionKt {
    ...
    public static final long currentAbsoluteScrollOffset(PagerState pagerState) {
        return (((long) pagerState.getCurrentPage()) * ((long) pagerState.getPageSizeWithSpacing$foundation_release())) + MathKt.roundToLong(pagerState.getCurrentPageOffsetFraction() * ((float) pagerState.getPageSizeWithSpacing$foundation_release()));
    }
}
