...
public interface PageSize {
    ...
    public static final class Fixed implements PageSize {
        ...
        public final float m1092getPageSizeD9Ej5fM() {
            return this.pageSize;
        }

        public int calculateMainAxisPageSize(Density density, int i, int i2) {
            return density.m7086roundToPx0680j_4(this.pageSize);
        }
        ...
        public boolean equals(Object obj) {
            ...
            return Dp.m7116equalsimpl0(this.pageSize, ((Fixed) obj).pageSize);
        }

        public int hashCode() {
            return Dp.m7117hashCodeimpl(this.pageSize);
        }
    }
}
