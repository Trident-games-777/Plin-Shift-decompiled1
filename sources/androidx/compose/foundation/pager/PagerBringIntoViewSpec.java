...
final class PagerBringIntoViewSpec implements BringIntoViewSpec {
    ...
    public PagerBringIntoViewSpec(PagerState pagerState2, BringIntoViewSpec bringIntoViewSpec) {
    ...
    public float calculateScrollDistance(float f, float f2, float f3) {
        ...
        float firstVisiblePageOffset$foundation_release = ((float) this.pagerState.getFirstVisiblePageOffset$foundation_release()) * -1.0f;
        if (this.pagerState.getLastScrolledForward()) {
            firstVisiblePageOffset$foundation_release += (float) this.pagerState.getPageSizeWithSpacing$foundation_release();
        }
    ...
    private final float overrideProposedOffsetMove(float f) {
        float firstVisiblePageOffset$foundation_release = ((float) this.pagerState.getFirstVisiblePageOffset$foundation_release()) * ((float) -1);
