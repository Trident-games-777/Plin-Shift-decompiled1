...
public final class ClipScrollableContainerKt$VerticalScrollableClipModifier$1 implements Shape {
    ...
    public Outline m297createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
        float r6 = (float) density.m7086roundToPx0680j_4(ClipScrollableContainerKt.getMaxSupportedElevation());
        return new Outline.Rectangle(new Rect(-r6, 0.0f, Size.m4056getWidthimpl(j) + r6, Size.m4053getHeightimpl(j)));
    }
}
