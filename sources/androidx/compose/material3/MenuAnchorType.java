...
public final class MenuAnchorType {
    ...
    public static final String PrimaryEditable = m2193constructorimpl("PrimaryEditable");
    /* access modifiers changed from: private */
    public static final String PrimaryNotEditable = m2193constructorimpl("PrimaryNotEditable");
    /* access modifiers changed from: private */
    public static final String SecondaryEditable = m2193constructorimpl("SecondaryEditable");
    private final String name;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ MenuAnchorType m2192boximpl(String str) {
        return new MenuAnchorType(str);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static String m2193constructorimpl(String str) {
        return str;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2194equalsimpl(String str, Object obj) {
        return (obj instanceof MenuAnchorType) && Intrinsics.areEqual((Object) str, (Object) ((MenuAnchorType) obj).m2198unboximpl());
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2195equalsimpl0(String str, String str2) {
        return Intrinsics.areEqual((Object) str, (Object) str2);
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m2196hashCodeimpl(String str) {
        return str.hashCode();
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2197toStringimpl(String str) {
        return str;
    }

    public boolean equals(Object obj) {
        return m2194equalsimpl(this.name, obj);
    }

    public int hashCode() {
        return m2196hashCodeimpl(this.name);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ String m2198unboximpl() {
        return this.name;
    }
    ...
    public String toString() {
        return m2197toStringimpl(this.name);
    }
}
