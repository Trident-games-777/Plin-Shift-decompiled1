...
final class NavigationBarKt$NavigationBar$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C123@5642L425:NavigationBar.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(105663120, i, -1, "androidx.compose.material3.NavigationBar.<anonymous> (NavigationBar.kt:123)");
            }
            Modifier selectableGroup = SelectableGroupKt.selectableGroup(SizeKt.m830defaultMinSizeVpY3zN4$default(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, (Object) null), this.$windowInsets), 0.0f, NavigationBarKt.NavigationBarHeight, 1, (Object) null));
            ...
            MeasurePolicy rowMeasurePolicy = RowKt.rowMeasurePolicy(Arrangement.INSTANCE.m623spacedBy0680j_4(NavigationBarKt.getNavigationBarItemHorizontalPadding()), centerVertically, composer, 54);
