...
final class IconButtonKt$FilledIconButton$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    IconButtonKt$FilledIconButton$2(Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C231@10831L304:IconButton.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1560623888, i, -1, "androidx.compose.material3.FilledIconButton.<anonymous> (IconButton.kt:231)");
            }
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 1882507244, "C239@11116L9:IconButton.kt#uh7d8r");
