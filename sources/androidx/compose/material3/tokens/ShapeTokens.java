...
public final class ShapeTokens {
    ...
    private static final RoundedCornerShape CornerMedium = RoundedCornerShapeKt.m1150RoundedCornerShape0680j_4(Dp.m7111constructorimpl((float) 12.0d));
    private static final Shape CornerNone = RectangleShapeKt.getRectangleShape();
    private static final RoundedCornerShape CornerSmall = RoundedCornerShapeKt.m1150RoundedCornerShape0680j_4(Dp.m7111constructorimpl((float) 8.0d));
    ...
    static {
        float f = (float) 28.0d;
        CornerExtraLarge = RoundedCornerShapeKt.m1150RoundedCornerShape0680j_4(Dp.m7111constructorimpl(f));
        float f2 = (float) 0.0d;
        CornerExtraLargeTop = RoundedCornerShapeKt.m1151RoundedCornerShapea9UjIt4(Dp.m7111constructorimpl(f), Dp.m7111constructorimpl(f), Dp.m7111constructorimpl(f2), Dp.m7111constructorimpl(f2));
        float f3 = (float) 4.0d;
        CornerExtraSmall = RoundedCornerShapeKt.m1150RoundedCornerShape0680j_4(Dp.m7111constructorimpl(f3));
        CornerExtraSmallTop = RoundedCornerShapeKt.m1151RoundedCornerShapea9UjIt4(Dp.m7111constructorimpl(f3), Dp.m7111constructorimpl(f3), Dp.m7111constructorimpl(f2), Dp.m7111constructorimpl(f2));
        float f4 = (float) 16.0d;
        CornerLarge = RoundedCornerShapeKt.m1150RoundedCornerShape0680j_4(Dp.m7111constructorimpl(f4));
        CornerLargeEnd = RoundedCornerShapeKt.m1151RoundedCornerShapea9UjIt4(Dp.m7111constructorimpl(f2), Dp.m7111constructorimpl(f4), Dp.m7111constructorimpl(f4), Dp.m7111constructorimpl(f2));
        CornerLargeTop = RoundedCornerShapeKt.m1151RoundedCornerShapea9UjIt4(Dp.m7111constructorimpl(f4), Dp.m7111constructorimpl(f4), Dp.m7111constructorimpl(f2), Dp.m7111constructorimpl(f2));
    }
}
