...
public final class FilledAutocompleteTokens {
    ...
    private static final float MenuContainerElevation = ElevationTokens.INSTANCE.m3197getLevel2D9Ej5fM();
    ...
    private static final float TextFieldFocusActiveIndicatorHeight = Dp.m7111constructorimpl((float) 2.0d);
    ...
    private static final float TextFieldLeadingIconSize = Dp.m7111constructorimpl((float) 20.0d);
    private static final ColorSchemeKeyTokens TextFieldTrailingIconColor = ColorSchemeKeyTokens.OnSurfaceVariant;
    private static final float TextFieldTrailingIconSize = Dp.m7111constructorimpl((float) 24.0d);
    ...
    static {
        float f = (float) 1.0d;
        TextFieldActiveIndicatorHeight = Dp.m7111constructorimpl(f);
        TextFieldDisabledActiveIndicatorHeight = Dp.m7111constructorimpl(f);
        TextFieldHoverActiveIndicatorHeight = Dp.m7111constructorimpl(f);
    }
    ...
    public final float m3255getMenuContainerElevationD9Ej5fM() {
    ...
    public final float m3256getTextFieldActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3257getTextFieldDisabledActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3258getTextFieldFocusActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3259getTextFieldHoverActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3260getTextFieldLeadingIconSizeD9Ej5fM() {
    ...
    public final float m3261getTextFieldTrailingIconSizeD9Ej5fM() {
