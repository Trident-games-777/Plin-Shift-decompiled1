...
public final class ProgressIndicatorTokens {
    ...
    private static final float Size = Dp.m7111constructorimpl((float) 48.0d);
    ...
    static {
        float f = (float) 4.0d;
        ActiveThickness = Dp.m7111constructorimpl(f);
        ActiveTrackSpace = Dp.m7111constructorimpl(f);
        StopShape = Dp.m7111constructorimpl(f);
        StopSize = Dp.m7111constructorimpl(f);
        TrackThickness = Dp.m7111constructorimpl(f);
    }
    ...
    public final float m3485getActiveThicknessD9Ej5fM() {
        return ActiveThickness;
    }

    /* renamed from: getActiveTrackSpace-D9Ej5fM  reason: not valid java name */
    public final float m3486getActiveTrackSpaceD9Ej5fM() {
    ...
    public final float m3488getStopShapeD9Ej5fM() {
        return StopShape;
    }

    /* renamed from: getStopSize-D9Ej5fM  reason: not valid java name */
    public final float m3489getStopSizeD9Ej5fM() {
        return StopSize;
    }
    ...
    public final float m3490getTrackThicknessD9Ej5fM() {
        return TrackThickness;
    }

    /* renamed from: getSize-D9Ej5fM  reason: not valid java name */
    public final float m3487getSizeD9Ej5fM() {
        return Size;
    }
}
