...
public final class OutlinedIconButtonTokens {
    ...
    private static final float ContainerSize = Dp.m7111constructorimpl((float) 40.0d);
    ...
    private static final float Size = Dp.m7111constructorimpl((float) 24.0d);
    ...
    public final float m3376getContainerSizeD9Ej5fM() {
    ...
    public final float m3378getUnselectedOutlineWidthD9Ej5fM() {
