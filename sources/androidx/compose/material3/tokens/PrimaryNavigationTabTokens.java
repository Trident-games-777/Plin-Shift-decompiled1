...
public final class PrimaryNavigationTabTokens {
    ...
    private static final float ContainerHeight = Dp.m7111constructorimpl((float) 48.0d);
    ...
    private static final float IconAndLabelTextContainerHeight = Dp.m7111constructorimpl((float) 64.0d);
    ...
    static {
        ...
        ActiveIndicatorShape = RoundedCornerShapeKt.m1150RoundedCornerShape0680j_4(Dp.m7111constructorimpl(f));
    }
    ...
    public final float m3480getActiveIndicatorHeightD9Ej5fM() {
    ...
    public final float m3483getIconAndLabelTextContainerHeightD9Ej5fM() {
