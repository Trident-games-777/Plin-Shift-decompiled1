...
public final class NavigationBarTokens {
    ...
    private static final float ActiveIndicatorWidth = Dp.m7111constructorimpl((float) 64.0d);
    ...
    private static final float ContainerElevation = ElevationTokens.INSTANCE.m3197getLevel2D9Ej5fM();
    private static final float ContainerHeight = Dp.m7111constructorimpl((float) 80.0d);
