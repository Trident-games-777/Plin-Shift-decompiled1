...
final class NavigationItemKt$placeLabelAndStartIcon$1 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    ...
    NavigationItemKt$placeLabelAndStartIcon$1(Placeable placeable, int i, int i2, Placeable placeable2, int i3, int i4, Placeable placeable3, int i5, int i6, Placeable placeable4, int i7, int i8) {
        super(1);
