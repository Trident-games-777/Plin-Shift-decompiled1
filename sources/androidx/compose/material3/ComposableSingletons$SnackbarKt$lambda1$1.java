...
final class ComposableSingletons$SnackbarKt$lambda1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            IconKt.m2124Iconww6aTOc(close, Strings_androidKt.m2992getString2EP1pXo(Strings.m2922constructorimpl(R.string.m3c_snackbar_dismiss), composer, 0), (Modifier) null, 0, composer, 0, 12);
            if (ComposerKt.isTraceInProgress()) {
