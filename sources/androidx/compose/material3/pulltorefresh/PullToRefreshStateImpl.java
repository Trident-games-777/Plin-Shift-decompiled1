...
public final class PullToRefreshStateImpl implements PullToRefreshState {
    ...
    public static final Saver<PullToRefreshStateImpl, Float> Saver = SaverKt.Saver(PullToRefreshStateImpl$Companion$Saver$1.INSTANCE, PullToRefreshStateImpl$Companion$Saver$2.INSTANCE);
    /* access modifiers changed from: private */
    ...
    public Object animateToThreshold(Continuation<? super Unit> continuation) {
        Object animateTo$default = Animatable.animateTo$default(this.anim, Boxing.boxFloat(1.0f), (AnimationSpec) null, (Object) null, (Function1) null, continuation, 14, (Object) null);
    ...
    public Object animateToHidden(Continuation<? super Unit> continuation) {
        Object animateTo$default = Animatable.animateTo$default(this.anim, Boxing.boxFloat(0.0f), (AnimationSpec) null, (Object) null, (Function1) null, continuation, 14, (Object) null);
        if (animateTo$default == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
            return animateTo$default;
        }
        return Unit.INSTANCE;
