...
public final class InputIdentifier {
    ...
    public static final int EndDateInput = m2142constructorimpl(2);
    /* access modifiers changed from: private */
    public static final int SingleDateInput = m2142constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int StartDateInput = m2142constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ InputIdentifier m2141boximpl(int i) {
        return new InputIdentifier(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m2142constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2143equalsimpl(int i, Object obj) {
        return (obj instanceof InputIdentifier) && i == ((InputIdentifier) obj).m2147unboximpl();
    }
    ...
    public int hashCode() {
        return m2145hashCodeimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m2147unboximpl() {
        return this.value;
    }
    ...
    public static String m2146toStringimpl(int i) {
        if (m2144equalsimpl0(i, SingleDateInput)) {
            return "SingleDateInput";
        }
        if (m2144equalsimpl0(i, StartDateInput)) {
            return "StartDateInput";
        }
        if (m2144equalsimpl0(i, EndDateInput)) {
            return "EndDateInput";
        }
        return "Unknown";
    }
