...
public final class ElevationKt {
    ...
    public static /* synthetic */ Object m2917animateElevationrAjV9yQ$default(Animatable animatable, float f, Interaction interaction, Interaction interaction2, Continuation continuation, int i, Object obj) {
        if ((i & 2) != 0) {
            interaction = null;
        }
        if ((i & 4) != 0) {
        ...
        return m2916animateElevationrAjV9yQ(animatable, f, interaction, interaction2, continuation);
    }

    /* renamed from: animateElevation-rAjV9yQ  reason: not valid java name */
    public static final Object m2916animateElevationrAjV9yQ(Animatable<Dp, ?> animatable, float f, Interaction interaction, Interaction interaction2, Continuation<? super Unit> continuation) {
        ...
        if (animationSpec != null) {
            Object animateTo$default = Animatable.animateTo$default(animatable, Dp.m7109boximpl(f), animationSpec, (Object) null, (Function1) null, continuation, 12, (Object) null);
            if (animateTo$default == IntrinsicsKt.getCOROUTINE_SUSPENDED()) {
                return animateTo$default;
            }
            return Unit.INSTANCE;
        }
        Object snapTo = animatable.snapTo(Dp.m7109boximpl(f), continuation);
    ...
    static {
        ...
        HoveredOutgoingSpec = new TweenSpec<>(MenuKt.InTransitionDuration, 0, cubicBezierEasing, 2, (DefaultConstructorMarker) null);
    }
}
