...
public final class BasicTooltip_androidKt$BasicTooltipBox$2$1$invoke$$inlined$onDispose$1 implements DisposableEffectResult {
    final /* synthetic */ TooltipState $state$inlined;

    public BasicTooltip_androidKt$BasicTooltipBox$2$1$invoke$$inlined$onDispose$1(TooltipState tooltipState) {
        this.$state$inlined = tooltipState;
    }
