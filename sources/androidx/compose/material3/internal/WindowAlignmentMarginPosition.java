...
public final class WindowAlignmentMarginPosition {
    ...
    public static final class Horizontal implements MenuPosition.Horizontal {
        ...
        public int m3001position95KtPRI(IntRect intRect, long j, int i, LayoutDirection layoutDirection) {
            if (i >= IntSize.m7283getWidthimpl(j) - (this.margin * 2)) {
                return Alignment.Companion.getCenterHorizontally().align(i, IntSize.m7283getWidthimpl(j), layoutDirection);
            }
            return RangesKt.coerceIn(this.alignment.align(i, IntSize.m7283getWidthimpl(j), layoutDirection), this.margin, (IntSize.m7283getWidthimpl(j) - this.margin) - i);
        }
    }
    ...
    public static final class Vertical implements MenuPosition.Vertical {
        ...
        public int m3002positionJVtK1S4(IntRect intRect, long j, int i) {
            if (i >= IntSize.m7282getHeightimpl(j) - (this.margin * 2)) {
                return Alignment.Companion.getCenterVertically().align(i, IntSize.m7282getHeightimpl(j));
            }
            return RangesKt.coerceIn(this.alignment.align(i, IntSize.m7282getHeightimpl(j)), this.margin, (IntSize.m7282getHeightimpl(j) - this.margin) - i);
        }
    }
}
