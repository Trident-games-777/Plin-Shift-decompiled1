...
final class BasicTooltip_androidKt$TooltipPopup$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C148@5564L128,146@5501L235:BasicTooltip.android.kt#mqatfk");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(610617071, i, -1, "androidx.compose.material3.internal.TooltipPopup.<anonymous> (BasicTooltip.android.kt:146)");
            }
            Modifier modifier = Modifier.Companion;
            ComposerKt.sourceInformationMarkerStart(composer, 1377587702, "CC(remember):BasicTooltip.android.kt#9igjgp");
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -1900261851, "C153@5717L9:BasicTooltip.android.kt#mqatfk");
