...
final class TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C192@8136L35,192@8109L301:TextFieldImpl.kt#mqatfk");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1526229403, i, -1, "androidx.compose.material3.internal.CommonDecorationBox.<anonymous>.<anonymous> (TextFieldImpl.kt:192)");
            }
            Modifier modifier = Modifier.Companion;
            ComposerKt.sourceInformationMarkerStart(composer, -1325775517, "CC(remember):TextFieldImpl.kt#9igjgp");
            ...
            if (changed || rememberedValue == Composer.Companion.getEmpty()) {
                rememberedValue = new TextFieldImplKt$CommonDecorationBox$3$decoratedSuffix$1$1$1(state);
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -1244476505, "C193@8199L189:TextFieldImpl.kt#mqatfk");
