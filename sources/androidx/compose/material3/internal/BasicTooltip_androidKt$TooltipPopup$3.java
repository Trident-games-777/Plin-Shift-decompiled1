...
final class BasicTooltip_androidKt$TooltipPopup$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    BasicTooltip_androidKt$TooltipPopup$3(PopupPositionProvider popupPositionProvider, TooltipState tooltipState, CoroutineScope coroutineScope, boolean z, Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
