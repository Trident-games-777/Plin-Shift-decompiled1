...
final class LabelKt$Label$wrappedContent$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C83@3656L87:Label.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1950723216, i, -1, "androidx.compose.material3.Label.<anonymous> (Label.kt:83)");
            }
            final Ref.ObjectRef<MutableState<LayoutCoordinates>> objectRef = this.$anchorBounds;
            Modifier onGloballyPositioned = OnGloballyPositionedModifierKt.onGloballyPositioned(Modifier.Companion, new Function1<LayoutCoordinates, Unit>() {
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -90340533, "C83@3732L9:Label.kt#uh7d8r");
