...
public final class SearchBarColors {
    ...
    private SearchBarColors(long j, long j2) {
        this(j, j2, SearchBar_androidKt.UnspecifiedTextFieldColors, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m4240equalsimpl0(this.containerColor, searchBarColors.containerColor) && Color.m4240equalsimpl0(this.dividerColor, searchBarColors.dividerColor) && Intrinsics.areEqual((Object) this.inputFieldColors, (Object) searchBarColors.inputFieldColors);
    }

    public int hashCode() {
        return (((Color.m4246hashCodeimpl(this.containerColor) * 31) + Color.m4246hashCodeimpl(this.dividerColor)) * 31) + this.inputFieldColors.hashCode();
    }
}
