...
final class CardKt$Card$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    CardKt$Card$3(Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(776921067, i, -1, "androidx.compose.material3.Card.<anonymous> (Card.kt:161)");
            }
