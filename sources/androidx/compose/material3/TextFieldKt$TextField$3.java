    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i2 & 3) != 2 || !composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1163788208, i2, -1, "androidx.compose.material3.TextField.<anonymous> (TextField.kt:387)");
            }
            ...
            final TextFieldValue textFieldValue8 = this.$value;
            ...
            AnonymousClass1 r2 = new Function3<Function2<? super Composer, ? super Integer, ? extends Unit>, Composer, Integer, Unit>() {
                ...
                public final void invoke(Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
                    int i2;
                    Composer composer2 = composer;
                    ComposerKt.sourceInformation(composer2, "C411@21680L816:TextField.kt#uh7d8r");
            ...
            BasicTextFieldKt.BasicTextField(textFieldValue7, (Function1<? super TextFieldValue, Unit>) function13, r3, z2, z3, textStyle, keyboardOptions, keyboardActions, z4, i3, i4, visualTransformation, (Function1<? super TextLayoutResult, Unit>) null, mutableInteractionSource, (Brush) solidColor6, (Function3<? super Function2<? super Composer, ? super Integer, Unit>, ? super Composer, ? super Integer, Unit>) ComposableLambdaKt.rememberComposableLambda(1751957978, true, r2, composer2, 54), composer3, 0, (int) ProfileVerifier.CompilationStatus.RESULT_CODE_ERROR_CANT_WRITE_PROFILE_VERIFICATION_RESULT_CACHE_FILE, 4096);
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventEnd();
                return;
            }
