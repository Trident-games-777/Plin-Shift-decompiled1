...
final class SwitchKt$Switch$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    SwitchKt$Switch$1(boolean z, Function1<? super Boolean, Unit> function1, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function2, boolean z2, SwitchColors switchColors, MutableInteractionSource mutableInteractionSource, int i, int i2) {
        super(2);
        this.$checked = z;
