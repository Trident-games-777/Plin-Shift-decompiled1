...
final class TabRowKt$SecondaryScrollableTabRow$1 extends Lambda implements Function3<TabIndicatorScope, Composer, Integer, Unit> {
    ...
    public final void invoke(TabIndicatorScope tabIndicatorScope, Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C433@22217L121:TabRow.kt#uh7d8r");
        if ((i & 6) == 0) {
            i |= (i & 8) == 0 ? composer.changed((Object) tabIndicatorScope) : composer.changedInstance(tabIndicatorScope) ? 4 : 2;
        }
        if ((i & 19) != 18 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1535842470, i, -1, "androidx.compose.material3.SecondaryScrollableTabRow.<anonymous> (TabRow.kt:433)");
            }
