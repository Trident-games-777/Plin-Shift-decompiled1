...
public final class CarouselKt$Carousel$1$clipShape$1$1 implements Shape {
    ...
    CarouselKt$Carousel$1$clipShape$1$1(CarouselItemInfoImpl carouselItemInfoImpl) {
        this.$carouselItemInfo = carouselItemInfoImpl;
    }

    /* renamed from: createOutline-Pq9zytI  reason: not valid java name */
    public Outline m2897createOutlinePq9zytI(long j, LayoutDirection layoutDirection, Density density) {
