...
public final class CarouselDefaults {
    ...
    private static final float AnchorSize = Dp.m7111constructorimpl((float) 10);
    public static final CarouselDefaults INSTANCE = new CarouselDefaults();
    private static final float MaxSmallItemSize = Dp.m7111constructorimpl((float) 56);
    public static final float MediumLargeItemDiffThreshold = 0.85f;
    private static final float MinSmallItemSize = Dp.m7111constructorimpl((float) 40);
    ...
    public final TargetedFlingBehavior singleAdvanceFlingBehavior(CarouselState carouselState, AnimationSpec<Float> animationSpec, Composer composer, int i, int i2) {
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(1701587199, i3, -1, "androidx.compose.material3.carousel.CarouselDefaults.singleAdvanceFlingBehavior (Carousel.kt:611)");
        }
        TargetedFlingBehavior flingBehavior = PagerDefaults.INSTANCE.flingBehavior(carouselState.getPagerState$material3_release(), PagerSnapDistance.Companion.atMost(1), (DecayAnimationSpec<Float>) null, animationSpec2, 0.0f, composer, ((i3 << 6) & 7168) | (PagerDefaults.$stable << 15), 20);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public final TargetedFlingBehavior multiBrowseFlingBehavior(CarouselState carouselState, DecayAnimationSpec<Float> decayAnimationSpec, AnimationSpec<Float> animationSpec, Composer composer, int i, int i2) {
        ...
        AnimationSpec<Float> spring$default = (i2 & 4) != 0 ? AnimationSpecKt.spring$default(0.0f, 400.0f, (Object) null, 5, (Object) null) : animationSpec;
        if (ComposerKt.isTraceInProgress()) {
        ...
        CarouselDefaults$multiBrowseFlingBehavior$pagerSnapDistance$1 carouselDefaults$multiBrowseFlingBehavior$pagerSnapDistance$1 = new CarouselDefaults$multiBrowseFlingBehavior$pagerSnapDistance$1();
        TargetedFlingBehavior flingBehavior = PagerDefaults.INSTANCE.flingBehavior(carouselState.getPagerState$material3_release(), carouselDefaults$multiBrowseFlingBehavior$pagerSnapDistance$1, rememberSplineBasedDecay, spring$default, 0.0f, composer, (PagerDefaults.$stable << 15) | ((i << 3) & 8064), 16);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public final TargetedFlingBehavior noSnapFlingBehavior(Composer composer, int i) {
        ...
        if (rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = new CarouselDefaults$noSnapFlingBehavior$decayLayoutInfoProvider$1$1();
