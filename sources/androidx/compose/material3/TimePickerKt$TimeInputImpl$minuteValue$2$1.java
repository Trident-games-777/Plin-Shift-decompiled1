...
final class TimePickerKt$TimeInputImpl$minuteValue$2$1 extends Lambda implements Function0<MutableState<TextFieldValue>> {
    ...
    public final MutableState<TextFieldValue> invoke() {
        return SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(new TextFieldValue(CalendarLocale_jvmKt.toLocalString$default(this.$state.getMinute(), 2, 0, false, 6, (Object) null), 0, (TextRange) null, 6, (DefaultConstructorMarker) null), (SnapshotMutationPolicy) null, 2, (Object) null);
    }
}
