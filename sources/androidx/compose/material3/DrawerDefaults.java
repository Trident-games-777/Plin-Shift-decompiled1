...
public final class DrawerDefaults {
    ...
    private static final float DismissibleDrawerElevation = NavigationDrawerTokens.INSTANCE.m3350getStandardContainerElevationD9Ej5fM();
    public static final DrawerDefaults INSTANCE = new DrawerDefaults();
    private static final float MaximumDrawerWidth = NavigationDrawerTokens.INSTANCE.m3347getContainerWidthD9Ej5fM();
    private static final float ModalDrawerElevation = ElevationTokens.INSTANCE.m3195getLevel0D9Ej5fM();
    private static final float PermanentDrawerElevation = NavigationDrawerTokens.INSTANCE.m3350getStandardContainerElevationD9Ej5fM();
    ...
    public final float m2037getMaximumDrawerWidthD9Ej5fM() {
    ...
    public final WindowInsets getWindowInsets(Composer composer, int i) {
        ...
        WindowInsets r5 = WindowInsetsKt.m874onlybOOhFvg(SystemBarsDefaultInsets_androidKt.getSystemBarsForVisualComponents(WindowInsets.Companion, composer, 6), WindowInsetsSides.m888plusgK_yJZ4(WindowInsetsSides.Companion.m903getVerticalJoeWqyM(), WindowInsetsSides.Companion.m901getStartJoeWqyM()));
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
