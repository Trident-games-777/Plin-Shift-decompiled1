...
final class DateRangePickerKt$DateRangePicker$6 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    DateRangePickerKt$DateRangePicker$6(DateRangePickerState dateRangePickerState, Modifier modifier, DatePickerFormatter datePickerFormatter, Function2<? super Composer, ? super Integer, Unit> function2, Function2<? super Composer, ? super Integer, Unit> function22, boolean z, DatePickerColors datePickerColors, int i, int i2) {
        super(2);
