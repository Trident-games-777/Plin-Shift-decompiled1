...
final class IconButtonKt$OutlinedIconToggleButton$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    IconButtonKt$OutlinedIconToggleButton$2(Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C572@27133L174:IconButton.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1207657396, i, -1, "androidx.compose.material3.OutlinedIconToggleButton.<anonymous> (IconButton.kt:572)");
            }
            Modifier r10 = SizeKt.m845size3ABfNKs(Modifier.Companion, OutlinedIconButtonTokens.INSTANCE.m3376getContainerSizeD9Ej5fM());
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 278710712, "C576@27288L9:IconButton.kt#uh7d8r");
