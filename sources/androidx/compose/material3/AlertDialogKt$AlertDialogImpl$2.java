...
final class AlertDialogKt$AlertDialogImpl$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    AlertDialogKt$AlertDialogImpl$2(Function0<Unit> function0, Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, Function2<? super Composer, ? super Integer, Unit> function22, Function2<? super Composer, ? super Integer, Unit> function23, Function2<? super Composer, ? super Integer, Unit> function24, Function2<? super Composer, ? super Integer, Unit> function25, Shape shape, long j, long j2, long j3, long j4, float f, DialogProperties dialogProperties, int i, int i2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ...
        long j5 = j4;
        float f2 = f;
        AlertDialogKt.m1706AlertDialogImplwrnwzgE(function02, function27, modifier, function22, function23, function24, function25, shape, j, j2, j3, j5, f2, dialogProperties2, composer, RecomposeScopeImplKt.updateChangedFlags(this.$$changed | 1), RecomposeScopeImplKt.updateChangedFlags(this.$$changed1));
    }
}
