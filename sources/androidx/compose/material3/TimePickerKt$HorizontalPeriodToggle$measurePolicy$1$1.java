...
final class TimePickerKt$HorizontalPeriodToggle$measurePolicy$1$1 implements MeasurePolicy {
    ...
    public final MeasureResult m2734measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), (Object) "Spacer")) {
                ...
                final Placeable r1 = measurable.m5848measureBRTryo0(Constraints.m7043copyZbe2FdA$default(j, 0, measureScope2.m7086roundToPx0680j_4(TimePickerTokens.INSTANCE.m3568getPeriodSelectorOutlineWidthD9Ej5fM()), 0, 0, 12, (Object) null));
                ...
                for (int i3 = 0; i3 < size3; i3++) {
                    arrayList2.add(((Measurable) list3.get(i3)).m5848measureBRTryo0(Constraints.m7043copyZbe2FdA$default(j, 0, Constraints.m7052getMaxWidthimpl(j) / 2, 0, 0, 12, (Object) null)));
                }
                ...
                return MeasureScope.layout$default(measureScope2, Constraints.m7052getMaxWidthimpl(j), Constraints.m7051getMaxHeightimpl(j), (Map) null, new Function1<Placeable.PlacementScope, Unit>() {
                    ...
                    public final void invoke(Placeable.PlacementScope placementScope) {
                        ...
                        Placeable.PlacementScope.place$default(placementScope2, list4.get(1), list4.get(0).getWidth(), 0, 0.0f, 4, (Object) null);
                        Placeable.PlacementScope.place$default(placementScope2, r1, list4.get(0).getWidth() - (r1.getWidth() / 2), 0, 0.0f, 4, (Object) null);
                    }
                }, 4, (Object) null);
            }
        }
