...
final class DatePickerKt$DatePicker$4 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C201@9419L50,198@9209L283:DatePicker.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1982226759, i, -1, "androidx.compose.material3.DatePicker.<anonymous> (DatePicker.kt:198)");
            }
            Modifier padding = PaddingKt.padding(Modifier.Companion, DatePickerKt.getDatePickerModeTogglePadding());
            int r0 = this.$state.m1994getDisplayModejFl4v0();
            ComposerKt.sourceInformationMarkerStart(composer, -2079723184, "CC(remember):DatePicker.kt#9igjgp");
