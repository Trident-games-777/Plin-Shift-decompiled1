...
final class SliderDefaults$Track$12 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    SliderDefaults$Track$12(SliderDefaults sliderDefaults, RangeSliderState rangeSliderState, Modifier modifier, boolean z, SliderColors sliderColors, Function2<? super DrawScope, ? super Offset, Unit> function2, Function3<? super DrawScope, ? super Offset, ? super Color, Unit> function3, float f, float f2, int i, int i2) {
        super(2);
