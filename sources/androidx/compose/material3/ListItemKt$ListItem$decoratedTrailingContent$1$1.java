...
final class ListItemKt$ListItem$decoratedTrailingContent$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C145@6087L321:ListItem.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1512306332, i, -1, "androidx.compose.material3.ListItem.<anonymous>.<anonymous> (ListItem.kt:145)");
            }
            Modifier r10 = PaddingKt.m779paddingqDBjuR0$default(Modifier.Companion, ListItemKt.getTrailingContentStartPadding(), 0.0f, 0.0f, 0.0f, 14, (Object) null);
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 690581204, "C146@6168L222:ListItem.kt#uh7d8r");
            Composer composer2 = composer;
            ListItemKt.m2170ProvideTextStyleFromToken3JVO9M(listItemColors.m2166trailingIconColorvNxB06k$material3_release(true), ListTokens.INSTANCE.getListItemTrailingSupportingTextFont(), function2, composer2, 48);
