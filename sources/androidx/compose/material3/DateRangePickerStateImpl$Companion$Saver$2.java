...
final class DateRangePickerStateImpl$Companion$Saver$2 extends Lambda implements Function1<List, DateRangePickerStateImpl> {
    ...
    public final DateRangePickerStateImpl invoke(List<? extends Object> list) {
        ...
        return new DateRangePickerStateImpl((Long) list.get(0), (Long) list.get(1), (Long) list.get(2), intRange, DisplayMode.m2024constructorimpl(((Integer) obj3).intValue()), this.$selectableDates, this.$locale, (DefaultConstructorMarker) null);
    }
}
