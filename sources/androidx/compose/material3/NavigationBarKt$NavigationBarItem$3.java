...
final class NavigationBarKt$NavigationBarItem$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    NavigationBarKt$NavigationBarItem$3(RowScope rowScope, boolean z, Function0<Unit> function0, Function2<? super Composer, ? super Integer, Unit> function2, Modifier modifier, boolean z2, Function2<? super Composer, ? super Integer, Unit> function22, boolean z3, NavigationBarItemColors navigationBarItemColors, MutableInteractionSource mutableInteractionSource, int i, int i2) {
        super(2);
