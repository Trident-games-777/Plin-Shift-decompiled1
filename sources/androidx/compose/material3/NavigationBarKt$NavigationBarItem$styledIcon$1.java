...
final class NavigationBarKt$NavigationBarItem$styledIcon$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C187@8623L201,193@9006L193:NavigationBar.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1419576100, i, -1, "androidx.compose.material3.NavigationBarItem.<anonymous> (NavigationBar.kt:186)");
            }
            Composer composer2 = composer;
            State<Color> r11 = SingleValueAnimationKt.m123animateColorAsStateeuL9pac(this.$colors.m2245iconColorWaAFU9c$material3_release(this.$selected, this.$enabled), AnimationSpecKt.tween$default(100, 0, (Easing) null, 6, (Object) null), (String) null, (Function1<? super Color, Unit>) null, composer2, 48, 12);
