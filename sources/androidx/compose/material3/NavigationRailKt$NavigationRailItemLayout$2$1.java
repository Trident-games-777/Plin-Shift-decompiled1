...
final class NavigationRailKt$NavigationRailItemLayout$2$1 implements MeasurePolicy {
    ...
    public final MeasureResult m2319measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        float f;
        Object obj;
        Placeable placeable;
        ...
        while (i < size) {
            ...
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), (Object) "icon")) {
                ...
                float f2 = (float) 2;
                int width = r5.getWidth() + measureScope2.m7086roundToPx0680j_4(Dp.m7111constructorimpl(NavigationRailKt.IndicatorHorizontalPadding * f2));
                ...
                int height = r5.getHeight() + measureScope2.m7086roundToPx0680j_4(Dp.m7111constructorimpl(f * f2));
                ...
                while (i2 < size2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), (Object) "indicatorRipple")) {
                        ...
                        placeable = null;
                        if (this.$label == null) {
                            return NavigationRailKt.m2317placeIconX9ElhV4(measureScope2, r5, r6, r7, j);
                        }
                        Intrinsics.checkNotNull(placeable);
                        return NavigationRailKt.m2318placeLabelAndIconzUg2_y0(measureScope, placeable, r5, r6, r7, j, this.$alwaysShowLabel, floatValue);
                    }
