...
final class AppBarKt$BottomAppBar$6 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C912@45018L348:AppBar.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1243053520, i, -1, "androidx.compose.material3.BottomAppBar.<anonymous> (AppBar.kt:912)");
            }
            Modifier padding = PaddingKt.padding(SizeKt.m831height3ABfNKs(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxWidth$default(Modifier.Companion, 0.0f, 1, (Object) null), this.$windowInsets), BottomAppBarTokens.INSTANCE.m3039getContainerHeightD9Ej5fM()), this.$contentPadding);
