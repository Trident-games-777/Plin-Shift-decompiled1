...
final class NavigationDrawerKt$DrawerSheet$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    NavigationDrawerKt$DrawerSheet$1(DrawerPredictiveBackState drawerPredictiveBackState, boolean z, WindowInsets windowInsets, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        Modifier modifier;
        ComposerKt.sourceInformation(composer, "C784@32654L319:NavigationDrawer.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(669057502, i, -1, "androidx.compose.material3.DrawerSheet.<anonymous> (NavigationDrawer.kt:780)");
            }
            if (this.$drawerPredictiveBackState != null) {
                modifier = NavigationDrawerKt.predictiveBackDrawerChild(Modifier.Companion, this.$drawerPredictiveBackState, this.$isRtl);
            } else {
                modifier = Modifier.Companion;
            }
            Modifier windowInsetsPadding = WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.m849sizeInqDBjuR0$default(Modifier.Companion, NavigationDrawerKt.MinimumDrawerWidth, 0.0f, DrawerDefaults.INSTANCE.m2037getMaximumDrawerWidthD9Ej5fM(), 0.0f, 10, (Object) null).then(modifier), this.$windowInsets);
