...
public final class NavigationBarArrangement {
    ...
    public static final int Centered = m2226constructorimpl(1);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int EqualWeight = m2226constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ NavigationBarArrangement m2225boximpl(int i) {
        return new NavigationBarArrangement(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m2226constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m2227equalsimpl(int i, Object obj) {
        return (obj instanceof NavigationBarArrangement) && i == ((NavigationBarArrangement) obj).m2231unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2228equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m2229hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    public boolean equals(Object obj) {
        return m2227equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2229hashCodeimpl(this.value);
    }
    ...
    public static String m2230toStringimpl(int i) {
        if (m2228equalsimpl0(i, EqualWeight)) {
            return "EqualWeight";
        }
        if (m2228equalsimpl0(i, Centered)) {
            return "Centered";
        }
        return "Unknown";
    }
