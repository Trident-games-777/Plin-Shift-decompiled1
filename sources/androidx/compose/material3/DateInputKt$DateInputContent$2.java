...
final class DateInputKt$DateInputContent$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ...
        int i2 = i;
        ComposerKt.sourceInformation(composer2, "C89@3929L47,87@3850L140:DateInput.kt#uh7d8r");
        if ((i2 & 3) != 2 || !composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1819015125, i2, -1, "androidx.compose.material3.DateInputContent.<anonymous> (DateInput.kt:87)");
            }
            String str = this.$labelText;
            Modifier modifier = Modifier.Companion;
            ComposerKt.sourceInformationMarkerStart(composer2, -49706674, "CC(remember):DateInput.kt#9igjgp");
