...
final class DatePickerKt$Year$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    DatePickerKt$Year$3(Modifier modifier, boolean z, boolean z2, Function0<Unit> function0, boolean z3, String str, DatePickerColors datePickerColors, Function2<? super Composer, ? super Integer, Unit> function2, int i) {
        super(2);
