...
final class NavigationRailKt$NavigationRail$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C124@5624L602:NavigationRail.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            Modifier selectableGroup = SelectableGroupKt.selectableGroup(PaddingKt.m777paddingVpY3zN4$default(SizeKt.m852widthInVpY3zN4$default(WindowInsetsPaddingKt.windowInsetsPadding(SizeKt.fillMaxHeight$default(Modifier.Companion, 0.0f, 1, (Object) null), this.$windowInsets), NavigationRailTokens.INSTANCE.m3354getContainerWidthD9Ej5fM(), 0.0f, 2, (Object) null), 0.0f, NavigationRailKt.getNavigationRailVerticalPadding(), 1, (Object) null));
            Alignment.Horizontal centerHorizontally = Alignment.Companion.getCenterHorizontally();
            Arrangement.HorizontalOrVertical r1 = Arrangement.INSTANCE.m623spacedBy0680j_4(NavigationRailKt.getNavigationRailVerticalPadding());
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 933375077, "C137@6207L9:NavigationRail.kt#uh7d8r");
            composer.startReplaceGroup(722845512);
            ComposerKt.sourceInformation(composer, "134@6103L8,135@6128L52");
            if (function3 != null) {
                function3.invoke(columnScope, composer, 6);
                SpacerKt.Spacer(SizeKt.m831height3ABfNKs(Modifier.Companion, NavigationRailKt.NavigationRailHeaderPadding), composer, 6);
            }
