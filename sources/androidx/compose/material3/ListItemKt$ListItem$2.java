...
final class ListItemKt$ListItem$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C163@6771L272:ListItem.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1502590376, i, -1, "androidx.compose.material3.ListItem.<anonymous> (ListItem.kt:163)");
            }
