...
final class SliderKt$RangeSlider$1 extends Lambda implements Function3<RangeSliderState, Composer, Integer, Unit> {
    ...
    public final void invoke(RangeSliderState rangeSliderState, Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C424@19428L147:Slider.kt#uh7d8r");
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-811582901, i, -1, "androidx.compose.material3.RangeSlider.<anonymous> (Slider.kt:424)");
        }
        SliderDefaults.INSTANCE.m2481Thumb9LiSoMs(this.$startInteractionSource, (Modifier) null, this.$colors, this.$enabled, 0, composer, 196614, 18);
        if (ComposerKt.isTraceInProgress()) {
