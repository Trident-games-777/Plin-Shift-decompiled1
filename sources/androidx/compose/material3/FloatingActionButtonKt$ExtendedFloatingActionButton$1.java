...
final class FloatingActionButtonKt$ExtendedFloatingActionButton$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    FloatingActionButtonKt$ExtendedFloatingActionButton$1(Function3<? super RowScope, ? super Composer, ? super Integer, Unit> function3) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C301@14357L319:FloatingActionButton.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(398457247, i, -1, "androidx.compose.material3.ExtendedFloatingActionButton.<anonymous> (FloatingActionButton.kt:301)");
            }
            Modifier r11 = PaddingKt.m777paddingVpY3zN4$default(SizeKt.m849sizeInqDBjuR0$default(Modifier.Companion, FloatingActionButtonKt.ExtendedFabMinimumWidth, 0.0f, 0.0f, 0.0f, 14, (Object) null), FloatingActionButtonKt.ExtendedFabTextPadding, 0.0f, 2, (Object) null);
            ...
            Modifier materializeModifier = ComposedModifierKt.materializeModifier(composer, r11);
