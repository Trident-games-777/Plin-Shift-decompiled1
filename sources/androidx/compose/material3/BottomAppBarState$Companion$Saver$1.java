...
final class BottomAppBarState$Companion$Saver$1 extends Lambda implements Function2<SaverScope, BottomAppBarState, List<? extends Float>> {
    ...
    public final List<Float> invoke(SaverScope saverScope, BottomAppBarState bottomAppBarState) {
        return CollectionsKt.listOf(Float.valueOf(bottomAppBarState.getHeightOffsetLimit()), Float.valueOf(bottomAppBarState.getHeightOffset()), Float.valueOf(bottomAppBarState.getContentOffset()));
    }
}
