...
final class SearchBarDefaults$InputField$4$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    SearchBarDefaults$InputField$4$1$1(Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C551@26198L60:SearchBar.android.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1401341985, i, -1, "androidx.compose.material3.SearchBarDefaults.InputField.<anonymous>.<anonymous>.<anonymous> (SearchBar.android.kt:551)");
            }
            Modifier r10 = OffsetKt.m734offsetVpY3zN4$default(Modifier.Companion, SearchBar_androidKt.SearchBarIconOffsetX, 0.0f, 2, (Object) null);
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -127763558, "C551@26247L9:SearchBar.android.kt#uh7d8r");
