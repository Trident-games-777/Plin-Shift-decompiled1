...
final class RippleNodeFactory implements IndicationNodeFactory {
    ...
    public /* synthetic */ RippleNodeFactory(boolean z, float f, ColorProducer colorProducer2, DefaultConstructorMarker defaultConstructorMarker) {
        this(z, f, colorProducer2);
    }

    private RippleNodeFactory(boolean z, float f, ColorProducer colorProducer2, long j) {
        this.bounded = z;
        this.radius = f;
        this.colorProducer = colorProducer2;
        this.color = j;
    }

    private RippleNodeFactory(boolean z, float f, ColorProducer colorProducer2) {
        this(z, f, colorProducer2, Color.Companion.m4275getUnspecified0d7_KjU());
    }
    ...
    public DelegatableNode create(InteractionSource interactionSource) {
        ColorProducer colorProducer2 = this.colorProducer;
        if (colorProducer2 == null) {
            colorProducer2 = new RippleNodeFactory$create$colorProducer$1(this);
        }
        return new DelegatingThemeAwareRippleNode(interactionSource, this.bounded, this.radius, colorProducer2, (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (this.bounded == rippleNodeFactory.bounded && Dp.m7116equalsimpl0(this.radius, rippleNodeFactory.radius) && Intrinsics.areEqual((Object) this.colorProducer, (Object) rippleNodeFactory.colorProducer)) {
            return Color.m4240equalsimpl0(this.color, rippleNodeFactory.color);
        }
        return false;
    }

    public int hashCode() {
        int hashCode = ((Boolean.hashCode(this.bounded) * 31) + Dp.m7117hashCodeimpl(this.radius)) * 31;
        ColorProducer colorProducer2 = this.colorProducer;
        return ((hashCode + (colorProducer2 != null ? colorProducer2.hashCode() : 0)) * 31) + Color.m4246hashCodeimpl(this.color);
    }
}
