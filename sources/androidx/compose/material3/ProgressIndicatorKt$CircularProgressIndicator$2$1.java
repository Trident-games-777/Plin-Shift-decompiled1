...
final class ProgressIndicatorKt$CircularProgressIndicator$2$1 extends Lambda implements Function1<SemanticsPropertyReceiver, Unit> {
    final /* synthetic */ Function0<Float> $coercedProgress;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ProgressIndicatorKt$CircularProgressIndicator$2$1(Function0<Float> function0) {
        super(1);
