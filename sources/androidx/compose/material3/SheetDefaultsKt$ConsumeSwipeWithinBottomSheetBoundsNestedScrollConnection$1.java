...
public final class SheetDefaultsKt$ConsumeSwipeWithinBottomSheetBoundsNestedScrollConnection$1 implements NestedScrollConnection {
    ...
    public long m2460onPreScrollOzD1aCk(long j, int i) {
        float offsetToFloat = offsetToFloat(j);
        if (offsetToFloat >= 0.0f || !NestedScrollSource.m5469equalsimpl0(i, NestedScrollSource.Companion.m5481getUserInputWNlRxjI())) {
    ...
    public long m2458onPostScrollDzOQY0M(long j, long j2, int i) {
    ...
    public Object m2459onPreFlingQWom1Mo(long j, Continuation<? super Velocity> continuation) {
    ...
    public Object m2457onPostFlingRZ2iAVY(long j, long j2, Continuation<? super Velocity> continuation) {
