...
final class ListItemKt$ListItem$decoratedOverlineContent$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C124@5359L164:ListItem.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-764441232, i, -1, "androidx.compose.material3.ListItem.<anonymous>.<anonymous> (ListItem.kt:124)");
            }
            ListItemKt.m2170ProvideTextStyleFromToken3JVO9M(this.$colors.m2164overlineColor0d7_KjU$material3_release(), ListTokens.INSTANCE.getListItemOverlineFont(), this.$it, composer, 48);
            if (ComposerKt.isTraceInProgress()) {
