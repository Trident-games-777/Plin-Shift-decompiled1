...
final class ComposableSingletons$ModalBottomSheetKt$lambda2$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    public static final ComposableSingletons$ModalBottomSheetKt$lambda2$1 INSTANCE = new ComposableSingletons$ModalBottomSheetKt$lambda2$1();

    ComposableSingletons$ModalBottomSheetKt$lambda2$1() {
        super(2);
    }
