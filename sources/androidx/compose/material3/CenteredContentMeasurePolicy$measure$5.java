...
final class CenteredContentMeasurePolicy$measure$5 extends Lambda implements Function1<Placeable.PlacementScope, Unit> {
    final /* synthetic */ Ref.IntRef $barHorizontalPadding;
    final /* synthetic */ List<Placeable> $itemsPlaceables;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    CenteredContentMeasurePolicy$measure$5(Ref.IntRef intRef, List<? extends Placeable> list) {
        super(1);
        this.$barHorizontalPadding = intRef;
    ...
    public final void invoke(Placeable.PlacementScope placementScope) {
        int i = this.$barHorizontalPadding.element;
        ...
        while (i2 < size) {
            ...
            Placeable.PlacementScope.placeRelative$default(placementScope2, placeable, i3, 0, 0.0f, 4, (Object) null);
