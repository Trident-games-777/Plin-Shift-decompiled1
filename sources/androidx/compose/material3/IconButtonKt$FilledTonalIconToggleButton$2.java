...
final class IconButtonKt$FilledTonalIconToggleButton$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    IconButtonKt$FilledTonalIconToggleButton$2(Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C435@20487L314:IconButton.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -1171714300, "C443@20782L9:IconButton.kt#uh7d8r");
