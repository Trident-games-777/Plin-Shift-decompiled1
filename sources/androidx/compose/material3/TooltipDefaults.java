...
public final class TooltipDefaults {
    ...
    private static final long caretSize = DpKt.m7133DpSizeYgX7TsA(Dp.m7111constructorimpl((float) 16), Dp.m7111constructorimpl((float) 8));
    ...
    public final long m2847getCaretSizeMYxV2XQ() {
        return caretSize;
    }
    ...
    public final RichTooltipColors m2850richTooltipColorsro_MJ88(long j, long j2, long j3, long j4, Composer composer, int i, int i2) {
        Composer composer2 = composer;
        ComposerKt.sourceInformationMarkerStart(composer2, 1498555081, "C(richTooltipColors)P(1:c#ui.graphics.Color,2:c#ui.graphics.Color,3:c#ui.graphics.Color,0:c#ui.graphics.Color)274@11844L11:Tooltip.kt#uh7d8r");
        ...
        RichTooltipColors r1 = getDefaultRichTooltipColors$material3_release(MaterialTheme.INSTANCE.getColorScheme(composer2, 6)).m2379copyjRlVdoo(r6, r8, r10, r12);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
    ...
    public final PopupPositionProvider m2848rememberPlainTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
        ...
        ComposerKt.sourceInformationMarkerEnd(composer);
        int r3 = ((Density) consume).m7086roundToPx0680j_4(f);
    ...
    public final PopupPositionProvider m2849rememberRichTooltipPositionProviderkHDZbjc(float f, Composer composer, int i, int i2) {
