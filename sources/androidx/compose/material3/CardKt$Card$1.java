...
final class CardKt$Card$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C96@4269L25:Card.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(664103990, i, -1, "androidx.compose.material3.Card.<anonymous> (Card.kt:96)");
            }
