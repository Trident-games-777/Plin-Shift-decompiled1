...
final class SurfaceKt$Surface$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    SurfaceKt$Surface$3(Modifier modifier, Shape shape, long j, float f, BorderStroke borderStroke, boolean z, MutableInteractionSource mutableInteractionSource, boolean z2, Function0<Unit> function0, float f2, Function2<? super Composer, ? super Integer, Unit> function2) {
        super(2);
    ...
    public final void invoke(Composer composer, int i) {
        ...
        if ((i2 & 3) != 2 || !composer2.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1164547968, i2, -1, "androidx.compose.material3.Surface.<anonymous> (Surface.kt:312)");
            }
            ...
            Modifier r1 = SelectableKt.m1109selectableO2vRcR0$default(SurfaceKt.m2542surfaceXOJAsU(minimumInteractiveComponentSize, shape, r8, borderStroke, ((Density) consume).m7091toPx0680j_4(this.$shadowElevation)), this.$selected, this.$interactionSource, RippleKt.m2389rippleOrFallbackImplementation9IZ8Weo(false, 0.0f, 0, composer2, 0, 7), this.$enabled, (Role) null, this.$onClick, 16, (Object) null);
