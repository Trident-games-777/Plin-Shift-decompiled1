...
final class NavigationDrawerKt$ModalNavigationDrawer$2$4$1 extends Lambda implements Function1<Density, IntOffset> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return IntOffset.m7232boximpl(m2267invokeBjo55l4((Density) obj));
    }

    /* renamed from: invoke-Bjo55l4  reason: not valid java name */
    public final long m2267invokeBjo55l4(Density density) {
        float currentOffset = this.$drawerState.getCurrentOffset();
        if (Float.isNaN(currentOffset)) {
            return IntOffset.Companion.m7251getZeronOccac();
        }
        return IntOffsetKt.IntOffset(MathKt.roundToInt(currentOffset), 0);
    }
}
