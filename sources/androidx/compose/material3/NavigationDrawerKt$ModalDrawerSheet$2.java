...
final class NavigationDrawerKt$ModalDrawerSheet$2 extends Lambda implements Function3<DrawerPredictiveBackState, Composer, Integer, Unit> {
    ...
    NavigationDrawerKt$ModalDrawerSheet$2(WindowInsets windowInsets, Modifier modifier, Shape shape, long j, long j2, float f, Function3<? super ColumnScope, ? super Composer, ? super Integer, Unit> function3) {
        super(3);
    ...
    public final void invoke(DrawerPredictiveBackState drawerPredictiveBackState, Composer composer, int i) {
        ...
        ComposerKt.sourceInformation(composer, "C613@25207L254:NavigationDrawer.kt#uh7d8r");
        if ((i & 6) == 0) {
        ...
        if ((i2 & 19) != 18 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(1552342929, i2, -1, "androidx.compose.material3.ModalDrawerSheet.<anonymous> (NavigationDrawer.kt:613)");
            }
