...
final class TooltipKt$TooltipBox$wrappedContent$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C138@6034L27,138@5989L87:Tooltip.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1130808188, i, -1, "androidx.compose.material3.TooltipBox.<anonymous> (Tooltip.kt:138)");
            }
            Modifier modifier = Modifier.Companion;
            ComposerKt.sourceInformationMarkerStart(composer, -1741232635, "CC(remember):Tooltip.kt#9igjgp");
            MutableState<LayoutCoordinates> mutableState = this.$anchorBounds;
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 1844551025, "C138@6065L9:Tooltip.kt#uh7d8r");
