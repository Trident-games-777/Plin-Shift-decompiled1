...
final class TooltipStateImpl implements TooltipState {
    ...
    public Object show(MutatePriority mutatePriority, Continuation<? super Unit> continuation) {
        Object mutate = this.mutatorMutex.mutate(mutatePriority, new TooltipStateImpl$show$2(this, new TooltipStateImpl$show$cancellableShow$1(this, (Continuation<? super TooltipStateImpl$show$cancellableShow$1>) null), mutatePriority, (Continuation<? super TooltipStateImpl$show$2>) null), continuation);
