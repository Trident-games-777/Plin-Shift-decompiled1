...
final class ModalBottomSheet_androidKt$ModalBottomSheetDialog$dialog$1$1$1 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C296@12687L164:ModalBottomSheet.android.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-1560960657, i, -1, "androidx.compose.material3.ModalBottomSheetDialog.<anonymous>.<anonymous>.<anonymous> (ModalBottomSheet.android.kt:296)");
            }
            ...
            ComposerKt.sourceInformationMarkerStart(composer, -490070203, "C299@12809L16:ModalBottomSheet.android.kt#uh7d8r");
            ModalBottomSheet_androidKt.ModalBottomSheetDialog$lambda$0(state).invoke(composer, 0);
