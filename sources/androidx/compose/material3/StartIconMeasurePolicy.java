...
final class StartIconMeasurePolicy implements MeasurePolicy {
    ...
    public final float m2524getIndicatorHorizontalPaddingD9Ej5fM() {
        return this.indicatorHorizontalPadding;
    }

    /* renamed from: getIndicatorVerticalPadding-D9Ej5fM  reason: not valid java name */
    public final float m2525getIndicatorVerticalPaddingD9Ej5fM() {
        return this.indicatorVerticalPadding;
    }

    /* renamed from: getStartIconToLabelHorizontalPadding-D9Ej5fM  reason: not valid java name */
    public final float m2526getStartIconToLabelHorizontalPaddingD9Ej5fM() {
        return this.startIconToLabelHorizontalPadding;
    }

    /* renamed from: measure-3p2s80s  reason: not valid java name */
    public MeasureResult m2527measure3p2s80s(MeasureScope measureScope, List<? extends Measurable> list, long j) {
        MeasureScope measureScope2 = measureScope;
        List<? extends Measurable> list2 = list;
        float floatValue = this.animationProgress.invoke().floatValue();
        long r6 = Constraints.m7043copyZbe2FdA$default(j, 0, 0, 0, 0, 10, (Object) null);
        float f = (float) 2;
        long r9 = ConstraintsKt.m7071offsetNN6EwU(r6, -measureScope2.m7086roundToPx0680j_4(Dp.m7111constructorimpl(this.indicatorHorizontalPadding * f)), -measureScope2.m7086roundToPx0680j_4(Dp.m7111constructorimpl(this.indicatorVerticalPadding * f)));
        int size = list2.size();
        int i = 0;
        while (i < size) {
            Measurable measurable = (Measurable) list2.get(i);
            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable), (Object) "icon")) {
                Placeable r4 = measurable.m5848measureBRTryo0(r9);
                ...
                while (i2 < size2) {
                    ...
                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable2), (Object) Constants.ScionAnalytics.PARAM_LABEL)) {
                        Placeable r8 = measurable2.m5848measureBRTryo0(ConstraintsKt.m7072offsetNN6EwU$default(r9, -(r4.getWidth() + measureScope2.m7086roundToPx0680j_4(this.startIconToLabelHorizontalPadding)), 0, 2, (Object) null));
                        int width = r4.getWidth() + r8.getWidth() + measureScope2.m7086roundToPx0680j_4(Dp.m7111constructorimpl(this.startIconToLabelHorizontalPadding + Dp.m7111constructorimpl(this.indicatorHorizontalPadding * f)));
                        int max = Math.max(r4.getHeight(), r8.getHeight()) + measureScope2.m7086roundToPx0680j_4(Dp.m7111constructorimpl(this.indicatorVerticalPadding * f));
                        int roundToInt = MathKt.roundToInt(((float) width) * floatValue);
                        int size3 = list2.size();
                        int i3 = 0;
                        while (i3 < size3) {
                            Measurable measurable3 = (Measurable) list2.get(i3);
                            if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable3), (Object) "indicatorRipple")) {
                                Placeable r5 = measurable3.m5848measureBRTryo0(ConstraintsKt.m7067constrainN9IONVI(r6, Constraints.Companion.m7062fixedJhjzzOo(width, max)));
                                int size4 = list2.size();
                                int i4 = 0;
                                while (i4 < size4) {
                                    Measurable measurable4 = (Measurable) list2.get(i4);
                                    if (Intrinsics.areEqual(LayoutIdKt.getLayoutId(measurable4), (Object) "indicator")) {
                                        return NavigationItemKt.m2297placeLabelAndStartIconnru01g4(measureScope2, r8, r4, r5, measurable4.m5848measureBRTryo0(ConstraintsKt.m7067constrainN9IONVI(r6, Constraints.Companion.m7062fixedJhjzzOo(roundToInt, max))), j, this.startIconToLabelHorizontalPadding);
                                    }
                                    Placeable placeable = r4;
                                    Placeable placeable2 = r8;
                                    i4++;
                                    r4 = placeable;
                            ...
                            Placeable placeable3 = r4;
                            Placeable placeable4 = r8;
                            i3++;
                            r4 = placeable3;
                            measureScope2 = measureScope;
                        }
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable), (Object) "icon")) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    ...
                    if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable2), (Object) Constants.ScionAnalytics.PARAM_LABEL)) {
                        return maxIntrinsicWidth + intrinsicMeasurable2.maxIntrinsicWidth(i) + intrinsicMeasureScope.m7086roundToPx0680j_4(Dp.m7111constructorimpl(Dp.m7111constructorimpl(this.indicatorHorizontalPadding * ((float) 2)) + this.startIconToLabelHorizontalPadding));
                    }
                }
                throw new NoSuchElementException("Collection contains no element matching the predicate.");
            }
        ...
        for (int i2 = 0; i2 < size; i2++) {
            ...
            if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable), (Object) "icon")) {
                ...
                for (int i3 = 0; i3 < size2; i3++) {
                    IntrinsicMeasurable intrinsicMeasurable2 = (IntrinsicMeasurable) list.get(i3);
                    if (Intrinsics.areEqual(TextFieldImplKt.getLayoutId(intrinsicMeasurable2), (Object) Constants.ScionAnalytics.PARAM_LABEL)) {
                        return Math.max(maxIntrinsicHeight, intrinsicMeasurable2.maxIntrinsicHeight(i)) + intrinsicMeasureScope.m7086roundToPx0680j_4(Dp.m7111constructorimpl(this.indicatorVerticalPadding * ((float) 2)));
                    }
                }
                throw new NoSuchElementException("Collection contains no element matching the predicate.");
            }
