...
final class DatePickerKt$Day$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    public final void invoke(Composer composer, int i) {
        ComposerKt.sourceInformation(composer, "C1960@88518L303:DatePicker.kt#uh7d8r");
        if ((i & 3) != 2 || !composer.getSkipping()) {
            if (ComposerKt.isTraceInProgress()) {
                ComposerKt.traceEventStart(-2031780827, i, -1, "androidx.compose.material3.Day.<anonymous> (DatePicker.kt:1960)");
            }
            Modifier r10 = SizeKt.m839requiredSizeVpY3zN4(Modifier.Companion, DatePickerModalTokens.INSTANCE.m3167getDateStateLayerWidthD9Ej5fM(), DatePickerModalTokens.INSTANCE.m3166getDateStateLayerHeightD9Ej5fM());
            ...
            ComposerKt.sourceInformationMarkerStart(composer, 2117902499, "C1968@88802L9:DatePicker.kt#uh7d8r");
