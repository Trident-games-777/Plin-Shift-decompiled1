...
public final class TimePickerLayoutType {
    ...
    public static final int Horizontal = m2739constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Vertical = m2739constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ TimePickerLayoutType m2738boximpl(int i) {
    ...
    public static boolean m2740equalsimpl(int i, Object obj) {
        return (obj instanceof TimePickerLayoutType) && i == ((TimePickerLayoutType) obj).m2744unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m2741equalsimpl0(int i, int i2) {
        return i == i2;
    }
    ...
    public boolean equals(Object obj) {
        return m2740equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m2742hashCodeimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m2744unboximpl() {
        return this.value;
    }
    ...
    public static final class Companion {
        ...
        public final int m2745getHorizontalQJTpgSE() {
            return TimePickerLayoutType.Horizontal;
        }

        /* renamed from: getVertical-QJTpgSE  reason: not valid java name */
        public final int m2746getVerticalQJTpgSE() {
            return TimePickerLayoutType.Vertical;
        }
    }

    public String toString() {
        return m2743toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m2743toStringimpl(int i) {
        if (m2741equalsimpl0(i, Horizontal)) {
            return "Horizontal";
        }
        if (m2741equalsimpl0(i, Vertical)) {
            return "Vertical";
        }
        return "Unknown";
    }
