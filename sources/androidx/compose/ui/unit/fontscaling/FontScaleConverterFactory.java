...
public final class FontScaleConverterFactory {
    ...
    private final float getScaleFromKey(int i) {
        return ((float) i) / ScaleKeyMultiplier;
    }
    ...
    public final FontScaleConverter forScale(float f) {
        ...
        float f3 = f;
        FontScaleConverter createInterpolatedTableBetween = createInterpolatedTableBetween(fontScaleConverter, sLookupTables.valueAt(i), MathUtils.INSTANCE.constrainedMap(0.0f, 1.0f, f2, getScaleFromKey(sLookupTables.keyAt(i)), f3));
