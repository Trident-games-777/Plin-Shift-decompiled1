...
public final class IntRectKt {
    ...
    public static final IntRect m7273IntRectVbeCjmY(long j, long j2) {
        return new IntRect(IntOffset.m7241getXimpl(j), IntOffset.m7242getYimpl(j), IntOffset.m7241getXimpl(j) + IntSize.m7283getWidthimpl(j2), IntOffset.m7242getYimpl(j) + IntSize.m7282getHeightimpl(j2));
    }

    /* renamed from: IntRect-E1MhUcY  reason: not valid java name */
    public static final IntRect m7272IntRectE1MhUcY(long j, long j2) {
        return new IntRect(IntOffset.m7241getXimpl(j), IntOffset.m7242getYimpl(j), IntOffset.m7241getXimpl(j2), IntOffset.m7242getYimpl(j2));
    }

    /* renamed from: IntRect-ar5cAso  reason: not valid java name */
    public static final IntRect m7274IntRectar5cAso(long j, int i) {
        return new IntRect(IntOffset.m7241getXimpl(j) - i, IntOffset.m7242getYimpl(j) - i, IntOffset.m7241getXimpl(j) + i, IntOffset.m7242getYimpl(j) + i);
    }
