...
public interface FontScaling {
    ...
    public static final class DefaultImpls {
        ...
        public static long m7225toSp0xMU5do(FontScaling fontScaling, float f) {
            return FontScaling.super.m7223toSp0xMU5do(f);
        }

        @Deprecated
        /* renamed from: toDp-GaN1DYA  reason: not valid java name */
        public static float m7224toDpGaN1DYA(FontScaling fontScaling, long j) {
            return FontScaling.super.m7222toDpGaN1DYA(j);
        }
    }

    /* renamed from: toSp-0xMU5do  reason: not valid java name */
    long m7223toSp0xMU5do(float f) {
    ...
    float m7222toDpGaN1DYA(long j) {
        ...
        FontScaleConverter forScale = FontScaleConverterFactory.INSTANCE.forScale(getFontScale());
        float r5 = TextUnit.m7306getValueimpl(j);
        return forScale == null ? Dp.m7111constructorimpl(r5 * getFontScale()) : Dp.m7111constructorimpl(forScale.convertSpToDp(r5));
    }
}
