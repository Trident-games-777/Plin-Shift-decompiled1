    ...
    public static final void populateViewStructure(AndroidAutofill androidAutofill, ViewStructure viewStructure) {
        ...
        for (Map.Entry next : androidAutofill.getAutofillTree().getChildren().entrySet()) {
            ...
            if (newChild != null) {
                ...
                AutofillApi26Helper.INSTANCE.setAutofillType(newChild, ContentDataType.Companion.m3845getTextA48pgw8());
                ...
                if (boundingBox == null) {
                    ...
                    AutofillApi23Helper.INSTANCE.setDimens(newChild, round, round2, 0, 0, Math.round(boundingBox.getRight()) - round, Math.round(boundingBox.getBottom()) - round2);
                }
            }
            addChildCount++;
        }
