...
final class ComposedModifierKt$materializeImpl$result$1 extends Lambda implements Function2<Modifier, Modifier.Element, Modifier> {
    final /* synthetic */ Composer $this_materializeImpl;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    ComposedModifierKt$materializeImpl$result$1(Composer composer) {
        super(2);
    ...
    public final Modifier invoke(Modifier modifier, Modifier.Element element) {
        ...
        if (element instanceof ComposedModifier) {
            ...
            modifier2 = ComposedModifierKt.materializeImpl(this.$this_materializeImpl, (Modifier) ((Function3) TypeIntrinsics.beforeCheckcastToFunctionOfArity(factory, 3)).invoke(Modifier.Companion, this.$this_materializeImpl, 0));
        } else {
            modifier2 = element;
        }
