...
public final class BiasAlignment implements Alignment {
    ...
    public long m3821alignKFBX0sM(long j, long j2, LayoutDirection layoutDirection) {
        float f;
        float r0 = ((float) (IntSize.m7283getWidthimpl(j2) - IntSize.m7283getWidthimpl(j))) / 2.0f;
        float r3 = ((float) (IntSize.m7282getHeightimpl(j2) - IntSize.m7282getHeightimpl(j))) / 2.0f;
        ...
        float f2 = (float) 1;
        return IntOffsetKt.IntOffset(Math.round(r0 * (f + f2)), Math.round(r3 * (f2 + this.verticalBias)));
    }
    ...
    public static final class Horizontal implements Alignment.Horizontal {
        ...
        public int align(int i, int i2, LayoutDirection layoutDirection) {
            return Math.round((((float) (i2 - i)) / 2.0f) * (((float) 1) + (layoutDirection == LayoutDirection.Ltr ? this.bias : ((float) -1) * this.bias)));
        }
    }
    ...
    public static final class Vertical implements Alignment.Vertical {
        ...
        public int align(int i, int i2) {
            return Math.round((((float) (i2 - i)) / 2.0f) * (((float) 1) + this.bias));
        }
    }
}
