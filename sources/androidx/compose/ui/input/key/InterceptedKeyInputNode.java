...
final class InterceptedKeyInputNode extends Modifier.Node implements SoftKeyboardInterceptionModifierNode {
    ...
    public boolean m5117onInterceptKeyBeforeSoftKeyboardZmokQxo(KeyEvent keyEvent) {
        Function1<? super KeyEvent, Boolean> function1 = this.onEvent;
        if (function1 != null) {
            return function1.invoke(KeyEvent.m5413boximpl(keyEvent)).booleanValue();
        }
        return false;
    }

    /* renamed from: onPreInterceptKeyBeforeSoftKeyboard-ZmokQxo  reason: not valid java name */
    public boolean m5118onPreInterceptKeyBeforeSoftKeyboardZmokQxo(KeyEvent keyEvent) {
