...
public final class ProcessResult {
    ...
    public static final /* synthetic */ ProcessResult m5674boximpl(int i) {
    ...
    public static boolean m5676equalsimpl(int i, Object obj) {
        return (obj instanceof ProcessResult) && i == ((ProcessResult) obj).m5682unboximpl();
    }
    ...
    public static final boolean m5678getAnyMovementConsumedimpl(int i) {
        return (i & 2) != 0;
    }

    /* renamed from: getDispatchedToAPointerInputModifier-impl  reason: not valid java name */
    public static final boolean m5679getDispatchedToAPointerInputModifierimpl(int i) {
        return (i & 1) != 0;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m5680hashCodeimpl(int i) {
        return Integer.hashCode(i);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m5681toStringimpl(int i) {
        return "ProcessResult(value=" + i + ')';
    }

    public boolean equals(Object obj) {
        return m5676equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m5680hashCodeimpl(this.value);
    }

    public String toString() {
        return m5681toStringimpl(this.value);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ int m5682unboximpl() {
        return this.value;
    }
