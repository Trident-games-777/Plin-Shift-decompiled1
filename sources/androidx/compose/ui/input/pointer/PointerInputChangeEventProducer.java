...
final class PointerInputChangeEventProducer {
    ...
    public final InternalPointerEvent produce(PointerInputEvent pointerInputEvent, PositionCalculator positionCalculator) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            PointerInputData pointerInputData = this.previousPointerInputData.get(pointerInputEventData.m5602getIdJ3iCeTQ());
            if (pointerInputData == null) {
                z = false;
                j2 = pointerInputEventData.getUptime();
                j = pointerInputEventData.m5604getPositionF1C5BW0();
                ...
                j = positionCalculator.m5673screenToLocalMKHz9U(pointerInputData.m5592getPositionOnScreenF1C5BW0());
            }
            longSparseArray.put(pointerInputEventData.m5602getIdJ3iCeTQ(), new PointerInputChange(pointerInputEventData.m5602getIdJ3iCeTQ(), pointerInputEventData.getUptime(), pointerInputEventData.m5604getPositionF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.getPressure(), j2, j, z, false, pointerInputEventData.m5607getTypeT8wyACA(), pointerInputEventData.getHistorical(), pointerInputEventData.m5606getScrollDeltaF1C5BW0(), pointerInputEventData.m5603getOriginalEventPositionF1C5BW0(), (DefaultConstructorMarker) null));
            if (pointerInputEventData.getDown()) {
                this.previousPointerInputData.put(pointerInputEventData.m5602getIdJ3iCeTQ(), new PointerInputData(pointerInputEventData.getUptime(), pointerInputEventData.m5605getPositionOnScreenF1C5BW0(), pointerInputEventData.getDown(), pointerInputEventData.m5607getTypeT8wyACA(), (DefaultConstructorMarker) null));
            } else {
                this.previousPointerInputData.remove(pointerInputEventData.m5602getIdJ3iCeTQ());
            }
        }
    ...
    private static final class PointerInputData {
        ...
        public final long m5592getPositionOnScreenF1C5BW0() {
        ...
        public final int m5593getTypeT8wyACA() {
            return this.type;
        }
    }
}
