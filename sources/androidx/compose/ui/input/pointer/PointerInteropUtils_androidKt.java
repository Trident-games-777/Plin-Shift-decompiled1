...
public final class PointerInteropUtils_androidKt {
    ...
    public static final void m5650toMotionEventScoped4ec7I(PointerEvent pointerEvent, long j, Function1<? super MotionEvent, Unit> function1) {
        m5651toMotionEventScopeubNVwUQ(pointerEvent, j, function1, false);
    }

    /* renamed from: toCancelMotionEventScope-d-4ec7I  reason: not valid java name */
    public static final void m5649toCancelMotionEventScoped4ec7I(PointerEvent pointerEvent, long j, Function1<? super MotionEvent, Unit> function1) {
        m5651toMotionEventScopeubNVwUQ(pointerEvent, j, function1, true);
    }
    ...
    private static final void m5651toMotionEventScopeubNVwUQ(PointerEvent pointerEvent, long j, Function1<? super MotionEvent, Unit> function1, boolean z) {
        ...
        if (motionEvent$ui_release != null) {
            ...
            motionEvent$ui_release.offsetLocation(-Offset.m3987getXimpl(j), -Offset.m3988getYimpl(j));
