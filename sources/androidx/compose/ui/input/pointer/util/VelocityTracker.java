...
public final class VelocityTracker {
    ...
    public VelocityTracker() {
        VelocityTracker1D.Strategy strategy2;
        if (VelocityTrackerKt.getVelocityTrackerStrategyUseImpulse()) {
            strategy2 = VelocityTracker1D.Strategy.Impulse;
        } else {
            strategy2 = VelocityTracker1D.Strategy.Lsq2;
        }
        this.strategy = strategy2;
        this.xVelocityTracker = new VelocityTracker1D(false, strategy2, 1, (DefaultConstructorMarker) null);
        this.yVelocityTracker = new VelocityTracker1D(false, strategy2, 1, (DefaultConstructorMarker) null);
        this.currentPointerPositionAccumulator = Offset.Companion.m4003getZeroF1C5BW0();
    }

    /* renamed from: getCurrentPointerPositionAccumulator-F1C5BW0$ui_release  reason: not valid java name */
    public final long m5708getCurrentPointerPositionAccumulatorF1C5BW0$ui_release() {
        return this.currentPointerPositionAccumulator;
    }

    /* renamed from: setCurrentPointerPositionAccumulator-k-4lQ0M$ui_release  reason: not valid java name */
    public final void m5709setCurrentPointerPositionAccumulatork4lQ0M$ui_release(long j) {
    ...
    public final void m5705addPositionUv8p0NA(long j, long j2) {
        this.xVelocityTracker.addDataPoint(j, Offset.m3987getXimpl(j2));
        this.yVelocityTracker.addDataPoint(j, Offset.m3988getYimpl(j2));
    }

    /* renamed from: calculateVelocity-9UxMQ8M  reason: not valid java name */
    public final long m5706calculateVelocity9UxMQ8M() {
        return m5707calculateVelocityAH228Gc(VelocityKt.Velocity(Float.MAX_VALUE, Float.MAX_VALUE));
    }

    /* renamed from: calculateVelocity-AH228Gc  reason: not valid java name */
    public final long m5707calculateVelocityAH228Gc(long j) {
        if (!(Velocity.m7350getXimpl(j) > 0.0f && Velocity.m7351getYimpl(j) > 0.0f)) {
            InlineClassHelperKt.throwIllegalStateException("maximumVelocity should be a positive value. You specified=" + Velocity.m7357toStringimpl(j));
        }
        return VelocityKt.Velocity(this.xVelocityTracker.calculateVelocity(Velocity.m7350getXimpl(j)), this.yVelocityTracker.calculateVelocity(Velocity.m7351getYimpl(j)));
    }
