...
public final class VelocityTrackerKt {
    ...
    private static final void addPointerInputChangeLegacy(VelocityTracker velocityTracker, PointerInputChange pointerInputChange) {
        if (PointerEventKt.changedToDownIgnoreConsumed(pointerInputChange)) {
            velocityTracker.m5709setCurrentPointerPositionAccumulatork4lQ0M$ui_release(pointerInputChange.m5587getPositionF1C5BW0());
            velocityTracker.resetTracking();
        }
        long r0 = pointerInputChange.m5588getPreviousPositionF1C5BW0();
        List<HistoricalChange> historical = pointerInputChange.getHistorical();
        int size = historical.size();
        int i = 0;
        while (i < size) {
            HistoricalChange historicalChange = historical.get(i);
            long r02 = Offset.m3991minusMKHz9U(historicalChange.m5512getPositionF1C5BW0(), r0);
            long r6 = historicalChange.m5512getPositionF1C5BW0();
            velocityTracker.m5709setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m3992plusMKHz9U(velocityTracker.m5708getCurrentPointerPositionAccumulatorF1C5BW0$ui_release(), r02));
            velocityTracker.m5705addPositionUv8p0NA(historicalChange.getUptimeMillis(), velocityTracker.m5708getCurrentPointerPositionAccumulatorF1C5BW0$ui_release());
            i++;
            r0 = r6;
        }
        velocityTracker.m5709setCurrentPointerPositionAccumulatork4lQ0M$ui_release(Offset.m3992plusMKHz9U(velocityTracker.m5708getCurrentPointerPositionAccumulatorF1C5BW0$ui_release(), Offset.m3991minusMKHz9U(pointerInputChange.m5587getPositionF1C5BW0(), r0)));
        velocityTracker.m5705addPositionUv8p0NA(pointerInputChange.getUptimeMillis(), velocityTracker.m5708getCurrentPointerPositionAccumulatorF1C5BW0$ui_release());
    }
    ...
    private static final void addPointerInputChangeWithFix(VelocityTracker velocityTracker, PointerInputChange pointerInputChange) {
        ...
        if (!PointerEventKt.changedToUpIgnoreConsumed(pointerInputChange)) {
            ...
            for (int i = 0; i < size; i++) {
                HistoricalChange historicalChange = historical.get(i);
                velocityTracker.m5705addPositionUv8p0NA(historicalChange.getUptimeMillis(), historicalChange.m5511getOriginalEventPositionF1C5BW0$ui_release());
            }
            velocityTracker.m5705addPositionUv8p0NA(pointerInputChange.getUptimeMillis(), pointerInputChange.m5586getOriginalEventPositionF1C5BW0$ui_release());
        }
    ...
    public static final float[] polyFitLeastSquares(float[] fArr, float[] fArr2, int i, int i2, float[] fArr3) {
        ...
        for (int i11 = 0; i11 < i5; i11++) {
            ...
            ArraysKt.copyInto(fArr4[i11], fArr7, 0, 0, i3);
            for (int i12 = 0; i12 < i11; i12++) {
                float[] fArr8 = fArr5[i12];
                float dot = dot(fArr7, fArr8);
                for (int i13 = 0; i13 < i3; i13++) {
                    fArr7[i13] = fArr7[i13] - (fArr8[i13] * dot);
                }
            }
