...
final class PointerHoverIconModifierNode$findOverridingAncestorNode$1 extends Lambda implements Function1<PointerHoverIconModifierNode, Boolean> {
    final /* synthetic */ Ref.ObjectRef<PointerHoverIconModifierNode> $pointerHoverIconModifierNode;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    PointerHoverIconModifierNode$findOverridingAncestorNode$1(Ref.ObjectRef<PointerHoverIconModifierNode> objectRef) {
        super(1);
