...
public final class InputModeManagerImpl implements InputModeManager {
    ...
    private InputModeManagerImpl(int i, Function1<? super InputMode, Boolean> function1) {
        ...
        this.inputMode$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(InputMode.m5103boximpl(i), (SnapshotMutationPolicy) null, 2, (Object) null);
    }

    /* renamed from: getInputMode-aOaMEAU  reason: not valid java name */
    public int m5114getInputModeaOaMEAU() {
        return ((InputMode) this.inputMode$delegate.getValue()).m5109unboximpl();
    }

    /* renamed from: setInputMode-iuPiT84  reason: not valid java name */
    public void m5116setInputModeiuPiT84(int i) {
        this.inputMode$delegate.setValue(InputMode.m5103boximpl(i));
    }

    /* renamed from: requestInputMode-iuPiT84  reason: not valid java name */
    public boolean m5115requestInputModeiuPiT84(int i) {
        return this.onRequestInputModeChange.invoke(InputMode.m5103boximpl(i)).booleanValue();
    }
}
