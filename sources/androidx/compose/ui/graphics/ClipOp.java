...
public final class ClipOp {
    ...
    public static final int Difference = m4221constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Intersect = m4221constructorimpl(1);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ ClipOp m4220boximpl(int i) {
        return new ClipOp(i);
    }
    ...
    public static boolean m4222equalsimpl(int i, Object obj) {
        return (obj instanceof ClipOp) && i == ((ClipOp) obj).m4226unboximpl();
    }
    ...
    public static String m4225toStringimpl(int i) {
        if (m4223equalsimpl0(i, Difference)) {
            return "Difference";
        }
        if (m4223equalsimpl0(i, Intersect)) {
            return "Intersect";
        }
        return "Unknown";
    }
