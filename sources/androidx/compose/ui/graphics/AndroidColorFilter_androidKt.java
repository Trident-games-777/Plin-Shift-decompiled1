...
public final class AndroidColorFilter_androidKt {
    ...
    public static final ColorFilter asComposeColorFilter(ColorFilter colorFilter) {
        ...
        if (!(colorFilter instanceof LightingColorFilter) || !supportsLightingColorFilterQuery()) {
            ...
            if (!(colorFilter2 instanceof ColorMatrixColorFilter) || !supportsColorMatrixQuery()) {
                return new ColorFilter(colorFilter2);
            }
            return new ColorMatrixColorFilter((float[]) null, colorFilter2, (DefaultConstructorMarker) null);
        }
    ...
    public static final ColorFilter m4094actualTintColorFilterxETnrds(long j, int i) {
        if (Build.VERSION.SDK_INT >= 29) {
            return BlendModeColorFilterHelper.INSTANCE.m4174BlendModeColorFilterxETnrds(j, i);
        }
        return new PorterDuffColorFilter(ColorKt.m4293toArgb8_81llA(j), AndroidBlendMode_androidKt.m4080toPorterDuffModes9anfk8(i));
    }

    /* renamed from: actualColorMatrixColorFilter-jHG-Opc  reason: not valid java name */
    public static final ColorFilter m4092actualColorMatrixColorFilterjHGOpc(float[] fArr) {
        return new ColorMatrixColorFilter(fArr);
    }

    /* renamed from: actualLightingColorFilter--OWjLjI  reason: not valid java name */
    public static final ColorFilter m4093actualLightingColorFilterOWjLjI(long j, long j2) {
        return new LightingColorFilter(ColorKt.m4293toArgb8_81llA(j), ColorKt.m4293toArgb8_81llA(j2));
    }
    ...
    public static final float[] actualColorMatrixFromFilter(ColorFilter colorFilter) {
        if ((colorFilter instanceof ColorMatrixColorFilter) && supportsColorMatrixQuery()) {
            return ColorMatrixFilterHelper.INSTANCE.m4319getColorMatrix8unuwjk((ColorMatrixColorFilter) colorFilter);
        }
