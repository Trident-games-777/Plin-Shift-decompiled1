...
public interface Path {
    ...
    void m4526addPathUv8p0NA(Path path, long j);
    ...
    boolean m4528opN5in7k0(Path path, Path path2, int i);
    ...
    void m4529setFillTypeoQ8Xj4U(int i);

    /* renamed from: transform-58bKbWc  reason: not valid java name */
    void m4530transform58bKbWc(float[] fArr) {
    }

    /* renamed from: translate-k-4lQ0M  reason: not valid java name */
    void m4531translatek4lQ0M(long j);
    ...
    public static final class DefaultImpls {
        ...
        @Deprecated
        /* renamed from: transform-58bKbWc  reason: not valid java name */
        public static void m4534transform58bKbWc(Path path, float[] fArr) {
            Path.super.m4530transform58bKbWc(fArr);
        }
    ...
    static /* synthetic */ void m4525addPathUv8p0NA$default(Path path, Path path2, long j, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                j = Offset.Companion.m4003getZeroF1C5BW0();
            }
            path.m4526addPathUv8p0NA(path2, j);
            return;
        }
    ...
    PathIterator iterator() {
        return AndroidPathIterator_androidKt.PathIterator$default(this, (PathIterator.ConicEvaluation) null, 0.0f, 6, (Object) null);
    }
    ...
    Path plus(Path path) {
        ...
        Path.m4528opN5in7k0(this, path, PathOperation.Companion.m4558getUnionb3I0S0c());
        return Path;
    }

    Path minus(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.m4528opN5in7k0(this, path, PathOperation.Companion.m4555getDifferenceb3I0S0c());
        return Path;
    }
    ...
    Path and(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.m4528opN5in7k0(this, path, PathOperation.Companion.m4556getIntersectb3I0S0c());
        return Path;
    }

    Path xor(Path path) {
        Path Path = AndroidPath_androidKt.Path();
        Path.m4528opN5in7k0(this, path, PathOperation.Companion.m4559getXorb3I0S0c());
        return Path;
    }
    ...
    public static final class Companion {
        ...
        public final Path m4532combinexh6zSI8(int i, Path path, Path path2) {
            Path Path = AndroidPath_androidKt.Path();
            if (Path.m4528opN5in7k0(path, path2, i)) {
                return Path;
            }
