...
public final class SweepGradient extends ShaderBrush {
    ...
    public Shader m4647createShaderuvyYCjk(long j) {
        long j2;
        if (OffsetKt.m4008isUnspecifiedk4lQ0M(this.center)) {
            j2 = SizeKt.m4066getCenteruvyYCjk(j);
        } else {
            j2 = OffsetKt.Offset(Offset.m3987getXimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m4056getWidthimpl(j) : Offset.m3987getXimpl(this.center), Offset.m3988getYimpl(this.center) == Float.POSITIVE_INFINITY ? Size.m4053getHeightimpl(j) : Offset.m3988getYimpl(this.center));
        }
        return ShaderKt.m4597SweepGradientShader9KIMszo(j2, this.colors, this.stops);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Offset.m3984equalsimpl0(this.center, sweepGradient.center) && Intrinsics.areEqual((Object) this.colors, (Object) sweepGradient.colors) && Intrinsics.areEqual((Object) this.stops, (Object) sweepGradient.stops);
    }

    public int hashCode() {
        int r0 = ((Offset.m3989hashCodeimpl(this.center) * 31) + this.colors.hashCode()) * 31;
        List<Float> list = this.stops;
        return r0 + (list != null ? list.hashCode() : 0);
    }

    public String toString() {
        return "SweepGradient(" + (OffsetKt.m4006isSpecifiedk4lQ0M(this.center) ? "center=" + Offset.m3995toStringimpl(this.center) + ", " : "") + "colors=" + this.colors + ", stops=" + this.stops + ')';
    }
}
