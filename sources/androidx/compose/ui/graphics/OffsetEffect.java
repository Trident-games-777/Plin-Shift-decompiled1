...
public final class OffsetEffect extends RenderEffect {
    ...
    public RenderEffect createRenderEffect() {
        return RenderEffectVerificationHelper.INSTANCE.m4578createOffsetEffectUv8p0NA(this.renderEffect, this.offset);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.renderEffect, (Object) offsetEffect.renderEffect) && Offset.m3984equalsimpl0(this.offset, offsetEffect.offset);
    }

    public int hashCode() {
        RenderEffect renderEffect2 = this.renderEffect;
        return ((renderEffect2 != null ? renderEffect2.hashCode() : 0) * 31) + Offset.m3989hashCodeimpl(this.offset);
    }

    public String toString() {
        return "OffsetEffect(renderEffect=" + this.renderEffect + ", offset=" + Offset.m3995toStringimpl(this.offset) + ')';
    }
}
