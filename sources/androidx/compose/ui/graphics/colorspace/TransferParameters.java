...
public final class TransferParameters {
    ...
    public static /* synthetic */ TransferParameters copy$default(TransferParameters transferParameters, double d2, double d3, double d4, double d5, double d6, double d7, double d8, int i, Object obj) {
        return transferParameters.copy((i & 1) != 0 ? transferParameters.gamma : d2, (i & 2) != 0 ? transferParameters.f81a : d3, (i & 4) != 0 ? transferParameters.b : d4, (i & 8) != 0 ? transferParameters.c : d5, (i & 16) != 0 ? transferParameters.d : d6, (i & 32) != 0 ? transferParameters.e : d7, (i & 64) != 0 ? transferParameters.f : d8);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Double.compare(this.gamma, transferParameters.gamma) == 0 && Double.compare(this.f81a, transferParameters.f81a) == 0 && Double.compare(this.b, transferParameters.b) == 0 && Double.compare(this.c, transferParameters.c) == 0 && Double.compare(this.d, transferParameters.d) == 0 && Double.compare(this.e, transferParameters.e) == 0 && Double.compare(this.f, transferParameters.f) == 0;
    }

    public int hashCode() {
        return (((((((((((Double.hashCode(this.gamma) * 31) + Double.hashCode(this.f81a)) * 31) + Double.hashCode(this.b)) * 31) + Double.hashCode(this.c)) * 31) + Double.hashCode(this.d)) * 31) + Double.hashCode(this.e)) * 31) + Double.hashCode(this.f);
    }

    public String toString() {
        return "TransferParameters(gamma=" + this.gamma + ", a=" + this.f81a + ", b=" + this.b + ", c=" + this.c + ", d=" + this.d + ", e=" + this.e + ", f=" + this.f + ')';
    }
