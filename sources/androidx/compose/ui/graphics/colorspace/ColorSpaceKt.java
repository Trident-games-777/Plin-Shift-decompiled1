...
public final class ColorSpaceKt {
    ...
    private static final Connector m4702createConnectorYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        if (colorSpace == colorSpace2) {
            return Connector.Companion.identity$ui_graphics_release(colorSpace);
        }
        if (!ColorModel.m4689equalsimpl0(colorSpace.m4698getModelxdoWZVw(), ColorModel.Companion.m4696getRgbxdoWZVw()) || !ColorModel.m4689equalsimpl0(colorSpace2.m4698getModelxdoWZVw(), ColorModel.Companion.m4696getRgbxdoWZVw())) {
    ...
    public static /* synthetic */ Connector m4701connectYBCOT_4$default(ColorSpace colorSpace, ColorSpace colorSpace2, int i, int i2, Object obj) {
        if ((i2 & 1) != 0) {
            colorSpace2 = ColorSpaces.INSTANCE.getSrgb();
        }
        if ((i2 & 2) != 0) {
            i = RenderIntent.Companion.m4721getPerceptualuksYyKA();
        }
        return m4700connectYBCOT_4(colorSpace, colorSpace2, i);
    }

    /* renamed from: connect-YBCOT_4  reason: not valid java name */
    public static final Connector m4700connectYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        ...
        if ((id$ui_graphics_release | id$ui_graphics_release2) < 0) {
            return m4702createConnectorYBCOT_4(colorSpace, colorSpace2, i);
        }
        ...
        if (connector == null) {
            connector = m4702createConnectorYBCOT_4(colorSpace, colorSpace2, i);
    ...
    public static final ColorSpace adapt(ColorSpace colorSpace, WhitePoint whitePoint, Adaptation adaptation) {
        if (ColorModel.m4689equalsimpl0(colorSpace.m4698getModelxdoWZVw(), ColorModel.Companion.m4696getRgbxdoWZVw())) {
            Intrinsics.checkNotNull(colorSpace, "null cannot be cast to non-null type androidx.compose.ui.graphics.colorspace.Rgb");
