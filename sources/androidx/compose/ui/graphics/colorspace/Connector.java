...
public class Connector {
    ...
    public final int m4703getRenderIntentuksYyKA() {
        return this.renderIntent;
    }

    /* JADX INFO: this call moved to the top of the method (can break code semantics) */
    private Connector(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
        this(colorSpace, colorSpace2, ColorModel.m4689equalsimpl0(colorSpace.m4698getModelxdoWZVw(), ColorModel.Companion.m4696getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace, Illuminant.INSTANCE.getD50(), (Adaptation) null, 2, (Object) null) : colorSpace, ColorModel.m4689equalsimpl0(colorSpace2.m4698getModelxdoWZVw(), ColorModel.Companion.m4696getRgbxdoWZVw()) ? ColorSpaceKt.adapt$default(colorSpace2, Illuminant.INSTANCE.getD50(), (Adaptation) null, 2, (Object) null) : colorSpace2, i, Companion.m4706computeTransformYBCOT_4(colorSpace, colorSpace2, i), (DefaultConstructorMarker) null);
    }
    ...
    public static final class RgbConnector extends Connector {
        ...
        private RgbConnector(androidx.compose.ui.graphics.colorspace.Rgb r9, androidx.compose.ui.graphics.colorspace.Rgb r10, int r11) {
            /*
                ...
                r0.mSource = r9
                r0.mDestination = r10
                float[] r9 = r8.m4708computeTransformYBCOT_4(r9, r10, r5)
                r0.mTransform = r9
                return
            */
        ...
        private final float[] m4708computeTransformYBCOT_4(Rgb rgb, Rgb rgb2, int i) {
            ...
            if (RenderIntent.m4716equalsimpl0(i, RenderIntent.Companion.m4720getAbsoluteuksYyKA())) {
        ...
        public long m4709transformToColorl2rxGTc$ui_graphics_release(long j) {
            float r0 = Color.m4245getRedimpl(j);
            float r1 = Color.m4244getGreenimpl(j);
            float r2 = Color.m4242getBlueimpl(j);
            float r7 = Color.m4241getAlphaimpl(j);
            float invoke = (float) this.mSource.getEotfFunc$ui_graphics_release().invoke((double) r0);
            float invoke2 = (float) this.mSource.getEotfFunc$ui_graphics_release().invoke((double) r1);
            float invoke3 = (float) this.mSource.getEotfFunc$ui_graphics_release().invoke((double) r2);
            float[] fArr = this.mTransform;
            return ColorKt.Color((float) this.mDestination.getOetfFunc$ui_graphics_release().invoke((double) ((fArr[0] * invoke) + (fArr[3] * invoke2) + (fArr[6] * invoke3))), (float) this.mDestination.getOetfFunc$ui_graphics_release().invoke((double) ((fArr[1] * invoke) + (fArr[4] * invoke2) + (fArr[7] * invoke3))), (float) this.mDestination.getOetfFunc$ui_graphics_release().invoke((double) ((fArr[2] * invoke) + (fArr[5] * invoke2) + (fArr[8] * invoke3))), r7, this.mDestination);
        }
    }
    ...
    public static final class Companion {
        ...
        /* renamed from: computeTransform-YBCOT_4  reason: not valid java name */
        public final float[] m4706computeTransformYBCOT_4(ColorSpace colorSpace, ColorSpace colorSpace2, int i) {
            if (!RenderIntent.m4716equalsimpl0(i, RenderIntent.Companion.m4720getAbsoluteuksYyKA())) {
                return null;
            }
            boolean r8 = ColorModel.m4689equalsimpl0(colorSpace.m4698getModelxdoWZVw(), ColorModel.Companion.m4696getRgbxdoWZVw());
            boolean r1 = ColorModel.m4689equalsimpl0(colorSpace2.m4698getModelxdoWZVw(), ColorModel.Companion.m4696getRgbxdoWZVw());
            if (r8 && r1) {
                return null;
            }
            if (!r8 && !r1) {
        ...
        public final Connector identity$ui_graphics_release(ColorSpace colorSpace) {
            return new Connector$Companion$identity$1(colorSpace, RenderIntent.Companion.m4722getRelativeuksYyKA());
        }
    }

    /* renamed from: transformToColor-l2rxGTc$ui_graphics_release  reason: not valid java name */
    public long m4704transformToColorl2rxGTc$ui_graphics_release(long j) {
        float r0 = Color.m4245getRedimpl(j);
        float r1 = Color.m4244getGreenimpl(j);
        float r2 = Color.m4242getBlueimpl(j);
        float r7 = Color.m4241getAlphaimpl(j);
        long xy$ui_graphics_release = this.transformSource.toXy$ui_graphics_release(r0, r1, r2);
        ...
        float z$ui_graphics_release = this.transformSource.toZ$ui_graphics_release(r0, r1, r2);
        ...
        return this.transformDestination.m4699xyzaToColorJlNiLsg$ui_graphics_release(f, intBitsToFloat2, z$ui_graphics_release, r7, this.destination);
    }
}
