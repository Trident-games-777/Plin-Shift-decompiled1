...
public final class AndroidVertexMode_androidKt {
    ...
    public static final Canvas.VertexMode m4134toAndroidVertexModeJOOmi9M(int i) {
        if (VertexMode.m4677equalsimpl0(i, VertexMode.Companion.m4683getTrianglesc2xauaI())) {
            return Canvas.VertexMode.TRIANGLES;
        }
        if (VertexMode.m4677equalsimpl0(i, VertexMode.Companion.m4682getTriangleStripc2xauaI())) {
            return Canvas.VertexMode.TRIANGLE_STRIP;
        }
        if (VertexMode.m4677equalsimpl0(i, VertexMode.Companion.m4681getTriangleFanc2xauaI())) {
