...
public final class LayerSnapshotV28 implements LayerSnapshotImpl {
    ...
    private static final class GraphicsLayerPicture extends Picture {
        ...
        public GraphicsLayerPicture(GraphicsLayer graphicsLayer2) {
        ...
        public int getWidth() {
            return IntSize.m7283getWidthimpl(this.graphicsLayer.m4973getSizeYbymL2g());
        }

        public int getHeight() {
            return IntSize.m7282getHeightimpl(this.graphicsLayer.m4973getSizeYbymL2g());
        }

        public void draw(Canvas canvas) {
            this.graphicsLayer.draw$ui_graphics_release(AndroidCanvas_androidKt.Canvas(canvas), (GraphicsLayer) null);
        }
    }
}
