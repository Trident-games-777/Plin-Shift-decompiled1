...
public final class AndroidTileMode_androidKt {
    ...
    public static final boolean m4132isSupported0vamqd0(int i) {
        return Build.VERSION.SDK_INT >= 31 || !TileMode.m4651equalsimpl0(i, TileMode.Companion.m4656getDecal3opZhB0());
    }

    /* renamed from: toAndroidTileMode-0vamqd0  reason: not valid java name */
    public static final Shader.TileMode m4133toAndroidTileMode0vamqd0(int i) {
        if (TileMode.m4651equalsimpl0(i, TileMode.Companion.m4655getClamp3opZhB0())) {
            return Shader.TileMode.CLAMP;
        }
        if (TileMode.m4651equalsimpl0(i, TileMode.Companion.m4658getRepeated3opZhB0())) {
            return Shader.TileMode.REPEAT;
        }
        if (TileMode.m4651equalsimpl0(i, TileMode.Companion.m4657getMirror3opZhB0())) {
            return Shader.TileMode.MIRROR;
        }
        if (!TileMode.m4651equalsimpl0(i, TileMode.Companion.m4656getDecal3opZhB0())) {
            return Shader.TileMode.CLAMP;
        }
    ...
    public static final int toComposeTileMode(Shader.TileMode tileMode) {
        ...
        if (i == 1) {
            return TileMode.Companion.m4655getClamp3opZhB0();
        }
        if (i == 2) {
            return TileMode.Companion.m4657getMirror3opZhB0();
        }
        if (i == 3) {
            return TileMode.Companion.m4658getRepeated3opZhB0();
        }
        if (Build.VERSION.SDK_INT < 31 || tileMode != Shader.TileMode.DECAL) {
            return TileMode.Companion.m4655getClamp3opZhB0();
        }
        return TileModeVerificationHelper.INSTANCE.m4659getComposeTileModeDecal3opZhB0();
    }
}
