...
public final class VectorPainter extends Painter {
    ...
    public VectorPainter(GroupComponent groupComponent) {
        this.size$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default(Size.m4044boximpl(Size.Companion.m4065getZeroNHjbRc()), (SnapshotMutationPolicy) null, 2, (Object) null);
    ...
    public final long m5072getSizeNHjbRc$ui_release() {
        return ((Size) this.size$delegate.getValue()).m4061unboximpl();
    }

    /* renamed from: setSize-uvyYCjk$ui_release  reason: not valid java name */
    public final void m5074setSizeuvyYCjk$ui_release(long j) {
    ...
    public final long m5073getViewportSizeNHjbRc$ui_release() {
        return this.vector.m5063getViewportSizeNHjbRc$ui_release();
    }

    /* renamed from: setViewportSize-uvyYCjk$ui_release  reason: not valid java name */
    public final void m5075setViewportSizeuvyYCjk$ui_release(long j) {
        this.vector.m5064setViewportSizeuvyYCjk$ui_release(j);
    }
    ...
    public final int m5070getBitmapConfig_sVssgQ$ui_release() {
        return this.vector.m5062getCacheBitmapConfig_sVssgQ$ui_release();
    }
    ...
    public long m5071getIntrinsicSizeNHjbRc() {
        return m5072getSizeNHjbRc$ui_release();
    }
    ...
    public void onDraw(DrawScope drawScope) {
        ...
        if (!getAutoMirror$ui_release() || drawScope.getLayoutDirection() != LayoutDirection.Rtl) {
            ...
            long r2 = drawScope.m4864getCenterF1C5BW0();
            DrawContext drawContext = drawScope.getDrawContext();
            long r5 = drawContext.m4806getSizeNHjbRc();
            drawContext.getCanvas().save();
            try {
                drawContext.getTransform().m4930scale0AR0LA0(-1.0f, 1.0f, r2);
                vectorComponent.draw(drawScope, this.currentAlpha, colorFilter);
            } finally {
