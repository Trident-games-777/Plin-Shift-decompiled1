...
public final class PathComponent extends VNode {
    ...
    public final int m5056getPathFillTypeRgk1Os() {
        return this.pathFillType;
    }

    /* renamed from: setPathFillType-oQ8Xj4U  reason: not valid java name */
    public final void m5059setPathFillTypeoQ8Xj4U(int i) {
        this.pathFillType = i;
        this.renderPath.m4529setFillTypeoQ8Xj4U(i);
        invalidate();
    }
    ...
    public final int m5057getStrokeLineCapKaPHkGw() {
        return this.strokeLineCap;
    }

    /* renamed from: setStrokeLineCap-BeK7IIE  reason: not valid java name */
    public final void m5060setStrokeLineCapBeK7IIE(int i) {
    ...
    public final int m5058getStrokeLineJoinLxFBmk8() {
        return this.strokeLineJoin;
    }

    /* renamed from: setStrokeLineJoin-Ww9F2mQ  reason: not valid java name */
    public final void m5061setStrokeLineJoinWw9F2mQ(int i) {
    ...
    private final void updateRenderPath() {
        ...
        if (Intrinsics.areEqual((Object) this.renderPath, (Object) this.path)) {
            ...
            int r0 = this.renderPath.m4527getFillTypeRgk1Os();
            this.renderPath.rewind();
            this.renderPath.m4529setFillTypeoQ8Xj4U(r0);
        }
    ...
    public void draw(DrawScope drawScope) {
        ...
        if (brush != null) {
            DrawScope.m4835drawPathGBMwjPU$default(drawScope, this.renderPath, brush, this.fillAlpha, (DrawStyle) null, (ColorFilter) null, 0, 56, (Object) null);
        }
        Brush brush2 = this.stroke;
        if (brush2 != null) {
            Stroke stroke2 = this.strokeStyle;
            if (this.isStrokeDirty || stroke2 == null) {
                Stroke stroke3 = new Stroke(this.strokeLineWidth, this.strokeLineMiter, this.strokeLineCap, this.strokeLineJoin, (PathEffect) null, 16, (DefaultConstructorMarker) null);
                this.strokeStyle = stroke3;
                this.isStrokeDirty = false;
                stroke2 = stroke3;
            }
            DrawScope.m4835drawPathGBMwjPU$default(drawScope, this.renderPath, brush2, this.strokeAlpha, stroke2, (ColorFilter) null, 0, 48, (Object) null);
        }
    }
