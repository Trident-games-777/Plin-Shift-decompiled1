...
public final class DrawCache {
    ...
    private int config = ImageBitmapConfig.Companion.m4462getArgb8888_sVssgQ();
    ...
    public final void m5045drawCachedImageFqjB98A(int i, long j, Density density, LayoutDirection layoutDirection2, Function1<? super DrawScope, Unit> function1) {
        ...
        if (imageBitmap == null || canvas == null || IntSize.m7283getWidthimpl(j) > imageBitmap.getWidth() || IntSize.m7282getHeightimpl(j) > imageBitmap.getHeight() || !ImageBitmapConfig.m4457equalsimpl0(this.config, i)) {
            imageBitmap = ImageBitmapKt.m4467ImageBitmapx__hDU$default(IntSize.m7283getWidthimpl(j), IntSize.m7282getHeightimpl(j), i, false, (ColorSpace) null, 24, (Object) null);
        ...
        long r4 = IntSizeKt.m7295toSizeozmzZPI(j);
        ...
        drawParams2.m4764setSizeuvyYCjk(r4);
        canvas.save();
    ...
    public final void drawInto(DrawScope drawScope, float f, ColorFilter colorFilter) {
        ...
        DrawScope.m4829drawImageAZ2fEMs$default(drawScope, imageBitmap, 0, this.size, 0, 0, f, (DrawStyle) null, colorFilter, 0, 0, 858, (Object) null);
    }

    private final void clear(DrawScope drawScope) {
        DrawScope.m4840drawRectnJ9OG0$default(drawScope, Color.Companion.m4265getBlack0d7_KjU(), 0, 0, 0.0f, (DrawStyle) null, (ColorFilter) null, BlendMode.Companion.m4143getClear0nO6VwU(), 62, (Object) null);
    }
}
