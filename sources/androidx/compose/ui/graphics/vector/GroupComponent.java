...
public final class GroupComponent extends VNode {
    ...
    private long tintColor = Color.Companion.m4275getUnspecified0d7_KjU();
    ...
    public final long m5047getTintColor0d7_KjU() {
    ...
    private final void markTintForBrush(Brush brush) {
        ...
        if (brush instanceof SolidColor) {
            m5046markTintForColor8_81llA(((SolidColor) brush).m4616getValue0d7_KjU());
        } else {
            markNotTintable();
        }
    }
    ...
    private final void m5046markTintForColor8_81llA(long j) {
        if (this.isTintable && j != 16) {
            long j2 = this.tintColor;
            if (j2 == 16) {
                this.tintColor = j;
            } else if (!VectorKt.m5069rgbEqualOWjLjI(j2, j)) {
                markNotTintable();
            }
        }
    }
    ...
    public final void markTintForVNode(VNode vNode) {
        if (vNode instanceof PathComponent) {
            ...
            if (!groupComponent.isTintable || !this.isTintable) {
                ...
                m5046markTintForColor8_81llA(groupComponent.tintColor);
            }
        }
    }
    ...
    private final void markNotTintable() {
        ...
        this.tintColor = Color.Companion.m4275getUnspecified0d7_KjU();
    }
    ...
    private final void updateMatrix() {
        ...
        float[] fArr2 = fArr;
        Matrix.m4494translateimpl$default(fArr2, this.pivotX + this.translationX, this.pivotY + this.translationY, 0.0f, 4, (Object) null);
        Matrix.m4486rotateZimpl(fArr2, this.rotation);
        Matrix.m4487scaleimpl(fArr2, this.scaleX, this.scaleY, 1.0f);
        Matrix.m4494translateimpl$default(fArr2, -this.pivotX, -this.pivotY, 0.0f, 4, (Object) null);
    }
    ...
    public void draw(DrawScope drawScope) {
        ...
        try {
            ...
            float[] fArr = this.groupMatrix;
            if (fArr != null) {
                transform.m4931transform58bKbWc((fArr != null ? Matrix.m4472boximpl(fArr) : null).m4495unboximpl());
            }
            Path path = this.clipPath;
            if (getWillClipPath() && path != null) {
                DrawTransform.m4921clipPathmtrdDE$default(transform, path, 0, 2, (Object) null);
            }
