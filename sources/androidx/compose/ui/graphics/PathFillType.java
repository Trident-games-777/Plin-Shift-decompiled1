...
public final class PathFillType {
    ...
    public static final int EvenOdd = m4537constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int NonZero = m4537constructorimpl(0);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ PathFillType m4536boximpl(int i) {
        return new PathFillType(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static int m4537constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m4538equalsimpl(int i, Object obj) {
        return (obj instanceof PathFillType) && i == ((PathFillType) obj).m4542unboximpl();
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m4539equalsimpl0(int i, int i2) {
        return i == i2;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m4540hashCodeimpl(int i) {
    ...
    public static final class Companion {
        ...
        public final int m4544getNonZeroRgk1Os() {
            return PathFillType.NonZero;
        }

        /* renamed from: getEvenOdd-Rg-k1Os  reason: not valid java name */
        public final int m4543getEvenOddRgk1Os() {
    ...
    public static String m4541toStringimpl(int i) {
        if (m4539equalsimpl0(i, NonZero)) {
            return "NonZero";
        }
        if (m4539equalsimpl0(i, EvenOdd)) {
            return "EvenOdd";
        }
        return "Unknown";
    }
