...
public final class BlendModeColorFilter extends ColorFilter {
    ...
    public final long m4173getColor0d7_KjU() {
        return this.color;
    }

    /* renamed from: getBlendMode-0nO6VwU  reason: not valid java name */
    public final int m4172getBlendMode0nO6VwU() {
    ...
    private BlendModeColorFilter(long j, int i) {
        this(j, i, AndroidColorFilter_androidKt.m4094actualTintColorFilterxETnrds(j, i), (DefaultConstructorMarker) null);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Color.m4240equalsimpl0(this.color, blendModeColorFilter.color) && BlendMode.m4139equalsimpl0(this.blendMode, blendModeColorFilter.blendMode);
    }

    public int hashCode() {
        return (Color.m4246hashCodeimpl(this.color) * 31) + BlendMode.m4140hashCodeimpl(this.blendMode);
    }

    public String toString() {
        return "BlendModeColorFilter(color=" + Color.m4247toStringimpl(this.color) + ", blendMode=" + BlendMode.m4141toStringimpl(this.blendMode) + ')';
    }
}
