...
public final class SolidColor extends Brush {
    ...
    public final long m4616getValue0d7_KjU() {
        return this.value;
    }

    /* renamed from: applyTo-Pq9zytI  reason: not valid java name */
    public void m4615applyToPq9zytI(long j, Paint paint, float f) {
        long j2;
        paint.setAlpha(1.0f);
        if (f == 1.0f) {
            j2 = this.value;
            ...
            long j3 = this.value;
            j2 = Color.m4238copywmQWz5c$default(j3, Color.m4241getAlphaimpl(j3) * f, 0.0f, 0.0f, 0.0f, 14, (Object) null);
        }
        paint.m4510setColor8_81llA(j2);
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof SolidColor) && Color.m4240equalsimpl0(this.value, ((SolidColor) obj).value);
    }
    ...
    public String toString() {
        return "SolidColor(value=" + Color.m4247toStringimpl(this.value) + ')';
    }
}
