...
public final class ImageBitmapConfig {
    ...
    public static final int Alpha8 = m4455constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Argb8888 = m4455constructorimpl(0);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int F16 = m4455constructorimpl(3);
    /* access modifiers changed from: private */
    public static final int Gpu = m4455constructorimpl(4);
    /* access modifiers changed from: private */
    public static final int Rgb565 = m4455constructorimpl(2);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ ImageBitmapConfig m4454boximpl(int i) {
    ...
    public static boolean m4456equalsimpl(int i, Object obj) {
        return (obj instanceof ImageBitmapConfig) && i == ((ImageBitmapConfig) obj).m4460unboximpl();
    }
    ...
    public static final class Companion {
        ...
        public final int m4462getArgb8888_sVssgQ() {
            return ImageBitmapConfig.Argb8888;
        }

        /* renamed from: getAlpha8-_sVssgQ  reason: not valid java name */
        public final int m4461getAlpha8_sVssgQ() {
            return ImageBitmapConfig.Alpha8;
        }

        /* renamed from: getRgb565-_sVssgQ  reason: not valid java name */
        public final int m4465getRgb565_sVssgQ() {
            return ImageBitmapConfig.Rgb565;
        }

        /* renamed from: getF16-_sVssgQ  reason: not valid java name */
        public final int m4463getF16_sVssgQ() {
            return ImageBitmapConfig.F16;
        }

        /* renamed from: getGpu-_sVssgQ  reason: not valid java name */
        public final int m4464getGpu_sVssgQ() {
    ...
    public static String m4459toStringimpl(int i) {
        if (m4457equalsimpl0(i, Argb8888)) {
            return "Argb8888";
        }
        if (m4457equalsimpl0(i, Alpha8)) {
            return "Alpha8";
        }
        if (m4457equalsimpl0(i, Rgb565)) {
            return "Rgb565";
        }
        if (m4457equalsimpl0(i, F16)) {
            return "F16";
        }
        if (m4457equalsimpl0(i, Gpu)) {
            return "Gpu";
        }
        return "Unknown";
    }
