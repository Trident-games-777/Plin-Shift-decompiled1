...
public final class ColorMatrixColorFilter extends ColorFilter {
    ...
    private ColorMatrixColorFilter(float[] fArr) {
        this(fArr, AndroidColorFilter_androidKt.m4092actualColorMatrixColorFilterjHGOpc(fArr), (DefaultConstructorMarker) null);
    }

    /* renamed from: copyColorMatrix-gBh15pI$default  reason: not valid java name */
    public static /* synthetic */ float[] m4316copyColorMatrixgBh15pI$default(ColorMatrixColorFilter colorMatrixColorFilter, float[] fArr, int i, Object obj) {
        if ((i & 1) != 0) {
            fArr = ColorMatrix.m4296constructorimpl$default((float[]) null, 1, (DefaultConstructorMarker) null);
        }
        return colorMatrixColorFilter.m4318copyColorMatrixgBh15pI(fArr);
    }

    /* renamed from: copyColorMatrix-gBh15pI  reason: not valid java name */
    public final float[] m4318copyColorMatrixgBh15pI(float[] fArr) {
        float[] fArr2 = fArr;
        ArraysKt.copyInto$default(m4317obtainColorMatrixp10uLo(), fArr2, 0, 0, 0, 14, (Object) null);
        return fArr2;
    }
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ColorMatrixColorFilter) && Arrays.equals(m4317obtainColorMatrixp10uLo(), ((ColorMatrixColorFilter) obj).m4317obtainColorMatrixp10uLo());
    }

    /* renamed from: obtainColorMatrix-p10-uLo  reason: not valid java name */
    private final float[] m4317obtainColorMatrixp10uLo() {
    ...
    public int hashCode() {
        float[] fArr = this.colorMatrix;
        if (fArr != null) {
            return ColorMatrix.m4303hashCodeimpl(fArr);
        }
        return 0;
    }
    ...
    public String toString() {
        ...
        float[] fArr = this.colorMatrix;
        return sb.append(fArr == null ? "null" : ColorMatrix.m4314toStringimpl(fArr)).append(')').toString();
    }
}
