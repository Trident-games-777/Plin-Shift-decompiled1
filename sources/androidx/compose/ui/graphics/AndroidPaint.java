...
public final class AndroidPaint implements Paint {
    ...
    public AndroidPaint(Paint paint) {
        ...
        this._blendMode = BlendMode.Companion.m4170getSrcOver0nO6VwU();
    }
    ...
    public long m4101getColor0d7_KjU() {
        return AndroidPaint_androidKt.getNativeColor(this.internalPaint);
    }

    /* renamed from: setColor-8_81llA  reason: not valid java name */
    public void m4107setColor8_81llA(long j) {
        AndroidPaint_androidKt.m4113setNativeColor4WTKRHQ(this.internalPaint, j);
    }

    /* renamed from: getBlendMode-0nO6VwU  reason: not valid java name */
    public int m4100getBlendMode0nO6VwU() {
        return this._blendMode;
    }

    /* renamed from: setBlendMode-s9anfk8  reason: not valid java name */
    public void m4106setBlendModes9anfk8(int i) {
        if (!BlendMode.m4139equalsimpl0(this._blendMode, i)) {
            this._blendMode = i;
            AndroidPaint_androidKt.m4112setNativeBlendModeGB0RdKg(this.internalPaint, i);
        }
    }

    /* renamed from: getStyle-TiuSbCo  reason: not valid java name */
    public int m4105getStyleTiuSbCo() {
        return AndroidPaint_androidKt.getNativeStyle(this.internalPaint);
    }

    /* renamed from: setStyle-k9PVt8s  reason: not valid java name */
    public void m4111setStylek9PVt8s(int i) {
        AndroidPaint_androidKt.m4117setNativeStyle5YerkU(this.internalPaint, i);
    }
    ...
    public int m4103getStrokeCapKaPHkGw() {
        return AndroidPaint_androidKt.getNativeStrokeCap(this.internalPaint);
    }

    /* renamed from: setStrokeCap-BeK7IIE  reason: not valid java name */
    public void m4109setStrokeCapBeK7IIE(int i) {
        AndroidPaint_androidKt.m4115setNativeStrokeCapCSYIeUk(this.internalPaint, i);
    }

    /* renamed from: getStrokeJoin-LxFBmk8  reason: not valid java name */
    public int m4104getStrokeJoinLxFBmk8() {
        return AndroidPaint_androidKt.getNativeStrokeJoin(this.internalPaint);
    }

    /* renamed from: setStrokeJoin-Ww9F2mQ  reason: not valid java name */
    public void m4110setStrokeJoinWw9F2mQ(int i) {
        AndroidPaint_androidKt.m4116setNativeStrokeJoinkLtJ_vA(this.internalPaint, i);
    }
    ...
    public int m4102getFilterQualityfv9h1I() {
        return AndroidPaint_androidKt.getNativeFilterQuality(this.internalPaint);
    }

    /* renamed from: setFilterQuality-vDHp3xo  reason: not valid java name */
    public void m4108setFilterQualityvDHp3xo(int i) {
        AndroidPaint_androidKt.m4114setNativeFilterQuality50PEsBU(this.internalPaint, i);
    }
