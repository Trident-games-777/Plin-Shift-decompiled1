...
final class ColorMatrixFilterHelper {
    ...
    public final float[] m4319getColorMatrix8unuwjk(ColorMatrixColorFilter colorMatrixColorFilter) {
        ColorMatrix colorMatrix = new ColorMatrix();
        colorMatrixColorFilter.getColorMatrix(colorMatrix);
        return ColorMatrix.m4295constructorimpl(colorMatrix.getArray());
    }
}
