...
public final class DrawScopeKt {
    ...
    public static /* synthetic */ void m4913rotateRg1IO4c$default(DrawScope drawScope, float f, long j, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawScope.m4864getCenterF1C5BW0();
        }
        DrawContext drawContext = drawScope.getDrawContext();
        long r0 = drawContext.m4806getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().m4929rotateUv8p0NA(f, j);
            function1.invoke(drawScope);
        } finally {
            drawContext.getCanvas().restore();
            drawContext.m4807setSizeuvyYCjk(r0);
        }
    }

    /* renamed from: rotateRad-Rg1IO4c$default  reason: not valid java name */
    public static /* synthetic */ void m4915rotateRadRg1IO4c$default(DrawScope drawScope, float f, long j, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawScope.m4864getCenterF1C5BW0();
        }
        DrawContext drawContext = drawScope.getDrawContext();
        ...
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().m4929rotateUv8p0NA(DegreesKt.degrees(f), j);
            function1.invoke(drawScope);
        } finally {
            drawContext.getCanvas().restore();
            drawContext.m4807setSizeuvyYCjk(r0);
    ...
    public static /* synthetic */ void m4917scaleFgt4K4Q$default(DrawScope drawScope, float f, float f2, long j, Function1 function1, int i, Object obj) {
        if ((i & 4) != 0) {
            j = drawScope.m4864getCenterF1C5BW0();
        }
        DrawContext drawContext = drawScope.getDrawContext();
        ...
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().m4930scale0AR0LA0(f, f2, j);
            function1.invoke(drawScope);
        } finally {
            drawContext.getCanvas().restore();
            drawContext.m4807setSizeuvyYCjk(r0);
    ...
    public static /* synthetic */ void m4919scaleRg1IO4c$default(DrawScope drawScope, float f, long j, Function1 function1, int i, Object obj) {
        if ((i & 2) != 0) {
            j = drawScope.m4864getCenterF1C5BW0();
        }
        DrawContext drawContext = drawScope.getDrawContext();
        ...
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().m4930scale0AR0LA0(f, f, j);
            function1.invoke(drawScope);
        } finally {
            drawContext.getCanvas().restore();
            drawContext.m4807setSizeuvyYCjk(r0);
    ...
    public static /* synthetic */ void m4908clipRectrOu3jXo$default(DrawScope drawScope, float f, float f2, float f3, float f4, int i, Function1 function1, int i2, Object obj) {
        float f5 = (i2 & 1) != 0 ? 0.0f : f;
        float f6 = (i2 & 2) != 0 ? 0.0f : f2;
        if ((i2 & 4) != 0) {
            f3 = Size.m4056getWidthimpl(drawScope.m4865getSizeNHjbRc());
        }
        float f7 = f3;
        if ((i2 & 8) != 0) {
            f4 = Size.m4053getHeightimpl(drawScope.m4865getSizeNHjbRc());
        }
        float f8 = f4;
        if ((i2 & 16) != 0) {
        ...
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().m4926clipRectN_I0leg(f5, f6, f7, f8, i3);
            function1.invoke(drawScope);
            drawContext.getCanvas().restore();
    ...
    public static /* synthetic */ void m4906clipPathKD09W0M$default(DrawScope drawScope, Path path, int i, Function1 function1, int i2, Object obj) {
        if ((i2 & 2) != 0) {
            i = ClipOp.Companion.m4228getIntersectrtfAjoo();
        }
        DrawContext drawContext = drawScope.getDrawContext();
        ...
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().m4925clipPathmtrdDE(path, i);
            function1.invoke(drawScope);
        } finally {
            drawContext.getCanvas().restore();
            drawContext.m4807setSizeuvyYCjk(r0);
    ...
    public static final void withTransform(DrawScope drawScope, Function1<? super DrawTransform, Unit> function1, Function1<? super DrawScope, Unit> function12) {
        DrawContext drawContext = drawScope.getDrawContext();
        long r1 = drawContext.m4806getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
            ...
            drawContext.getCanvas().restore();
            drawContext.m4807setSizeuvyYCjk(r1);
        }
    }

    /* renamed from: draw-ymL40Pk  reason: not valid java name */
    public static final void m4910drawymL40Pk(DrawScope drawScope, Density density, LayoutDirection layoutDirection, Canvas canvas, long j, GraphicsLayer graphicsLayer, Function1<? super DrawScope, Unit> function1) {
        ...
        long r3 = drawScope.getDrawContext().m4806getSizeNHjbRc();
        ...
        try {
            ...
            drawContext2.m4807setSizeuvyYCjk(r3);
            drawContext2.setGraphicsLayer(graphicsLayer2);
        }
    }

    /* renamed from: draw-ymL40Pk$default  reason: not valid java name */
    public static /* synthetic */ void m4911drawymL40Pk$default(DrawScope drawScope, Density density, LayoutDirection layoutDirection, Canvas canvas, long j, GraphicsLayer graphicsLayer, Function1 function1, int i, Object obj) {
        if ((i & 16) != 0) {
            graphicsLayer = null;
        }
        Density density2 = drawScope.getDrawContext().getDensity();
        LayoutDirection layoutDirection2 = drawScope.getDrawContext().getLayoutDirection();
        Canvas canvas2 = drawScope.getDrawContext().getCanvas();
        long r1 = drawScope.getDrawContext().m4806getSizeNHjbRc();
        GraphicsLayer graphicsLayer2 = drawScope.getDrawContext().getGraphicsLayer();
        DrawContext drawContext = drawScope.getDrawContext();
        drawContext.setDensity(density);
        drawContext.setLayoutDirection(layoutDirection);
        ...
        try {
            ...
            drawContext2.setLayoutDirection(layoutDirection2);
            drawContext2.setCanvas(canvas2);
            drawContext2.m4807setSizeuvyYCjk(r1);
            drawContext2.setGraphicsLayer(graphicsLayer2);
        }
    }
    ...
    public static final void m4912rotateRg1IO4c(DrawScope drawScope, float f, long j, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long r1 = drawContext.m4806getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m4914rotateRadRg1IO4c(DrawScope drawScope, float f, long j, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long r1 = drawContext.m4806getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m4916scaleFgt4K4Q(DrawScope drawScope, float f, float f2, long j, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long r1 = drawContext.m4806getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m4918scaleRg1IO4c(DrawScope drawScope, float f, long j, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long r1 = drawContext.m4806getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final void m4907clipRectrOu3jXo(DrawScope drawScope, float f, float f2, float f3, float f4, int i, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long r2 = drawContext.m4806getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
            drawContext.getTransform().m4926clipRectN_I0leg(f, f2, f3, f4, i);
            function1.invoke(drawScope);
            drawContext.getCanvas().restore();
            drawContext.m4807setSizeuvyYCjk(r2);
        } catch (Throwable th) {
            Throwable th2 = th;
            drawContext.getCanvas().restore();
            drawContext.m4807setSizeuvyYCjk(r2);
    ...
    public static final void m4905clipPathKD09W0M(DrawScope drawScope, Path path, int i, Function1<? super DrawScope, Unit> function1) {
        DrawContext drawContext = drawScope.getDrawContext();
        long r1 = drawContext.m4806getSizeNHjbRc();
        drawContext.getCanvas().save();
        try {
    ...
    public static final /* synthetic */ void m4909drawGRGpd60(DrawScope drawScope, Density density, LayoutDirection layoutDirection, Canvas canvas, long j, Function1<? super DrawScope, Unit> function1) {
        Density density2 = drawScope.getDrawContext().getDensity();
        LayoutDirection layoutDirection2 = drawScope.getDrawContext().getLayoutDirection();
        Canvas canvas2 = drawScope.getDrawContext().getCanvas();
        long r3 = drawScope.getDrawContext().m4806getSizeNHjbRc();
