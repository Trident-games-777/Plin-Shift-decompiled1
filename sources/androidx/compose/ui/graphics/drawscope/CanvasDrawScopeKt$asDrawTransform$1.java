...
public final class CanvasDrawScopeKt$asDrawTransform$1 implements DrawTransform {
    ...
    public long m4770getSizeNHjbRc() {
        return this.$this_asDrawTransform.m4806getSizeNHjbRc();
    }

    /* renamed from: getCenter-F1C5BW0  reason: not valid java name */
    public long m4769getCenterF1C5BW0() {
        return SizeKt.m4066getCenteruvyYCjk(m4770getSizeNHjbRc());
    }
    ...
    public void inset(float f, float f2, float f3, float f4) {
        ...
        long Size = SizeKt.Size(Size.m4056getWidthimpl(m4770getSizeNHjbRc()) - (f3 + f), Size.m4053getHeightimpl(m4770getSizeNHjbRc()) - (f4 + f2));
        if (!(Size.m4056getWidthimpl(Size) >= 0.0f && Size.m4053getHeightimpl(Size) >= 0.0f)) {
    ...
    public void m4768clipRectN_I0leg(float f, float f2, float f3, float f4, int i) {
        this.$this_asDrawTransform.getCanvas().m4205clipRectN_I0leg(f, f2, f3, f4, i);
    }

    /* renamed from: clipPath-mtrdD-E  reason: not valid java name */
    public void m4767clipPathmtrdDE(Path path, int i) {
        this.$this_asDrawTransform.getCanvas().m4204clipPathmtrdDE(path, i);
    }
    ...
    public void m4771rotateUv8p0NA(float f, long j) {
        Canvas canvas = this.$this_asDrawTransform.getCanvas();
    ...
    public void m4772scale0AR0LA0(float f, float f2, long j) {
        Canvas canvas = this.$this_asDrawTransform.getCanvas();
        canvas.translate(Offset.m3987getXimpl(j), Offset.m3988getYimpl(j));
        canvas.scale(f, f2);
        canvas.translate(-Offset.m3987getXimpl(j), -Offset.m3988getYimpl(j));
    ...
    public void m4773transform58bKbWc(float[] fArr) {
        this.$this_asDrawTransform.getCanvas().m4207concat58bKbWc(fArr);
    }
}
