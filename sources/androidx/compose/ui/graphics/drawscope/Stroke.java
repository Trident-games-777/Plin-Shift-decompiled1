...
public final class Stroke extends DrawStyle {
    ...
    public static final int DefaultCap = StrokeCap.Companion.m4634getButtKaPHkGw();
    /* access modifiers changed from: private */
    public static final int DefaultJoin = StrokeJoin.Companion.m4645getMiterLxFBmk8();
    ...
    public final int m4951getCapKaPHkGw() {
        return this.cap;
    }

    /* renamed from: getJoin-LxFBmk8  reason: not valid java name */
    public final int m4952getJoinLxFBmk8() {
        return this.join;
    }
    ...
    public static final class Companion {
        ...
        public final int m4953getDefaultCapKaPHkGw() {
            return Stroke.DefaultCap;
        }

        /* renamed from: getDefaultJoin-LxFBmk8  reason: not valid java name */
        public final int m4954getDefaultJoinLxFBmk8() {
    ...
    public boolean equals(Object obj) {
        ...
        return this.width == stroke.width && this.miter == stroke.miter && StrokeCap.m4630equalsimpl0(this.cap, stroke.cap) && StrokeJoin.m4640equalsimpl0(this.join, stroke.join) && Intrinsics.areEqual((Object) this.pathEffect, (Object) stroke.pathEffect);
    }

    public int hashCode() {
        int hashCode = ((((((Float.hashCode(this.width) * 31) + Float.hashCode(this.miter)) * 31) + StrokeCap.m4631hashCodeimpl(this.cap)) * 31) + StrokeJoin.m4641hashCodeimpl(this.join)) * 31;
        PathEffect pathEffect2 = this.pathEffect;
        return hashCode + (pathEffect2 != null ? pathEffect2.hashCode() : 0);
    }

    public String toString() {
        return "Stroke(width=" + this.width + ", miter=" + this.miter + ", cap=" + StrokeCap.m4632toStringimpl(this.cap) + ", join=" + StrokeJoin.m4642toStringimpl(this.join) + ", pathEffect=" + this.pathEffect + ')';
    }
}
