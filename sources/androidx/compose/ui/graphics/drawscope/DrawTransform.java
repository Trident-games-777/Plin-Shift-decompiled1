...
public interface DrawTransform {
    ...
    void m4925clipPathmtrdDE(Path path, int i);

    /* renamed from: clipRect-N_I0leg  reason: not valid java name */
    void m4926clipRectN_I0leg(float f, float f2, float f3, float f4, int i);

    /* renamed from: getSize-NH-jbRc  reason: not valid java name */
    long m4928getSizeNHjbRc();

    void inset(float f, float f2, float f3, float f4);

    /* renamed from: rotate-Uv8p0NA  reason: not valid java name */
    void m4929rotateUv8p0NA(float f, long j);

    /* renamed from: scale-0AR0LA0  reason: not valid java name */
    void m4930scale0AR0LA0(float f, float f2, long j);

    /* renamed from: transform-58bKbWc  reason: not valid java name */
    void m4931transform58bKbWc(float[] fArr);
    ...
    public static final class DefaultImpls {
        ...
        public static long m4934getCenterF1C5BW0(DrawTransform drawTransform) {
            return DrawTransform.super.m4927getCenterF1C5BW0();
        }
    }

    /* renamed from: getCenter-F1C5BW0  reason: not valid java name */
    long m4927getCenterF1C5BW0() {
        float f = (float) 2;
        return OffsetKt.Offset(Size.m4056getWidthimpl(m4928getSizeNHjbRc()) / f, Size.m4053getHeightimpl(m4928getSizeNHjbRc()) / f);
    }

    /* renamed from: clipRect-N_I0leg$default  reason: not valid java name */
    static /* synthetic */ void m4922clipRectN_I0leg$default(DrawTransform drawTransform, float f, float f2, float f3, float f4, int i, int i2, Object obj) {
        if (obj == null) {
            if ((i2 & 1) != 0) {
                f = 0.0f;
            }
            ...
            if ((i2 & 4) != 0) {
                f3 = Size.m4056getWidthimpl(drawTransform.m4928getSizeNHjbRc());
            }
            if ((i2 & 8) != 0) {
                f4 = Size.m4053getHeightimpl(drawTransform.m4928getSizeNHjbRc());
            }
            if ((i2 & 16) != 0) {
                i = ClipOp.Companion.m4228getIntersectrtfAjoo();
            }
            drawTransform.m4926clipRectN_I0leg(f, f2, f3, f4, i);
            return;
        }
    ...
    static /* synthetic */ void m4921clipPathmtrdDE$default(DrawTransform drawTransform, Path path, int i, int i2, Object obj) {
        if (obj == null) {
            if ((i2 & 2) != 0) {
                i = ClipOp.Companion.m4228getIntersectrtfAjoo();
            }
            drawTransform.m4925clipPathmtrdDE(path, i);
            return;
        }
    ...
    static /* synthetic */ void m4923rotateUv8p0NA$default(DrawTransform drawTransform, float f, long j, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                j = drawTransform.m4927getCenterF1C5BW0();
            }
            drawTransform.m4929rotateUv8p0NA(f, j);
            return;
        }
    ...
    static /* synthetic */ void m4924scale0AR0LA0$default(DrawTransform drawTransform, float f, float f2, long j, int i, Object obj) {
        if (obj == null) {
            if ((i & 4) != 0) {
                j = drawTransform.m4927getCenterF1C5BW0();
            }
            drawTransform.m4930scale0AR0LA0(f, f2, j);
            return;
        }
