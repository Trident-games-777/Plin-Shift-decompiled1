...
public final class NodeKindKt {
    ...
    public static final boolean m6147contains64DMado(int i, int i2) {
        return (i & i2) != 0;
    }
    ...
    public static final int m6149or64DMado(int i, int i2) {
        return i | i2;
    }
    ...
    public static final int calculateNodeKindSetFrom(Modifier.Node node) {
        ...
        int r2 = NodeKind.m6139constructorimpl(1);
        if (node instanceof LayoutModifierNode) {
            r2 |= NodeKind.m6139constructorimpl(2);
        }
        if (node instanceof DrawModifierNode) {
            r2 |= NodeKind.m6139constructorimpl(4);
        }
        if (node instanceof SemanticsModifierNode) {
            r2 |= NodeKind.m6139constructorimpl(8);
        }
        if (node instanceof PointerInputModifierNode) {
            r2 |= NodeKind.m6139constructorimpl(16);
        }
        if (node instanceof ModifierLocalModifierNode) {
            r2 |= NodeKind.m6139constructorimpl(32);
        }
        if (node instanceof ParentDataModifierNode) {
            r2 |= NodeKind.m6139constructorimpl(64);
        }
        if (node instanceof LayoutAwareModifierNode) {
            r2 |= NodeKind.m6139constructorimpl(128);
        }
        if (node instanceof GlobalPositionAwareModifierNode) {
            r2 |= NodeKind.m6139constructorimpl(256);
        }
        if (node instanceof ApproachLayoutModifierNode) {
            r2 |= NodeKind.m6139constructorimpl(512);
        }
        if (node instanceof FocusTargetNode) {
            r2 |= NodeKind.m6139constructorimpl(1024);
        }
        if (node instanceof FocusPropertiesModifierNode) {
            r2 |= NodeKind.m6139constructorimpl(2048);
        }
        if (node instanceof FocusEventModifierNode) {
            r2 |= NodeKind.m6139constructorimpl(4096);
        }
        if (node instanceof KeyInputModifierNode) {
            r2 |= NodeKind.m6139constructorimpl(8192);
        }
        if (node instanceof RotaryInputModifierNode) {
            r2 |= NodeKind.m6139constructorimpl(16384);
        }
        if (node instanceof CompositionLocalConsumerModifierNode) {
            r2 |= NodeKind.m6139constructorimpl(32768);
        }
        if (node instanceof SoftKeyboardInterceptionModifierNode) {
            r2 |= NodeKind.m6139constructorimpl(131072);
        }
        if (node instanceof TraversableNode) {
            r2 |= NodeKind.m6139constructorimpl(262144);
        }
        mutableObjectIntMap.set(classKeyForObject, r2);
        return r2;
    }
    ...
    private static final void autoInvalidateNodeSelf(Modifier.Node node, int i, int i2) {
        if (i2 != 0 || node.getShouldAutoInvalidate()) {
            if ((NodeKind.m6139constructorimpl(2) & i) != 0 && (node instanceof LayoutModifierNode)) {
                LayoutModifierNodeKt.invalidateMeasurement((LayoutModifierNode) node);
                if (i2 == 2) {
                    DelegatableNodeKt.m5954requireCoordinator64DMado(node, NodeKind.m6139constructorimpl(2)).onRelease();
                }
            }
            if (!((NodeKind.m6139constructorimpl(128) & i) == 0 || !(node instanceof LayoutAwareModifierNode) || i2 == 2)) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateMeasurements$ui_release();
            }
            if (!((NodeKind.m6139constructorimpl(256) & i) == 0 || !(node instanceof GlobalPositionAwareModifierNode) || i2 == 2)) {
                DelegatableNodeKt.requireLayoutNode(node).invalidateOnPositioned$ui_release();
            }
            if ((NodeKind.m6139constructorimpl(4) & i) != 0 && (node instanceof DrawModifierNode)) {
                DrawModifierNodeKt.invalidateDraw((DrawModifierNode) node);
            }
            if ((NodeKind.m6139constructorimpl(8) & i) != 0 && (node instanceof SemanticsModifierNode)) {
                SemanticsModifierNodeKt.invalidateSemantics((SemanticsModifierNode) node);
            }
            if ((NodeKind.m6139constructorimpl(64) & i) != 0 && (node instanceof ParentDataModifierNode)) {
                ParentDataModifierNodeKt.invalidateParentData((ParentDataModifierNode) node);
            }
            if (!((NodeKind.m6139constructorimpl(1024) & i) == 0 || !(node instanceof FocusTargetNode) || i2 == 2)) {
                FocusTargetNodeKt.invalidateFocusTarget((FocusTargetNode) node);
            }
            if ((NodeKind.m6139constructorimpl(2048) & i) != 0 && (node instanceof FocusPropertiesModifierNode)) {
            ...
            if ((i & NodeKind.m6139constructorimpl(4096)) != 0 && (node instanceof FocusEventModifierNode)) {
    ...
    public static final boolean m6148getIncludeSelfInTraversalH91voCI(int i) {
        return (i & NodeKind.m6139constructorimpl(128)) != 0;
    }

    public static final int calculateNodeKindSetFrom(Modifier.Element element) {
        int r0 = NodeKind.m6139constructorimpl(1);
        if (element instanceof LayoutModifier) {
            r0 |= NodeKind.m6139constructorimpl(2);
        }
        if (element instanceof DrawModifier) {
            r0 |= NodeKind.m6139constructorimpl(4);
        }
        if (element instanceof SemanticsModifier) {
            r0 |= NodeKind.m6139constructorimpl(8);
        }
        if (element instanceof PointerInputModifier) {
            r0 |= NodeKind.m6139constructorimpl(16);
        }
        if ((element instanceof ModifierLocalConsumer) || (element instanceof ModifierLocalProvider)) {
            r0 |= NodeKind.m6139constructorimpl(32);
        }
        if (element instanceof FocusEventModifier) {
            r0 |= NodeKind.m6139constructorimpl(4096);
        }
        if (element instanceof FocusOrderModifier) {
            r0 |= NodeKind.m6139constructorimpl(2048);
        }
        if (element instanceof OnGloballyPositionedModifier) {
            r0 |= NodeKind.m6139constructorimpl(256);
        }
        if (element instanceof ParentDataModifier) {
            r0 |= NodeKind.m6139constructorimpl(64);
        }
        return ((element instanceof OnPlacedModifier) || (element instanceof OnRemeasuredModifier)) ? NodeKind.m6139constructorimpl(128) | r0 : r0;
    }
}
