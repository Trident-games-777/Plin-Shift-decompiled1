...
public interface OwnedLayer {
    ...
    void m6190inverseTransform58bKbWc(float[] fArr);

    /* renamed from: isInLayer-k-4lQ0M  reason: not valid java name */
    boolean m6191isInLayerk4lQ0M(long j);

    void mapBounds(MutableRect mutableRect, boolean z);

    /* renamed from: mapOffset-8S9VItk  reason: not valid java name */
    long m6192mapOffset8S9VItk(long j, boolean z);

    /* renamed from: move--gyyYBs  reason: not valid java name */
    void m6193movegyyYBs(long j);

    /* renamed from: resize-ozmzZPI  reason: not valid java name */
    void m6194resizeozmzZPI(long j);

    void reuseLayer(Function2<? super Canvas, ? super GraphicsLayer, Unit> function2, Function0<Unit> function0);

    /* renamed from: transform-58bKbWc  reason: not valid java name */
    void m6195transform58bKbWc(float[] fArr);
