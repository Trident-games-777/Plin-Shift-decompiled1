...
public final class SemanticsModifierNodeKt {
    ...
    public static final Rect touchBoundsInRoot(Modifier.Node node, boolean z) {
        ...
        if (!z) {
            return LayoutCoordinatesKt.boundsInRoot(DelegatableNodeKt.m5954requireCoordinator64DMado(node, NodeKind.m6139constructorimpl(8)));
        }
        return DelegatableNodeKt.m5954requireCoordinator64DMado(node, NodeKind.m6139constructorimpl(8)).touchBoundsInRoot();
    }
}
