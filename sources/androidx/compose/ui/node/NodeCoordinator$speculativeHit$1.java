...
final class NodeCoordinator$speculativeHit$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        this.this$0.m6098speculativeHitJHbHoSQ(NodeCoordinatorKt.m6137nextUntilhw7D004(this.$this_speculativeHit, this.$hitTestSource.m6135entityTypeOLwlOKw(), NodeKind.m6139constructorimpl(2)), this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer, this.$distanceFromEdge);
    }
}
