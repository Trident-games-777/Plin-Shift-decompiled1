...
public abstract class AlignmentLines {
    ...
    public abstract long m5935calculatePositionInParentR5De75A(NodeCoordinator nodeCoordinator, long j);
    ...
    public final void addAlignmentLine(AlignmentLine alignmentLine, int i, NodeCoordinator nodeCoordinator) {
        ...
        while (true) {
            Offset = m5935calculatePositionInParentR5De75A(nodeCoordinator, Offset);
        ...
        if (alignmentLine instanceof HorizontalAlignmentLine) {
            f = Offset.m3988getYimpl(Offset);
        } else {
            f = Offset.m3987getXimpl(Offset);
        }
