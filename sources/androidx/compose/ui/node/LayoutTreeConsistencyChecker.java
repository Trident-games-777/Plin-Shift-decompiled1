...
public final class LayoutTreeConsistencyChecker {
    ...
    private final boolean consistentLayoutState(LayoutNode layoutNode) {
        ...
        if (Intrinsics.areEqual((Object) layoutNode.isPlacedInLookahead(), (Object) true)) {
            ...
            return layoutNode.getLookaheadMeasurePending$ui_release() ? this.relayoutNodes.contains(layoutNode, true) || (parent$ui_release != null && parent$ui_release.getLookaheadMeasurePending$ui_release()) || layoutState$ui_release == LayoutNode.LayoutState.LookaheadMeasuring || (parent$ui_release != null && parent$ui_release.getMeasurePending$ui_release() && Intrinsics.areEqual((Object) layoutNode.getLookaheadRoot$ui_release(), (Object) layoutNode)) : !layoutNode.getLookaheadLayoutPending$ui_release() || this.relayoutNodes.contains(layoutNode, true) || parent$ui_release == null || parent$ui_release.getLookaheadMeasurePending$ui_release() || parent$ui_release.getLookaheadLayoutPending$ui_release() || layoutState$ui_release == LayoutNode.LayoutState.LookaheadMeasuring || layoutState$ui_release == LayoutNode.LayoutState.LookaheadLayingOut || (parent$ui_release.getLayoutPending$ui_release() && Intrinsics.areEqual((Object) layoutNode.getLookaheadRoot$ui_release(), (Object) layoutNode));
        }
    }
