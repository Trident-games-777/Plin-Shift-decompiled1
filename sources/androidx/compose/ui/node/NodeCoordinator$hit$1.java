...
final class NodeCoordinator$hit$1 extends Lambda implements Function0<Unit> {
    ...
    public final void invoke() {
        this.this$0.m6094hit1hIXUjU(NodeCoordinatorKt.m6137nextUntilhw7D004(this.$this_hit, this.$hitTestSource.m6135entityTypeOLwlOKw(), NodeKind.m6139constructorimpl(2)), this.$hitTestSource, this.$pointerPosition, this.$hitTestResult, this.$isTouchEvent, this.$isInLayer);
    }
}
