...
final class SaversKt$OffsetSaver$1 extends Lambda implements Function2<SaverScope, Offset, Object> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj, Object obj2) {
        return m6498invokeUv8p0NA((SaverScope) obj, ((Offset) obj2).m3997unboximpl());
    }

    /* renamed from: invoke-Uv8p0NA  reason: not valid java name */
    public final Object m6498invokeUv8p0NA(SaverScope saverScope, long j) {
        if (Offset.m3984equalsimpl0(j, Offset.Companion.m4002getUnspecifiedF1C5BW0())) {
            return (Serializable) false;
        }
        return CollectionsKt.arrayListOf(SaversKt.save(Float.valueOf(Offset.m3987getXimpl(j))), SaversKt.save(Float.valueOf(Offset.m3988getYimpl(j))));
    }
}
