...
public final class TextLayout_androidKt {
    ...
    public static final long VerticalPaddings(int i, int i2) {
        return VerticalPaddings.m6613constructorimpl((((long) i2) & 4294967295L) | (((long) i) << 32));
    }
    ...
    public static final Paint.FontMetricsInt getLastLineMetrics(TextLayout textLayout, TextPaint textPaint, TextDirectionHeuristic textDirectionHeuristic, LineHeightStyleSpan[] lineHeightStyleSpanArr) {
        ...
        int lineCount = textLayout.getLineCount() - 1;
        if (textLayout.getLayout().getLineStart(lineCount) != textLayout.getLayout().getLineEnd(lineCount) || lineHeightStyleSpanArr2 == null || lineHeightStyleSpanArr2.length == 0) {
            return null;
        }
        SpannableString spannableString = new SpannableString("​");
        LineHeightStyleSpan lineHeightStyleSpan = (LineHeightStyleSpan) ArraysKt.first((T[]) lineHeightStyleSpanArr2);
