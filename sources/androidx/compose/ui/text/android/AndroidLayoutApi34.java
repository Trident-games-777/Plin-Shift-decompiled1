...
public final class AndroidLayoutApi34 {
    ...
    public final int[] getRangeForRect$ui_text_release(TextLayout textLayout, RectF rectF, int i, Function2<? super RectF, ? super RectF, Boolean> function2) {
        ...
        return textLayout.getLayout().getRangeForRect(rectF, segmentFinder, new AndroidLayoutApi34$$ExternalSyntheticLambda0(function2));
    }
