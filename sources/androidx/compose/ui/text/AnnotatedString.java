...
public final class AnnotatedString implements CharSequence {
    ...
    public final AnnotatedString m6408subSequence5zctL8(long j) {
        return subSequence(TextRange.m6562getMinimpl(j), TextRange.m6561getMaximpl(j));
    }
    ...
    public final List<Range<LinkAnnotation>> getLinkAnnotations(int i, int i2) {
        List<Range<LinkAnnotation>> list;
        List<Range<? extends Object>> list2 = this.annotations;
        if (list2 != null) {
            ArrayList arrayList = new ArrayList(list2.size());
            int size = list2.size();
    ...
    public final boolean hasEqualAnnotations(AnnotatedString annotatedString) {
        return Intrinsics.areEqual((Object) this.annotations, (Object) annotatedString.annotations);
    }
    ...
    public static final class Builder implements Appendable {
        ...
        public final void addLink(LinkAnnotation.Url url, int i, int i2) {
            this.annotations.add(new MutableRange(url, i, i2, (String) null, 8, (DefaultConstructorMarker) null));
        }

        public final void addLink(LinkAnnotation.Clickable clickable, int i, int i2) {
            this.annotations.add(new MutableRange(clickable, i, i2, (String) null, 8, (DefaultConstructorMarker) null));
        }
        ...
        public final int pushLink(LinkAnnotation linkAnnotation) {
            MutableRange mutableRange = new MutableRange(linkAnnotation, this.text.length(), 0, (String) null, 12, (DefaultConstructorMarker) null);
            this.styleStack.add(mutableRange);
            this.annotations.add(mutableRange);
            return this.styleStack.size() - 1;
        }
