...
public final class AndroidTextStyle_androidKt {
    ...
    public static final PlatformParagraphStyle lerp(PlatformParagraphStyle platformParagraphStyle, PlatformParagraphStyle platformParagraphStyle2, float f) {
        ...
        return new PlatformParagraphStyle(((EmojiSupportMatch) SpanStyleKt.lerpDiscrete(EmojiSupportMatch.m6409boximpl(platformParagraphStyle.m6493getEmojiSupportMatch_3YsG6Y()), EmojiSupportMatch.m6409boximpl(platformParagraphStyle2.m6493getEmojiSupportMatch_3YsG6Y()), f)).m6415unboximpl(), ((Boolean) SpanStyleKt.lerpDiscrete(Boolean.valueOf(platformParagraphStyle.getIncludeFontPadding()), Boolean.valueOf(platformParagraphStyle2.getIncludeFontPadding()), f)).booleanValue(), (DefaultConstructorMarker) null);
    }
}
