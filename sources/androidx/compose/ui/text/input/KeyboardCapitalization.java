...
public final class KeyboardCapitalization {
    ...
    public static final int Characters = m6775constructorimpl(1);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int None = m6775constructorimpl(0);
    /* access modifiers changed from: private */
    public static final int Sentences = m6775constructorimpl(3);
    /* access modifiers changed from: private */
    public static final int Unspecified = m6775constructorimpl(-1);
    /* access modifiers changed from: private */
    public static final int Words = m6775constructorimpl(2);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ KeyboardCapitalization m6774boximpl(int i) {
        return new KeyboardCapitalization(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m6775constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m6776equalsimpl(int i, Object obj) {
        return (obj instanceof KeyboardCapitalization) && i == ((KeyboardCapitalization) obj).m6780unboximpl();
    }
    ...
    public boolean equals(Object obj) {
        return m6776equalsimpl(this.value, obj);
    }

    public int hashCode() {
        return m6778hashCodeimpl(this.value);
    }
    ...
    public String toString() {
        return m6779toStringimpl(this.value);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m6779toStringimpl(int i) {
        if (m6777equalsimpl0(i, Unspecified)) {
            return "Unspecified";
        }
        if (m6777equalsimpl0(i, None)) {
            return "None";
        }
        if (m6777equalsimpl0(i, Characters)) {
            return "Characters";
        }
        if (m6777equalsimpl0(i, Words)) {
            return "Words";
        }
        if (m6777equalsimpl0(i, Sentences)) {
            return "Sentences";
        }
        return "Invalid";
    }
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m6781getCharactersIUNYP9k$annotations() {
        }

        /* renamed from: getNone-IUNYP9k$annotations  reason: not valid java name */
        public static /* synthetic */ void m6782getNoneIUNYP9k$annotations() {
        }

        /* renamed from: getSentences-IUNYP9k$annotations  reason: not valid java name */
        public static /* synthetic */ void m6783getSentencesIUNYP9k$annotations() {
        }

        /* renamed from: getUnspecified-IUNYP9k$annotations  reason: not valid java name */
        public static /* synthetic */ void m6784getUnspecifiedIUNYP9k$annotations() {
        }

        /* renamed from: getWords-IUNYP9k$annotations  reason: not valid java name */
        public static /* synthetic */ void m6785getWordsIUNYP9k$annotations() {
        }
        ...
        public final int m6789getUnspecifiedIUNYP9k() {
            return KeyboardCapitalization.Unspecified;
        }

        /* renamed from: getNone-IUNYP9k  reason: not valid java name */
        public final int m6787getNoneIUNYP9k() {
            return KeyboardCapitalization.None;
        }

        /* renamed from: getCharacters-IUNYP9k  reason: not valid java name */
        public final int m6786getCharactersIUNYP9k() {
            return KeyboardCapitalization.Characters;
        }

        /* renamed from: getWords-IUNYP9k  reason: not valid java name */
        public final int m6790getWordsIUNYP9k() {
            return KeyboardCapitalization.Words;
        }

        /* renamed from: getSentences-IUNYP9k  reason: not valid java name */
        public final int m6788getSentencesIUNYP9k() {
