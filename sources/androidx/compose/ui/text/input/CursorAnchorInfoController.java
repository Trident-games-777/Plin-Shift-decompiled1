...
public final class CursorAnchorInfoController {
    ...
    private final void updateCursorAnchorInfo() {
        if (this.inputMethodManager.isActive()) {
            this.textFieldToRootTransform.invoke(androidx.compose.ui.graphics.Matrix.m4472boximpl(this.matrix));
            this.rootPositionCalculator.m5671localToScreen58bKbWc(this.matrix);
