...
public final class EditingBuffer {
    ...
    private EditingBuffer(AnnotatedString annotatedString, long j) {
        ...
        this.selectionStart = TextRange.m6562getMinimpl(j);
        this.selectionEnd = TextRange.m6561getMaximpl(j);
        this.compositionStart = -1;
        this.compositionEnd = -1;
        int r0 = TextRange.m6562getMinimpl(j);
        int r5 = TextRange.m6561getMaximpl(j);
    ...
    public final TextRange m6735getCompositionMzsxiRA$ui_text_release() {
    ...
    public final long m6736getSelectiond9O1mEE$ui_text_release() {
    ...
    public final void delete$ui_text_release(int i, int i2) {
        ...
        long r5 = EditingBufferKt.m6737updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.selectionStart, this.selectionEnd), TextRange);
        setSelectionStart(TextRange.m6562getMinimpl(r5));
        setSelectionEnd(TextRange.m6561getMaximpl(r5));
        if (hasComposition$ui_text_release()) {
            long r52 = EditingBufferKt.m6737updateRangeAfterDeletepWDy79M(TextRangeKt.TextRange(this.compositionStart, this.compositionEnd), TextRange);
            if (TextRange.m6558getCollapsedimpl(r52)) {
                commitComposition$ui_text_release();
                return;
            }
            this.compositionStart = TextRange.m6562getMinimpl(r52);
            this.compositionEnd = TextRange.m6561getMaximpl(r52);
        }
    }
