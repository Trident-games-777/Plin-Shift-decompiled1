    ...
    public void applyTo(EditingBuffer editingBuffer) {
        ...
        while (true) {
            if (i3 < i) {
                ...
                if (editingBuffer.getSelectionStart$ui_text_release() <= i5) {
                    ...
                    i4 = EditCommandKt.access$isSurrogatePair(editingBuffer.get$ui_text_release((editingBuffer.getSelectionStart$ui_text_release() - i5) + -1), editingBuffer.get$ui_text_release(editingBuffer.getSelectionStart$ui_text_release() - i5)) ? i4 + 2 : i5;
                    i3++;
                }
            } else {
                break;
        ...
        while (true) {
            ...
            if (editingBuffer.getSelectionEnd$ui_text_release() + i8 >= editingBuffer.getLength$ui_text_release()) {
                ...
                i7 = EditCommandKt.access$isSurrogatePair(editingBuffer.get$ui_text_release((editingBuffer.getSelectionEnd$ui_text_release() + i8) + -1), editingBuffer.get$ui_text_release(editingBuffer.getSelectionEnd$ui_text_release() + i8)) ? i7 + 2 : i8;
                i2++;
            }
        }
