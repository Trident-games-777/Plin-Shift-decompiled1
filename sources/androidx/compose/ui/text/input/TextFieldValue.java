...
public final class TextFieldValue {
    ...
    private TextFieldValue(AnnotatedString annotatedString2, long j, TextRange textRange) {
        ...
        this.selection = TextRangeKt.m6570coerceIn8ffj60Q(j, 0, getText().length());
        this.composition = textRange != null ? TextRange.m6552boximpl(TextRangeKt.m6570coerceIn8ffj60Q(textRange.m6568unboximpl(), 0, getText().length())) : null;
    }
    ...
    public /* synthetic */ TextFieldValue(AnnotatedString annotatedString2, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(annotatedString2, (i & 2) != 0 ? TextRange.Companion.m6569getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ TextFieldValue(String str, long j, TextRange textRange, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this((i & 1) != 0 ? "" : str, (i & 2) != 0 ? TextRange.Companion.m6569getZerod9O1mEE() : j, (i & 4) != 0 ? null : textRange, (DefaultConstructorMarker) null);
    }
    ...
    public final long m6823getSelectiond9O1mEE() {
        return this.selection;
    }

    /* renamed from: getComposition-MzsxiRA  reason: not valid java name */
    public final TextRange m6822getCompositionMzsxiRA() {
        return this.composition;
    }

    /* renamed from: copy-3r_uNRQ$default  reason: not valid java name */
    public static /* synthetic */ TextFieldValue m6818copy3r_uNRQ$default(TextFieldValue textFieldValue, AnnotatedString annotatedString2, long j, TextRange textRange, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textFieldValue.m6820copy3r_uNRQ(annotatedString2, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ  reason: not valid java name */
    public final TextFieldValue m6820copy3r_uNRQ(AnnotatedString annotatedString2, long j, TextRange textRange) {
        return new TextFieldValue(annotatedString2, j, textRange, (DefaultConstructorMarker) null);
    }

    /* renamed from: copy-3r_uNRQ$default  reason: not valid java name */
    public static /* synthetic */ TextFieldValue m6819copy3r_uNRQ$default(TextFieldValue textFieldValue, String str, long j, TextRange textRange, int i, Object obj) {
        if ((i & 2) != 0) {
            j = textFieldValue.selection;
        }
        if ((i & 4) != 0) {
        ...
        return textFieldValue.m6821copy3r_uNRQ(str, j, textRange);
    }

    /* renamed from: copy-3r_uNRQ  reason: not valid java name */
    public final TextFieldValue m6821copy3r_uNRQ(String str, long j, TextRange textRange) {
    ...
    public boolean equals(Object obj) {
        ...
        return TextRange.m6557equalsimpl0(this.selection, textFieldValue.selection) && Intrinsics.areEqual((Object) this.composition, (Object) textFieldValue.composition) && Intrinsics.areEqual((Object) this.annotatedString, (Object) textFieldValue.annotatedString);
    }

    public int hashCode() {
        int hashCode = ((this.annotatedString.hashCode() * 31) + TextRange.m6565hashCodeimpl(this.selection)) * 31;
        TextRange textRange = this.composition;
        return hashCode + (textRange != null ? TextRange.m6565hashCodeimpl(textRange.m6568unboximpl()) : 0);
    }

    public String toString() {
        return "TextFieldValue(text='" + this.annotatedString + "', selection=" + TextRange.m6567toStringimpl(this.selection) + ", composition=" + this.composition + ')';
    }
