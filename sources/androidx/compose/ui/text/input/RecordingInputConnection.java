...
public final class RecordingInputConnection implements InputConnection {
    ...
    public final void updateInputState(TextFieldValue textFieldValue, InputMethodManager inputMethodManager) {
        if (this.isActive) {
            ...
            TextRange r0 = textFieldValue.m6822getCompositionMzsxiRA();
            int i = -1;
            int r02 = r0 != null ? TextRange.m6562getMinimpl(r0.m6568unboximpl()) : -1;
            TextRange r2 = textFieldValue.m6822getCompositionMzsxiRA();
            if (r2 != null) {
                i = TextRange.m6561getMaximpl(r2.m6568unboximpl());
            }
            inputMethodManager.updateSelection(TextRange.m6562getMinimpl(textFieldValue.m6823getSelectiond9O1mEE()), TextRange.m6561getMaximpl(textFieldValue.m6823getSelectiond9O1mEE()), r02, i);
        }
    }
    ...
    public CharSequence getSelectedText(int i) {
        if (TextRange.m6558getCollapsedimpl(this.mTextFieldValue.m6823getSelectiond9O1mEE())) {
            return null;
        }
    ...
    public int getCursorCapsMode(int i) {
        return TextUtils.getCapsMode(this.mTextFieldValue.getText(), TextRange.m6562getMinimpl(this.mTextFieldValue.m6823getSelectiond9O1mEE()), i);
    }
    ...
    public boolean performEditorAction(int i) {
        ...
        this.eventCallback.m6773onImeActionKlQnJC8(i2);
        return true;
    }
