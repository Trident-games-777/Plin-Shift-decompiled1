...
final class SaversKt$SpanStyleSaver$1 extends Lambda implements Function2<SaverScope, SpanStyle, Object> {
    ...
    public final Object invoke(SaverScope saverScope, SpanStyle spanStyle) {
        ...
        return CollectionsKt.arrayListOf(SaversKt.save(Color.m4229boximpl(spanStyle.m6514getColor0d7_KjU()), SaversKt.getSaver(Color.Companion), saverScope2), SaversKt.save(TextUnit.m7296boximpl(spanStyle.m6515getFontSizeXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), saverScope2), SaversKt.save(spanStyle.getFontWeight(), SaversKt.getSaver(FontWeight.Companion), saverScope2), SaversKt.save(spanStyle.m6516getFontStyle4Lr2A7w()), SaversKt.save(spanStyle.m6517getFontSynthesisZQGJjVo()), SaversKt.save(-1), SaversKt.save(spanStyle.getFontFeatureSettings()), SaversKt.save(TextUnit.m7296boximpl(spanStyle.m6518getLetterSpacingXSAIIZE()), SaversKt.getSaver(TextUnit.Companion), saverScope2), SaversKt.save(spanStyle.m6513getBaselineShift5SSeXJ0(), SaversKt.getSaver(BaselineShift.Companion), saverScope2), SaversKt.save(spanStyle.getTextGeometricTransform(), SaversKt.getSaver(TextGeometricTransform.Companion), saverScope2), SaversKt.save(spanStyle.getLocaleList(), SaversKt.getSaver(LocaleList.Companion), saverScope2), SaversKt.save(Color.m4229boximpl(spanStyle.m6512getBackground0d7_KjU()), SaversKt.getSaver(Color.Companion), saverScope2), SaversKt.save(spanStyle.getTextDecoration(), SaversKt.getSaver(TextDecoration.Companion), saverScope2), SaversKt.save(spanStyle.getShadow(), SaversKt.getSaver(Shadow.Companion), saverScope2));
    }
}
