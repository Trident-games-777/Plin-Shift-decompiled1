...
public final class AndroidParagraphIntrinsics implements ParagraphIntrinsics {
    ...
    public AndroidParagraphIntrinsics(String str, TextStyle textStyle, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, FontFamily.Resolver resolver, Density density2) {
        ...
        this.textDirectionHeuristic = AndroidParagraphIntrinsics_androidKt.m6837resolveTextDirectionHeuristicsHklW4sA(textStyle.m6607getTextDirections_7Xco(), textStyle.getLocaleList());
    ...
    public boolean getHasStaleResolvedFonts() {
        ...
        if (this.emojiCompatProcessed || !AndroidParagraphIntrinsics_androidKt.getHasEmojiCompat(this.style) || !EmojiCompatStatus.INSTANCE.getFontLoaded().getValue().booleanValue()) {
            return false;
        }
        return true;
    }
