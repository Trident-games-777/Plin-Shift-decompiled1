...
final class SpannableExtensions_androidKt$setFontAttributes$1 extends Lambda implements Function3<SpanStyle, Integer, Integer, Unit> {
    ...
    public final void invoke(SpanStyle spanStyle, int i, int i2) {
        ...
        FontStyle r5 = spanStyle.m6516getFontStyle4Lr2A7w();
        FontStyle r52 = FontStyle.m6675boximpl(r5 != null ? r5.m6681unboximpl() : FontStyle.Companion.m6685getNormal_LCdwA());
        FontSynthesis r7 = spanStyle.m6517getFontSynthesisZQGJjVo();
        spannable.setSpan(new TypefaceSpan(function4.invoke(fontFamily, fontWeight, r52, FontSynthesis.m6686boximpl(r7 != null ? r7.m6694unboximpl() : FontSynthesis.Companion.m6695getAllGVVA2EU()))), i, i2, 33);
    }
}
