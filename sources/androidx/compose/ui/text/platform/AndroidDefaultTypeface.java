...
public final class AndroidDefaultTypeface implements AndroidTypeface {
    ...
    public Typeface m6829getNativeTypefacePYhJU0U(FontWeight fontWeight, int i, int i2) {
        return TypefaceHelperMethodsApi28.INSTANCE.create(Typeface.DEFAULT, fontWeight.getWeight(), FontStyle.m6678equalsimpl0(i, FontStyle.Companion.m6684getItalic_LCdwA()));
    }
}
