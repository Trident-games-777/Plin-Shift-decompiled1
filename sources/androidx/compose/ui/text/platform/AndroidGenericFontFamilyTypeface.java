...
public final class AndroidGenericFontFamilyTypeface implements AndroidTypeface {
    ...
    public Typeface m6832getNativeTypefacePYhJU0U(FontWeight fontWeight, int i, int i2) {
        return m6831buildStyledTypefaceFO1MlWM(fontWeight, i);
    }

    /* renamed from: buildStyledTypeface-FO1MlWM  reason: not valid java name */
    private final Typeface m6831buildStyledTypefaceFO1MlWM(FontWeight fontWeight, int i) {
        return TypefaceHelperMethodsApi28.INSTANCE.create(this.nativeTypeface, fontWeight.getWeight(), FontStyle.m6678equalsimpl0(i, FontStyle.Companion.m6684getItalic_LCdwA()));
    }
}
