...
public final class TextIndent {
    ...
    public final long m7012getFirstLineXSAIIZE() {
        return this.firstLine;
    }

    /* renamed from: getRestLine-XSAIIZE  reason: not valid java name */
    public final long m7013getRestLineXSAIIZE() {
    ...
    public static /* synthetic */ TextIndent m7010copyNB67dxo$default(TextIndent textIndent, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
        ...
        return textIndent.m7011copyNB67dxo(j, j2);
    }

    /* renamed from: copy-NB67dxo  reason: not valid java name */
    public final TextIndent m7011copyNB67dxo(long j, long j2) {
    ...
    public boolean equals(Object obj) {
        ...
        return TextUnit.m7303equalsimpl0(this.firstLine, textIndent.firstLine) && TextUnit.m7303equalsimpl0(this.restLine, textIndent.restLine);
    }

    public int hashCode() {
        return (TextUnit.m7307hashCodeimpl(this.firstLine) * 31) + TextUnit.m7307hashCodeimpl(this.restLine);
    }

    public String toString() {
        return "TextIndent(firstLine=" + TextUnit.m7313toStringimpl(this.firstLine) + ", restLine=" + TextUnit.m7313toStringimpl(this.restLine) + ')';
    }
}
