...
public final class TextDrawStyleKt {
    public static final TextForegroundStyle lerp(TextForegroundStyle textForegroundStyle, TextForegroundStyle textForegroundStyle2, float f) {
        ...
        if (!z && !(textForegroundStyle2 instanceof BrushStyle)) {
            return TextForegroundStyle.Companion.m7008from8_81llA(ColorKt.m4290lerpjxsXWHM(textForegroundStyle.m7007getColor0d7_KjU(), textForegroundStyle2.m7007getColor0d7_KjU(), f));
        }
        if (!z || !(textForegroundStyle2 instanceof BrushStyle)) {
    ...
    public static final long m7006modulateDxMtmZc(long j, float f) {
