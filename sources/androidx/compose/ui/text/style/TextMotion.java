...
public final class TextMotion {
    ...
    public static final TextMotion Animated = new TextMotion(Linearity.Companion.m7025getLinear4e0Vf04(), true, (DefaultConstructorMarker) null);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final TextMotion Static = new TextMotion(Linearity.Companion.m7024getFontHinting4e0Vf04(), false, (DefaultConstructorMarker) null);
    ...
    public final int m7016getLinearity4e0Vf04$ui_text_release() {
    ...
    public static /* synthetic */ TextMotion m7014copyJdDtMQo$ui_text_release$default(TextMotion textMotion, int i, boolean z, int i2, Object obj) {
        if ((i2 & 1) != 0) {
        ...
        return textMotion.m7015copyJdDtMQo$ui_text_release(i, z);
    }

    /* renamed from: copy-JdDtMQo$ui_text_release  reason: not valid java name */
    public final TextMotion m7015copyJdDtMQo$ui_text_release(int i, boolean z) {
    ...
    public boolean equals(Object obj) {
        ...
        return Linearity.m7020equalsimpl0(this.linearity, textMotion.linearity) && this.subpixelTextPositioning == textMotion.subpixelTextPositioning;
    }

    public int hashCode() {
        return (Linearity.m7021hashCodeimpl(this.linearity) * 31) + Boolean.hashCode(this.subpixelTextPositioning);
    }
    ...
    public static final class Linearity {
        public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
        /* access modifiers changed from: private */
        public static final int FontHinting = m7018constructorimpl(2);
        /* access modifiers changed from: private */
        public static final int Linear = m7018constructorimpl(1);
        /* access modifiers changed from: private */
        public static final int None = m7018constructorimpl(3);
        private final int value;

        /* renamed from: box-impl  reason: not valid java name */
        public static final /* synthetic */ Linearity m7017boximpl(int i) {
        ...
        public static boolean m7019equalsimpl(int i, Object obj) {
            return (obj instanceof Linearity) && i == ((Linearity) obj).m7023unboximpl();
        }
        ...
        public boolean equals(Object obj) {
            return m7019equalsimpl(this.value, obj);
        }
        ...
        public final /* synthetic */ int m7023unboximpl() {
            return this.value;
        }
        ...
        public static final class Companion {
            ...
            public final int m7025getLinear4e0Vf04() {
                return Linearity.Linear;
            }

            /* renamed from: getFontHinting-4e0Vf04  reason: not valid java name */
            public final int m7024getFontHinting4e0Vf04() {
                return Linearity.FontHinting;
            }

            /* renamed from: getNone-4e0Vf04  reason: not valid java name */
            public final int m7026getNone4e0Vf04() {
        ...
        public static String m7022toStringimpl(int i) {
            if (m7020equalsimpl0(i, Linear)) {
                return "Linearity.Linear";
            }
            if (m7020equalsimpl0(i, FontHinting)) {
                return "Linearity.FontHinting";
            }
            if (m7020equalsimpl0(i, None)) {
                return "Linearity.None";
            }
            return "Invalid";
        }
