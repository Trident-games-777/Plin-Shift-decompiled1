...
public final class Hyphens {
    ...
    public static final int Auto = m6890constructorimpl(2);
    public static final Companion Companion = new Companion((DefaultConstructorMarker) null);
    /* access modifiers changed from: private */
    public static final int None = m6890constructorimpl(1);
    /* access modifiers changed from: private */
    public static final int Unspecified = m6890constructorimpl(Integer.MIN_VALUE);
    private final int value;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ Hyphens m6889boximpl(int i) {
        return new Hyphens(i);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    private static int m6890constructorimpl(int i) {
        return i;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m6891equalsimpl(int i, Object obj) {
        return (obj instanceof Hyphens) && i == ((Hyphens) obj).m6895unboximpl();
    }
    ...
    public final /* synthetic */ int m6895unboximpl() {
        return this.value;
    }
    ...
    public static String m6894toStringimpl(int i) {
        if (m6892equalsimpl0(i, None)) {
            return "Hyphens.None";
        }
        if (m6892equalsimpl0(i, Auto)) {
            return "Hyphens.Auto";
        }
        if (m6892equalsimpl0(i, Unspecified)) {
            return "Hyphens.Unspecified";
        }
        return "Invalid";
    }
