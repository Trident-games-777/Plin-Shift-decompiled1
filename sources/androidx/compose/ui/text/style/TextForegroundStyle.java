...
public interface TextForegroundStyle {
    ...
    public static final class Unspecified implements TextForegroundStyle {
        ...
        /* renamed from: getColor-0d7_KjU  reason: not valid java name */
        public long m7009getColor0d7_KjU() {
    ...
    public static final class Companion {
        ...
        public final TextForegroundStyle m7008from8_81llA(long j) {
            return j != 16 ? new ColorStyle(j, (DefaultConstructorMarker) null) : Unspecified.INSTANCE;
        }
        ...
        public final TextForegroundStyle from(Brush brush, float f) {
            ...
            if (brush instanceof SolidColor) {
                return m7008from8_81llA(TextDrawStyleKt.m7006modulateDxMtmZc(((SolidColor) brush).m4616getValue0d7_KjU(), f));
            }
