...
final class ColorStyle implements TextForegroundStyle {
    ...
    public static /* synthetic */ ColorStyle m6884copy8_81llA$default(ColorStyle colorStyle, long j, int i, Object obj) {
        if ((i & 1) != 0) {
            j = colorStyle.value;
        }
        return colorStyle.m6886copy8_81llA(j);
    }

    /* renamed from: component1-0d7_KjU  reason: not valid java name */
    public final long m6885component10d7_KjU() {
        return this.value;
    }

    /* renamed from: copy-8_81llA  reason: not valid java name */
    public final ColorStyle m6886copy8_81llA(long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return (obj instanceof ColorStyle) && Color.m4240equalsimpl0(this.value, ((ColorStyle) obj).value);
    }
    ...
    public int hashCode() {
        return Color.m4246hashCodeimpl(this.value);
    }

    public String toString() {
        return "ColorStyle(value=" + Color.m4247toStringimpl(this.value) + ')';
    }
    ...
    public final long m6888getValue0d7_KjU() {
        return this.value;
    }

    /* renamed from: getColor-0d7_KjU  reason: not valid java name */
    public long m6887getColor0d7_KjU() {
        return this.value;
    }

    public float getAlpha() {
        return Color.m4241getAlphaimpl(m6887getColor0d7_KjU());
    }
}
