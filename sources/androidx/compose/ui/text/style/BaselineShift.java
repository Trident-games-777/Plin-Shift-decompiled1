...
public final class BaselineShift {
    ...
    public static final float None = m6870constructorimpl(0.0f);
    /* access modifiers changed from: private */
    public static final float Subscript = m6870constructorimpl(-0.5f);
    /* access modifiers changed from: private */
    public static final float Superscript = m6870constructorimpl(0.5f);
    private final float multiplier;

    /* renamed from: box-impl  reason: not valid java name */
    public static final /* synthetic */ BaselineShift m6869boximpl(float f) {
        return new BaselineShift(f);
    }

    /* renamed from: constructor-impl  reason: not valid java name */
    public static float m6870constructorimpl(float f) {
        return f;
    }

    /* renamed from: equals-impl  reason: not valid java name */
    public static boolean m6871equalsimpl(float f, Object obj) {
        return (obj instanceof BaselineShift) && Float.compare(f, ((BaselineShift) obj).m6875unboximpl()) == 0;
    }

    /* renamed from: equals-impl0  reason: not valid java name */
    public static final boolean m6872equalsimpl0(float f, float f2) {
        return Float.compare(f, f2) == 0;
    }

    /* renamed from: hashCode-impl  reason: not valid java name */
    public static int m6873hashCodeimpl(float f) {
        return Float.hashCode(f);
    }

    /* renamed from: toString-impl  reason: not valid java name */
    public static String m6874toStringimpl(float f) {
        return "BaselineShift(multiplier=" + f + ')';
    }

    public boolean equals(Object obj) {
        return m6871equalsimpl(this.multiplier, obj);
    }

    public int hashCode() {
        return m6873hashCodeimpl(this.multiplier);
    }

    public String toString() {
        return m6874toStringimpl(this.multiplier);
    }

    /* renamed from: unbox-impl  reason: not valid java name */
    public final /* synthetic */ float m6875unboximpl() {
    ...
    public static final class Companion {
        ...
        public static /* synthetic */ void m6876getNoney9eOQZs$annotations() {
        }

        /* renamed from: getSubscript-y9eOQZs$annotations  reason: not valid java name */
        public static /* synthetic */ void m6877getSubscripty9eOQZs$annotations() {
        }

        /* renamed from: getSuperscript-y9eOQZs$annotations  reason: not valid java name */
        public static /* synthetic */ void m6878getSuperscripty9eOQZs$annotations() {
        }
