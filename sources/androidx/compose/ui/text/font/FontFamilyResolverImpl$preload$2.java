...
final class FontFamilyResolverImpl$preload$2 extends Lambda implements Function1<TypefaceRequest, TypefaceResult> {
    ...
    public final TypefaceResult invoke(TypefaceRequest typefaceRequest) {
        ...
        TypefaceResult resolve2 = this.this$0.platformFamilyTypefaceAdapter.resolve(typefaceRequest, this.this$0.getPlatformFontLoader$ui_text_release(), AnonymousClass2.INSTANCE, this.this$0.createDefaultTypeface);
        if (resolve2 != null) {
            return resolve2;
        }
