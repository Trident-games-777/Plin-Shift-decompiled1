...
public final class TypefaceRequest {
    ...
    public static /* synthetic */ TypefaceRequest m6727copye1PVR60$default(TypefaceRequest typefaceRequest, FontFamily fontFamily2, FontWeight fontWeight2, int i, int i2, Object obj, int i3, Object obj2) {
        if ((i3 & 1) != 0) {
        ...
        int i4 = i2;
        Object obj3 = obj;
        return typefaceRequest.m6730copye1PVR60(fontFamily2, fontWeight2, i, i4, obj3);
    }
    ...
    public final int m6728component3_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: component4-GVVA2EU  reason: not valid java name */
    public final int m6729component4GVVA2EU() {
    ...
    public final TypefaceRequest m6730copye1PVR60(FontFamily fontFamily2, FontWeight fontWeight2, int i, int i2, Object obj) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.fontFamily, (Object) typefaceRequest.fontFamily) && Intrinsics.areEqual((Object) this.fontWeight, (Object) typefaceRequest.fontWeight) && FontStyle.m6678equalsimpl0(this.fontStyle, typefaceRequest.fontStyle) && FontSynthesis.m6689equalsimpl0(this.fontSynthesis, typefaceRequest.fontSynthesis) && Intrinsics.areEqual(this.resourceLoaderCacheKey, typefaceRequest.resourceLoaderCacheKey);
    }

    public int hashCode() {
        FontFamily fontFamily2 = this.fontFamily;
        int i = 0;
        int hashCode = (((((((fontFamily2 == null ? 0 : fontFamily2.hashCode()) * 31) + this.fontWeight.hashCode()) * 31) + FontStyle.m6679hashCodeimpl(this.fontStyle)) * 31) + FontSynthesis.m6690hashCodeimpl(this.fontSynthesis)) * 31;
    ...
    public String toString() {
        return "TypefaceRequest(fontFamily=" + this.fontFamily + ", fontWeight=" + this.fontWeight + ", fontStyle=" + FontStyle.m6680toStringimpl(this.fontStyle) + ", fontSynthesis=" + FontSynthesis.m6693toStringimpl(this.fontSynthesis) + ", resourceLoaderCacheKey=" + this.resourceLoaderCacheKey + ')';
    }
    ...
    public final int m6731getFontStyle_LCdwA() {
        return this.fontStyle;
    }

    /* renamed from: getFontSynthesis-GVVA2EU  reason: not valid java name */
    public final int m6732getFontSynthesisGVVA2EU() {
        return this.fontSynthesis;
    }
