...
public final class FontFamilyResolver_androidKt {
    ...
    public static /* synthetic */ State m6655resolveAsTypefaceWqqsr6A$default(FontFamily.Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
            fontFamily = null;
        }
        if ((i3 & 2) != 0) {
        ...
        if ((i3 & 8) != 0) {
            i2 = FontSynthesis.Companion.m6695getAllGVVA2EU();
        }
        return m6654resolveAsTypefaceWqqsr6A(resolver, fontFamily, fontWeight, i, i2);
    }

    /* renamed from: resolveAsTypeface-Wqqsr6A  reason: not valid java name */
    public static final State<Typeface> m6654resolveAsTypefaceWqqsr6A(FontFamily.Resolver resolver, FontFamily fontFamily, FontWeight fontWeight, int i, int i2) {
        State<Object> r0 = resolver.m6652resolveDPcqOEQ(fontFamily, fontWeight, i, i2);
