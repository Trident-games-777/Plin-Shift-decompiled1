...
public final class PlatformFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> function1, Function1<? super TypefaceRequest, ? extends Object> function12) {
        ...
        if (z) {
            typeface = this.platformTypefaceResolver.m6705createDefaultFO1MlWM(typefaceRequest.getFontWeight(), typefaceRequest.m6731getFontStyle_LCdwA());
        } else if (fontFamily instanceof GenericFontFamily) {
            typeface = this.platformTypefaceResolver.m6706createNamedRetOiIg((GenericFontFamily) typefaceRequest.getFontFamily(), typefaceRequest.getFontWeight(), typefaceRequest.m6731getFontStyle_LCdwA());
            ...
            typeface = ((AndroidTypeface) typeface2).m6849getNativeTypefacePYhJU0U(typefaceRequest.getFontWeight(), typefaceRequest.m6731getFontStyle_LCdwA(), typefaceRequest.m6732getFontSynthesisGVVA2EU());
        }
