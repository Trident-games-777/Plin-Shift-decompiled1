...
public final class AndroidFontUtils_androidKt {
    ...
    public static final int m6628getAndroidTypefaceStyleFO1MlWM(FontWeight fontWeight, int i) {
        return getAndroidTypefaceStyle(fontWeight.compareTo(getAndroidBold(FontWeight.Companion)) >= 0, FontStyle.m6678equalsimpl0(i, FontStyle.Companion.m6684getItalic_LCdwA()));
    }
}
