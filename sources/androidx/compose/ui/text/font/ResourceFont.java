...
public final class ResourceFont implements Font {
    ...
    public static /* synthetic */ void m6722getLoadingStrategyPKNRLFQ$annotations() {
    }
    ...
    public /* synthetic */ ResourceFont(int r8, androidx.compose.ui.text.font.FontWeight r9, int r10, androidx.compose.ui.text.font.FontVariation.Settings r11, int r12, int r13, kotlin.jvm.internal.DefaultConstructorMarker r14) {
        ...
        L_0x000a:
            ...
            int r10 = r9.m6685getNormal_LCdwA()
        L_0x0015:
            r3 = r10
            r9 = r13 & 8
            ...
            androidx.compose.ui.text.font.FontVariation$Settings r11 = r9.m6700Settings6EWAqTQ(r2, r3, r10)
        L_0x0023:
            r4 = r11
            r9 = r13 & 16
            ...
            int r12 = r9.m6669getAsyncPKNRLFQ()
        L_0x002e:
            r5 = r12
            r6 = 0
            r0 = r7
    ...
    public int m6726getStyle_LCdwA() {
        return this.style;
    }
    ...
    public int m6725getLoadingStrategyPKNRLFQ() {
        return this.loadingStrategy;
    }

    /* renamed from: copy-RetOiIg$default  reason: not valid java name */
    public static /* synthetic */ ResourceFont m6721copyRetOiIg$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        if ((i3 & 4) != 0) {
            i2 = resourceFont.m6726getStyle_LCdwA();
        }
        return resourceFont.m6724copyRetOiIg(i, fontWeight, i2);
    }

    /* renamed from: copy-RetOiIg  reason: not valid java name */
    public final ResourceFont m6724copyRetOiIg(int i, FontWeight fontWeight, int i2) {
        return m6720copyF3nL8kk$default(this, i, fontWeight, i2, m6725getLoadingStrategyPKNRLFQ(), (FontVariation.Settings) null, 16, (Object) null);
    }

    /* renamed from: copy-F3nL8kk$default  reason: not valid java name */
    public static /* synthetic */ ResourceFont m6720copyF3nL8kk$default(ResourceFont resourceFont, int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings, int i4, Object obj) {
        if ((i4 & 1) != 0) {
            i = resourceFont.resId;
        }
        if ((i4 & 2) != 0) {
        ...
        if ((i4 & 8) != 0) {
            i3 = resourceFont.m6725getLoadingStrategyPKNRLFQ();
        }
        if ((i4 & 16) != 0) {
        ...
        return resourceFont.m6723copyF3nL8kk(i, fontWeight, i2, i5, settings2);
    }

    /* renamed from: copy-F3nL8kk  reason: not valid java name */
    public final ResourceFont m6723copyF3nL8kk(int i, FontWeight fontWeight, int i2, int i3, FontVariation.Settings settings) {
    ...
    public boolean equals(Object obj) {
        ...
        return this.resId == resourceFont.resId && Intrinsics.areEqual((Object) getWeight(), (Object) resourceFont.getWeight()) && FontStyle.m6678equalsimpl0(m6726getStyle_LCdwA(), resourceFont.m6726getStyle_LCdwA()) && Intrinsics.areEqual((Object) this.variationSettings, (Object) resourceFont.variationSettings) && FontLoadingStrategy.m6665equalsimpl0(m6725getLoadingStrategyPKNRLFQ(), resourceFont.m6725getLoadingStrategyPKNRLFQ());
    }

    public int hashCode() {
        return (((((((this.resId * 31) + getWeight().hashCode()) * 31) + FontStyle.m6679hashCodeimpl(m6726getStyle_LCdwA())) * 31) + FontLoadingStrategy.m6666hashCodeimpl(m6725getLoadingStrategyPKNRLFQ())) * 31) + this.variationSettings.hashCode();
    }

    public String toString() {
        return "ResourceFont(resId=" + this.resId + ", weight=" + getWeight() + ", style=" + FontStyle.m6680toStringimpl(m6726getStyle_LCdwA()) + ", loadingStrategy=" + FontLoadingStrategy.m6667toStringimpl(m6725getLoadingStrategyPKNRLFQ()) + ')';
    }
}
