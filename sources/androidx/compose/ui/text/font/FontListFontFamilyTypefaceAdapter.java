...
public final class FontListFontFamilyTypefaceAdapter implements FontFamilyTypefaceAdapter {
    ...
    public final Object preload(FontFamily fontFamily, PlatformFontLoader platformFontLoader, Continuation<? super Unit> continuation) {
        ...
        for (int i = 0; i < size; i++) {
            ...
            if (FontLoadingStrategy.m6665equalsimpl0(font.m6649getLoadingStrategyPKNRLFQ(), FontLoadingStrategy.Companion.m6669getAsyncPKNRLFQ())) {
                arrayList.add(font);
            }
        }
        List list = arrayList;
        ...
        for (int i2 = 0; i2 < size2; i2++) {
            ...
            arrayList2.add(TuplesKt.to(font2.getWeight(), FontStyle.m6675boximpl(font2.m6650getStyle_LCdwA())));
        }
        ...
        while (i4 < size4) {
            ...
            int r3 = ((FontStyle) pair.component2()).m6681unboximpl();
            List list4 = (List) FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m6674matchFontRetOiIg((List<? extends Font>) fonts, fontWeight, r3), new TypefaceRequest(fontFamily2, fontWeight, r3, FontSynthesis.Companion.m6695getAllGVVA2EU(), platformFontLoader2.getCacheKey(), (DefaultConstructorMarker) null), this.asyncTypefaceCache, platformFontLoader2, FontListFontFamilyTypefaceAdapter$preload$2$1.INSTANCE).component1();
            if (list4 != null) {
    ...
    public TypefaceResult resolve(TypefaceRequest typefaceRequest, PlatformFontLoader platformFontLoader, Function1<? super TypefaceResult.Immutable, Unit> function1, Function1<? super TypefaceRequest, ? extends Object> function12) {
        ...
        Pair access$firstImmediatelyAvailable = FontListFontFamilyTypefaceAdapterKt.firstImmediatelyAvailable(fontMatcher.m6674matchFontRetOiIg((List<? extends Font>) ((FontListFontFamily) typefaceRequest.getFontFamily()).getFonts(), typefaceRequest.getFontWeight(), typefaceRequest.m6731getFontStyle_LCdwA()), typefaceRequest, this.asyncTypefaceCache, platformFontLoader, function12);
