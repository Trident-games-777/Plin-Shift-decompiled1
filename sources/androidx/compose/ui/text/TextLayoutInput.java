...
public final class TextLayoutInput {
    ...
    public final int m6533getOverflowgIe3tQ8() {
    ...
    public final long m6532getConstraintsmsEJaDk() {
    ...
    public static /* synthetic */ TextLayoutInput m6530copyhu1Yfo$default(TextLayoutInput textLayoutInput, AnnotatedString annotatedString, TextStyle textStyle, List<AnnotatedString.Range<Placeholder>> list, int i, boolean z, int i2, Density density2, LayoutDirection layoutDirection2, Font.ResourceLoader resourceLoader, long j, int i3, Object obj) {
        if ((i3 & 1) != 0) {
        ...
        int i5 = i;
        boolean z2 = z;
        return textLayoutInput.m6531copyhu1Yfo(annotatedString, textStyle, list, i5, z2, i4, density3, layoutDirection3, resourceLoader2, j2);
    }
    ...
    public final TextLayoutInput m6531copyhu1Yfo(AnnotatedString annotatedString, TextStyle textStyle, List<AnnotatedString.Range<Placeholder>> list, int i, boolean z, int i2, Density density2, LayoutDirection layoutDirection2, Font.ResourceLoader resourceLoader, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.text, (Object) textLayoutInput.text) && Intrinsics.areEqual((Object) this.style, (Object) textLayoutInput.style) && Intrinsics.areEqual((Object) this.placeholders, (Object) textLayoutInput.placeholders) && this.maxLines == textLayoutInput.maxLines && this.softWrap == textLayoutInput.softWrap && TextOverflow.m7030equalsimpl0(this.overflow, textLayoutInput.overflow) && Intrinsics.areEqual((Object) this.density, (Object) textLayoutInput.density) && this.layoutDirection == textLayoutInput.layoutDirection && Intrinsics.areEqual((Object) this.fontFamilyResolver, (Object) textLayoutInput.fontFamilyResolver) && Constraints.m7045equalsimpl0(this.constraints, textLayoutInput.constraints);
    }

    public int hashCode() {
        return (((((((((((((((((this.text.hashCode() * 31) + this.style.hashCode()) * 31) + this.placeholders.hashCode()) * 31) + this.maxLines) * 31) + Boolean.hashCode(this.softWrap)) * 31) + TextOverflow.m7031hashCodeimpl(this.overflow)) * 31) + this.density.hashCode()) * 31) + this.layoutDirection.hashCode()) * 31) + this.fontFamilyResolver.hashCode()) * 31) + Constraints.m7055hashCodeimpl(this.constraints);
    }

    public String toString() {
        return "TextLayoutInput(text=" + this.text + ", style=" + this.style + ", placeholders=" + this.placeholders + ", maxLines=" + this.maxLines + ", softWrap=" + this.softWrap + ", overflow=" + TextOverflow.m7032toStringimpl(this.overflow) + ", density=" + this.density + ", layoutDirection=" + this.layoutDirection + ", fontFamilyResolver=" + this.fontFamilyResolver + ", constraints=" + Constraints.m7057toStringimpl(this.constraints) + ')';
    }
}
