...
public final class ParagraphKt {
    ...
    public static final Paragraph Paragraph(String str, TextStyle textStyle, float f, Density density, FontFamily.Resolver resolver, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int i, boolean z) {
        return AndroidParagraph_androidKt.m6840ActualParagraphO3s9Psw(str, textStyle, list, list2, i, z, ConstraintsKt.Constraints$default(0, ceilToInt(f), 0, 0, 13, (Object) null), density, resolver);
    }

    /* renamed from: Paragraph-UdtVg6A$default  reason: not valid java name */
    public static /* synthetic */ Paragraph m6447ParagraphUdtVg6A$default(String str, TextStyle textStyle, long j, Density density, FontFamily.Resolver resolver, List list, List list2, int i, boolean z, int i2, Object obj) {
        List list3;
        int i3 = i2;
        List emptyList = (i3 & 32) != 0 ? CollectionsKt.emptyList() : list;
        if ((i3 & 64) != 0) {
        ...
        return m6446ParagraphUdtVg6A(str, textStyle, j, density, resolver, emptyList, list3, (i3 & 128) != 0 ? Integer.MAX_VALUE : i, (i3 & 256) != 0 ? false : z);
    }

    /* renamed from: Paragraph-UdtVg6A  reason: not valid java name */
    public static final Paragraph m6446ParagraphUdtVg6A(String str, TextStyle textStyle, long j, Density density, FontFamily.Resolver resolver, List<AnnotatedString.Range<SpanStyle>> list, List<AnnotatedString.Range<Placeholder>> list2, int i, boolean z) {
        int i2 = i;
        Density density2 = density;
        int i3 = i2;
        boolean z2 = z;
        FontFamily.Resolver resolver2 = resolver;
        return AndroidParagraph_androidKt.m6840ActualParagraphO3s9Psw(str, textStyle, list, list2, i3, z2, j, density2, resolver2);
    }
    ...
    public static final Paragraph Paragraph(ParagraphIntrinsics paragraphIntrinsics, int i, boolean z, float f) {
        return AndroidParagraph_androidKt.m6839ActualParagraphhBUhpc(paragraphIntrinsics, i, z, ConstraintsKt.Constraints$default(0, ceilToInt(f), 0, 0, 13, (Object) null));
    }

    /* renamed from: Paragraph-_EkL_-Y$default  reason: not valid java name */
    public static /* synthetic */ Paragraph m6449Paragraph_EkL_Y$default(ParagraphIntrinsics paragraphIntrinsics, long j, int i, boolean z, int i2, Object obj) {
        if ((i2 & 4) != 0) {
            i = Integer.MAX_VALUE;
        }
        if ((i2 & 8) != 0) {
        ...
        return m6448Paragraph_EkL_Y(paragraphIntrinsics, j, i, z);
    }

    /* renamed from: Paragraph-_EkL_-Y  reason: not valid java name */
    public static final Paragraph m6448Paragraph_EkL_Y(ParagraphIntrinsics paragraphIntrinsics, long j, int i, boolean z) {
        return AndroidParagraph_androidKt.m6839ActualParagraphhBUhpc(paragraphIntrinsics, i, z, j);
    }
