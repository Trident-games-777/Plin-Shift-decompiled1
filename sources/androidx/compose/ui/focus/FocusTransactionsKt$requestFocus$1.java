...
final class FocusTransactionsKt$requestFocus$1 extends Lambda implements Function0<Unit> {
    final /* synthetic */ FocusTargetNode $this_requestFocus;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    FocusTransactionsKt$requestFocus$1(FocusTargetNode focusTargetNode) {
        super(0);
