    ...
    public static final boolean requestFocus(FocusRequesterModifierNode focusRequesterModifierNode) {
        ...
        while (node != null) {
            if (node instanceof FocusTargetNode) {
                ...
                return TwoDimensionalFocusSearchKt.m3948findChildCorrespondingToFocusEnterOMvw8(focusTargetNode, FocusDirection.Companion.m3899getEnterdhqQ8s(), FocusRequesterModifierNodeKt$requestFocus$1$1.INSTANCE);
            }
                        ...
                        if (node2 == null) {
                            ...
                            while (node2 != null) {
                                if (node2 instanceof FocusTargetNode) {
                                    ...
                                    return TwoDimensionalFocusSearchKt.m3948findChildCorrespondingToFocusEnterOMvw8(focusTargetNode2, FocusDirection.Companion.m3899getEnterdhqQ8s(), FocusRequesterModifierNodeKt$requestFocus$1$1.INSTANCE);
                                }
