...
public interface FocusOwner extends FocusManager {
    ...
    boolean m3909clearFocusI7lrPNg(boolean z, boolean z2, boolean z3, int i);

    /* renamed from: dispatchInterceptedSoftKeyboardEvent-ZmokQxo  reason: not valid java name */
    boolean m3910dispatchInterceptedSoftKeyboardEventZmokQxo(KeyEvent keyEvent);

    /* renamed from: dispatchKeyEvent-YhN2O0w  reason: not valid java name */
    boolean m3911dispatchKeyEventYhN2O0w(KeyEvent keyEvent, Function0<Boolean> function0);
    ...
    Boolean m3912focusSearchULY8qGw(int i, Rect rect, Function1<? super FocusTargetNode, Boolean> function1);
    ...
    boolean m3913requestFocusForOwner7o62pno(FocusDirection focusDirection, Rect rect);
    ...
    boolean m3914takeFocusaToIllA(int i, Rect rect);

    /* renamed from: dispatchKeyEvent-YhN2O0w$default  reason: not valid java name */
    static /* synthetic */ boolean m3908dispatchKeyEventYhN2O0w$default(FocusOwner focusOwner, KeyEvent keyEvent, Function0 function0, int i, Object obj) {
        if (obj == null) {
            if ((i & 2) != 0) {
                function0 = FocusOwner$dispatchKeyEvent$1.INSTANCE;
            }
            return focusOwner.m3911dispatchKeyEventYhN2O0w(keyEvent, function0);
        }
