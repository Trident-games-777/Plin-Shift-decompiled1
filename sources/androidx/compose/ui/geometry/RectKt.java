...
public final class RectKt {
    ...
    public static final Rect m4027Recttz77jQw(long j, long j2) {
        return new Rect(Offset.m3987getXimpl(j), Offset.m3988getYimpl(j), Offset.m3987getXimpl(j) + Size.m4056getWidthimpl(j2), Offset.m3988getYimpl(j) + Size.m4053getHeightimpl(j2));
    }

    /* renamed from: Rect-0a9Yr6o  reason: not valid java name */
    public static final Rect m4025Rect0a9Yr6o(long j, long j2) {
        return new Rect(Offset.m3987getXimpl(j), Offset.m3988getYimpl(j), Offset.m3987getXimpl(j2), Offset.m3988getYimpl(j2));
    }

    /* renamed from: Rect-3MmeM6k  reason: not valid java name */
    public static final Rect m4026Rect3MmeM6k(long j, float f) {
        return new Rect(Offset.m3987getXimpl(j) - f, Offset.m3988getYimpl(j) - f, Offset.m3987getXimpl(j) + f, Offset.m3988getYimpl(j) + f);
    }
