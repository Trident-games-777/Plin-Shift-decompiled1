...
public final class CornerRadiusKt {
    ...
    public static final long m3973lerp3Ry4LBc(long j, long j2, float f) {
        return CornerRadius(MathHelpersKt.lerp(CornerRadius.m3962getXimpl(j), CornerRadius.m3962getXimpl(j2), f), MathHelpersKt.lerp(CornerRadius.m3963getYimpl(j), CornerRadius.m3963getYimpl(j2), f));
    }

    public static final long CornerRadius(float f, float f2) {
        long floatToRawIntBits = (long) Float.floatToRawIntBits(f);
        return CornerRadius.m3956constructorimpl((((long) Float.floatToRawIntBits(f2)) & 4294967295L) | (floatToRawIntBits << 32));
    }
}
