...
public final class AndroidViewHolder_androidKt {
    ...
    public static final void layoutAccordingTo(View view, LayoutNode layoutNode) {
        ...
        int round = Math.round(Offset.m3987getXimpl(positionInRoot));
        int round2 = Math.round(Offset.m3988getYimpl(positionInRoot));
    ...
    public static final int toNestedScrollSource(int i) {
        if (i == 0) {
            return NestedScrollSource.Companion.m5481getUserInputWNlRxjI();
        }
        return NestedScrollSource.Companion.m5480getSideEffectWNlRxjI();
    }
}
