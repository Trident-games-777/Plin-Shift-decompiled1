...
public final class PlatformTextInputModifierNodeKt {
    private static final ProvidableCompositionLocal<ChainedPlatformTextInputInterceptor> LocalChainedPlatformTextInputInterceptor = CompositionLocalKt.staticCompositionLocalOf(PlatformTextInputModifierNodeKt$LocalChainedPlatformTextInputInterceptor$1.INSTANCE);
    ...
    public static final java.lang.Object establishTextInputSession(androidx.compose.ui.platform.PlatformTextInputModifierNode r4, kotlin.jvm.functions.Function2<? super androidx.compose.ui.platform.PlatformTextInputSessionScope, ? super kotlin.coroutines.Continuation<?>, ? extends java.lang.Object> r5, kotlin.coroutines.Continuation<?> r6) {
        ...
        L_0x0032:
            ...
            androidx.compose.runtime.ProvidableCompositionLocal<androidx.compose.ui.platform.ChainedPlatformTextInputInterceptor> r2 = LocalChainedPlatformTextInputInterceptor
    ...
    public static final void InterceptPlatformTextInput(PlatformTextInputInterceptor platformTextInputInterceptor, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        int i2;
        ...
        if ((i & 6) == 0) {
            i2 = ((i & 8) == 0 ? startRestartGroup.changed((Object) platformTextInputInterceptor) : startRestartGroup.changedInstance(platformTextInputInterceptor) ? 4 : 2) | i;
        } else {
            i2 = i;
        }
        if ((i & 48) == 0) {
        ...
        if ((i2 & 19) != 18 || !startRestartGroup.getSkipping()) {
            ...
            boolean changed = startRestartGroup.changed((Object) chainedPlatformTextInputInterceptor);
            ...
            CompositionLocalKt.CompositionLocalProvider((ProvidedValue<?>) providableCompositionLocal.provides(chainedPlatformTextInputInterceptor2), function2, startRestartGroup, (i2 & 112) | ProvidedValue.$stable);
            if (ComposerKt.isTraceInProgress()) {
        ...
        if (endRestartGroup != null) {
            endRestartGroup.updateScope(new PlatformTextInputModifierNodeKt$InterceptPlatformTextInput$1(platformTextInputInterceptor, function2, i));
        }
    }

    /* access modifiers changed from: private */
    /* JADX WARNING: Code restructure failed: missing block: B:17:0x0044, code lost:
        if (r5.textInputSession(r7, r0) == r1) goto L_0x0055;
     */
    /* JADX WARNING: Code restructure failed: missing block: B:21:0x0053, code lost:
        if (r6.textInputSession(r5, r7, r0) == r1) goto L_0x0055;
     */
