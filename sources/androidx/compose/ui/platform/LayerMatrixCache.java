...
public final class LayerMatrixCache<T> {
    ...
    public final float[] m6294calculateMatrixGrdbGEg(T t) {
        float[] fArr = this.matrixCache;
        if (fArr == null) {
            fArr = androidx.compose.ui.graphics.Matrix.m4474constructorimpl$default((float[]) null, 1, (DefaultConstructorMarker) null);
        ...
        if (matrix2 == null || !Intrinsics.areEqual((Object) matrix, (Object) matrix2)) {
            AndroidMatrixConversions_androidKt.m4099setFromtUYjHk(fArr, matrix);
    ...
    public final float[] m6293calculateInverseMatrixbWbORWo(T t) {
        ...
        if (this.isInverseDirty) {
            this.isInverseValid = InvertMatrixKt.m6291invertToJiSxe2E(m6294calculateMatrixGrdbGEg(t), fArr);
