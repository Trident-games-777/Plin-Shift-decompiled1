        ...
        synchronized (map) {
            try {
                ...
                if (stateFlow2 == null) {
                    ...
                    stateFlow2 = FlowKt.stateIn(FlowKt.flow(new WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1$1(contentResolver, uriFor, new WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1$contentObserver$1(Channel$default, HandlerCompat.createAsync(Looper.getMainLooper())), Channel$default, context2, (Continuation<? super WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1$1>) null)), CoroutineScopeKt.MainScope(), SharingStarted.Companion.WhileSubscribed$default(SharingStarted.Companion, 0, 0, 3, (Object) null), Float.valueOf(Settings.Global.getFloat(context2.getContentResolver(), "animator_duration_scale", 1.0f)));
                    map.put(context2, stateFlow2);
                }
