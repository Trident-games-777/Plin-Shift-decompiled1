...
public interface ViewConfiguration {
    ...
    public static final class DefaultImpls {
        ...
        public static long m6338getMinimumTouchTargetSizeMYxV2XQ(ViewConfiguration viewConfiguration) {
            return ViewConfiguration.super.m6337getMinimumTouchTargetSizeMYxV2XQ();
        }
    ...
    /* renamed from: getMinimumTouchTargetSize-MYxV2XQ  reason: not valid java name */
    long m6337getMinimumTouchTargetSizeMYxV2XQ() {
        float f = (float) 48;
        return DpKt.m7133DpSizeYgX7TsA(Dp.m7111constructorimpl(f), Dp.m7111constructorimpl(f));
    }
}
