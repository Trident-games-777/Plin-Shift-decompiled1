...
public final class CompositionLocalsKt {
    ...
    private static final ProvidableCompositionLocal<GraphicsContext> LocalGraphicsContext = CompositionLocalKt.staticCompositionLocalOf(CompositionLocalsKt$LocalGraphicsContext$1.INSTANCE);
    ...
    private static final ProvidableCompositionLocal<Boolean> LocalProvidableScrollCaptureInProgress = CompositionLocalKt.compositionLocalOf$default((SnapshotMutationPolicy) null, CompositionLocalsKt$LocalProvidableScrollCaptureInProgress$1.INSTANCE, 1, (Object) null);
    ...
    public static final void ProvideCommonCompositionLocals(Owner owner, UriHandler uriHandler, Function2<? super Composer, ? super Integer, Unit> function2, Composer composer, int i) {
        ...
        if ((i & 6) == 0) {
            i2 = ((i & 8) == 0 ? startRestartGroup.changed((Object) owner) : startRestartGroup.changedInstance(owner) ? 4 : 2) | i;
        } else {
            i2 = i;
        }
        if ((i & 48) == 0) {
            i2 |= (i & 64) == 0 ? startRestartGroup.changed((Object) uriHandler) : startRestartGroup.changedInstance(uriHandler) ? 32 : 16;
        }
        if ((i & 384) == 0) {
