...
public final class DeviceRenderNodeData {
    ...
    public static /* synthetic */ DeviceRenderNodeData m6271copyfuCbV5c$default(DeviceRenderNodeData deviceRenderNodeData, long j, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2, float f3, float f4, float f5, int i7, int i8, float f6, float f7, float f8, float f9, float f10, float f11, boolean z, boolean z2, float f12, RenderEffect renderEffect2, int i9, int i10, Object obj) {
        int i11;
        RenderEffect renderEffect3;
        DeviceRenderNodeData deviceRenderNodeData2 = deviceRenderNodeData;
        int i12 = i10;
        long j2 = (i12 & 1) != 0 ? deviceRenderNodeData2.uniqueId : j;
        int i13 = (i12 & 2) != 0 ? deviceRenderNodeData2.left : i;
        int i14 = (i12 & 4) != 0 ? deviceRenderNodeData2.top : i2;
        int i15 = (i12 & 8) != 0 ? deviceRenderNodeData2.right : i3;
        int i16 = (i12 & 16) != 0 ? deviceRenderNodeData2.bottom : i4;
        int i17 = (i12 & 32) != 0 ? deviceRenderNodeData2.width : i5;
        int i18 = (i12 & 64) != 0 ? deviceRenderNodeData2.height : i6;
        float f13 = (i12 & 128) != 0 ? deviceRenderNodeData2.scaleX : f;
        float f14 = (i12 & 256) != 0 ? deviceRenderNodeData2.scaleY : f2;
        float f15 = (i12 & 512) != 0 ? deviceRenderNodeData2.translationX : f3;
        float f16 = (i12 & 1024) != 0 ? deviceRenderNodeData2.translationY : f4;
        float f17 = (i12 & 2048) != 0 ? deviceRenderNodeData2.elevation : f5;
        int i19 = (i12 & 4096) != 0 ? deviceRenderNodeData2.ambientShadowColor : i7;
        long j3 = j2;
        int i20 = (i12 & 8192) != 0 ? deviceRenderNodeData2.spotShadowColor : i8;
        float f18 = (i12 & 16384) != 0 ? deviceRenderNodeData2.rotationZ : f6;
        float f19 = (i12 & 32768) != 0 ? deviceRenderNodeData2.rotationX : f7;
        float f20 = (i10 & 65536) != 0 ? deviceRenderNodeData2.rotationY : f8;
        float f21 = (i10 & 131072) != 0 ? deviceRenderNodeData2.cameraDistance : f9;
        float f22 = (i10 & 262144) != 0 ? deviceRenderNodeData2.pivotX : f10;
        float f23 = (i10 & 524288) != 0 ? deviceRenderNodeData2.pivotY : f11;
        boolean z3 = (i10 & 1048576) != 0 ? deviceRenderNodeData2.clipToOutline : z;
        boolean z4 = (i10 & 2097152) != 0 ? deviceRenderNodeData2.clipToBounds : z2;
        float f24 = (i10 & 4194304) != 0 ? deviceRenderNodeData2.alpha : f12;
        RenderEffect renderEffect4 = (i10 & 8388608) != 0 ? deviceRenderNodeData2.renderEffect : renderEffect2;
        if ((i10 & 16777216) != 0) {
            renderEffect3 = renderEffect4;
            i11 = deviceRenderNodeData2.compositingStrategy;
        } else {
            i11 = i9;
            renderEffect3 = renderEffect4;
        }
        return deviceRenderNodeData2.m6273copyfuCbV5c(j3, i13, i14, i15, i16, i17, i18, f13, f14, f15, f16, f17, i19, i20, f18, f19, f20, f21, f22, f23, z3, z4, f24, renderEffect3, i11);
    }
    ...
    public final int m6272component25NrFUSI() {
    ...
    public final DeviceRenderNodeData m6273copyfuCbV5c(long j, int i, int i2, int i3, int i4, int i5, int i6, float f, float f2, float f3, float f4, float f5, int i7, int i8, float f6, float f7, float f8, float f9, float f10, float f11, boolean z, boolean z2, float f12, RenderEffect renderEffect2, int i9) {
    ...
    public int hashCode() {
        ...
        return ((hashCode + (renderEffect2 == null ? 0 : renderEffect2.hashCode())) * 31) + CompositingStrategy.m4326hashCodeimpl(this.compositingStrategy);
    }
    ...
    public String toString() {
        ...
        sb.append(", renderEffect=").append(this.renderEffect).append(", compositingStrategy=").append(CompositingStrategy.m4327toStringimpl(this.compositingStrategy)).append(')');
        return sb.toString();
    }
    ...
    public final int m6274getCompositingStrategyNrFUSI() {
        return this.compositingStrategy;
    }

    /* renamed from: setCompositingStrategy-aDBOjCE  reason: not valid java name */
    public final void m6275setCompositingStrategyaDBOjCE(int i) {
