...
final class WindowRecomposer_androidKt$getAnimationScaleFlowFor$1$1$1 extends SuspendLambda implements Function2<FlowCollector<? super Float>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:23:0x0085, code lost:
        if (r4.emit(kotlin.coroutines.jvm.internal.Boxing.boxFloat(android.provider.Settings.Global.getFloat(r8.$applicationContext.getContentResolver(), "animator_duration_scale", 1.0f)), r8) == r0) goto L_0x0087;
     */
