...
final class AndroidComposeView$_inputModeManager$1 extends Lambda implements Function1<InputMode, Boolean> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return m6241invokeiuPiT84(((InputMode) obj).m5109unboximpl());
    }

    /* renamed from: invoke-iuPiT84  reason: not valid java name */
    public final Boolean m6241invokeiuPiT84(int i) {
        boolean z;
        if (InputMode.m5106equalsimpl0(i, InputMode.Companion.m5111getTouchaOaMEAU())) {
            z = this.this$0.isInTouchMode();
        } else {
            z = InputMode.m5106equalsimpl0(i, InputMode.Companion.m5110getKeyboardaOaMEAU()) ? this.this$0.isInTouchMode() ? this.this$0.requestFocusFromTouch() : true : false;
        }
