...
public final class ApproachIntrinsicsMeasureScope$layout$1 implements MeasureResult {
    ...
    ApproachIntrinsicsMeasureScope$layout$1(int i, int i2, Map<AlignmentLine, Integer> map, Function1<? super RulerScope, Unit> function1) {
        this.$w = i;
        this.$h = i2;
