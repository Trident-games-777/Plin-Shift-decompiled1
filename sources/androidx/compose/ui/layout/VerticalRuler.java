...
public final class VerticalRuler extends Ruler {
    ...
    public float calculateCoordinate$ui_release(float f, LayoutCoordinates layoutCoordinates, LayoutCoordinates layoutCoordinates2) {
        return Offset.m3987getXimpl(layoutCoordinates2.m5801localPositionOfR5De75A(layoutCoordinates, OffsetKt.Offset(f, ((float) IntSize.m7282getHeightimpl(layoutCoordinates.m5800getSizeYbymL2g())) / 2.0f)));
    }
}
