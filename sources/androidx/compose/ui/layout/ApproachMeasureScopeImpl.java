...
public final class ApproachMeasureScopeImpl implements ApproachMeasureScope, MeasureScope, LookaheadScope {
    ...
    public int m5737roundToPxR2X_6o(long j) {
        return this.coordinator.m7085roundToPxR2X_6o(j);
    }

    /* renamed from: roundToPx-0680j_4  reason: not valid java name */
    public int m5738roundToPx0680j_4(float f) {
        return this.coordinator.m7086roundToPx0680j_4(f);
    }

    /* renamed from: toDp-GaN1DYA  reason: not valid java name */
    public float m5739toDpGaN1DYA(long j) {
        return this.coordinator.m7222toDpGaN1DYA(j);
    }

    /* renamed from: toDp-u2uoSUM  reason: not valid java name */
    public float m5740toDpu2uoSUM(float f) {
        return this.coordinator.m7087toDpu2uoSUM(f);
    }

    /* renamed from: toDp-u2uoSUM  reason: not valid java name */
    public float m5741toDpu2uoSUM(int i) {
        return this.coordinator.m7088toDpu2uoSUM(i);
    }

    /* renamed from: toDpSize-k-rfVVM  reason: not valid java name */
    public long m5742toDpSizekrfVVM(long j) {
        return this.coordinator.m7089toDpSizekrfVVM(j);
    }

    /* renamed from: toPx--R2X_6o  reason: not valid java name */
    public float m5743toPxR2X_6o(long j) {
        return this.coordinator.m7090toPxR2X_6o(j);
    }

    /* renamed from: toPx-0680j_4  reason: not valid java name */
    public float m5744toPx0680j_4(float f) {
        return this.coordinator.m7091toPx0680j_4(f);
    }
    ...
    public long m5745toSizeXkaWNTQ(long j) {
        return this.coordinator.m7092toSizeXkaWNTQ(j);
    }

    /* renamed from: toSp-0xMU5do  reason: not valid java name */
    public long m5746toSp0xMU5do(float f) {
        return this.coordinator.m7223toSp0xMU5do(f);
    }

    /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
    public long m5747toSpkPz2Gy4(float f) {
        return this.coordinator.m7093toSpkPz2Gy4(f);
    }

    /* renamed from: toSp-kPz2Gy4  reason: not valid java name */
    public long m5748toSpkPz2Gy4(int i) {
        return this.coordinator.m7094toSpkPz2Gy4(i);
    }
    ...
    public long m5735getLookaheadConstraintsmsEJaDk() {
        Constraints r0 = this.coordinator.m5987getLookaheadConstraintsDWUhwKw$ui_release();
        if (r0 != null) {
            return r0.m7058unboximpl();
        }
    ...
    public long m5736getLookaheadSizeYbymL2g() {
    ...
    public LayoutCoordinates getLookaheadScopeCoordinates(Placeable.PlacementScope placementScope) {
        ...
        if (lookaheadRoot$ui_release == null) {
        ...
        } else if (!lookaheadRoot$ui_release.isVirtualLookaheadRoot$ui_release()) {
            ...
            if (parent$ui_release == null || (nodeCoordinator = parent$ui_release.getInnerCoordinator$ui_release()) == null) {
                nodeCoordinator = lookaheadRoot$ui_release.getChildren$ui_release().get(0).getOuterCoordinator$ui_release();
            }
    ...
    public MeasureResult layout(int i, int i2, Map<AlignmentLine, Integer> map, Function1<? super RulerScope, Unit> function1, Function1<? super Placeable.PlacementScope, Unit> function12) {
        ...
        return new ApproachMeasureScopeImpl$layout$1(i, i2, map, function1, function12, this);
    }
}
