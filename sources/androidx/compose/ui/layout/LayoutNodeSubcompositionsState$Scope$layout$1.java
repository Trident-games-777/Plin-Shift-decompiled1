...
public final class LayoutNodeSubcompositionsState$Scope$layout$1 implements MeasureResult {
    ...
    LayoutNodeSubcompositionsState$Scope$layout$1(int i, int i2, Map<AlignmentLine, Integer> map, Function1<? super RulerScope, Unit> function1, LayoutNodeSubcompositionsState.Scope scope, LayoutNodeSubcompositionsState layoutNodeSubcompositionsState, Function1<? super Placeable.PlacementScope, Unit> function12) {
        this.$width = i;
        this.$height = i2;
