...
final class SharedTransitionScopeKt$SharedTransitionScope$1$2$1 extends Lambda implements Function1<ContentDrawScope, Unit> {
    final /* synthetic */ SharedTransitionScopeImpl $sharedScope;

    /* JADX INFO: super call moved to the top of the method (can break code semantics) */
    SharedTransitionScopeKt$SharedTransitionScope$1$2$1(SharedTransitionScopeImpl sharedTransitionScopeImpl) {
        super(1);
