...
final class EnterExitTransitionKt$createModifier$2$1 extends Lambda implements Function1<GraphicsLayerScope, Unit> {
    ...
    EnterExitTransitionKt$createModifier$2$1(boolean z, Function0<Boolean> function0) {
        super(1);
        this.$disableClip = z;
    ...
    public final void invoke(GraphicsLayerScope graphicsLayerScope) {
        graphicsLayerScope.setClip(!this.$disableClip && this.$isEnabled.invoke().booleanValue());
    }
}
