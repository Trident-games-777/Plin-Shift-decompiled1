...
public abstract class EnterTransition {
    ...
    public final EnterTransition plus(EnterTransition enterTransition) {
        ...
        return new EnterTransitionImpl(new TransitionData(fade, slide, changeSize, scale, false, MapsKt.plus(getData$animation_release().getEffectsMap(), enterTransition.getData$animation_release().getEffectsMap()), 16, (DefaultConstructorMarker) null));
    }
