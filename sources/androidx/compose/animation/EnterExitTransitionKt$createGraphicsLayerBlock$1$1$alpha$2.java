...
final class EnterExitTransitionKt$createGraphicsLayerBlock$1$1$alpha$2 extends Lambda implements Function1<EnterExitState, Float> {
    ...
    EnterExitTransitionKt$createGraphicsLayerBlock$1$1$alpha$2(EnterTransition enterTransition, ExitTransition exitTransition) {
        super(1);
