...
final class VectorConvertersKt$IntOffsetToVector$1 extends Lambda implements Function1<IntOffset, AnimationVector2D> {
    ...
    public /* bridge */ /* synthetic */ Object invoke(Object obj) {
        return m207invokegyyYBs(((IntOffset) obj).m7250unboximpl());
    }

    /* renamed from: invoke--gyyYBs  reason: not valid java name */
    public final AnimationVector2D m207invokegyyYBs(long j) {
        return new AnimationVector2D((float) IntOffset.m7241getXimpl(j), (float) IntOffset.m7242getYimpl(j));
    }
}
