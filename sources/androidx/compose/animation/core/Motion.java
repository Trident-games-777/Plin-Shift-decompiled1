...
public final class Motion {
    ...
    public static final /* synthetic */ Motion m170boximpl(long j) {
        return new Motion(j);
    }
    ...
    public static boolean m174equalsimpl(long j, Object obj) {
        return (obj instanceof Motion) && j == ((Motion) obj).m180unboximpl();
    }
    ...
    public static String m179toStringimpl(long j) {
        return "Motion(packedValue=" + j + ')';
    }

    public boolean equals(Object obj) {
        return m174equalsimpl(this.packedValue, obj);
    }

    public int hashCode() {
        return m178hashCodeimpl(this.packedValue);
    }

    public String toString() {
        return m179toStringimpl(this.packedValue);
    }
    ...
    public static final long m172copyXB9eQnU(long j, float f, float f2) {
        return SpringSimulationKt.Motion(f, f2);
    }

    /* renamed from: copy-XB9eQnU$default  reason: not valid java name */
    public static /* synthetic */ long m173copyXB9eQnU$default(long j, float f, float f2, int i, Object obj) {
        if ((i & 1) != 0) {
            f = m176getValueimpl(j);
        }
        if ((i & 2) != 0) {
            f2 = m177getVelocityimpl(j);
        }
        return m172copyXB9eQnU(j, f, f2);
    }

    /* renamed from: getValue-impl  reason: not valid java name */
    public static final float m176getValueimpl(long j) {
        return Float.intBitsToFloat((int) (j >> 32));
    }

    /* renamed from: getVelocity-impl  reason: not valid java name */
    public static final float m177getVelocityimpl(long j) {
