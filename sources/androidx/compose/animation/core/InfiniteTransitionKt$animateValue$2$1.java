...
final class InfiniteTransitionKt$animateValue$2$1 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
    ...
    InfiniteTransitionKt$animateValue$2$1(InfiniteTransition infiniteTransition, InfiniteTransition.TransitionAnimationState<T, V> transitionAnimationState) {
        super(1);
    ...
    public final DisposableEffectResult invoke(DisposableEffectScope disposableEffectScope) {
        ...
        return new InfiniteTransitionKt$animateValue$2$1$invoke$$inlined$onDispose$1(this.$this_animateValue, this.$transitionAnimation);
    }
}
