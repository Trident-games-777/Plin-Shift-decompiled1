...
final class StartDelayAnimationSpec<T> implements AnimationSpec<T> {
    ...
    public StartDelayAnimationSpec(AnimationSpec<T> animationSpec2, long j) {
    ...
    public boolean equals(Object obj) {
        ...
        if (startDelayAnimationSpec.startDelayNanos != this.startDelayNanos || !Intrinsics.areEqual((Object) startDelayAnimationSpec.animationSpec, (Object) this.animationSpec)) {
            return false;
        }
        return true;
    }
