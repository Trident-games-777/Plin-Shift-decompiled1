        ...
        if ((i2 & 3) != 2 || !startRestartGroup.getSkipping()) {
            ...
            if (isRunning() || getRefreshChildNeeded()) {
                ...
                if (changedInstance || rememberedValue2 == Composer.Companion.getEmpty()) {
                    rememberedValue2 = new InfiniteTransition$run$1$1(mutableState, this, (Continuation<? super InfiniteTransition$run$1$1>) null);
                    startRestartGroup.updateRememberedValue(rememberedValue2);
                }
                ComposerKt.sourceInformationMarkerEnd(startRestartGroup);
                EffectsKt.LaunchedEffect((Object) this, (Function2<? super CoroutineScope, ? super Continuation<? super Unit>, ? extends Object>) (Function2) rememberedValue2, startRestartGroup, i2 & 14);
