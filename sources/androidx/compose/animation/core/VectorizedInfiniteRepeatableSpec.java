...
public final class VectorizedInfiniteRepeatableSpec<V extends AnimationVector> implements VectorizedAnimationSpec<V> {
    ...
    public /* synthetic */ VectorizedInfiniteRepeatableSpec(VectorizedDurationBasedAnimationSpec vectorizedDurationBasedAnimationSpec, RepeatMode repeatMode2, long j, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(vectorizedDurationBasedAnimationSpec, (i & 2) != 0 ? RepeatMode.Restart : repeatMode2, (i & 4) != 0 ? StartOffset.m186constructorimpl$default(0, 0, 2, (DefaultConstructorMarker) null) : j, (DefaultConstructorMarker) null);
    }
    ...
    public /* synthetic */ VectorizedInfiniteRepeatableSpec(VectorizedDurationBasedAnimationSpec vectorizedDurationBasedAnimationSpec, RepeatMode repeatMode2) {
        this(vectorizedDurationBasedAnimationSpec, repeatMode2, StartOffset.m186constructorimpl$default(0, 0, 2, (DefaultConstructorMarker) null), (DefaultConstructorMarker) null);
    }
    ...
    private final V repetitionStartVelocity(long j, V v, V v2, V v3) {
        ...
        return this.animation.getVelocityFromNanos(j3 - j2, v, v3, v2);
    }

    public V getValueFromNanos(long j, V v, V v2, V v3) {
        V v4 = v;
        V v5 = v2;
        return this.animation.getValueFromNanos(repetitionPlayTimeNanos(j), v4, v5, repetitionStartVelocity(j, v4, v3, v5));
    }

    public V getVelocityFromNanos(long j, V v, V v2, V v3) {
        V v4 = v;
        V v5 = v2;
        return this.animation.getVelocityFromNanos(repetitionPlayTimeNanos(j), v4, v5, repetitionStartVelocity(j, v4, v3, v5));
    }
}
