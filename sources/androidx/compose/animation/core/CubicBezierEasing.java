...
public final class CubicBezierEasing implements Easing {
    ...
    public float transform(float f) {
        if (f > 0.0f && f < 1.0f) {
            float findFirstCubicRoot = BezierKt.findFirstCubicRoot(0.0f - f, this.f80a - f, this.c - f, 1.0f - f);
    ...
    private final void throwNoSolution(float f) {
        throw new IllegalArgumentException("The cubic curve with parameters (" + this.f80a + ", " + this.b + ", " + this.c + ", " + this.d + ") has no solution at " + f);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return this.f80a == cubicBezierEasing.f80a && this.b == cubicBezierEasing.b && this.c == cubicBezierEasing.c && this.d == cubicBezierEasing.d;
    }

    public int hashCode() {
        return (((((Float.hashCode(this.f80a) * 31) + Float.hashCode(this.b)) * 31) + Float.hashCode(this.c)) * 31) + Float.hashCode(this.d);
    }

    public String toString() {
        return "CubicBezierEasing(a=" + this.f80a + ", b=" + this.b + ", c=" + this.c + ", d=" + this.d + ')';
    }
}
