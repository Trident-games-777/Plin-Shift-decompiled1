...
final class SuspendAnimationKt$animate$6 extends Lambda implements Function1<Long, Unit> {
    ...
    public final void invoke(long j) {
        ...
        long j2 = j;
        T animationScope = new AnimationScope(t, typeConverter, v, j2, targetValue, j, true, new Function0<Unit>() {
            public final void invoke() {
                animationState.setRunning$animation_core_release(false);
            }
        });
        SuspendAnimationKt.doAnimationFrameWithScale(animationScope, j2, this.$durationScale, this.$animation, this.$this_animate, this.$block);
