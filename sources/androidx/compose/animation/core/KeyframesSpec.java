...
public final class KeyframesSpec<T> implements DurationBasedAnimationSpec<T> {
    ...
    public static final class KeyframesSpecConfig<T> extends KeyframesSpecBaseConfig<T, KeyframeEntity<T>> {
        ...
        public KeyframeEntity<T> createEntityFor$animation_core_release(T t) {
            return new KeyframeEntity<>(t, (Easing) null, 0, 6, (DefaultConstructorMarker) null);
        }

        public KeyframeEntity<T> at(T t, int i) {
            KeyframeEntity<T> keyframeEntity = new KeyframeEntity<>(t, (Easing) null, 0, 6, (DefaultConstructorMarker) null);
            getKeyframes$animation_core_release().set(i, keyframeEntity);
            return keyframeEntity;
        }

        public KeyframeEntity<T> atFraction(T t, float f) {
            return at((Object) t, Math.round(((float) getDurationMillis()) * f));
        }
        ...
        public final KeyframeEntity<T> m169usingngzHuyU(KeyframeEntity<T> keyframeEntity, int i) {
            keyframeEntity.m168setArcModeRur9ykg$animation_core_release(i);
            return keyframeEntity;
        }
    }
    ...
    public <V extends AnimationVector> VectorizedKeyframesSpec<V> vectorize(TwoWayConverter<T, V> twoWayConverter) {
                ...
                if ((((~j) << 7) & j & -9187201950435737472L) != -9187201950435737472L) {
                    ...
                    while (i5 < i4) {
                        if ((255 & j) < 128) {
                            ...
                            jArr2 = jArr3;
                            iArr2 = iArr3;
                            mutableIntObjectMap.set(i7, new VectorizedKeyframeSpecElementInfo((AnimationVector) twoWayConverter.getConvertToVector().invoke(keyframeEntity.getValue$animation_core_release()), keyframeEntity.getEasing$animation_core_release(), keyframeEntity.m167getArcMode9TMq4$animation_core_release(), (DefaultConstructorMarker) null));
                        } else {
                            jArr2 = jArr3;
                            iArr2 = iArr3;
                            i = i3;
        ...
        mutableIntList.sort();
        return new VectorizedKeyframesSpec<>(mutableIntList, mutableIntObjectMap, this.config.getDurationMillis(), this.config.getDelayMillis(), EasingKt.getLinearEasing(), ArcMode.Companion.m164getArcLinear9TMq4(), (DefaultConstructorMarker) null);
    }
    ...
    public static final class KeyframeEntity<T> extends KeyframeBaseEntity<T> {
        ...
        public /* synthetic */ KeyframeEntity(Object obj, Easing easing, int i, int i2, DefaultConstructorMarker defaultConstructorMarker) {
            this(obj, (i2 & 2) != 0 ? EasingKt.getLinearEasing() : easing, (i2 & 4) != 0 ? ArcMode.Companion.m164getArcLinear9TMq4() : i, (DefaultConstructorMarker) null);
        }

        /* renamed from: getArcMode--9T-Mq4$animation_core_release  reason: not valid java name */
        public final int m167getArcMode9TMq4$animation_core_release() {
            return this.arcMode;
        }

        /* renamed from: setArcMode-Rur9ykg$animation_core_release  reason: not valid java name */
        public final void m168setArcModeRur9ykg$animation_core_release(int i) {
            this.arcMode = i;
        }
        ...
        public boolean equals(Object obj) {
            ...
            return Intrinsics.areEqual(keyframeEntity.getValue$animation_core_release(), getValue$animation_core_release()) && Intrinsics.areEqual((Object) keyframeEntity.getEasing$animation_core_release(), (Object) getEasing$animation_core_release()) && ArcMode.m158equalsimpl0(keyframeEntity.arcMode, this.arcMode);
        }

        public int hashCode() {
            Object value$animation_core_release = getValue$animation_core_release();
            return ((((value$animation_core_release != null ? value$animation_core_release.hashCode() : 0) * 31) + ArcMode.m159hashCodeimpl(this.arcMode)) * 31) + getEasing$animation_core_release().hashCode();
        }
    }
}
