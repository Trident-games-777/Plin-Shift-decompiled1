...
final class InfiniteTransitionKt$animateValue$1$1 extends Lambda implements Function0<Unit> {
    ...
    InfiniteTransitionKt$animateValue$1$1(T t, InfiniteTransition.TransitionAnimationState<T, V> transitionAnimationState, T t2, InfiniteRepeatableSpec<T> infiniteRepeatableSpec) {
        super(0);
        this.$initialValue = t;
