...
final class SizeAnimationModifierElement extends ModifierNodeElement<SizeAnimationModifierNode> {
    ...
    public static /* synthetic */ SizeAnimationModifierElement copy$default(SizeAnimationModifierElement sizeAnimationModifierElement, FiniteAnimationSpec<IntSize> finiteAnimationSpec, Alignment alignment2, Function2<IntSize, IntSize, Unit> function2, int i, Object obj) {
        if ((i & 1) != 0) {
            finiteAnimationSpec = sizeAnimationModifierElement.animationSpec;
        }
        if ((i & 2) != 0) {
            alignment2 = sizeAnimationModifierElement.alignment;
        }
        if ((i & 4) != 0) {
            function2 = sizeAnimationModifierElement.finishedListener;
        }
        return sizeAnimationModifierElement.copy(finiteAnimationSpec, alignment2, function2);
    }
    ...
    public final SizeAnimationModifierElement copy(FiniteAnimationSpec<IntSize> finiteAnimationSpec, Alignment alignment2, Function2<? super IntSize, ? super IntSize, Unit> function2) {
        return new SizeAnimationModifierElement(finiteAnimationSpec, alignment2, function2);
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Intrinsics.areEqual((Object) this.animationSpec, (Object) sizeAnimationModifierElement.animationSpec) && Intrinsics.areEqual((Object) this.alignment, (Object) sizeAnimationModifierElement.alignment) && Intrinsics.areEqual((Object) this.finishedListener, (Object) sizeAnimationModifierElement.finishedListener);
    }
    ...
    public SizeAnimationModifierElement(FiniteAnimationSpec<IntSize> finiteAnimationSpec, Alignment alignment2, Function2<? super IntSize, ? super IntSize, Unit> function2) {
