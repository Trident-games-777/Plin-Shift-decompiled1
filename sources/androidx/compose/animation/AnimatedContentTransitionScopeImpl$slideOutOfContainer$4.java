...
final class AnimatedContentTransitionScopeImpl$slideOutOfContainer$4 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int i) {
        ...
        return this.$targetOffset.invoke(Integer.valueOf((-IntOffset.m7242getYimpl(this.this$0.m61calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), r0))) + IntSize.m7282getHeightimpl(r0)));
    }
}
