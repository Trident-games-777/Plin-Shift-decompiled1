...
final class AnimatedContentTransitionScopeImpl$slideIntoContainer$3 extends Lambda implements Function1<Integer, Integer> {
    ...
    public final Integer invoke(int i) {
        return this.$initialOffset.invoke(Integer.valueOf(IntSize.m7282getHeightimpl(this.this$0.m62getCurrentSizeYbymL2g()) - IntOffset.m7242getYimpl(this.this$0.m61calculateOffsetemnUabE(IntSizeKt.IntSize(i, i), this.this$0.m62getCurrentSizeYbymL2g()))));
    }
}
