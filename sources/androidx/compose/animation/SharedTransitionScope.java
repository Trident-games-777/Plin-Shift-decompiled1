...
public interface SharedTransitionScope extends LookaheadScope {
    ...
    public interface PlaceHolderSize {
        ...
        long m115calculateSizeJyjRU_E(long j, long j2);
        ...
        public static final class Companion {
            ...
            private static final PlaceHolderSize animatedSize = SharedTransitionScope$PlaceHolderSize$Companion$animatedSize$1.INSTANCE;
            private static final PlaceHolderSize contentSize = SharedTransitionScope$PlaceHolderSize$Companion$contentSize$1.INSTANCE;
    ...
    EnterTransition scaleInSharedContentToBounds(ContentScale contentScale, Alignment alignment) {
        return EnterExitTransitionKt.withEffect(EnterTransition.Companion.getNone(), (TransitionEffect) new ContentScaleTransitionEffect(contentScale, alignment));
    }
    ...
    ExitTransition scaleOutSharedContentToBounds(ContentScale contentScale, Alignment alignment) {
        return EnterExitTransitionKt.withEffect(ExitTransition.Companion.getNone(), (TransitionEffect) new ContentScaleTransitionEffect(contentScale, alignment));
    }
    ...
    static /* synthetic */ Modifier renderInSharedTransitionScopeOverlay$default(SharedTransitionScope sharedTransitionScope, Modifier modifier, Function0 function0, float f, Function2 function2, int i, Object obj) {
        if (obj == null) {
            if ((i & 1) != 0) {
                function0 = new SharedTransitionScope$renderInSharedTransitionScopeOverlay$1(sharedTransitionScope);
            }
            if ((i & 2) != 0) {
                f = 0.0f;
            }
    ...
    static /* synthetic */ Modifier sharedBounds$default(SharedTransitionScope sharedTransitionScope, Modifier modifier, SharedContentState sharedContentState, AnimatedVisibilityScope animatedVisibilityScope, EnterTransition enterTransition, ExitTransition exitTransition, BoundsTransform boundsTransform, ResizeMode resizeMode, PlaceHolderSize placeHolderSize, boolean z, float f, OverlayClip overlayClip, int i, Object obj) {
        ...
        int i2 = i;
        if (obj == null) {
            EnterTransition fadeIn$default = (i2 & 4) != 0 ? EnterExitTransitionKt.fadeIn$default((FiniteAnimationSpec) null, 0.0f, 3, (Object) null) : enterTransition;
            ExitTransition fadeOut$default = (i2 & 8) != 0 ? EnterExitTransitionKt.fadeOut$default((FiniteAnimationSpec) null, 0.0f, 3, (Object) null) : exitTransition;
            BoundsTransform access$getDefaultBoundsTransform$p = (i2 & 16) != 0 ? SharedTransitionScopeKt.DefaultBoundsTransform : boundsTransform;
            ...
            return sharedTransitionScope.sharedBounds(modifier, sharedContentState, animatedVisibilityScope, fadeIn$default, fadeOut$default, access$getDefaultBoundsTransform$p, ScaleToBounds, contentSize, z2, f2, overlayClip2);
        }
    ...
    public static final class SharedContentState {
        ...
        private final MutableState internalState$delegate = SnapshotStateKt__SnapshotStateKt.mutableStateOf$default((Object) null, (SnapshotMutationPolicy) null, 2, (Object) null);
