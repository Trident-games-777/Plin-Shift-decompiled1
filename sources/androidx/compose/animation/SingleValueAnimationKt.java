...
public final class SingleValueAnimationKt {
    ...
    public static final State<Color> m123animateColorAsStateeuL9pac(long j, AnimationSpec<Color> animationSpec, String str, Function1<? super Color, Unit> function1, Composer composer, int i, int i2) {
        ...
        ColorSpace r2 = Color.m4243getColorSpaceimpl(j);
        ...
        if (changed || rememberedValue == Composer.Companion.getEmpty()) {
            rememberedValue = ColorVectorConverterKt.getVectorConverter(Color.Companion).invoke(Color.m4243getColorSpaceimpl(j));
            composer.updateRememberedValue(rememberedValue);
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
        int i3 = i << 6;
        State<Color> animateValueAsState = AnimateAsStateKt.animateValueAsState(Color.m4229boximpl(j), (TwoWayConverter) rememberedValue, animationSpec2, null, str2, function12, composer, (i & 14) | ((i << 3) & 896) | (57344 & i3) | (i3 & 458752), 8);
        if (ComposerKt.isTraceInProgress()) {
    ...
    public static final /* synthetic */ State m122animateColorAsStateKTwxG1Y(long j, AnimationSpec animationSpec, Function1 function1, Composer composer, int i, int i2) {
        int i3 = i;
        ...
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventStart(-1942442407, i3, -1, "androidx.compose.animation.animateColorAsState (SingleValueAnimation.kt:79)");
        }
        State<Color> r11 = m123animateColorAsStateeuL9pac(j, animationSpec2, (String) null, function12, composer, (i3 & WebSocketProtocol.PAYLOAD_SHORT) | ((i3 << 3) & 7168), 4);
        if (ComposerKt.isTraceInProgress()) {
            ComposerKt.traceEventEnd();
        }
        ComposerKt.sourceInformationMarkerEnd(composer);
    ...
    public static final Animatable<Color, AnimationVector4D> m121Animatable8_81llA(long j) {
        return new Animatable<>(Color.m4229boximpl(j), ColorVectorConverterKt.getVectorConverter(Color.Companion).invoke(Color.m4243getColorSpaceimpl(j)), (Object) null, (String) null, 12, (DefaultConstructorMarker) null);
    }
}
