...
public class MotionLayout extends ConstraintLayout implements NestedScrollingParent3 {
    ...
    public void touchAnimateTo(int i, float f, float f2) {
        if (this.mScene != null && this.mTransitionLastPosition != f) {
            ...
            if (i == 0 || i == 1 || i == 2) {
                float f3 = f2;
                float f4 = i == 1 ? 0.0f : i == 2 ? 1.0f : f;
                this.mStopLogic.config(this.mTransitionLastPosition, f4, f3, duration, this.mScene.getMaxAcceleration(), this.mScene.getMaxVelocity());
                int i2 = this.mCurrentState;
                ...
                if (willJump(f2, this.mTransitionLastPosition, this.mScene.getMaxAcceleration())) {
                    ...
                    float f5 = f;
                    this.mStopLogic.config(this.mTransitionLastPosition, f5, f2, this.mTransitionDuration, this.mScene.getMaxAcceleration(), this.mScene.getMaxVelocity());
