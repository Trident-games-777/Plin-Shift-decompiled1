...
public class ConstraintSet {
    ...
    public void center(int i, int i2, int i3, int i4, int i5, int i6, int i7, float f) {
        if (i4 < 0) {
            ...
            this.mConstraints.get(Integer.valueOf(i10)).layout.horizontalBias = f;
        } else if (i3 == 6 || i3 == 7) {
            int i11 = i6;
            int i12 = i7;
            int i13 = i;
            ...
            this.mConstraints.get(Integer.valueOf(i13)).layout.horizontalBias = f;
        } else {
            int i14 = i;
            connect(i14, 3, i2, i3, i4);
            int i15 = i14;
            connect(i15, 4, i5, i6, i7);
            this.mConstraints.get(Integer.valueOf(i15)).layout.verticalBias = f;
        }
    }
    ...
    public void centerHorizontally(int i, int i2, int i3, int i4, int i5, int i6, int i7, float f) {
        ...
        this.mConstraints.get(Integer.valueOf(i9)).layout.horizontalBias = f;
    }
    ...
    public void centerVertically(int i, int i2, int i3, int i4, int i5, int i6, int i7, float f) {
        ...
        this.mConstraints.get(Integer.valueOf(i9)).layout.verticalBias = f;
    }
    ...
    public void load(android.content.Context r9, org.xmlpull.v1.XmlPullParser r10) {
        /*
            r8 = this;
            int r0 = r10.getEventType()     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
            r1 = 0
            r2 = r1
        L_0x0006:
            r3 = 1
            ...
            goto L_0x0185
        L_0x0015:
            java.lang.String r0 = r10.getName()     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
        ...
        L_0x0023:
            ...
            java.util.HashMap<java.lang.Integer, androidx.constraintlayout.widget.ConstraintSet$Constraint> r0 = r8.mConstraints     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
        ...
        L_0x0037:
            java.lang.String r0 = r10.getName()     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
            int r7 = r0.hashCode()     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
            switch(r7) {
        ...
        L_0x0098:
            ...
            androidx.constraintlayout.widget.ConstraintAttribute.parse(r9, r10, r0)     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
            goto L_0x0185
        L_0x00a1:
            ...
            int r10 = r10.getLineNumber()     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
            java.lang.StringBuilder r10 = r0.append(r10)     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
        ...
        L_0x00bc:
            ...
            android.util.AttributeSet r3 = android.util.Xml.asAttributeSet(r10)     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
            r0.fillFromAttributeList(r9, r3)     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
            goto L_0x0185
        L_0x00c9:
            java.lang.RuntimeException r9 = new java.lang.RuntimeException     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
            java.lang.StringBuilder r1 = new java.lang.StringBuilder     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
        ...
        L_0x013f:
            ...
            throw r9     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
        L_0x015a:
            android.util.AttributeSet r0 = android.util.Xml.asAttributeSet(r10)     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
            androidx.constraintlayout.widget.ConstraintSet$Constraint r0 = r8.fillFromAttributeList(r9, r0)     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
        ...
        L_0x0180:
            ...
            goto L_0x0185
        L_0x0182:
            r10.getName()     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
        L_0x0185:
            int r0 = r10.next()     // Catch:{ XmlPullParserException -> 0x0190, IOException -> 0x018b }
            goto L_0x0006
        L_0x018b:
            r9 = move-exception
            r9.printStackTrace()
