...
public final class PathIterator implements Iterator<PathSegment>, KMappedMarker {
    ...
    public final PathSegment.Type next(float[] fArr) {
        ...
        return next$default(this, fArr, 0, 2, (Object) null);
    }
    ...
    public PathIterator(Path path2, ConicEvaluation conicEvaluation2, float f) {
        PathIteratorImpl pathIteratorImpl;
        ...
        if (Build.VERSION.SDK_INT >= 34) {
            pathIteratorImpl = new PathIteratorApi34Impl(path2, conicEvaluation2, f);
        } else {
            pathIteratorImpl = new PathIteratorPreApi34Impl(path2, conicEvaluation2, f);
        }
        this.implementation = pathIteratorImpl;
    }
    ...
    public /* synthetic */ PathIterator(Path path2, ConicEvaluation conicEvaluation2, float f, int i, DefaultConstructorMarker defaultConstructorMarker) {
        this(path2, (i & 2) != 0 ? ConicEvaluation.AsQuadratics : conicEvaluation2, (i & 4) != 0 ? 0.25f : f);
    }
