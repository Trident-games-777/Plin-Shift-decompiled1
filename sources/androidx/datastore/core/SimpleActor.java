...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() {
                ...
                public final void invoke(Throwable th) {
                    ...
                    do {
                        Object r0 = ChannelResult.m9362getOrNullimpl(this.messageQueue.m9381tryReceivePtdJZtk());
                        if (r0 != null) {
    ...
    public final void offer(T t) {
        Object r7 = this.messageQueue.m9382trySendJP2dKIU(t);
        if (r7 instanceof ChannelResult.Closed) {
            Throwable r72 = ChannelResult.m9361exceptionOrNullimpl(r7);
            if (r72 == null) {
                r72 = new ClosedSendChannelException("Channel was closed normally");
            }
            throw r72;
        } else if (!ChannelResult.m9367isSuccessimpl(r7)) {
