...
public class NotificationCompat {
    ...
    static Action getActionCompatFromAction(Notification.Action action) {
        ...
        int semanticAction = Api28Impl.getSemanticAction(action2);
        ...
        if (Api23Impl.getIcon(action2) == null && action2.icon != 0) {
            return new Action(action2.icon, action2.title, action2.actionIntent, Api20Impl.getExtras(action2), remoteInputArr, (RemoteInput[]) null, z2, semanticAction, z3, isContextual, z4);
        }
        if (Api23Impl.getIcon(action2) != null) {
            iconCompat = IconCompat.createFromIconOrNullIfZeroResId(Api23Impl.getIcon(action2));
        }
        return new Action(iconCompat, action2.title, action2.actionIntent, Api20Impl.getExtras(action2), remoteInputArr, (RemoteInput[]) null, z2, semanticAction, z3, isContextual, z4);
    }
