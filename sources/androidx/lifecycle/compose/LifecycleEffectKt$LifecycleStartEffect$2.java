...
final class LifecycleEffectKt$LifecycleStartEffect$2 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    LifecycleEffectKt$LifecycleStartEffect$2(Object obj, Object obj2, LifecycleOwner lifecycleOwner, Function1<? super LifecycleStartStopEffectScope, ? extends LifecycleStopOrDisposeEffectResult> function1, int i, int i2) {
        super(2);
        this.$key1 = obj;
        this.$key2 = obj2;
