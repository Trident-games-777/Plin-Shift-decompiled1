...
final class LifecycleEffectKt$LifecycleStartEffect$3 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    LifecycleEffectKt$LifecycleStartEffect$3(Object obj, Object obj2, Object obj3, LifecycleOwner lifecycleOwner, Function1<? super LifecycleStartStopEffectScope, ? extends LifecycleStopOrDisposeEffectResult> function1, int i, int i2) {
        super(2);
        this.$key1 = obj;
        this.$key2 = obj2;
        this.$key3 = obj3;
