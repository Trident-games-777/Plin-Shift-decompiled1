...
final class LifecycleEffectKt$LifecycleResumeEffectImpl$1$1 extends Lambda implements Function1<DisposableEffectScope, DisposableEffectResult> {
    ...
    public /* synthetic */ class WhenMappings {
        ...
        static {
            ...
            L_0x0010:
                androidx.lifecycle.Lifecycle$Event r1 = androidx.lifecycle.Lifecycle.Event.ON_PAUSE     // Catch:{ NoSuchFieldError -> 0x0019 }
            ...
            L_0x0019:
                ...
                return
            */
            throw new UnsupportedOperationException("Method not decompiled: androidx.lifecycle.compose.LifecycleEffectKt$LifecycleResumeEffectImpl$1$1.WhenMappings.<clinit>():void");
        }
    }
    ...
    public final DisposableEffectResult invoke(DisposableEffectScope disposableEffectScope) {
        ...
        LifecycleEffectKt$LifecycleResumeEffectImpl$1$1$$ExternalSyntheticLambda0 lifecycleEffectKt$LifecycleResumeEffectImpl$1$1$$ExternalSyntheticLambda0 = new LifecycleEffectKt$LifecycleResumeEffectImpl$1$1$$ExternalSyntheticLambda0(this.$scope, objectRef, this.$effects);
        this.$lifecycleOwner.getLifecycle().addObserver(lifecycleEffectKt$LifecycleResumeEffectImpl$1$1$$ExternalSyntheticLambda0);
        return new LifecycleEffectKt$LifecycleResumeEffectImpl$1$1$invoke$$inlined$onDispose$1(this.$lifecycleOwner, lifecycleEffectKt$LifecycleResumeEffectImpl$1$1$$ExternalSyntheticLambda0, objectRef);
    }
