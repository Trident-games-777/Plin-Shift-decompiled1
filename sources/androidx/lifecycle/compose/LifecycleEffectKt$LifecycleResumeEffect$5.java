...
final class LifecycleEffectKt$LifecycleResumeEffect$5 extends Lambda implements Function2<Composer, Integer, Unit> {
    ...
    LifecycleEffectKt$LifecycleResumeEffect$5(LifecycleOwner lifecycleOwner, Function1<? super LifecycleResumePauseEffectScope, ? extends LifecyclePauseOrDisposeEffectResult> function1, int i, int i2) {
        super(2);
