...
final class FlowLiveDataConversions$asFlow$1 extends SuspendLambda implements Function2<ProducerScope<? super T>, Continuation<? super Unit>, Object> {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x006b, code lost:
        if (kotlinx.coroutines.BuildersKt.withContext(kotlinx.coroutines.Dispatchers.getMain().getImmediate(), new androidx.lifecycle.FlowLiveDataConversions$asFlow$1.AnonymousClass1((kotlin.coroutines.Continuation<? super androidx.lifecycle.FlowLiveDataConversions$asFlow$1.AnonymousClass1>) null), r9) == r0) goto L_0x00c9;
     */
    /* JADX WARNING: Removed duplicated region for block: B:25:0x009c A[Catch:{ all -> 0x0037 }] */
    ...
    public final java.lang.Object invokeSuspend(java.lang.Object r10) {
        ...
        L_0x0041:
            ...
            goto L_0x00c9
        L_0x006e:
            kotlinx.coroutines.MainCoroutineDispatcher r10 = kotlinx.coroutines.Dispatchers.getMain()     // Catch:{ all -> 0x0037 }
            kotlinx.coroutines.MainCoroutineDispatcher r10 = r10.getImmediate()     // Catch:{ all -> 0x0037 }
            kotlin.coroutines.CoroutineContext r10 = (kotlin.coroutines.CoroutineContext) r10     // Catch:{ all -> 0x0037 }
            androidx.lifecycle.FlowLiveDataConversions$asFlow$1$2 r5 = new androidx.lifecycle.FlowLiveDataConversions$asFlow$1$2     // Catch:{ all -> 0x0037 }
            androidx.lifecycle.LiveData<T> r7 = r9.$this_asFlow     // Catch:{ all -> 0x0037 }
            r5.<init>(r7, r1, r6)     // Catch:{ all -> 0x0037 }
            kotlin.jvm.functions.Function2 r5 = (kotlin.jvm.functions.Function2) r5     // Catch:{ all -> 0x0037 }
            r7 = r9
            kotlin.coroutines.Continuation r7 = (kotlin.coroutines.Continuation) r7     // Catch:{ all -> 0x0037 }
            r9.L$0 = r1     // Catch:{ all -> 0x0037 }
            r9.label = r4     // Catch:{ all -> 0x0037 }
            java.lang.Object r10 = kotlinx.coroutines.BuildersKt.withContext(r10, r5, r7)     // Catch:{ all -> 0x0037 }
            if (r10 != r0) goto L_0x008f
            goto L_0x00c9
        L_0x008f:
            r10 = r9
            kotlin.coroutines.Continuation r10 = (kotlin.coroutines.Continuation) r10     // Catch:{ all -> 0x0037 }
            r9.L$0 = r1     // Catch:{ all -> 0x0037 }
            r9.label = r3     // Catch:{ all -> 0x0037 }
            java.lang.Object r10 = kotlinx.coroutines.DelayKt.awaitCancellation(r10)     // Catch:{ all -> 0x0037 }
            if (r10 != r0) goto L_0x009d
            goto L_0x00c9
        L_0x009d:
            kotlin.KotlinNothingValueException r10 = new kotlin.KotlinNothingValueException     // Catch:{ all -> 0x0037 }
            r10.<init>()     // Catch:{ all -> 0x0037 }
    ...
    public static final void invokeSuspend$lambda$0(ProducerScope producerScope, Object obj) {
        producerScope.m9382trySendJP2dKIU(obj);
    }
}
