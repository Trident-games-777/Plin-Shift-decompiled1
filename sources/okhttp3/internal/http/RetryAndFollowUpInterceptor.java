...
public final class RetryAndFollowUpInterceptor implements Interceptor {
    ...
    public okhttp3.Response intercept(okhttp3.Interceptor.Chain r11) throws java.io.IOException {
        ...
        L_0x0019:
            ...
            boolean r6 = r1.isCanceled()     // Catch:{ all -> 0x00df }
            if (r6 != 0) goto L_0x00d7
            okhttp3.Response r0 = r11.proceed(r0)     // Catch:{ RouteException -> 0x00b1, IOException -> 0x0099 }
            if (r7 == 0) goto L_0x0040
            okhttp3.Response$Builder r0 = r0.newBuilder()     // Catch:{ all -> 0x00df }
            okhttp3.Response$Builder r6 = r7.newBuilder()     // Catch:{ all -> 0x00df }
            okhttp3.Response$Builder r6 = r6.body(r4)     // Catch:{ all -> 0x00df }
            okhttp3.Response r6 = r6.build()     // Catch:{ all -> 0x00df }
            okhttp3.Response$Builder r0 = r0.priorResponse(r6)     // Catch:{ all -> 0x00df }
            okhttp3.Response r0 = r0.build()     // Catch:{ all -> 0x00df }
        L_0x0040:
            r7 = r0
            okhttp3.internal.connection.Exchange r0 = r1.getInterceptorScopedExchange$okhttp()     // Catch:{ all -> 0x00df }
            okhttp3.Request r6 = r10.followUpRequest(r7, r0)     // Catch:{ all -> 0x00df }
            if (r6 != 0) goto L_0x005a
            if (r0 == 0) goto L_0x0056
            boolean r11 = r0.isDuplex$okhttp()     // Catch:{ all -> 0x00df }
            if (r11 == 0) goto L_0x0056
            r1.timeoutEarlyExit()     // Catch:{ all -> 0x00df }
        L_0x0056:
            r1.exitNetworkInterceptorExchange$okhttp(r3)
            return r7
        L_0x005a:
            okhttp3.RequestBody r0 = r6.body()     // Catch:{ all -> 0x00df }
            if (r0 == 0) goto L_0x006a
            boolean r0 = r0.isOneShot()     // Catch:{ all -> 0x00df }
            if (r0 == 0) goto L_0x006a
            r1.exitNetworkInterceptorExchange$okhttp(r3)
            return r7
        L_0x006a:
            okhttp3.ResponseBody r0 = r7.body()     // Catch:{ all -> 0x00df }
            if (r0 == 0) goto L_0x0075
            java.io.Closeable r0 = (java.io.Closeable) r0     // Catch:{ all -> 0x00df }
            okhttp3.internal.Util.closeQuietly((java.io.Closeable) r0)     // Catch:{ all -> 0x00df }
        L_0x0075:
            int r8 = r8 + 1
            r0 = 20
            ...
            goto L_0x0018
        L_0x0080:
            java.net.ProtocolException r11 = new java.net.ProtocolException     // Catch:{ all -> 0x00df }
        ...
        L_0x0099:
            r6 = move-exception
            boolean r9 = r6 instanceof okhttp3.internal.http2.ConnectionShutdownException     // Catch:{ all -> 0x00df }
            r9 = r9 ^ r5
            boolean r9 = r10.recover(r6, r1, r0, r9)     // Catch:{ all -> 0x00df }
            if (r9 == 0) goto L_0x00aa
            java.util.Collection r2 = (java.util.Collection) r2     // Catch:{ all -> 0x00df }
            java.util.List r2 = kotlin.collections.CollectionsKt.plus(r2, r6)     // Catch:{ all -> 0x00df }
            goto L_0x00c6
        L_0x00aa:
            java.lang.Exception r6 = (java.lang.Exception) r6     // Catch:{ all -> 0x00df }
            java.lang.Throwable r11 = okhttp3.internal.Util.withSuppressed(r6, r2)     // Catch:{ all -> 0x00df }
            throw r11     // Catch:{ all -> 0x00df }
        L_0x00b1:
            r6 = move-exception
            java.io.IOException r9 = r6.getLastConnectException()     // Catch:{ all -> 0x00df }
            boolean r9 = r10.recover(r9, r1, r0, r3)     // Catch:{ all -> 0x00df }
            if (r9 == 0) goto L_0x00cc
            java.util.Collection r2 = (java.util.Collection) r2     // Catch:{ all -> 0x00df }
            java.io.IOException r6 = r6.getFirstConnectException()     // Catch:{ all -> 0x00df }
            java.util.List r2 = kotlin.collections.CollectionsKt.plus(r2, r6)     // Catch:{ all -> 0x00df }
        L_0x00c6:
            r1.exitNetworkInterceptorExchange$okhttp(r5)
            r6 = r3
            goto L_0x0019
        L_0x00cc:
            java.io.IOException r11 = r6.getFirstConnectException()     // Catch:{ all -> 0x00df }
            java.lang.Exception r11 = (java.lang.Exception) r11     // Catch:{ all -> 0x00df }
            java.lang.Throwable r11 = okhttp3.internal.Util.withSuppressed(r11, r2)     // Catch:{ all -> 0x00df }
            throw r11     // Catch:{ all -> 0x00df }
        L_0x00d7:
            java.io.IOException r11 = new java.io.IOException     // Catch:{ all -> 0x00df }
