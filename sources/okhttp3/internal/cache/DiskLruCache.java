...
public final class DiskLruCache implements Closeable, Flushable {
    ...
    /* JADX WARNING: Code restructure failed: missing block: B:18:0x0072, code lost:
        if (r3.exhausted() == false) goto L_0x0074;
     */
    ...
    /* JADX WARNING: Unknown top exception splitter block from list: {B:16:0x0065=Splitter:B:16:0x0065, B:24:0x0085=Splitter:B:24:0x0085} */
    ...
    private final void readJournal() throws java.io.IOException {
        /*
            ...
            r3 = r2
            okio.BufferedSource r3 = (okio.BufferedSource) r3     // Catch:{ all -> 0x00b6 }
            java.lang.String r4 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x00b6 }
            java.lang.String r5 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x00b6 }
            java.lang.String r6 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x00b6 }
            java.lang.String r7 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x00b6 }
            java.lang.String r8 = r3.readUtf8LineStrict()     // Catch:{ all -> 0x00b6 }
            java.lang.String r9 = MAGIC     // Catch:{ all -> 0x00b6 }
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r9, (java.lang.Object) r4)     // Catch:{ all -> 0x00b6 }
            if (r9 == 0) goto L_0x0085
            java.lang.String r9 = VERSION_1     // Catch:{ all -> 0x00b6 }
            boolean r9 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r9, (java.lang.Object) r5)     // Catch:{ all -> 0x00b6 }
            if (r9 == 0) goto L_0x0085
            int r9 = r10.appVersion     // Catch:{ all -> 0x00b6 }
            java.lang.String r9 = java.lang.String.valueOf(r9)     // Catch:{ all -> 0x00b6 }
            boolean r6 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r9, (java.lang.Object) r6)     // Catch:{ all -> 0x00b6 }
            if (r6 == 0) goto L_0x0085
            int r6 = r10.valueCount     // Catch:{ all -> 0x00b6 }
            java.lang.String r6 = java.lang.String.valueOf(r6)     // Catch:{ all -> 0x00b6 }
            boolean r6 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r6, (java.lang.Object) r7)     // Catch:{ all -> 0x00b6 }
            if (r6 == 0) goto L_0x0085
            r6 = r8
            java.lang.CharSequence r6 = (java.lang.CharSequence) r6     // Catch:{ all -> 0x00b6 }
            int r6 = r6.length()     // Catch:{ all -> 0x00b6 }
            if (r6 > 0) goto L_0x0085
            r0 = 0
        L_0x005b:
            java.lang.String r1 = r3.readUtf8LineStrict()     // Catch:{ EOFException -> 0x0065 }
            r10.readJournalLine(r1)     // Catch:{ EOFException -> 0x0065 }
            int r0 = r0 + 1
            goto L_0x005b
        L_0x0065:
            java.util.LinkedHashMap<java.lang.String, okhttp3.internal.cache.DiskLruCache$Entry> r1 = r10.lruEntries     // Catch:{ all -> 0x00b6 }
            int r1 = r1.size()     // Catch:{ all -> 0x00b6 }
            int r0 = r0 - r1
            r10.redundantOpCount = r0     // Catch:{ all -> 0x00b6 }
            boolean r0 = r3.exhausted()     // Catch:{ all -> 0x00b6 }
            if (r0 != 0) goto L_0x0078
            r10.rebuildJournal$okhttp()     // Catch:{ all -> 0x00b6 }
            goto L_0x007e
        L_0x0078:
            okio.BufferedSink r0 = r10.newJournalWriter()     // Catch:{ all -> 0x00b6 }
            r10.journalWriter = r0     // Catch:{ all -> 0x00b6 }
        L_0x007e:
            ...
            return
        L_0x0085:
            java.io.IOException r3 = new java.io.IOException     // Catch:{ all -> 0x00b6 }
            java.lang.StringBuilder r6 = new java.lang.StringBuilder     // Catch:{ all -> 0x00b6 }
            r6.<init>(r1)     // Catch:{ all -> 0x00b6 }
            java.lang.StringBuilder r1 = r6.append(r4)     // Catch:{ all -> 0x00b6 }
            java.lang.StringBuilder r1 = r1.append(r0)     // Catch:{ all -> 0x00b6 }
            java.lang.StringBuilder r1 = r1.append(r5)     // Catch:{ all -> 0x00b6 }
            java.lang.StringBuilder r1 = r1.append(r0)     // Catch:{ all -> 0x00b6 }
            java.lang.StringBuilder r1 = r1.append(r7)     // Catch:{ all -> 0x00b6 }
            java.lang.StringBuilder r0 = r1.append(r0)     // Catch:{ all -> 0x00b6 }
            java.lang.StringBuilder r0 = r0.append(r8)     // Catch:{ all -> 0x00b6 }
            r1 = 93
            java.lang.StringBuilder r0 = r0.append(r1)     // Catch:{ all -> 0x00b6 }
            java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x00b6 }
            r3.<init>(r0)     // Catch:{ all -> 0x00b6 }
    ...
    public final class Editor {
        ...
        public final okio.Source newSource(int r5) {
            /*
                ...
                monitor-enter(r0)
                boolean r1 = r4.done     // Catch:{ all -> 0x0049 }
                if (r1 != 0) goto L_0x003d
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r4.entry     // Catch:{ all -> 0x0049 }
                boolean r1 = r1.getReadable$okhttp()     // Catch:{ all -> 0x0049 }
                r2 = 0
                if (r1 == 0) goto L_0x003b
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r4.entry     // Catch:{ all -> 0x0049 }
                okhttp3.internal.cache.DiskLruCache$Editor r1 = r1.getCurrentEditor$okhttp()     // Catch:{ all -> 0x0049 }
                boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r1, (java.lang.Object) r4)     // Catch:{ all -> 0x0049 }
                if (r1 == 0) goto L_0x003b
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r4.entry     // Catch:{ all -> 0x0049 }
                boolean r1 = r1.getZombie$okhttp()     // Catch:{ all -> 0x0049 }
                if (r1 == 0) goto L_0x0025
                goto L_0x003b
            L_0x0025:
                okhttp3.internal.io.FileSystem r1 = r0.getFileSystem$okhttp()     // Catch:{ FileNotFoundException -> 0x0039 }
                ...
                okio.Source r2 = r1.source(r5)     // Catch:{ FileNotFoundException -> 0x0039 }
            L_0x0039:
                monitor-exit(r0)
                return r2
            L_0x003b:
            ...
            L_0x003d:
                ...
                java.lang.IllegalStateException r1 = new java.lang.IllegalStateException     // Catch:{ all -> 0x0049 }
                java.lang.String r5 = r5.toString()     // Catch:{ all -> 0x0049 }
                r1.<init>(r5)     // Catch:{ all -> 0x0049 }
        ...
        public final okio.Sink newSink(int r4) {
            /*
                ...
                monitor-enter(r0)
                boolean r1 = r3.done     // Catch:{ all -> 0x005f }
                if (r1 != 0) goto L_0x0053
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r3.entry     // Catch:{ all -> 0x005f }
                okhttp3.internal.cache.DiskLruCache$Editor r1 = r1.getCurrentEditor$okhttp()     // Catch:{ all -> 0x005f }
                boolean r1 = kotlin.jvm.internal.Intrinsics.areEqual((java.lang.Object) r1, (java.lang.Object) r3)     // Catch:{ all -> 0x005f }
                if (r1 != 0) goto L_0x0019
                okio.Sink r4 = okio.Okio.blackhole()     // Catch:{ all -> 0x005f }
                monitor-exit(r0)
                return r4
            L_0x0019:
                okhttp3.internal.cache.DiskLruCache$Entry r1 = r3.entry     // Catch:{ all -> 0x005f }
                ...
                boolean[] r1 = r3.written     // Catch:{ all -> 0x005f }
            ...
            L_0x0029:
                ...
                java.lang.Object r4 = r1.get(r4)     // Catch:{ all -> 0x005f }
                java.io.File r4 = (java.io.File) r4     // Catch:{ all -> 0x005f }
                okhttp3.internal.io.FileSystem r1 = r0.getFileSystem$okhttp()     // Catch:{ FileNotFoundException -> 0x004d }
                okio.Sink r4 = r1.sink(r4)     // Catch:{ FileNotFoundException -> 0x004d }
                okhttp3.internal.cache.FaultHidingSink r1 = new okhttp3.internal.cache.FaultHidingSink     // Catch:{ all -> 0x005f }
                okhttp3.internal.cache.DiskLruCache$Editor$newSink$1$1 r2 = new okhttp3.internal.cache.DiskLruCache$Editor$newSink$1$1     // Catch:{ all -> 0x005f }
                r2.<init>(r0, r3)     // Catch:{ all -> 0x005f }
                kotlin.jvm.functions.Function1 r2 = (kotlin.jvm.functions.Function1) r2     // Catch:{ all -> 0x005f }
                r1.<init>(r4, r2)     // Catch:{ all -> 0x005f }
                okio.Sink r1 = (okio.Sink) r1     // Catch:{ all -> 0x005f }
                monitor-exit(r0)
                return r1
            L_0x004d:
                okio.Sink r4 = okio.Okio.blackhole()     // Catch:{ all -> 0x005f }
