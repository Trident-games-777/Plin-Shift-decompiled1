...
public final class RealWebSocket implements WebSocket, WebSocketReader.FrameCallback {
    ...
    public final synchronized boolean close(int r7, java.lang.String r8, long r9) {
        /*
            ...
            monitor-enter(r6)
            okhttp3.internal.ws.WebSocketProtocol r1 = okhttp3.internal.ws.WebSocketProtocol.INSTANCE     // Catch:{ all -> 0x0052 }
            r1.validateCloseCode(r7)     // Catch:{ all -> 0x0052 }
            if (r8 == 0) goto L_0x0033
            okio.ByteString$Companion r1 = okio.ByteString.Companion     // Catch:{ all -> 0x0052 }
            okio.ByteString r1 = r1.encodeUtf8(r8)     // Catch:{ all -> 0x0052 }
            int r2 = r1.size()     // Catch:{ all -> 0x0052 }
            ...
            goto L_0x0034
        L_0x001c:
            java.lang.StringBuilder r7 = new java.lang.StringBuilder     // Catch:{ all -> 0x0052 }
            r7.<init>(r0)     // Catch:{ all -> 0x0052 }
            java.lang.StringBuilder r7 = r7.append(r8)     // Catch:{ all -> 0x0052 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x0052 }
            java.lang.IllegalArgumentException r8 = new java.lang.IllegalArgumentException     // Catch:{ all -> 0x0052 }
            java.lang.String r7 = r7.toString()     // Catch:{ all -> 0x0052 }
        ...
        L_0x0033:
            r1 = 0
        L_0x0034:
            boolean r8 = r6.failed     // Catch:{ all -> 0x0052 }
            if (r8 != 0) goto L_0x004f
            boolean r8 = r6.enqueuedClose     // Catch:{ all -> 0x0052 }
            if (r8 == 0) goto L_0x003d
            goto L_0x004f
        L_0x003d:
            r8 = 1
            r6.enqueuedClose = r8     // Catch:{ all -> 0x0052 }
            java.util.ArrayDeque<java.lang.Object> r0 = r6.messageAndCloseQueue     // Catch:{ all -> 0x0052 }
            okhttp3.internal.ws.RealWebSocket$Close r2 = new okhttp3.internal.ws.RealWebSocket$Close     // Catch:{ all -> 0x0052 }
            r2.<init>(r7, r1, r9)     // Catch:{ all -> 0x0052 }
            r0.add(r2)     // Catch:{ all -> 0x0052 }
            r6.runWriter()     // Catch:{ all -> 0x0052 }
            monitor-exit(r6)
            return r8
        L_0x004f:
            monitor-exit(r6)
