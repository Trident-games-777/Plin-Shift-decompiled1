...
public final class Cache implements Closeable, Flushable {
    ...
    public Cache(File file, long j, FileSystem fileSystem) {
        ...
        this.cache = new DiskLruCache(fileSystem2, file, VERSION, 2, j, TaskRunner.INSTANCE);
    }
    ...
    public final File m9478deprecated_directory() {
        return this.cache.getDirectory();
    }
    ...
    private static final class Entry {
        ...
        public Entry(okio.Source r9) throws java.io.IOException {
            /*
                ...
                r2 = r1
                okio.Source r2 = (okio.Source) r2     // Catch:{ all -> 0x012d }
                okio.BufferedSource r9 = okio.Okio.buffer((okio.Source) r9)     // Catch:{ all -> 0x012d }
                java.lang.String r2 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x012d }
                okhttp3.HttpUrl$Companion r3 = okhttp3.HttpUrl.Companion     // Catch:{ all -> 0x012d }
                okhttp3.HttpUrl r3 = r3.parse(r2)     // Catch:{ all -> 0x012d }
                if (r3 == 0) goto L_0x0109
                r8.url = r3     // Catch:{ all -> 0x012d }
                java.lang.String r0 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x012d }
                r8.requestMethod = r0     // Catch:{ all -> 0x012d }
                okhttp3.Headers$Builder r0 = new okhttp3.Headers$Builder     // Catch:{ all -> 0x012d }
                r0.<init>()     // Catch:{ all -> 0x012d }
                okhttp3.Cache$Companion r2 = okhttp3.Cache.Companion     // Catch:{ all -> 0x012d }
                int r2 = r2.readInt$okhttp(r9)     // Catch:{ all -> 0x012d }
                r3 = 0
                r4 = r3
            L_0x0035:
                if (r4 >= r2) goto L_0x0041
                java.lang.String r5 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x012d }
                r0.addLenient$okhttp(r5)     // Catch:{ all -> 0x012d }
                int r4 = r4 + 1
                goto L_0x0035
            L_0x0041:
                okhttp3.Headers r0 = r0.build()     // Catch:{ all -> 0x012d }
                r8.varyHeaders = r0     // Catch:{ all -> 0x012d }
                okhttp3.internal.http.StatusLine$Companion r0 = okhttp3.internal.http.StatusLine.Companion     // Catch:{ all -> 0x012d }
                java.lang.String r2 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x012d }
                okhttp3.internal.http.StatusLine r0 = r0.parse(r2)     // Catch:{ all -> 0x012d }
                okhttp3.Protocol r2 = r0.protocol     // Catch:{ all -> 0x012d }
                r8.protocol = r2     // Catch:{ all -> 0x012d }
                int r2 = r0.code     // Catch:{ all -> 0x012d }
                r8.code = r2     // Catch:{ all -> 0x012d }
                java.lang.String r0 = r0.message     // Catch:{ all -> 0x012d }
                r8.message = r0     // Catch:{ all -> 0x012d }
                okhttp3.Headers$Builder r0 = new okhttp3.Headers$Builder     // Catch:{ all -> 0x012d }
                r0.<init>()     // Catch:{ all -> 0x012d }
                okhttp3.Cache$Companion r2 = okhttp3.Cache.Companion     // Catch:{ all -> 0x012d }
                int r2 = r2.readInt$okhttp(r9)     // Catch:{ all -> 0x012d }
            L_0x0068:
                ...
                java.lang.String r4 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x012d }
                r0.addLenient$okhttp(r4)     // Catch:{ all -> 0x012d }
                int r3 = r3 + 1
                goto L_0x0068
            L_0x0074:
                java.lang.String r2 = SENT_MILLIS     // Catch:{ all -> 0x012d }
                java.lang.String r3 = r0.get(r2)     // Catch:{ all -> 0x012d }
                java.lang.String r4 = RECEIVED_MILLIS     // Catch:{ all -> 0x012d }
                java.lang.String r5 = r0.get(r4)     // Catch:{ all -> 0x012d }
                r0.removeAll(r2)     // Catch:{ all -> 0x012d }
                r0.removeAll(r4)     // Catch:{ all -> 0x012d }
                r6 = 0
                if (r3 == 0) goto L_0x008f
                long r2 = java.lang.Long.parseLong(r3)     // Catch:{ all -> 0x012d }
                goto L_0x0090
            L_0x008f:
                r2 = r6
            L_0x0090:
                r8.sentRequestMillis = r2     // Catch:{ all -> 0x012d }
                if (r5 == 0) goto L_0x0098
                long r6 = java.lang.Long.parseLong(r5)     // Catch:{ all -> 0x012d }
            L_0x0098:
                r8.receivedResponseMillis = r6     // Catch:{ all -> 0x012d }
                okhttp3.Headers r0 = r0.build()     // Catch:{ all -> 0x012d }
                r8.responseHeaders = r0     // Catch:{ all -> 0x012d }
                boolean r0 = r8.isHttps()     // Catch:{ all -> 0x012d }
                r2 = 0
                if (r0 == 0) goto L_0x0101
                java.lang.String r0 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x012d }
                r3 = r0
                java.lang.CharSequence r3 = (java.lang.CharSequence) r3     // Catch:{ all -> 0x012d }
                int r3 = r3.length()     // Catch:{ all -> 0x012d }
                if (r3 > 0) goto L_0x00e2
                java.lang.String r0 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x012d }
                okhttp3.CipherSuite$Companion r3 = okhttp3.CipherSuite.Companion     // Catch:{ all -> 0x012d }
                okhttp3.CipherSuite r0 = r3.forJavaName(r0)     // Catch:{ all -> 0x012d }
                java.util.List r3 = r8.readCertificateList(r9)     // Catch:{ all -> 0x012d }
                java.util.List r4 = r8.readCertificateList(r9)     // Catch:{ all -> 0x012d }
                boolean r5 = r9.exhausted()     // Catch:{ all -> 0x012d }
                if (r5 != 0) goto L_0x00d7
                okhttp3.TlsVersion$Companion r5 = okhttp3.TlsVersion.Companion     // Catch:{ all -> 0x012d }
                java.lang.String r9 = r9.readUtf8LineStrict()     // Catch:{ all -> 0x012d }
                okhttp3.TlsVersion r9 = r5.forJavaName(r9)     // Catch:{ all -> 0x012d }
                goto L_0x00d9
            L_0x00d7:
                okhttp3.TlsVersion r9 = okhttp3.TlsVersion.SSL_3_0     // Catch:{ all -> 0x012d }
            L_0x00d9:
                okhttp3.Handshake$Companion r5 = okhttp3.Handshake.Companion     // Catch:{ all -> 0x012d }
                okhttp3.Handshake r9 = r5.get(r9, r0, r3, r4)     // Catch:{ all -> 0x012d }
                r8.handshake = r9     // Catch:{ all -> 0x012d }
                goto L_0x0103
            L_0x00e2:
                java.io.IOException r9 = new java.io.IOException     // Catch:{ all -> 0x012d }
                ...
                java.lang.StringBuilder r2 = r2.append(r3)     // Catch:{ all -> 0x012d }
                java.lang.StringBuilder r0 = r2.append(r0)     // Catch:{ all -> 0x012d }
                r2 = 34
                java.lang.StringBuilder r0 = r0.append(r2)     // Catch:{ all -> 0x012d }
                java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x012d }
                r9.<init>(r0)     // Catch:{ all -> 0x012d }
                throw r9     // Catch:{ all -> 0x012d }
            L_0x0101:
                r8.handshake = r2     // Catch:{ all -> 0x012d }
            L_0x0103:
                kotlin.Unit r9 = kotlin.Unit.INSTANCE     // Catch:{ all -> 0x012d }
                kotlin.io.CloseableKt.closeFinally(r1, r2)
                return
            L_0x0109:
                java.io.IOException r9 = new java.io.IOException     // Catch:{ all -> 0x012d }
                java.lang.StringBuilder r3 = new java.lang.StringBuilder     // Catch:{ all -> 0x012d }
                r3.<init>(r0)     // Catch:{ all -> 0x012d }
                java.lang.StringBuilder r0 = r3.append(r2)     // Catch:{ all -> 0x012d }
                java.lang.String r0 = r0.toString()     // Catch:{ all -> 0x012d }
                r9.<init>(r0)     // Catch:{ all -> 0x012d }
                okhttp3.internal.platform.Platform$Companion r0 = okhttp3.internal.platform.Platform.Companion     // Catch:{ all -> 0x012d }
                okhttp3.internal.platform.Platform r0 = r0.get()     // Catch:{ all -> 0x012d }
                java.lang.String r2 = "cache corruption"
                r3 = r9
                java.lang.Throwable r3 = (java.lang.Throwable) r3     // Catch:{ all -> 0x012d }
                r4 = 5
                r0.log(r2, r4, r3)     // Catch:{ all -> 0x012d }
                java.lang.Throwable r9 = (java.lang.Throwable) r9     // Catch:{ all -> 0x012d }
                throw r9     // Catch:{ all -> 0x012d }
            L_0x012d:
                r9 = move-exception
